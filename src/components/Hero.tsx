...
export function Hero({ lab }: HeroProps) {
  return (
    <section className="max-w-page-lg mx-auto px-3xl max-md:px-xl pt-5xl pb-4xl">
      ...
      <h1
        className="font-2 font-light text-[clamp(56px,9vw,132px)] leading-[.95] tracking-1 text-text max-w-[11ch] mb-2xl [&_em]:italic [&_em]:font-normal [&_em]:text-color-accent"
      ...
      />
      <p className="font-2 italic font-light text-7 leading-[1.35] text-text-dim max-w-col mt-xl">{lab.deck}</p>
    </section>
  );
}
