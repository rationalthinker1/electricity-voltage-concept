...
export function LabShell({
  ...
  return (
    <>
      ...
      <section>
        <div className="reveal in max-w-col-lg text-6 leading-5 text-text-dim [&_p]:mb-prose-3 [&_p_strong]:text-text [&_p_strong]:font-medium [&_strong]:text-text [&_strong]:font-medium [&_em]:italic [&_em]:text-text [&_h3]:font-2 [&_h3]:font-normal [&_h3]:italic [&_h3]:text-9 [&_h3]:leading-1 [&_h3]:my-4xl [&_h3]:mb-xl [&_h3]:text-text [&_h3]:tracking-1 [&_.pullout]:font-2 [&_.pullout]:italic [&_.pullout]:font-light [&_.pullout]:text-8 [&_.pullout]:leading-3 [&_.pullout]:text-text [&_.pullout]:py-xl [&_.pullout]:pr-0 [&_.pullout]:pl-2xl [&_.pullout]:my-2xl [&_.pullout]:border-l-2 [&_.pullout]:border-accent [&_.math]:font-2 [&_.math]:italic [&_.math]:text-8 [&_.math]:text-center [&_.math]:my-2xl [&_.math]:text-text [&_.math_sub]:text-[.55em] [&_.math_sup]:text-[.55em] [&_.kbd]:font-3 [&_.kbd]:text-[.85em] [&_.kbd]:text-accent [&_.kbd]:bg-accent-soft [&_.kbd]:py-xxs [&_.kbd]:px-md [&_.kbd]:rounded-2">{prose}</div>
