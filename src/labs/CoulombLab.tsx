  ...
  const prose = (
    <>
      ...
      <p className="mb-prose-3">
        ...
        distances of order 10⁻¹⁰ m up to the laboratory scale, with the inverse-square exponent confirmed to about <strong className="text-text font-medium">2 ± 2×10⁻¹⁶</strong> by
        Williams, Faller and Hill in 1971<Cite id="williams-faller-hill-1971" in={SOURCES} />.
      </p>
      <p className="mb-prose-3">
        It applies whenever the charges are <em className="italic text-text">static</em> (or moving slowly enough that retardation effects can be ignored) and can be
        treated as <em className="italic text-text">point-like</em>. Real charged objects of finite size that are close together violate it: the field of an extended
        distribution is only approximately <em className="italic text-text">kQ/r²</em> near the surface. The other invalid regime is the dynamic one — accelerating
      ...
      <ul>
        <li><strong className="text-text font-medium">F</strong> — magnitude of the electrostatic force on either charge, in newtons. Positive product Q₁Q₂ ⇒ repulsion; negative ⇒ attraction.</li>
        <li><strong className="text-text font-medium">Q₁, Q₂</strong> — the two point charges, in coulombs. Signed.</li>
        <li><strong className="text-text font-medium">r</strong> — the centre-to-centre separation between them, in meters.</li>
      ...
      <p className="mb-prose-3">
        The constant <strong className="text-text font-medium">k</strong> is large — by everyday standards, enormous. Two coulombs of charge separated by one meter would push
        each other apart with <strong className="text-text font-medium">~9×10⁹ N</strong>, roughly a billion kilograms' weight. Nothing in daily life shows this because
      ...
      <p className="mb-prose-3">
        That the exponent is exactly <strong className="text-text font-medium">2</strong> is empirical, but tied to the geometry of three-dimensional space: a sphere of radius
        <strong className="text-text font-medium"> r</strong> has area <strong className="text-text font-medium">4πr²</strong>, so a quantity radiated isotropically from a point dilutes as <strong className="text-text font-medium">1/r²</strong>.
        ...
        pushed that bound to <strong className="text-text font-medium">2 ± 2×10⁻¹⁶</strong><Cite id="williams-faller-hill-1971" in={SOURCES} />.
      </p>
      <p className="mb-prose-3">
        Limits and sanity checks: as <strong className="text-text font-medium">r → ∞</strong>, <strong className="text-text font-medium">F → 0</strong> — distant charges decouple. As <strong className="text-text font-medium">r → 0</strong>,
        <strong className="text-text font-medium"> F → ∞</strong> — the singularity is a sign that point charges are an idealization; real particles either have finite
      ...
      <p className="mb-prose-3">
        ...
        distance and reading the angle, he found the force to fall as <strong className="text-text font-medium">1/r²</strong>. By varying the magnitudes (charging one sphere,
      ...
      <p className="mb-prose-3">
        ...
        force that produces this null result is exactly <strong className="text-text font-medium">1/r²</strong><Cite id="cavendish-1773" in={SOURCES} />. Either route — direct
        measurement or the null test — converges on the same law.
      </p>
      <p className="mb-prose-3">
        The modern derivation goes the other way. Postulate Gauss's law, <strong className="text-text font-medium">∮ E·dA = Q/ε₀</strong>, plus the requirement that the field of an
      ...
      <TryIt
        tag="Problem 1.1.2"
        question={<>Take the same two charges from Problem 1.1.1. By what factor does the force change if you double the separation to <strong className="text-text font-medium">2 mm</strong>?</>}
        answer={
          <>
      ...
      <TryIt
        tag="Problem 1.1.3"
        question={<>Two electrons sit <strong className="text-text font-medium">1 Å</strong> (10⁻¹⁰ m) apart — roughly an interatomic spacing. Compute the electrostatic force, and the gravitational force, and their ratio.</>}
        answer={
          <>
      ...
      <TryIt
        tag="Problem 1.1.6"
        question={<>You triple <strong className="text-text font-medium">Q₁</strong> and halve <strong className="text-text font-medium">r</strong>. By what factor does the force change?</>}
        answer={
          <>
      ...
      <TryIt
        tag="Problem 1.1.9"
        question={<>Three charges sit on a line, equally spaced 1 cm apart: <strong className="text-text font-medium">+1 nC</strong> at x = 0, <strong className="text-text font-medium">+1 nC</strong> at x = 1 cm, <strong className="text-text font-medium">+1 nC</strong> at x = 2 cm. What is the net force on the middle charge?</>}
        answer={
          <>
      ...
      <TryIt
        tag="Problem 1.1.10"
        question={<>Write Coulomb's law in Gaussian (cgs-esu) units, where <strong className="text-text font-medium">F = q₁q₂/r²</strong> with no explicit constant. What is the value of "Coulomb's constant" in this unit system, and why?</>}
        answer={
          <>
      ...
      <TryIt
        tag="Problem 1.1.11"
        question={<>Why doesn't <strong className="text-text font-medium">F = kQ₁Q₂/r²</strong> hold for two charged metal spheres of finite radius when they are brought very close together? Be specific about what fails.</>}
        answer={
          <>
            <p className="mb-prose-3">Two effects break the point-charge approximation. First, <em className="italic text-text">induced polarization</em>: each sphere's charge redistributes in response to the other's field, so the centroids of charge no longer sit at the geometric centres — they shift toward each other (for opposite signs) or away (for same signs). Second, <em className="italic text-text">multipole structure</em>: even a uniformly charged sphere acts like a point charge only at distances large compared to its radius; close in, higher-order moments (induced by the neighbour) contribute<Cite id="griffiths-2017" in={SOURCES} />.</p>
            <p className="mb-prose-3">The shell theorem (a uniformly charged sphere produces the same external field as a point charge at its centre) is exact only for <em className="italic text-text">fixed</em> uniform charge — i.e. on an insulator. For two conductors, the redistribution is unavoidable, and the actual force at small separations is <em className="italic text-text">greater</em> than the naive Coulomb prediction.</p>
          </>
        }
      />
