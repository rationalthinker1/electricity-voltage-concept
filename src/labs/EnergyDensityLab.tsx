...
export default function EnergyDensityLab() {
  ...
  const labContent = (
    <LabGrid
      ...
      outputs={
        <>
          <Readout sym={<>u<sub>E</sub></>} label="Electric energy density" value={engJsx(computed.uE, 3, 'J/m³')} />
          <Readout sym={<>u<sub>B</sub></>} label="Magnetic energy density" value={engJsx(computed.uB, 3, 'J/m³')} />
          <Readout sym="u" label="Total energy density" value={engJsx(computed.u, 3, 'J/m³')} highlight />
          <Readout sym="U" label="Energy in volume" value={engJsx(computed.U, 3, 'J')} />
          <Readout sym="E*" label="E to match this B (= c·B)" value={engJsx(computed.EeqB, 3, 'V/m')} />
  ...
  const prose = (
    <>
      ...
      <p className="mb-prose-3">
        The trouble starts when you ask: <em className="italic text-text">where is the energy?</em> Assemble charges from infinity. You do positive work against their
      ...
      <p className="mb-prose-3">
        ...
        <strong className="text-text font-medium">E</strong> electric field magnitude (V/m). <strong className="text-text font-medium">B</strong> magnetic field magnitude (T). <strong className="text-text font-medium">ε<sub>0</sub></strong>
        and <strong className="text-text font-medium">µ<sub>0</sub></strong> the permittivity and permeability of free space. Total energy in a region is the volume integral
      ...
      <p className="mb-prose-3">
        Step two — recognize <strong className="text-text font-medium">Ad</strong> as the volume between the plates: precisely the region where the field lives. Energy per
      ...
      <p className="mb-prose-3">
        ...
        conservation theorem (Poynting's theorem) shows these formulas apply for <em className="italic text-text">any</em> electromagnetic field configuration in linear
      ...
      <TryIt
        tag="Problem 4.3.1"
        question={<>Electric field at air-breakdown threshold, <strong className="text-text font-medium">E = 3×10⁶ V/m</strong>. What is u<sub>E</sub>?</>}
        answer={
          <>
            <Formula>u<sub>E</sub> = ½ ε<sub>0</sub> E² = ½ (8.854×10⁻¹²)(3×10⁶)² = ½ (8.854×10⁻¹²)(9×10¹²)</Formula>
            <Formula>u<sub>E</sub> ≈ <strong className="text-text font-medium">40 J/m³</strong></Formula>
            <p className="mb-prose-3">The maximum energy density you can pack into an electric field in dry air at standard pressure. About the kinetic energy of
      ...
      <TryIt
        tag="Problem 4.3.2"
        question={<>A strong permanent magnet field of <strong className="text-text font-medium">B = 1 T</strong>. What is u<sub>B</sub>?</>}
        answer={
          <>
            <Formula>u<sub>B</sub> = B² / (2µ<sub>0</sub>) = 1 / (2 · 4π×10⁻⁷) ≈ <strong className="text-text font-medium">3.98×10⁵ J/m³</strong> ≈ 400 kJ/m³</Formula>
            <p className="mb-prose-3">Four hundred kilojoules per cubic meter, just sitting there in the field. Roughly the energy of 100 g of TNT<Cite id="jackson-1999" in={SOURCES} />.
      ...
      <TryIt
        tag="Problem 4.3.3"
        question={<>Earth's magnetic field is roughly <strong className="text-text font-medium">50 µT = 5×10⁻⁵ T</strong>. Energy density?</>}
        answer={
          <>
            <Formula>u<sub>B</sub> = (5×10⁻⁵)² / (2 · 4π×10⁻⁷) = (2.5×10⁻⁹) / (2.513×10⁻⁶)</Formula>
            <Formula>u<sub>B</sub> ≈ <strong className="text-text font-medium">1×10⁻³ J/m³ = 1 mJ/m³</strong></Formula>
            <p className="mb-prose-3">A milli-joule per cubic meter — the whole magnetosphere, summed over Earth's volume, still totals only about 10¹⁸ J,
      ...
      <TryIt
        tag="Problem 4.3.4"
        question={<>Earth's fair-weather atmospheric E-field is about <strong className="text-text font-medium">100 V/m</strong> at the surface. u<sub>E</sub>?</>}
        answer={
          <>
            <Formula>u<sub>E</sub> = ½(8.854×10⁻¹²)(100)² = ½(8.854×10⁻¹²)(10⁴) ≈ <strong className="text-text font-medium">4.4×10⁻⁸ J/m³</strong></Formula>
            <p className="mb-prose-3">About 44 nanojoules per cubic meter — orders of magnitude smaller than Earth's magnetic field energy density, which is
      ...
      <TryIt
        ...
        answer={
          <>
            ...
            <p className="mb-prose-3"><strong className="text-text font-medium">The magnetic field at 1 T stores 10,000× more energy than the electric field at its breakdown limit.</strong>
      ...
      <TryIt
        tag="Problem 4.3.6"
        question={<>A parallel-plate capacitor with <strong className="text-text font-medium">A = 100 cm²</strong>, <strong className="text-text font-medium">d = 1 mm</strong>, <strong className="text-text font-medium">V = 100 V</strong>.
          Verify that <strong className="text-text font-medium">½CV²</strong> equals <strong className="text-text font-medium">∫u<sub>E</sub> dV</strong>.</>}
        answer={
          <>
            <p className="mb-prose-3">From the formulas: C = ε<sub>0</sub> A/d, V = Ed.</p>
            <Formula>C = (8.854×10⁻¹²)(10⁻²) / (10⁻³) ≈ 88.5 pF</Formula>
            <Formula>½ C V² = ½ (88.5×10⁻¹²)(10⁴) ≈ <strong className="text-text font-medium">4.4×10⁻⁷ J</strong></Formula>
            <Formula>E = V/d = 10⁵ V/m, &nbsp; u<sub>E</sub> = ½ε<sub>0</sub>E² ≈ 4.4×10⁻² J/m³</Formula>
            <Formula>U<sub>field</sub> = u<sub>E</sub> · (Ad) = (4.4×10⁻²)(10⁻⁵) ≈ <strong className="text-text font-medium">4.4×10⁻⁷ J</strong></Formula>
            <p className="mb-prose-3">Identical. The energy ½CV² <em className="italic text-text">is</em> the field energy in the gap.</p>
          </>
        }
      />
      ...
      <TryIt
        tag="Problem 4.3.7"
        question={<>A solenoid: <strong className="text-text font-medium">n = 1000 turns/m</strong>, <strong className="text-text font-medium">I = 1 A</strong>, radius <strong className="text-text font-medium">r = 1 cm</strong>,
          length <strong className="text-text font-medium">ℓ = 10 cm</strong>. Verify ½LI² = ∫u<sub>B</sub> dV.</>}
        answer={
          <>
            ...
            <Formula>U<sub>field</sub> ≈ 0.628 × 3.14×10⁻⁵ ≈ <strong className="text-text font-medium">1.97×10⁻⁵ J</strong></Formula>
            ...
            <Formula>½ L I² = ½ (3.94×10⁻⁵)(1) ≈ <strong className="text-text font-medium">1.97×10⁻⁵ J</strong></Formula>
            <p className="mb-prose-3">Same number to within rounding<Cite id="griffiths-2017" in={SOURCES} />.</p>
          </>
        }
      />
      ...
      <TryIt
        tag="Problem 4.3.8"
        question={<>A clinical MRI scanner runs at <strong className="text-text font-medium">B = 3 T</strong>. What is the magnetic energy density inside the bore?</>}
        answer={
          <>
            <Formula>u<sub>B</sub> = (3)² / (2 · 4π×10⁻⁷) = 9 / (2.513×10⁻⁶) ≈ <strong className="text-text font-medium">3.58×10⁶ J/m³ ≈ 3.6 MJ/m³</strong></Formula>
            <p className="mb-prose-3">Three and a half million joules per cubic meter, sitting silently in the bore. Bore volume is roughly 0.3 m³, so the field
            holds about <strong className="text-text font-medium">1 MJ</strong> — comparable to a stick of dynamite. This is why dropped wrenches become guided missiles
      ...
      <TryIt
        tag="Problem 4.3.9"
        question={<>A camera-flash capacitor stores <strong className="text-text font-medium">1 J</strong> at <strong className="text-text font-medium">300 V</strong>. What is its capacitance? If its volume
          is about 1 cm³, what is the average energy density?</>}
        answer={
          <>
            <Formula>U = ½ C V² &nbsp;⇒&nbsp; C = 2U/V² = 2/(9×10⁴) ≈ <strong className="text-text font-medium">22 µF</strong></Formula>
            <Formula>u<sub>avg</sub> = U / V<sub>vol</sub> = 1 J / 10⁻⁶ m³ = <strong className="text-text font-medium">10⁶ J/m³ = 1 MJ/m³</strong></Formula>
            <p className="mb-prose-3">An electrolytic flash cap reaches MJ/m³ by exploiting tantalum-oxide dielectrics of order tens of nanometers thick — gap
      ...
      <TryIt
        tag="Problem 4.3.10"
        question={<>A car battery: <strong className="text-text font-medium">12 V × 100 A·hr</strong>. How many joules? Compare to magnetic energy in 1 m³ at 1 T.</>}
        answer={
          <>
            <Formula>U = V · Q = 12 V · (100 · 3600 C) ≈ <strong className="text-text font-medium">4.3×10⁶ J = 4.3 MJ</strong></Formula>
            <p className="mb-prose-3">A 1 m³ box of 1 T magnetic field holds 400 kJ — about <strong className="text-text font-medium">10×</strong> less than a car battery's chemical energy.
      ...
      <TryIt
        tag="Problem 4.3.11"
        question={<>The Sun's surface magnetic field averages <strong className="text-text font-medium">B ≈ 1 G = 10⁻⁴ T</strong> (with sunspot peaks near 0.1 T).
          What's u<sub>B</sub> at the surface? Compare to the energy density of visible sunlight at Earth (~10⁻⁵ J/m³).</>}
        answer={
          <>
            <Formula>u<sub>B</sub> ≈ (10⁻⁴)² / (2·4π×10⁻⁷) = 10⁻⁸ / (2.5×10⁻⁶) ≈ <strong className="text-text font-medium">4×10⁻³ J/m³</strong></Formula>
            <p className="mb-prose-3">About 400× the visible-light energy density at Earth's orbit. In sunspot regions, where B reaches 0.1 T, u<sub>B</sub>
