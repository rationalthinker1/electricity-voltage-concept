    ...
    <LabGrid
      ...
      outputs={
        <>
          ...
          <Readout sym="P" label="Power dissipated" value={prettyJsx(computed.P)} unit="W" highlight />
          <Readout sym={<>p<sub>v</sub></>} label="Power density" value={prettyJsx(computed.Edens)} unit="W/m³" />
          <Readout sym={<>t<sub>boil</sub></>} label="Time to boil 1 L water" value={formatTime(computed.t_water)} />
          <Readout sym={<>T<sub>eq</sub></>} label="Equilibrium temperature" value={prettyJsx(computed.T_eq)} unit="K" />
  ...
  const prose = (
    <>
      ...
      <p className="mb-prose-3">
        ...
        formulas <strong className="text-text font-medium">P = VI = I²R = V²/R</strong> are exact for an ideal ohmic resistor at constant temperature, in steady state, on DC or
        at frequencies low compared to inverses of the device's reactive time constants. They break down when <em className="italic text-text">R</em> itself depends on
      ...
      <p className="mb-prose-3">
        ...
        <strong className="text-text font-medium"> I</strong> is the current through it in amperes (A), and <strong className="text-text font-medium">R</strong> is the resistance in ohms (Ω). Energy delivered
        over a time interval Δt is <strong className="text-text font-medium">E = P · Δt</strong> in joules (J), or in practical-unit kilowatt-hours (kWh) for billing
      ...
      <p className="mb-prose-3">
        ...
        <em className="italic text-text"> lowered</em> their potential). It all goes into the lattice, as heat.
      </p>
      <Pullout>
      ...
      <p className="mb-prose-3">
        Why the <em className="italic text-text">quadratic</em> dependence on V or I? Because doubling V doubles I (Ohm's law), and power is their product. The intuition
      ...
      <p className="mb-prose-3">
        Why is the sign of P always positive in a resistor? Because <strong className="text-text font-medium">J · E ≥ 0</strong> everywhere inside an ohmic conductor: the field
      ...
      <p className="mb-prose-3">
        <em className="italic text-text">Microscopic, from field × current density.</em> Power per unit volume delivered to charges by the field is the dot product
        of <strong className="text-text font-medium">E</strong> and the current density <strong className="text-text font-medium">J</strong>:
      </p>
      ...
      <p className="mb-prose-3">
        <em className="italic text-text">Where the energy actually comes from.</em> In the Poynting picture, the energy enters the wire as electromagnetic flux <strong className="text-text font-medium">S = E × H</strong>
      ...
      <TryIt
        ...
        answer={
          <>
            ...
            <p className="mb-prose-3">
              Answer: <strong className="text-text font-medium">81 mW</strong>. A standard ¼ W resistor handles this with comfortable margin; an ⅛ W part would also be fine but
              with less headroom.
            </p>
          </>
        }
      ...
      <TryIt
        ...
        answer={
          <>
            ...
            <p className="mb-prose-3">
              Answer: <strong className="text-text font-medium">0.5 A</strong>. A typical 15 A residential branch circuit can run thirty such bulbs in parallel before tripping
              the breaker.
            </p>
          </>
        }
      ...
      <TryIt
        tag="Problem 3.4.3"
        question={<>Same 60 W bulb on 120 V. What is its <em className="italic text-text">hot</em> (operating) resistance?</>}
        answer={
          <>
            <MathBlock>R<sub>hot</sub> = V² / P = 120² / 60 = 240 Ω</MathBlock>
            <p className="mb-prose-3">
              Answer: <strong className="text-text font-medium">240 Ω</strong>. The <em className="italic text-text">cold</em> resistance of the same filament is about ten times less (~24 Ω) because tungsten's
      ...
      <TryIt
        ...
        answer={
          <>
            ...
            <p className="mb-prose-3">
              Answer: <strong className="text-text font-medium">12.5 A</strong> and <strong className="text-text font-medium">9.6 Ω</strong>. The 12.5 A draw is close to the typical 15 A branch limit — which is
      ...
      <TryIt
        ...
        answer={
          <>
            ...
            <p className="mb-prose-3">
              The "loss" is hundreds of <em className="italic text-text">terawatts</em> — vastly more than the 1 GW we wanted to deliver. The line just melts. The ratio of
              losses is <strong className="text-text font-medium">(500 000 / 120)² ≈ 1.7×10⁷</strong>: high-voltage transmission is seventeen million times more efficient per
              line. <em className="italic text-text">This</em> is why the grid runs at hundreds of kilovolts.
            </p>
          </>
        }
      />
      ...
      <TryIt
        ...
        answer={
          <>
            ...
            <p className="mb-prose-3">
              Answer: <strong className="text-text font-medium">4.32 MJ</strong> or <strong className="text-text font-medium">1.2 kWh</strong>. Roughly the energy in 100 grams of TNT, or 30 seconds of an average
      ...
      <TryIt
        ...
        answer={
          <>
            ...
            <p className="mb-prose-3">
              Answer: <strong className="text-text font-medium">72 kWh</strong>, costing <strong className="text-text font-medium">~$10.80</strong>. The kWh-meter on a building literally integrates P over time
      ...
      <TryIt
        ...
        hint={<>Approximate the overload as raising the wire by 100 K in 1 s with no heat loss. The fuse's <em className="italic text-text">own</em> resistance is small (~10 mΩ for an automotive fuse), giving P ≈ I²·R.</>}
        answer={
          <>
            ...
            <p className="mb-prose-3">
              Answer: heat capacity <strong className="text-text font-medium">~0.04 J/K</strong>. For a Zn/Cu fuse element with c ≈ 0.4 J/(g·K), that's roughly 100 mg of metal —
              ...
              the rule of thumb is that I²·t (sometimes written <em className="italic text-text">I²t</em>, called the "let-through") determines fuse blow.
            </p>
          </>
        }
      />
      ...
      <TryIt
        ...
        answer={
          <>
            ...
            <p className="mb-prose-3">
              Answer: about <strong className="text-text font-medium">5 minutes</strong>. Real heat transfer is slower because of losses to the environment, but the order of
              magnitude is right.
            </p>
          </>
        }
      ...
      <TryIt
        ...
        answer={
          <>
            ...
            <p className="mb-prose-3">
              Answer: <strong className="text-text font-medium">81 mW each</strong>, <strong className="text-text font-medium">162 mW total</strong>. Putting resistors in parallel <em className="italic text-text">doubles</em> the total
      ...
      <TryIt
        ...
        answer={
          <>
            ...
            <p className="mb-prose-3">
              Answer: about <strong className="text-text font-medium">2.5%</strong>. That 2.5 W heats the cable and the connectors — which is why USB-PD cables for the 100 W
