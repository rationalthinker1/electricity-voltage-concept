      ...
      <div className="flex flex-wrap gap-sm mb-lg">
        {PRESETS.map(preset => (
          <button
            key={preset.id}
            type="button"
            className="font-3 text-[11px] tracking-[.08em] uppercase px-md py-sm rounded-pill border border-border-1 bg-color-3 text-color-5 hover:text-color-4 hover:border-border-2"
