...
export interface LabManifestEntry {
  ...
  heroLabel: string;
  /** Hero headline JSX-as-HTML — keep <em> for accent italic. */
  heroHeadline: string;
...
export const MANIFEST: LabManifestEntry[] = [
  // ─── Chapter 1 — Electric Field ───
  {
    ...
    heroHeadline: 'Two charges. <em>One inverse-square law.</em>',
  ...
  },
  {
    ...
    heroHeadline: 'Charge tells space to <em>push back</em>.',
  ...
  // ─── Chapter 2 — Magnetic Field ───
  {
    ...
    heroHeadline: 'Moving charge <em>paints</em> magnetic field.',
  ...
  },
  {
    ...
    heroHeadline: 'Field turns charge in <em>circles</em>.',
  ...
  // ─── Chapter 3 — Conduction ───
  {
    ...
    heroHeadline: 'Field pushes charge. <em>Conductivity</em> is how easy the push is.',
  ...
  },
  {
    ...
    heroHeadline: 'Length adds, <em>area divides</em>.',
  ...
  },
  {
    ...
    heroHeadline: 'Electrons crash, <em>metal warms</em>.',
  ...
  // ─── Chapter 4 — Energy & Fields ───
  {
    ...
    heroHeadline: 'Plates hold <em>charge in waiting</em>.',
  ...
  },
  {
    ...
    heroHeadline: 'Coils <em>resist</em> change.',
  ...
  },
  {
    ...
    heroHeadline: '<em>Empty space</em> stores energy.',
