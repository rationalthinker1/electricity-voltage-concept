...
export const CHAPTER_META: Record<ChapterId, { title: string; eyebrow: string; blurb: string }> = {
  ch1: {
    ...
    blurb: 'Static charges build a field that fills space. From Coulomb\'s force law to the line integral that defines voltage.',
  },
  ch2: {
    eyebrow: 'Chapter II',
    title: 'Magnetic Field',
    blurb: 'Moving charges create circulation. From Biot–Savart to Faraday\'s law — the rotational half of electromagnetism.',
  },
  ch3: {
    eyebrow: 'Chapter III',
    title: 'Conduction',
    blurb: 'What happens when fields drive charges through real materials. Drift, Ohm, resistance, and where the heat comes from.',
  },
  ch4: {
    eyebrow: 'Chapter IV',
    title: 'Energy & Fields',
    blurb: 'Capacitors store E. Inductors store B. Fields carry joules per cubic meter. Poynting names the flow.',
  },
};
...
export const MANIFEST: LabManifestEntry[] = [
  ...
  },
  {
    ...
    title: "Gauss's Law",
    formula: (<>∮ E · dA = Q<sub className="text-[.58em] leading-none align-[-.32em]">enc</sub> / ε₀</>),
  ...
  },
  {
    ...
    formula: (<>V<sub className="text-[.58em] leading-none align-[-.32em]">ab</sub> = −∫<sub className="text-[.58em] leading-none align-[-.32em]">a</sub><sup className="text-[.58em] leading-none align-[.5em]">b</sup> E · dℓ</>),
  ...
  {
    number: '2.1', slug: 'biot-savart', chapter: 'ch2',
    ...
    heroHeadline: (<>Moving charge <em className="italic font-normal text-accent">paints</em> magnetic field.</>),
  ...
  },
  {
    ...
    title: "Ampère's Law",
    formula: (<>∮ B · dℓ = μ₀ I<sub className="text-[.58em] leading-none align-[-.32em]">enc</sub></>),
    blurb: 'The magnetic analog of Gauss. Symmetry collapses the integral.',
    heroLabel: "Chapter 2 · Lab 2.2 — Ampère's Law",
    heroHeadline: (<><em className="italic font-normal text-accent">Symmetry</em> hands you the field for free.</>),
  ...
  {
    number: '2.3', slug: 'lorentz', chapter: 'ch2',
    title: 'Lorentz Force',
    formula: (<>F = q (E + v × B)</>),
    blurb: 'The single equation defining what E and B do to a moving charge.',
    heroLabel: 'Chapter 2 · Lab 2.3 — Lorentz Force',
    heroHeadline: (<>Field turns charge in <em className="italic font-normal text-accent">circles</em>.</>),
  ...
  },
  {
    ...
    title: "Faraday's Law",
    formula: (<>EMF = − dΦ<sub className="text-[.58em] leading-none align-[-.32em]">B</sub> / dt</>),
    ...
    heroHeadline: (<>Changing field <em className="italic font-normal text-accent">conjures</em> voltage.</>),
  ...
  {
    number: '3.1', slug: 'ohms-law', chapter: 'ch3',
    ...
    heroHeadline: (<>Field pushes charge. <em className="italic font-normal text-accent">Conductivity</em> is how easy the push is.</>),
  ...
  {
    number: '3.2', slug: 'resistance', chapter: 'ch3',
    title: 'Resistance',
    formula: (<>R = ρ L / A</>),
    blurb: 'The wire-level lump of the microscopic law. Length adds, area divides.',
    heroLabel: 'Chapter 3 · Lab 3.2 — Resistance',
    heroHeadline: (<>Length adds, <em className="italic font-normal text-accent">area divides</em>.</>),
  ...
  },
  {
    ...
    formula: (<>v<sub className="text-[.58em] leading-none align-[-.32em]">d</sub> = I / (n q A)</>),
    ...
    heroHeadline: (<>Electrons move at the pace of a <em className="italic font-normal text-accent">glacier</em>.</>),
  ...
  {
    number: '3.4', slug: 'joule', chapter: 'ch3',
    title: 'Joule Heating',
    ...
    heroHeadline: (<>Electrons crash, <em className="italic font-normal text-accent">metal warms</em>.</>),
  ...
  {
    number: '4.2', slug: 'inductance', chapter: 'ch4',
    title: 'Inductance',
    formula: (<>V = − L dI/dt</>),
    blurb: 'Coils resist change. Energy stored in the magnetic field.',
    heroLabel: 'Chapter 4 · Lab 4.2 — Inductance',
    heroHeadline: (<>Coils <em className="italic font-normal text-accent">resist</em> change.</>),
  ...
  {
    number: '4.3', slug: 'energy-density', chapter: 'ch4',
    ...
    heroHeadline: (<><em className="italic font-normal text-accent">Empty space</em> stores energy.</>),
  ...
  {
    number: '4.4', slug: 'poynting', chapter: 'ch4',
    ...
    heroHeadline: (<>Energy flows <em className="italic font-normal text-accent">through space</em>, not through copper.</>),
  ...
  // ─── Appendix — Sandboxes ───
  {
    ...
    heroHeadline: (<>Drag, drop, <em className="italic font-normal text-accent">solve</em>.</>),
  ...
  },
  {
    ...
    heroHeadline: (<>Wire a whole <em className="italic font-normal text-accent">house</em>.</>),
  ...
  },
  {
    ...
    formula: (<>V<sub className="text-[.58em] leading-none align-[-.32em]">dq</sub> = R i<sub className="text-[.58em] leading-none align-[-.32em]">dq</sub> + L di<sub className="text-[.58em] leading-none align-[-.32em]">dq</sub>/dt + ω L i<sub className="text-[.58em] leading-none align-[-.32em]">dq</sub> + ω ψ</>),
    ...
    heroHeadline: (<>Drive a <em className="italic font-normal text-accent">motor</em>.</>),
  ...
  },
  {
    ...
    formula: (<>P<sub className="text-[.58em] leading-none align-[-.32em]">wheel</sub> = P<sub className="text-[.58em] leading-none align-[-.32em]">battery</sub> × η<sub className="text-[.58em] leading-none align-[-.32em]">inv</sub> × η<sub className="text-[.58em] leading-none align-[-.32em]">motor</sub> × η<sub className="text-[.58em] leading-none align-[-.32em]">gearbox</sub></>),
    ...
    heroHeadline: (<>Power an <em className="italic font-normal text-accent">EV</em>.</>),
  ...
  },
  {
    ...
    formula: (<>P<sub className="text-[.58em] leading-none align-[-.32em]">loss</sub> = I² R · n<sub className="text-[.58em] leading-none align-[-.32em]">lines</sub> + Σ generator droop</>),
    ...
    heroHeadline: (<>Run a <em className="italic font-normal text-accent">grid</em>.</>),
  ...
  },
  {
    ...
    formula: (<>Γ = (Z<sub className="text-[.58em] leading-none align-[-.32em]">ant</sub> − Z₀) / (Z<sub className="text-[.58em] leading-none align-[-.32em]">ant</sub> + Z₀)</>),
    ...
    heroHeadline: (<>Match an <em className="italic font-normal text-accent">antenna</em>.</>),
  ...
  },
  {
    ...
    formula: (<>ΔV ≈ I<sub className="text-[.58em] leading-none align-[-.32em]">load</sub> / (f<sub className="text-[.58em] leading-none align-[-.32em]">ripple</sub> C)</>),
    ...
    heroHeadline: (<>Build a <em className="italic font-normal text-accent">DC rail</em>.</>),
...
export const BASE_LAB_SOURCES: Record<string, SourceKey[]> = {
  coulomb:       ['coulomb-1785', 'cavendish-1773', 'williams-faller-hill-1971', 'griffiths-2017', 'codata-2018'],
