  ...
  return (
    <ChapterShell chapter={chapter}>
      ...
      <p>
        ...
        loop (in m); <M tex="Q_{\text{enc}}" />
        is the total charge enclosed by the surface (in coulombs) and <M tex="I_{\text{enc}}" />
        is the conduction current threading the loop (in amperes);{' '}
        <M tex="\Phi_B = \iint B \cdot dA" />
        and <M tex="\Phi_E = \iint E \cdot dA" />
        are the magnetic and electric fluxes through a surface bounded by the loop (in webers and
        V·m respectively); and <M tex="\varepsilon_0 = 8.854\times 10^{-12}\,\text{F/m}" />;{' '}
        <M tex="\mu_0 = 4\pi\times 10^{-7}\,\text{T·m/A}" /> in the SI system. These are the vacuum
      ...
      <p>
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">flux</strong> — the integral of a vector
              field over a surface, ∫ F · dA. For a closed surface, measures net "flow" of the field
              out of the enclosed volume. SI units depend on the field (V·m for E-flux, T·m² = Wb
              for B-flux).
            </>
          }
        >
        ...
        out of a closed surface) and two line integrals (circulation around a closed loop). The
        first equation says charge sources electric flux. The second says nothing sources magnetic
        flux. The third says a changing magnetic flux induces an electric circulation. The fourth
        says a current — or a changing electric flux — induces a magnetic circulation. Read them out
      ...
      <p>
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">divergence</strong> — a scalar measure of
              how much a vector field flows out of an infinitesimal volume. ∇·F &gt; 0 means a
              source, ∇·F &lt; 0 a sink, ∇·F = 0 a divergence-free field. The divergence theorem
              ties ∮F·dA = ∫∇·F dV.
            </>
          }
        >
        ...
        laws (what flows <em className="text-text italic">out</em> of a closed box). Two{' '}
        <Term
          def={
            <>
              <strong className="text-text font-medium">curl</strong> — a vector measure of a
              field's local circulation. ∇×F is nonzero where field lines loop around an axis.
              Stokes' theorem ties ∮F·dℓ = ∫(∇×F)·dA.
            </>
          }
        >
          curl
        </Term>{' '}
        laws (what flows <em className="text-text italic">around</em> a closed loop). The pattern is
      ...
      <p>
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">Gauss's law</strong> — the net electric flux
              through any closed surface equals the enclosed charge divided by ε₀: ∮ E · dA = Q
              <sub>enc</sub>/ε₀. Equivalent to Coulomb's inverse-square law plus the assumption of
              spherical symmetry.
            </>
          }
        >
        ...
        — says: the net electric flux through any closed surface is equal to the charge enclosed
        inside it, divided by ε₀. Pull a charge inside, flux goes up; push it back out, flux falls
        to zero. The shape of the surface doesn't matter — sphere, cube, ugly potato — only the
        total charge inside it counts
      ...
      <p>
        ...
        . If no charge is enclosed, every field line that enters must exit somewhere else — the
        books balance. This is the same divergence theorem Gauss proved for gravitational fields in
        1813; applying it to electric fields gives you the law that bears his name
        <Cite id="griffiths-2017" in={SOURCES} />. For a sphere centered on a point charge, the
        integral specializes to Coulomb's law (the 4π in 1/(4πε₀) is just the surface area of a unit
        sphere) — same physics, different bookkeeping.
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            A closed surface of any shape encloses a total charge of{' '}
            <strong className="text-text font-medium">1 μC</strong>. What is the total electric flux
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              Gauss's law gives the flux from the enclosed charge alone
              <Cite id="gauss-1813" in={SOURCES} />:
            </p>
            <Formula>
              Φ<sub>E</sub> = Q<sub>enc</sub> / ε₀ = (1×10⁻⁶) / (8.854×10⁻¹²)
            </Formula>
            <p className="mb-prose-1 last:mb-0">
      ...
      <p>
        ...
        <strong className="text-text font-medium">
          ...
          <Term
            def={
              <>
                <strong className="text-text font-medium">monopole</strong> — a hypothetical
                isolated north or south magnetic pole. None has ever been observed; every B-field
                line is a closed loop. The asymmetry with electric charge (which has free monopoles,
                the electron and proton) is an open puzzle of the Standard Model.
              </>
            }
          >
            monopoles
      ...
      <p>
        ...
        magnetic charge
        <Cite id="griffiths-2017" in={SOURCES} />. If one ever does turn up, the equation gains a
        source term and the symmetry of the four laws becomes much cleaner — but until then, the
        right-hand side is zero, and that asymmetry is one of the open puzzles of the Standard
        Model.
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            What is the net magnetic flux through any closed surface — say, a sphere drawn anywhere
            in the universe?
          </>
        }
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              Exactly <strong className="text-text font-medium">zero</strong>, no matter where or
            ...
            <p className="mb-prose-1 last:mb-0">
              Whatever <M tex="B" />
              -flux enters one side of any closed surface, the same amount comes out somewhere else.
              Every magnetic field line is a closed loop with no beginning and no end — because
              there is no isolated north or south pole to start or stop on
              <Cite id="griffiths-2017" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p>
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">Faraday's law</strong> — a changing magnetic
              flux through a loop drives an EMF around the loop: ∮ E · dℓ = − dΦ<sub>B</sub>/dt. The
              minus sign (Lenz's law) encodes energy conservation. Discovered experimentally by
              Faraday in 1831; see Ch. 7 for the full story.
            </>
          }
        >
          Faraday's law
        </Term>{' '}
        — discovered experimentally by Faraday in 1831 and published in 1832
      ...
      <p>
        ...
        induced current reinforce the change, you would have free energy on tap. The minus sign is
        energy conservation, made visible
        <Cite id="griffiths-2017" in={SOURCES} />.
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            The magnetic flux through a single-turn loop ramps linearly from{' '}
            <strong className="text-text font-medium">0</strong> to{' '}
            <strong className="text-text font-medium">1 mWb</strong>
            over <strong className="text-text font-medium">1 ms</strong>. What is the magnitude of
            the induced EMF around the loop?
          </>
        }
        ...
        answer={
          <>
            ...
            <Formula>
              |EMF| = |dΦ<sub>B</sub>/dt| = (1×10⁻³ Wb) / (1×10⁻³ s) = 1 V
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              ...
              but doesn't change the magnitude.) Multiply by <M tex="N" />
      ...
      <p>
        ...
        density, and changing magnetic flux.
      </p>
      ...
      <p>
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">Ampère–Maxwell law</strong> — currents and
              changing electric flux together source a magnetic circulation: ∮ B · dℓ = μ₀(I
              <sub>enc</sub> + ε₀ dΦ<sub>E</sub>/dt). Maxwell's 1865 displacement-current correction
              is what closes the loop and produces electromagnetic waves.
            </>
          }
        >
          Ampère–Maxwell law
        </Term>{' '}
        — is the one Maxwell rewrote. Ampère's original law, established empirically in 1826
      ...
      <p>
        ...
        being charged. Wrap an Amperian loop around the wire feeding one plate, and the formula
        gives a B-field tied to the wire's current. Slide the same loop a few centimeters along,
        into the gap between the plates, and — no conduction current pierces it. Same loop, same
        circulation expected by symmetry, suddenly zero current. Ampère's law disagrees with itself
      ...
      <p>
        ...
        <Term
          def={
            <>
              ...
              <M tex="J_D = \varepsilon_0\,\partial E/\partial t" />
        ...
        >
          <em className="text-text italic">displacement current</em>
        </Term>
        . In the capacitor gap there's no conduction current — but the E-field between the plates is
        growing, the electric flux through the loop is growing with it, and Maxwell's term exactly
        fills in for the missing conduction current. The two contributions are equal by charge
        conservation (continuity equation): whatever amount of charge per second is flowing into the
      ...
      <TryIt
        ...
        question={
          <>
            The electric field inside a charging capacitor's gap is changing at a rate of{' '}
            ...
            the displacement-current density <M tex="J_D" />
            there?
          </>
        }
        hint={
          <>
            <M tex="J_D = \varepsilon_0\, dE/dt" />.
          </>
        }
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              Plug in <M tex="\varepsilon_0" /> = 8.854×10⁻¹² F/m
              <Cite id="codata-2018" in={SOURCES} />:
            </p>
            <Formula>
              J<sub>D</sub> = ε₀ dE/dt = (8.854×10⁻¹²)(10⁹) ≈ 8.85×10⁻³ A/m²
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              About <strong className="text-text font-medium">8.85 mA/m²</strong> — a modest current
              density, but spread over the plate area it produces exactly the same magnetic
              circulation that the conduction current in the wires does
              <Cite id="maxwell-1865" in={SOURCES} />. Without Maxwell's term, ∮B·dℓ would jump
              discontinuously as the Amperian surface crosses the plate; with it, the integral is
              continuous and charge is conserved
              <Cite id="feynman-II-18" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p>
        ...
        sustain each other in empty space — which is exactly the next paragraph
        <Cite id="feynman-II-18" in={SOURCES} />.
      </p>
      ...
      <p>
        ...
        T/s and V/(m·s) respectively), and <M tex="\mu_0\varepsilon_0" />
        ...
        first equation; use the vector identity <M>∇×(∇×E) = ∇(∇·E) − ∇²E</M>; invoke Gauss for E
        (with ρ = 0, so ∇·E = 0); and substitute in the right-hand side of the second equation.
        ...
        <Term
          def={
            <>
              ...
              <M tex="\nabla^{2}\psi = (1/v^{2})\,\partial^{2}\psi/\partial t^{2}" /> whose
              solutions are travelling waves at speed <M tex="v" />. Maxwell's equations in vacuum
              reduce to this with <M tex="v = 1/\sqrt{\mu_0\varepsilon_0} = c" />.
            </>
          }
        >
          wave equation
        </Term>
        . The same manipulation on the second equation gives the same equation for B. Waves of E and
      ...
      <p>
        ...
        exact by definition; the relation <M>c = 1/√(ε₀ μ₀)</M> is now what locks ε₀ to μ₀, not the
        other way around. Hertz produced and detected radio-frequency electromagnetic waves in 1887,
        confirming Maxwell directly
      ...
      <TryIt
        ...
        question={
          <>
            Compute the propagation speed <M tex="c = 1/\sqrt{\mu_0\varepsilon_0}" />
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              Use CODATA values
              <Cite id="codata-2018" in={SOURCES} />: <M tex="\mu_0" /> = 1.25664×10⁻⁶ T·m/A,{' '}
              <M tex="\varepsilon_0" /> = 8.8542×10⁻¹² F/m. Then
            </p>
            ...
            <p className="mb-prose-1 last:mb-0">
              ...
              <strong className="text-text font-medium">2.998×10⁸ m/s</strong> — falling out of two
              constants measured by electrostatic and magnetostatic experiments alone. The number
              that astonished Maxwell in 1865 is the same number you just got with a calculator
              <Cite id="maxwell-1865" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <CaseStudies intro="Four case studies that turn the four equations into verifiable hardware: the experiment that proved Maxwell, the demonstration that crossed an ocean, the constellation that puts the four laws in your pocket, and the atomic line that maps the galaxy.">
        <CaseStudy
          ...
          summary={
            <em className="text-text italic">
              A spark gap, a resonant loop, and the laboratory production of the waves Maxwell had
              predicted twenty-three years earlier.
            </em>
          }
          specs={[
            {
            ...
            { label: 'Detector', value: 'Resonant copper loop with micrometer spark gap' },
            {
              ...
              value: 'Reflection from a zinc sheet ~13 m from source',
            },
            {
              label: 'Inferred propagation speed',
              value: "Consistent with c, within Hertz's ~10% error bars",
            },
          ]}
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            <Cite id="griffiths-2017" in={SOURCES} /> without having seen it tested at radio
            wavelengths. The experimental verification came from the Karlsruhe laboratory of{' '}
            <strong className="text-text font-medium">Heinrich Hertz</strong>, who in 1887–1888
            built the first deliberate electromagnetic-wave transmitter and detector and showed that
            the waves obeyed every prediction the four equations made
            <Cite id="hertz-1888" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
            ...
            damped ringing of the rod-pair as a tuned LC oscillator at radio frequency, radiating a
            short burst of the kind of wave §5 of Chapter 9 describes. The detector, a few meters
            away, was a resonant loop with its own micrometer gap; when the wave arrived, the
            induced EMF reached breakdown and a tiny secondary spark jumped
            <Cite id="hertz-1888" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
        ...
        <CaseStudy
          ...
          summary={
            <em className="text-text italic">
              12 December 1901: a three-dot Morse "S" from Poldhu, Cornwall, received on a
              kite-flown antenna at Signal Hill, Newfoundland.
            </em>
          }
          specs={[
            {
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            Thirteen years after Hertz,{' '}
            <strong className="text-text font-medium">Guglielmo Marconi</strong> wagered that
            Maxwell's waves would travel over the horizon — that the curvature of the Earth would
            not, in fact, stop them. On 12 December 1901 he and his assistant George Kemp received
            what they reported as the Morse letter "S" (three dots) transmitted from his station at
            Poldhu, Cornwall, on a kite-flown wire antenna at Signal Hill in St. John's,
            Newfoundland
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            arriving <M tex="E" />
            -field back into a measurable current — Faraday's law in its open-circuit form. None of
            it should have surprised anyone who had read Maxwell; all of it was new in 1901, because
            no one had thought to try the experiment at that range
            <Cite id="hong-2001-wireless" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
            ...
            whose refractive index becomes effectively imaginary for radio frequencies below roughly
            30 MHz. The reflection is itself a Maxwell-equations boundary problem. Within a decade,
        ...
        <CaseStudy
          ...
          specs={[
            ...
            {
              label: 'Received signal level at Earth',
              value: 'approximately −130 dBm (below thermal noise)',
            },
          ]}
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            <Cite id="kaplan-hegarty-2017" in={SOURCES} />. Your phone's GPS receiver listens for at
            least four of them, correlates the codes to recover travel time, and trilaterates a
            position. The whole edifice is
            <em className="text-text italic"> Maxwell's equations in action</em>: a transmitted
            plane wave, a free-space path-loss budget set by the wave's <M>1/r²</M> intensity
            fall-off, a receiver antenna obeying the reciprocity theorem.
          </p>
          <p className="mb-prose-2 last:mb-0">
            The numbers force respect. The received signal at the ground is around{' '}
            <strong className="text-text font-medium">−130 dBm</strong> — roughly <M>10⁻¹⁶</M>{' '}
            watts, well below the receiver's thermal noise floor. GPS works only because the
            pseudo-random code provides roughly 43 dB of processing gain when correlated against the
            receiver's local replica
        ...
        <CaseStudy
          ...
          summary={
            <em className="text-text italic">
              1420.406 MHz: an atomic spin-flip transition that maps the galaxy.
            </em>
          }
          specs={[
            {
            ...
            {
              label: 'Mean lifetime of the upper state',
              value: '~10⁷ years (forbidden M1 transition)',
            },
          ]}
        >
          <p className="mb-prose-2 last:mb-0">
          ...
          <p className="mb-prose-2 last:mb-0">
            Hendrik van de Hulst predicted the line in 1944 from quantum mechanics applied to
            Maxwell's equations in the standard way — bound-state energies of a charged particle in
            a Coulomb potential, plus the hyperfine coupling to nuclear spin.{' '}
            <strong className="text-text font-medium">Harold Ewen and Edward Purcell</strong> built
            a horn antenna on the roof of the Harvard physics building and detected it on 25 March
            1951
            <Cite id="ewen-purcell-1951" in={SOURCES} />. Within a few years it was a primary
            mapping tool: galactic spiral arms, the rotation curves that pointed at dark matter, the
            cosmic 21-cm signal from the early universe.
          </p>
          <p className="mb-prose-2 last:mb-0">
            From the perspective of the four equations, the line is the cleanest possible Maxwell
            solution: an oscillating magnetic dipole moment radiating into vacuum at one fixed
            frequency, with the transverse plane-wave structure of §7. The reason it's so useful is
            the reason §7 emphasized: a wave at λ = 21 cm passes through interstellar dust that
            visible light cannot, so radio telescopes see structures hidden from optical ones.
          </p>
        </CaseStudy>
      </CaseStudies>

      <FAQ intro="Loose threads from the synthesis chapter — questions that tend to come up after reading the four equations side by side.">
        <FAQItem q="Why are there exactly four equations and not five or three?">
          <p>
            The four equations correspond to two physical fields (E and B) crossed with two ways a
            field can have a source (a divergence — flux out of a closed surface — or a curl —
            circulation around a closed loop). That's a 2×2 grid, hence four equations. The current
            asymmetry — only E has a charge source on the divergence side — is what would change if
            a magnetic monopole were found, but the four-equation structure itself reflects the
            structure of vector calculus on a three-dimensional manifold
            <Cite id="griffiths-2017" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Are Maxwell's equations linear? Why does that matter?">
          <p>
            Yes — in vacuum the equations are perfectly linear in <M tex="E" /> and <M tex="B" />.
            That's why superposition works: shine two flashlights at each other and the beams pass
            through each other unaffected. Two charges? Add their fields. Two radio signals on the
            same frequency? They simply sum. Linearity is what makes Fourier analysis work for EM
            waves, why antennas can transmit multiple frequencies at once, and why the whole
            signal-processing toolkit applies to electromagnetism without modification. (In matter,
            response can be nonlinear at high intensities; "nonlinear optics" exists because the
            polarizability of the medium itself starts to depend on field amplitude.)
            <Cite id="jackson-1999" in={SOURCES} />
          </p>
        </FAQItem>
        ...
        <FAQItem q="Where does charge conservation fit into the four laws?">
          <p>
            ...
            <M tex="\partial\rho/\partial t + \nabla\cdot J = 0" />, the continuity equation, which
            is exactly the statement that charge is locally conserved. In fact, this is the reason
            Maxwell <em className="text-text italic">had</em> to add the displacement-current term:
            without it, the divergence of Ampère's right-hand side wouldn't match the divergence of
            the left, and charge conservation would fail in any non-steady situation
            <Cite id="feynman-II-18" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why is there a μ₀ε₀ but no 'G₀' gravitational equivalent?">
          <p>
            Because gravity, in its weak-field form, doesn't have an analogous curl law: Newtonian
            gravity has only the equivalent of Gauss's law (∇·g = −4πGρ). General relativity
            supplies the full nonlinear structure, and the speed of gravitational waves does fall
            out of Einstein's equations — and it equals c. So the analogy works, but only at the
            level of the full field theory, not at the level of Newton's law. There's no single
            "gravitational ε₀" because the constant G plays the role of both source-strength and
        ...
        <FAQItem q="What does 'displacement current' actually displace?">
          <p>
            Nothing. The name is a historical fossil from Maxwell's mechanical model of the ether,
            in which he imagined real charges being slightly displaced inside a dielectric medium
            that filled empty space. The ether is gone, the displacement is gone, but the term name
            survives. What's left is the operative mathematical fact: a time-varying electric flux
            contributes to the magnetic circulation, exactly like a conduction current does. It's a
            current in the bookkeeping sense — same units, same role in the equation — but not a
            flow of anything
            <Cite id="maxwell-1865" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Have we ever seen a magnetic monopole?">
          <p>
            No. Searches have included cosmic-ray detectors, accelerator experiments, ancient
            meteorites scanned with SQUIDs, and large-scale dedicated experiments like MoEDAL at the
            LHC. The result, every time: no confirmed monopole. The current experimental upper bound
            on monopole flux is small enough that they must be either extraordinarily rare or
        ...
        <FAQItem q="What would change if we did find one?">
          <p>
            ...
            <M tex="\oint B\cdot dA = \mu_0 Q_{m,\text{enc}}" />
            ...
            kind of stable, very massive particle exists, and the constraint of electric-charge
            quantization gets a deep explanation
            <Cite id="jackson-1999" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Is the symmetry between E and B perfect, or does the monopole asymmetry break it?">
          <p>
            In vacuum, far from any sources, the symmetry is perfect — swap E for cB and B for −E/c
            and the source-free Maxwell equations are invariant. With sources, the asymmetry shows
            up only in <em className="text-text italic">which</em> sources exist: we have electric
            charges and currents, no magnetic ones. The mathematical structure could accommodate
            both symmetrically; nature just hasn't supplied the second kind. This is one of those
            rare situations where the theory is more symmetric than the universe
            <Cite id="griffiths-2017" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Could the four laws be wrong? How would we know?">
          <p>
            Classical Maxwell electromagnetism is wrong at very short distances (where quantum
            electrodynamics is needed) and at very strong fields (where vacuum polarization causes
            nonlinear corrections). Within their classical domain, though, the equations are checked
            routinely to extreme precision — GPS, particle accelerators, radio astronomy,
            semiconductor design, the whole apparatus of modern physics. If a deviation existed at
            our energy scales, it would have shown up in some experiment by now. The boundary is
            sharp: Maxwell holds beautifully until quantum effects matter, then QED takes over and
            Maxwell falls out as the classical limit
            <Cite id="jackson-1999" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Are Maxwell's equations true in curved spacetime, near a black hole?">
          <p>
            ...
            light bends along null geodesics. The structure of "four equations" is preserved — in
            tensor notation it becomes only two
            <Cite id="jackson-1999" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What's the role of ε₀ and μ₀ — are they fundamental, or arbitrary unit choices?">
          <p>
            ...
            absent — there's just <M tex="c" />. The combination that's truly physical is the
            fine-structure constant <M tex="\alpha = e^{2}/(4\pi\varepsilon_0 \hbar c)" />, which is
        ...
        <FAQItem q="After the 2019 SI redefinition, are ε₀ and μ₀ still exact?">
          <p>
            ...
            charge <M tex="e" />, Planck's constant <M tex="h" />, the Boltzmann constant{' '}
            <M tex="k" />, and the Avogadro number became the exact defining constants. ε₀ and μ₀
            are now experimentally determined quantities, tied to the measured value of the
            fine-structure constant α. The numerical change is tiny — about 2×10⁻¹⁰ relative — but
            conceptually it flipped them from "definitions" to "measurements"
            <Cite id="codata-2018" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why isn't there a 'Faraday's law for B' that involves dE/dt?">
          <p>
            There is — that's the Ampère–Maxwell law. The fourth equation, with the
            displacement-current term, says exactly that a changing E sources a circulating B. It's
            not labelled "Faraday for B" by historical accident (Faraday was about induction in
            coils, where the changing thing is B). But mathematically, the two curl equations are
            mirror twins: changing B makes E loop; changing E makes B loop. The only difference is
            the minus sign in Faraday, which encodes Lenz / energy conservation, and the μ₀ε₀ factor
            on the Ampère–Maxwell side
            <Cite id="feynman-II-18" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why does the wave equation predict the speed of LIGHT — wasn't Maxwell just doing electricity?">
          <p>
            That was Maxwell's astonishment too. He was doing electricity and magnetism, derived the
            wave equation from his completed set of four laws, looked at the propagation speed, and
            realized it matched the independently-measured speed of light to within experimental
            error. From{' '}
            <em className="text-text italic">A Dynamical Theory of the Electromagnetic Field</em>:
            the agreement of the numbers{' '}
            <em className="text-text italic">
              "seems to show that light and magnetism are affections of the same substance"
            </em>
            <Cite id="maxwell-1865" in={SOURCES} />. Until that moment, optics and electromagnetism
            were separate subjects. After it, they were the same subject.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Can you derive Coulomb's law from Maxwell's equations?">
          <p>
            ...
            <M tex="\oint E\cdot dA = E\cdot 4\pi r^{2}" /> equals <M tex="Q/\varepsilon_0" />;
            solve for <M tex="E = Q/(4\pi\varepsilon_0 r^{2})" />; multiply by a test charge q to
            get the force. Coulomb's 1785 inverse-square law falls out of the more general law
        ...
        <FAQItem q="Could you replace the four equations with a single one using tensors / four-vectors?">
          <p>
            ...
            <M tex="\partial_{\mu}F^{\mu\nu} = \mu_0 J^{\nu}" />
            (the two source equations) and <M tex="\partial_{[\alpha}F_{\beta\gamma]} = 0" />
            (the two source-free equations, an algebraic Bianchi identity). In the language of
            differential forms, the second pair becomes <M tex="dF = 0" /> and the first{' '}
            <M tex="d{\star}F = J" />. None of this changes the physics, but it makes the
            relativistic structure of electromagnetism manifest — and it's the form that generalizes
            cleanly to curved spacetime
            <Cite id="jackson-1999" in={SOURCES} />.
          </p>
        </FAQItem>
