...
export default function Ch10Maxwell() {
  ...
  return (
    <ChapterShell chapter={chapter}>
      ...
      <p className="mb-prose-3">
        where <strong className="text-text font-medium">E</strong> is the electric field (in V/m, a vector at each point) and
        <strong className="text-text font-medium"> B</strong> is the magnetic field (in teslas); <strong className="text-text font-medium">dA</strong> is the outward-normal area
        element on a closed surface (in m²) and <strong className="text-text font-medium">dℓ</strong> is the tangent line element around a closed
        loop (in m); <strong className="text-text font-medium">Q<sub>enc</sub></strong> is the total charge enclosed by the surface (in coulombs)
        and <strong className="text-text font-medium">I<sub>enc</sub></strong> is the conduction current threading the loop (in amperes);
        <strong className="text-text font-medium"> Φ<sub>B</sub> = ∫∫ B · dA</strong> and <strong className="text-text font-medium">Φ<sub>E</sub> = ∫∫ E · dA</strong> are the
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">flux</strong> — the integral of a vector field over a surface, ∫ F · dA. For a closed surface, measures net "flow" of the field out of the enclosed volume. SI units depend on the field (V·m for E-flux, T·m² = Wb for B-flux).</>}>flux</Term> out of a closed surface) and two line integrals (circulation around a closed loop).
      ...
      <p className="pullout">
        Two <Term def={<><strong className="text-text font-medium">divergence</strong> — a scalar measure of how much a vector field flows out of an infinitesimal volume. ∇·F &gt; 0 means a source, ∇·F &lt; 0 a sink, ∇·F = 0 a divergence-free field. The divergence theorem ties ∮F·dA = ∫∇·F dV.</>}>divergence</Term> laws (what flows <em className="italic text-text">out</em> of a closed box). Two{' '}
        <Term def={<><strong className="text-text font-medium">curl</strong> — a vector measure of a field's local circulation. ∇×F is nonzero where field lines loop around an axis. Stokes' theorem ties ∮F·dℓ = ∫(∇×F)·dA.</>}>curl</Term> laws (what flows <em className="italic text-text">around</em> a closed loop).
      ...
      <p className="mb-prose-3">
        ...
        The demo below is a single rotating cubical box — the <em className="italic text-text">same</em> box for all four laws — with four toggleable
      ...
      <p className="mb-prose-3">
        The physical content is straightforward: <strong className="text-text font-medium">the only way for a closed surface to have net E flux out of it is if
      ...
      <TryIt
        tag="Try 10.1"
        question={
          <>A closed surface of any shape encloses a total charge of <strong className="text-text font-medium">1 μC</strong>. What is the total electric
        ...
        answer={
          <>
            ...
            <p className="mb-prose-1 last:mb-0">
              ≈ <strong className="text-text font-medium">1.13×10⁵ V·m</strong>, with <em className="italic text-text">ε₀</em> = 8.854×10⁻¹² F/m<Cite id="codata-2018" in={SOURCES} />.
      ...
      <p className="mb-prose-3">
        ...
        which they disappear. <strong className="text-text font-medium">No magnetic{' '}
        <Term def={<><strong className="text-text font-medium">monopole</strong> — a hypothetical isolated north or south magnetic pole. None has ever been observed; every B-field line is a closed loop. The asymmetry with electric charge (which has free monopoles, the electron and proton) is an open puzzle of the Standard Model.</>}>monopoles</Term></strong><Cite id="jackson-1999" in={SOURCES} />.
      </p>
      ...
      <TryIt
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              Exactly <strong className="text-text font-medium">zero</strong>, no matter where or how big the surface is<Cite id="jackson-1999" in={SOURCES} />:
            </p>
            <Formula>∮ B · dA = 0</Formula>
            <p className="mb-prose-1 last:mb-0">
              Whatever <strong className="text-text font-medium">B</strong>-flux enters one side of any closed surface, the same amount comes out somewhere
      ...
      <p className="mb-prose-3">
        The third equation —{' '}
        <Term def={<><strong className="text-text font-medium">Faraday's law</strong> — a changing magnetic flux through a loop drives an EMF around the loop: ∮ E · dℓ = − dΦ<sub>B</sub>/dt. The minus sign (Lenz's law) encodes energy conservation. Discovered experimentally by Faraday in 1831; see Ch. 7 for the full story.</>}>Faraday's law</Term>{' '}— discovered experimentally by Faraday in 1831 and published in 1832<Cite id="faraday-1832" in={SOURCES} />:
      </p>
      <Formula>∮ E · dℓ = − dΦ<sub>B</sub>/dt</Formula>
      <p className="mb-prose-3">
        A magnetic flux that changes in time produces a circulating electric field. Equivalently: <strong className="text-text font-medium">a time-varying
      ...
      <p className="mb-prose-3">
        ...
        always points in the direction whose induced current would <em className="italic text-text">oppose</em> the change in flux. If the universe
      ...
      <TryIt
        tag="Try 10.3"
        question={
          <>The magnetic flux through a single-turn loop ramps linearly from <strong className="text-text font-medium">0</strong> to <strong className="text-text font-medium">1 mWb</strong>
          over <strong className="text-text font-medium">1 ms</strong>. What is the magnitude of the induced EMF around the loop?</>
        }
        ...
        answer={
          <>
            ...
            <p className="mb-prose-1 last:mb-0">
              <strong className="text-text font-medium">1 V</strong> exactly, for the duration of the ramp. (The minus sign sets direction — which way the
              induced current would flow — but doesn't change the magnitude.) Multiply by <em className="italic text-text">N</em> turns and the EMF
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">Ampère–Maxwell law</strong> — currents and changing electric flux together source a magnetic circulation: ∮ B · dℓ = μ₀(I<sub>enc</sub> + ε₀ dΦ<sub>E</sub>/dt). Maxwell's 1865 displacement-current correction is what closes the loop and produces electromagnetic waves.</>}>Ampère–Maxwell law</Term>{' '}— is the one Maxwell rewrote. Ampère's original law, established empirically in 1826
        <Cite id="ampere-1826" in={SOURCES} />, was the magnetic counterpart of Faraday's:
      </p>
      <Formula>∮ B · dℓ = μ₀ I<sub>enc</sub></Formula>
      <p className="mb-prose-3">
        Current sources circulating B. Beautiful — but, Maxwell noticed in 1865, <em className="italic text-text">broken</em> in any situation where
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">displacement current</strong> — the term <em className="italic text-text">J<sub>D</sub> = ε₀ ∂E/∂t</em> that Maxwell added to Ampère's law in 1865. Not an actual flow of charge, but a changing electric flux that sources B exactly as a real current would. Without it, charge conservation fails in time-varying situations.</>}><em className="italic text-text">displacement current</em></Term>. In the capacitor
      ...
      <TryIt
        tag="Try 10.4"
        question={
          <>The electric field inside a charging capacitor's gap is changing at a rate of <strong className="text-text font-medium">1 GV/(m·s)</strong>
          (i.e. <strong className="text-text font-medium">10⁹ V/m per second</strong>). What is the displacement-current density <em className="italic text-text">J<sub>D</sub></em> there?</>
        }
        hint="J_D = ε₀ dE/dt."
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              Plug in <em className="italic text-text">ε₀</em> = 8.854×10⁻¹² F/m<Cite id="codata-2018" in={SOURCES} />:
            </p>
            <Formula>J<sub>D</sub> = ε₀ dE/dt = (8.854×10⁻¹²)(10⁹) ≈ 8.85×10⁻³ A/m²</Formula>
            <p className="mb-prose-1 last:mb-0">
              About <strong className="text-text font-medium">8.85 mA/m²</strong> — a modest current density, but spread over the plate area it produces
      ...
      <p className="mb-prose-3">
        where <strong className="text-text font-medium">∇ ×</strong> denotes the curl operator, <strong className="text-text font-medium">∂B/∂t</strong> and <strong className="text-text font-medium">∂E/∂t</strong>
        are the partial derivatives of the fields with respect to time at a fixed point in space (in T/s and
        V/(m·s) respectively), and <strong className="text-text font-medium">μ₀ε₀</strong> has units of s²/m². These are the differential
      ...
      <p className="mb-prose-3">
        where <strong className="text-text font-medium">∇²E</strong> is the vector Laplacian of the electric field (the sum of its three second
        spatial derivatives, in V/m³) and <strong className="text-text font-medium">∂²E/∂t²</strong> is the second derivative of E with respect to
        time at a fixed point in space (in V/(m·s²)). That's a{' '}
        <Term def={<><strong className="text-text font-medium">wave equation</strong> — a PDE of the form <em className="italic text-text">∇²ψ = (1/v²) ∂²ψ/∂t²</em> whose solutions are travelling waves at speed <em className="italic text-text">v</em>. Maxwell's equations in vacuum reduce to this with <em className="italic text-text">v = 1/√(μ₀ε₀) = c</em>.</>}>wave equation</Term>. The same manipulation on the second equation gives the same equation for B. Waves of E
        and B, propagating together through vacuum, with phase speed
      </p>
      <Formula>v = 1 / √(μ₀ ε₀)</Formula>
      <p className="mb-prose-3">
        where <strong className="text-text font-medium">v</strong> is the propagation speed of the wave (in m/s) and
        <strong className="text-text font-medium"> μ₀, ε₀</strong> are the two vacuum constants introduced in §1.
        ...
        for the era. Maxwell wrote, in <em className="italic text-text">A Dynamical Theory of the Electromagnetic Field</em>, that the agreement
      ...
      <TryIt
        tag="Try 10.5"
        question={
          <>Compute the propagation speed <em className="italic text-text">c = 1/√(μ₀ ε₀)</em> directly from the modern values of the two constants.</>
        }
        hint="μ₀ ≈ 1.257×10⁻⁶ T·m/A, ε₀ ≈ 8.854×10⁻¹² F/m."
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              Use CODATA values<Cite id="codata-2018" in={SOURCES} />: <em className="italic text-text">μ₀</em> = 1.25664×10⁻⁶ T·m/A,
              <em className="italic text-text"> ε₀</em> = 8.8542×10⁻¹² F/m. Then
            </p>
            <Formula>μ₀ ε₀ = 1.25664×10⁻⁶ × 8.8542×10⁻¹² ≈ 1.1127×10⁻¹⁷ s²/m²</Formula>
            <Formula>c = 1 / √(1.1127×10⁻¹⁷) ≈ 2.998×10⁸ m/s</Formula>
            <p className="mb-prose-1 last:mb-0">
              Exactly the speed of light — <strong className="text-text font-medium">2.998×10⁸ m/s</strong> — falling out of two constants measured by
      ...
      >
        <CaseStudy
          ...
          summary={<em className="italic text-text">A spark gap, a resonant loop, and the laboratory production of the waves Maxwell had predicted twenty-three years earlier.</em>}
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            Karlsruhe laboratory of <strong className="text-text font-medium">Heinrich Hertz</strong>, who in 1887–1888 built the first deliberate
        ...
        <CaseStudy
          ...
          summary={<em className="italic text-text">12 December 1901: a three-dot Morse "S" from Poldhu, Cornwall, received on a kite-flown antenna at Signal Hill, Newfoundland.</em>}
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            Thirteen years after Hertz, <strong className="text-text font-medium">Guglielmo Marconi</strong> wagered that Maxwell's waves would
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            receiving antenna had to convert the arriving <strong className="text-text font-medium">E</strong>-field back into a measurable current
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            <em className="italic text-text"> ionosphere</em>, an upper-atmospheric plasma layer whose refractive index becomes imaginary for
        ...
        <CaseStudy
          ...
          summary={<em className="italic text-text">1575.42 MHz, 20,200 km altitude, position to a few metres anywhere on Earth.</em>}
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            phase-coherent <strong className="text-text font-medium">1575.42 MHz</strong> carrier modulated with a pseudo-random ranging code
            ...
            <em className="italic text-text"> Maxwell's equations in action</em>: a transmitted plane wave, a free-space path-loss budget set
            by the wave's <InlineMath>1/r²</InlineMath> intensity fall-off, a receiver antenna obeying the
            reciprocity theorem.
          </p>
          <p className="mb-prose-2 last:mb-0">
            The numbers force respect. The received signal at the ground is around <strong className="text-text font-medium">−130 dBm</strong> —
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            out to require <em className="italic text-text">relativistic</em> corrections to the satellite clocks before launch. Chapter 9
        ...
        <CaseStudy
          ...
          summary={<em className="italic text-text">1420.406 MHz: an atomic spin-flip transition that maps the galaxy.</em>}
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            <strong className="text-text font-medium"> 5.87 μeV</strong> higher. The forbidden magnetic-dipole transition between them has a mean
            lifetime around <strong className="text-text font-medium">10⁷ years</strong>, but the interstellar medium contains so many hydrogen
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            hyperfine coupling to nuclear spin. <strong className="text-text font-medium">Harold Ewen and Edward Purcell</strong> built a horn
      ...
      >
        ...
        <FAQItem q="Are Maxwell's equations linear? Why does that matter?">
          <p>
            Yes — in vacuum the equations are perfectly linear in <strong className="text-text font-medium">E</strong> and <strong className="text-text font-medium">B</strong>. That's why
        ...
        <FAQItem q="Where does charge conservation fit into the four laws?">
          <p>
            ...
            Gauss for E: the result is <strong className="text-text font-medium">∂ρ/∂t + ∇·J = 0</strong>, the continuity equation, which is exactly the
            statement that charge is locally conserved. In fact, this is the reason Maxwell <em className="italic text-text">had</em> to add the
        ...
        <FAQItem q="What would change if we did find one?">
          <p>
            The second equation would gain a source term: <strong className="text-text font-medium">∮B·dA = μ₀ Q<sub>m,enc</sub></strong>, and Faraday's
        ...
        <FAQItem q="Is the symmetry between E and B perfect, or does the monopole asymmetry break it?">
          <p>
            ...
            Maxwell equations are invariant. With sources, the asymmetry shows up only in <em className="italic text-text">which</em> sources exist:
        ...
        <FAQItem q="Are Maxwell's equations true in curved spacetime, near a black hole?">
          <p>
            Yes, in their covariant form. Written using the electromagnetic field tensor <strong className="text-text font-medium">F<sup>μν</sup></strong>
        ...
        <FAQItem q="What's the role of ε₀ and μ₀ — are they fundamental, or arbitrary unit choices?">
          <p>
            ...
            with. In Gaussian units, both are absent — there's just <em className="italic text-text">c</em>. The combination that's truly physical is
            the fine-structure constant <strong className="text-text font-medium">α = e²/(4πε₀ ℏ c)</strong>, which is dimensionless and equals roughly
        ...
        <FAQItem q="After the 2019 SI redefinition, are ε₀ and μ₀ still exact?">
          <p>
            ...
            via ε₀ = 1/(μ₀ c²). After the 2019 SI revision, the elementary charge <em className="italic text-text">e</em>, Planck's constant
            <em className="italic text-text"> h</em>, the Boltzmann constant <em className="italic text-text">k</em>, and the Avogadro number became the exact defining constants.
        ...
        <FAQItem q="Why does the wave equation predict the speed of LIGHT — wasn't Maxwell just doing electricity?">
          <p>
            ...
            independently-measured speed of light to within experimental error. From <em className="italic text-text">A Dynamical Theory of the
            Electromagnetic Field</em>: the agreement of the numbers <em className="italic text-text">"seems to show that light and magnetism are
        ...
        <FAQItem q="Can you derive Coulomb's law from Maxwell's equations?">
          <p>
            ...
            the sphere; the integral <strong className="text-text font-medium">∮E·dA = E·4πr²</strong> equals <strong className="text-text font-medium">Q/ε₀</strong>; solve for
            <strong className="text-text font-medium"> E = Q/(4πε₀ r²)</strong>; multiply by a test charge q to get the force. Coulomb's 1785 inverse-square
        ...
        <FAQItem q="Could you replace the four equations with a single one using tensors / four-vectors?">
          <p>
            ...
            one. Defining the electromagnetic field tensor <strong className="text-text font-medium">F<sup>μν</sup></strong>, Maxwell's equations
            collapse to <strong className="text-text font-medium">∂<sub>μ</sub>F<sup>μν</sup> = μ₀ J<sup>ν</sup></strong> (the two source equations) and
            <strong className="text-text font-medium"> ∂<sub>[α</sub>F<sub>βγ]</sub> = 0</strong> (the two source-free equations, an algebraic Bianchi
            identity). In the language of differential forms, the second pair becomes <strong className="text-text font-medium">dF = 0</strong> and the
            first <strong className="text-text font-medium">d⋆F = J</strong>. None of this changes the physics, but it makes the relativistic structure
        ...
        <FAQItem q="How does QED relate to these — is QED just Maxwell + quantization?">
          <p>
            Close, but with a twist. Quantum electrodynamics promotes the classical field <strong className="text-text font-medium">F<sup>μν</sup></strong>
