  ...
  return (
    <ChapterShell chapter={chapter}>
      ...
      <p className="mb-prose-3">
        ...
        ε<sub>r</sub> and μ<sub>r</sub>
        are macroscopic averages over those microscopic responses. By the end of the chapter you'll
        be able to look at a number like ε<sub>r</sub>(water) ≈ 80 and tell, by eye, that water must
        have a permanent molecular dipole — there's no other way to get a number that big.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        bookkeeping behind your back — every bound charge, every aligned dipole, every induced
        orbital current. Bundle all that microscopic response into one number, and Maxwell's
        equations stay the same shape
        <Cite id="griffiths-2017" in={SOURCES} />
        <Cite id="jackson-1999" in={SOURCES} />. That's the deal.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        shifting in opposite directions, by an angstrom or so. The atom develops a tiny induced
        dipole moment — and if the molecule had a permanent dipole moment already (like water), it
      ...
      <p className="mb-prose-3">
        ...
        <strong className="text-text font-medium">
          <Term
            def={
              <>
                <strong className="text-text font-medium">polarization (P)</strong> — the volume
                density of electric dipole moment in a dielectric. SI unit: C/m². Linked to bound
                charge by{' '}
                <em className="text-text italic">
                  ρ<sub>b</sub> = −∇·P
                </em>
                , and to the applied field by{' '}
                <em className="text-text italic">
                  P = ε₀ χ<sub>e</sub> E
                </em>{' '}
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">
                susceptibility (χ<sub>e</sub>, χ<sub>m</sub>)
              </strong>{' '}
              — the dimensionless ratio relating a material's response to an applied field.
              Electric:{' '}
              <em className="text-text italic">
                P = ε₀ χ<sub>e</sub> E
              </em>
        ...
        χ<sub>e</sub> tells you how vigorously a material polarizes per unit applied field. For air
        it's about 5×10⁻⁴; for glass, a handful; for water, ∼79{' '}
        <Cite id="griffiths-2017" in={SOURCES} />. The Clausius–Mossotti relation links χ
        <sub>e</sub> to the molecular polarizability α and the number density N — derived
        independently by Mossotti in 1846 and Clausius in 1850
      ...
      <p className="mb-prose-3">
        ...
        law for dielectrics
        <Cite id="debye-1929" in={SOURCES} />. The dipole tails pile up on the left face and the
        heads on the right: those are the bound surface charges, and their net field{' '}
        <em className="text-text italic">opposes</em> the applied one. That cancellation is where ε
        <sub>r</sub> comes from — read it directly off the readout as the alignment grows.
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            ...
            <strong className="text-text font-medium">C₀ = 100 pF</strong> with a vacuum gap. Fill
            the gap with mica (
            <em className="text-text italic">
              ε<sub>r</sub>
            </em>{' '}
            ≈ 6.7), same geometry. What is the new capacitance?
          </>
        }
        hint={
          <>
        ...
        answer={
          <>
            <Formula>
              C = ε<sub>r</sub> · C<sub>0</sub> = 6.7 · 100 pF = 670 pF
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              Capacitance rises by a factor of{' '}
              <strong className="text-text font-medium">6.7 → 670 pF</strong>. Mica's{' '}
              <em className="text-text italic">
                ε<sub>r</sub>
              </em>{' '}
              ≈ 6.7 plus its high breakdown field is why early radio circuits used mica capacitors
              for tuned stages
              <Cite id="griffiths-2017" in={SOURCES} />.
            </p>
          </>
      ...
      <TryIt
        ...
        question={
          <>
            ...
            <em className="text-text italic">V</em>, one with a vacuum gap and one with a water
            dielectric (
            <em className="text-text italic">
              ε<sub>r</sub>
            </em>{' '}
            ≈ 80), compare the stored energies.
          </>
        }
        hint={
          <>
            U = ½CV²; C scales with ε<sub>r</sub> when V is held fixed.
          </>
        }
        answer={
          <>
            <Formula>
              U<sub>water</sub> / U<sub>vacuum</sub> = C<sub>water</sub> / C<sub>vacuum</sub> = ε
              <sub>r</sub> = 80
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              The water-filled cap stores <strong className="text-text font-medium">80×</strong> the
              energy for the same V — at the cost of water's high conductivity and dielectric loss
              above kHz, which is why nobody actually builds capacitors with liquid-water
      ...
      <p className="mb-prose-3">
        ...
        favors orientations with <strong className="text-text font-medium">p</strong> along{' '}
        <strong className="text-text font-medium">E</strong>. Integrate over the angular
        ...
        , which at small fields gives a polarization linear in E with a 1/T temperature dependence
        (Curie's law for dielectrics). Heat water up and ε<sub>r</sub>
      ...
      <p className="mb-prose-3">
        ...
        dielectric becomes a layer of free surface charge on a conductor — and at the conductor's
      ...
      <p className="mb-prose-3">
        ...
        In iron, cobalt, nickel, and a handful of their alloys and oxides, a quantum-mechanical
      ...
      <TryIt
        ...
        question={
          <>
            ...
            <strong className="text-text font-medium">M</strong>.
          </>
        }
        hint={
          <>
            For small χ<sub>m</sub>: H ≈ B/μ₀, so M = χ<sub>m</sub> H ≈ χ<sub>m</sub> B/μ₀.
          </>
        }
        answer={
          <>
            ...
            <p className="mb-prose-1 last:mb-0">
              ...
              ≈ 1.7×10⁶ A/m. That gap is why paramagnetic levitation in a 1 T lab magnet barely
              lifts an O₂ droplet, while a kitchen magnet sticks to a fridge door
      ...
      <p className="mb-prose-3">
        ...
        <strong className="text-text font-medium">B</strong> (and the thermal noise scrambles them
        right back), while the diamagnet's induced arrows point
        <em className="text-text italic"> against</em>{' '}
        <strong className="text-text font-medium">B</strong>. One has permanent moments; the other
      ...
      <p className="mb-prose-3">
        ...
        <strong className="text-text font-medium">
          <Term
            def={
              <>
                <strong className="text-text font-medium">magnetic domain</strong> — a region of a
                ferromagnet inside which the spontaneous magnetization is uniform and aligned along
                one easy axis. Domains are separated by thin walls (Bloch or Néel walls) across
                which the moment rotates; their pattern minimises the total magnetostatic energy.
              </>
            }
          >
            domains
      ...
      <p className="mb-prose-3">
        ...
        <strong className="text-text font-medium">B</strong> grow at the expense of the others — the
        walls move. Crank <strong className="text-text font-medium">B</strong> hard enough and every
        domain is aligned; the iron is
        <em className="text-text italic"> saturated</em>, with magnetization M<sub>s</sub>. Now ramp{' '}
        <strong className="text-text font-medium">B</strong> back to zero. The walls don't unwind
        cleanly. They get pinned on lattice imperfections, on grain boundaries, on crystal defects.
        Some of the alignment survives <strong className="text-text font-medium">B = 0</strong> —
        that's the
      ...
      <p className="mb-prose-3">
        ...
        . The area enclosed is the energy dissipated per cycle (per unit volume) as domain walls
        click past their pinning sites. For a transformer iron core you want this area as small as
      ...
      <p className="mb-prose-3">
          ...
          <Term
            def={
              <>
                ...
                — the temperature above which thermal energy overwhelms the exchange coupling that
                orders neighbouring spins. Below{' '}
                <em className="text-text italic">
                  T<sub>C</sub>
                </em>{' '}
                a ferromagnet has spontaneous magnetization; above it, the material is paramagnetic
                with{' '}
                <em className="text-text italic">
                  χ<sub>m</sub> ∝ 1/(T − T<sub>C</sub>)
                </em>{' '}
                (Curie–Weiss law).
              </>
            }
        ...
        (770 °C for iron, 1115 °C for cobalt) and the exchange coupling loses to thermal noise — the
        domains evaporate and the material becomes an ordinary paramagnet. This is why dropping a
        magnet in a campfire wipes it.
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            ...
            <strong className="text-text font-medium">L₀ = 2 mH</strong>. Insert a soft-iron core
            with{' '}
            <em className="text-text italic">
              μ<sub>r</sub>
            </em>{' '}
            ≈ 5000, same geometry. What is the new inductance?
          </>
        }
        hint={
          <>
            L = μ<sub>r</sub> · L<sub>air</sub> for a tightly-coupled solenoid.
          </>
        }
        answer={
          <>
            <Formula>
              L = μ<sub>r</sub> · L<sub>0</sub> = 5000 · 2 mH = 10 H
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              The iron core jumps the inductance by a factor of{' '}
              <strong className="text-text font-medium">5000 → 10 H</strong>. That is the whole
              reason every audio transformer, mains transformer, and switched-mode-supply
      ...
      <TryIt
        ...
        question={
          <>
            ...
            ≈ 1043 K. Using the rough power-law{' '}
            <em className="text-text italic">
              M(T) ≈ M₀ (1 − T/T<sub>C</sub>)<sup>β</sup>
            </em>{' '}
            with critical exponent <em className="text-text italic">β</em> ≈ 0.37, estimate the
            fraction of saturation magnetization remaining 100 K below the Curie point.
          </>
        }
        hint={
          <>
            Set T = T<sub>C</sub> − 100 K, so 1 − T/T<sub>C</sub> = 100/1043.
          </>
        }
        answer={
          <>
            <Formula>
              1 − T/T<sub>C</sub> = 100 / 1043 ≈ 0.0959
            </Formula>
            <Formula>
              M/M<sub>0</sub> ≈ (0.0959)<sup>0.37</sup> ≈ 0.42
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              At 100 K below the transition, only{' '}
              <strong className="text-text font-medium">~42 %</strong> of saturation magnetization
              survives. Within 10 K of{' '}
              <em className="text-text italic">
                T<sub>C</sub>
              </em>
              , M drops below 20 %. That steep decline is why permanent-magnet datasheets quote a
              maximum operating temperature well below the Curie point — and why magnetocaloric
              refrigeration with gadolinium (
              <em className="text-text italic">
                T<sub>C</sub>
              </em>{' '}
              ≈ 292 K) lands in the right temperature window for kitchen-scale cooling
              <Cite id="kittel-2005" in={SOURCES} />
              <Cite id="weiss-1907" in={SOURCES} />.
            </p>
          </>
      ...
      <p className="mb-prose-3">
        ...
        coil as if μ inside is just μ₀. Iron, by contrast, makes the coil's inductance jump by
        thousands. A real-world inductor without an iron core is a different category of device than
        one with an iron core; that's the entire physics of why you wind transformers on iron
        laminations.
      </p>
      ...
      <CaseStudies intro="Three places where the susceptibility numbers of this chapter become the working tolerances of an industry.">
        <CaseStudy
          ...
          summary={
            <>
              A Nobel-winning bilayer effect that read a generation of hard drives — engineered
              ferromagnet/non-magnet sandwiches whose resistance flips with a few-gauss field.
            </>
          }
          specs={[
            {
              label: 'Discovery (independent)',
              value: 'Fert (Orsay) & Grünberg (Jülich), 1988–89',
            },
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            previously known magnetoresistive effect
            <Cite id="baibich-1988" in={SOURCES} />. A parallel discovery at Jülich on Fe/Cr/Fe
            trilayers by Grünberg's group appeared shortly after
            <Cite id="binasch-grunberg-1989" in={SOURCES} />. The two papers shared the 2007 Nobel
            Prize in Physics.
          </p>
          <p className="mb-prose-2 last:mb-0">
            ...
            layers are antiparallel (zero field), every electron is "wrong" in one of the layers and
            the resistance is high. A small applied field flips both layers parallel, and electrons
            of one spin now travel relatively freely through the whole stack — resistance drops
            abruptly
            <Cite id="kittel-2005" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
        ...
        <CaseStudy
          ...
          summary={
            <>
              Barium titanate ferroelectrics push εᵣ into the thousands and pack farads of
              capacitance into millimetres of board space.
            </>
          }
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            <Term
              def={
                <>
                  <strong className="text-text font-medium">ferroelectric</strong> — a material with
                  a spontaneous, switchable electric polarization below a Curie temperature, in
                  direct analogy to a ferromagnet. Unit cells distort along one axis, giving each
                  cell a permanent dipole; cells cooperate over macroscopic domains.{' '}
                  <em className="text-text italic">
                    ε<sub>r</sub>
                  </em>{' '}
                  in the thousands and electric hysteresis loops.
                </>
              }
            >
              ferroelectric
            </Term>{' '}
            — a material with a <em className="text-text italic">spontaneous</em>
            electric polarization below its Curie temperature of about 120 °C, in direct analogy to
            ferromagnetism in iron
            <Cite id="kittel-2005" in={SOURCES} />. Its relative permittivity peaks at the
            ferroelectric transition and stays in the thousands across normal operating
            temperatures; Moulson and Herbert tabulate room-temperature values from about 1000 in
            coarse-grained pure BaTiO₃ up to 10000 in carefully-doped formulations
        ...
        <CaseStudy
          ...
          summary={
            <>
              Two ferromagnets, two Curie points 750 K apart — and the reason gadolinium can be a
              refrigerant near room temperature while iron cannot.
            </>
          }
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            through the conduction electrons and is much weaker — hence gadolinium's
            barely-above-ice-point T<sub>C</sub>.
          </p>
          <p className="mb-prose-2 last:mb-0">
            ...
            Curie–Weiss law
            <Cite id="weiss-1907" in={SOURCES} />. At T<sub>C</sub> itself, the magnetic specific
            heat develops a sharp peak. Because gadolinium's transition sits within reach of a
            domestic compressor, it is the working substance of the
            <strong className="text-text font-medium"> magnetocaloric refrigerator</strong>: cycle
            Gd through a strong magnetic field on and off, and the entropy associated with its spin
            order shows up as a temperature change of a few kelvin per cycle
            <Cite id="kittel-2005" in={SOURCES} />. Iron's T<sub>C</sub> of 770 °C makes the same
            trick irrelevant for everyday cooling.
          </p>
          <p className="mb-prose-2 last:mb-0">
      ...
      <FAQ intro="The microscopic story raises a lot of questions a quick read won't answer. Here are the ones a careful reader tends to surface.">
        <FAQItem q="Why is water's ε_r so much larger than glass's?">
          <p>
            Water has a permanent molecular dipole — the H–O–H bond angle is bent (∼104.5°) and
            oxygen is much more electronegative than hydrogen, so the molecule has a built-in dipole
            moment of about 1.85 debye. In an applied field these dipoles just rotate; no electron
            stretching is needed. Glass is a covalent network with no comparable permanent dipoles —
            only the much weaker induced electronic response, which gives ε<sub>r</sub> ≈ 4–10.
            Debye worked out the theory of polar liquids and got the right scaling for water in 1929
            <Cite id="debye-1929" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Is there a material with ε_r < 1?">
          <p>
            Not in the static (DC) limit, for an ordinary linear, passive dielectric — that would
            imply negative bound charge density per unit field, which violates energy
            considerations. At
            <em className="text-text italic"> finite frequencies</em>, however, ε(ω) can have a real
            part below 1 (or even negative) near resonances — this is what gives metals their
            characteristic optical reflectivity. So "static ε<sub>r</sub> &lt; 1" no, "ε<sub>r</sub>
            (ω) &lt; 1 at optical frequencies" yes, and it's exactly why a silver mirror reflects
            visible light <Cite id="jackson-1999" in={SOURCES} />.
          </p>
        </FAQItem>

        <FAQItem q="What's the difference between bound and free charge?">
          <p>
            <strong className="text-text font-medium">Free charge</strong> is mobile — the
            conduction electrons in a metal, the ions in a solution. You can put it on a capacitor
            plate, drive it through a wire, count it with an ammeter.{' '}
            ...
            <strong className="text-text font-medium">E</strong> fields; the distinction is purely
        ...
        <FAQItem q="Why does putting a dielectric in a capacitor increase its capacitance?">
          <p>
            Capacitance is <strong className="text-text font-medium">C = Q/V</strong>. With a
            ...
            <strong className="text-text font-medium">V = E · d</strong> drops by the same factor,
        ...
        <FAQItem q="Are dielectrics also conductors at high enough field?">
          <p>
            Yes — every dielectric has a <em className="text-text italic">breakdown field</em> above
            which it ionizes and conducts. Air breaks down at about 3 MV/m (the spark in a lightning
            bolt). Glass breaks at 10–25 MV/m. The mechanism is impact ionization: a stray electron
            is accelerated by the strong field, kicks another electron free on collision, both
            accelerate, both kick more loose, and an avalanche ensues. The dielectric becomes a
            conductor along the breakdown channel — sometimes permanently, if it carbonizes{' '}
            <Cite id="jackson-1999" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What's a ferroelectric?">
          <p>
            A material that — in analogy to a ferromagnet — has a{' '}
            <em className="text-text italic">spontaneous</em> electric polarization, even with no
            applied field. Barium titanate (BaTiO₃) is the canonical example; its unit cell is
            slightly distorted along one axis, giving each cell a permanent dipole moment, and the
            cells cooperate over macroscopic domains. Ferroelectrics show electric hysteresis loops,
            have ε<sub>r</sub> in the thousands, and are the basis of ceramic capacitors and some
            non-volatile memories <Cite id="kittel-2005" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What's the difference between B and H — really?">
          <p>
            <strong className="text-text font-medium">B</strong> is the magnetic field itself — the
            thing that pushes on moving charges, the thing that appears in Maxwell's equations and
            in the Lorentz force law. <strong className="text-text font-medium">H</strong> is a
            ...
            because separating free from bound current makes the boundary conditions much cleaner.
            Griffiths' description: H is to B as D is to E — a "fictitious" field invented to make
            life easier when matter is involved <Cite id="griffiths-2017" in={SOURCES} />.
          </p>
        </FAQItem>

        <FAQItem q="Why does a magnetic material saturate?">
          <p>
            Because the material is a finite collection of magnetic moments and once they're all
            ...
            <strong className="text-text font-medium">B</strong> harder and magnetization can't rise
        ...
        <FAQItem q="Why is permanent magnetization possible — what locks it?">
          <p>
            Two things, working together. First, exchange coupling makes a uniformly-magnetized
            state energetically favored at the microscopic scale. Second, the magnetization can be
            stuck in a particular direction by{' '}
            <em className="text-text italic">magnetocrystalline anisotropy</em> — certain crystal
            axes are "easier" to magnetize along than others — and by domain-wall pinning at lattice
            defects. Together these create deep local minima in the energy landscape that a small
            reverse field can't pull the system out of. That's the remanence{' '}
            <Cite id="weiss-1907" in={SOURCES} />
            <Cite id="kittel-2005" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why does heating a magnet kill it? (Curie temperature)">
          <p>
            Thermal energy <em className="text-text italic">kT</em> competes with the
            ...
            domain pattern is present and you have to remagnetize it.
          </p>
        </FAQItem>

        <FAQItem q="What's the difference between dia-, para-, ferro-, and antiferromagnetism?">
          <p>
            <strong className="text-text font-medium">Diamagnetism</strong>: induced orbital
            currents oppose the applied B; every material has it; χ<sub>m</sub> ≈ −10⁻⁵.{' '}
            <strong className="text-text font-medium">Paramagnetism</strong>: independent permanent
            moments align weakly with B against thermal noise; χ<sub>m</sub> ≈ +10⁻⁵ to +10⁻³,
            follows Curie's law.
            <strong className="text-text font-medium"> Ferromagnetism</strong>: exchange coupling
            forces parallel alignment of neighboring spins; spontaneous magnetization below T
            <sub>C</sub>; χ<sub>m</sub> up to ∼10⁶.
            <strong className="text-text font-medium"> Antiferromagnetism</strong>: exchange forces{' '}
            <em className="text-text italic">antiparallel</em> alignment of neighbors; net
            macroscopic magnetization is zero, but the spin sublattices each carry an ordered
            moment. MnO and most chromium compounds are antiferromagnetic. There's also
            <em className="text-text italic"> ferrimagnetism</em> — antiparallel sublattices of
            unequal magnitude, giving a net moment; magnetite (Fe₃O₄) is the textbook example{' '}
            <Cite id="kittel-2005" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Can you make a non-conducting magnet?">
          <p>
            Yes. <em className="text-text italic">Ferrites</em> — ceramic oxides of iron — are
            ferrimagnetic insulators. The classic black-magnet refrigerator magnet and the ceramic
            core of an RF transformer are both ferrites. Because they don't conduct, eddy currents
            are tiny — that's why they're preferred at radio frequencies, where the iron-laminate
            cores used in 60-Hz transformers would dissipate too much
            <Cite id="kittel-2005" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Is there a 'magnetic Coulomb's law'?">
          <p>
            ...
            been observed; Maxwell's <strong className="text-text font-medium">∇·B = 0</strong> is
        ...
        <FAQItem q="Why do certain materials become superconductors only at low temperatures?">
          <p>
            Conventional superconductivity arises from a phonon-mediated attractive interaction
            between electrons that, below some critical temperature T<sub>c</sub>, lets them form
            bound "Cooper pairs" and condense into a coherent quantum state with zero DC resistance.
            The pairing energy (the "gap") is tiny — typically about{' '}
            <em className="text-text italic">
              kT<sub>c</sub>
            </em>
        ...
        <FAQItem q="Why do MRI machines use such large fields?">
          <p>
            ...
            <strong className="text-text font-medium">B</strong>. At room temperature the proton's
            Zeeman splitting <em className="text-text italic">μB</em> is tiny compared to{' '}
            <em className="text-text italic">kT</em>, so only a few protons per million end up
        ...
        <FAQItem q="Why does refractive index depend on wavelength?">
          <p>
            Because the bound electrons in a material have natural resonance frequencies (typically
            in the UV for transparent solids). When the light's frequency is far below resonance,
            the electrons respond easily and the polarization tracks the field nearly in phase — ε
            <sub>r</sub>(ω) increases as ω approaches the resonance from below. That gives the
            characteristic "blue-bends-more" dispersion of glass. Right at resonance, absorption
            peaks and the material becomes opaque. Above resonance, ε<sub>r</sub>(ω) drops below 1,
            giving rise to all of the metal-like optical phenomena. The whole dispersion curve is
            one continuous function set by the material's resonance structure{' '}
            <Cite id="jackson-1999" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What's the Clausius–Mossotti relation, and what does it tell you?">
          <p>
            For a dilute or moderately dense collection of polarizable molecules — each with
            molecular polarizability α and number density N — the Clausius–Mossotti relation reads
          </p>
          <Formula size="sm">
          ...
          <p>
            ...
            <strong className="text-text font-medium">N</strong> is the number density of
            polarizable molecules (in m⁻³), <strong className="text-text font-medium">α</strong> is
            the molecular polarizability (in C·m²/V), and
            <strong className="text-text font-medium"> ε₀ ≈ 8.854×10⁻¹² F/m</strong> is the
            permittivity of free space.
          </p>
          <p>
            It links the macroscopic permittivity ε<sub>r</sub> to the microscopic α. The factor of
            (ε + 2) in the denominator is a self-field correction: each molecule sits in not only
            the external field but also the field of all the other dipoles, and the geometry of a
            spherical cavity inside a polarized continuum gives the 1/3 factor. Mossotti derived it
            in 1846; Clausius independently in 1850 <Cite id="clausius-1850" in={SOURCES} />. The
            same relation appears in optics as the Lorentz–Lorenz formula, with ε<sub>r</sub>{' '}
            replaced by n².
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why is the static ε_r of water 80 but its optical n is only 1.33?">
          <p>
            Because at low frequencies, the entire water molecule can rotate to align with the
            applied field — and that's where most of the polarization comes from. At optical
            frequencies (∼10¹⁵ Hz), the molecule can't rotate that fast; only the electronic
            response remains. So at low frequencies ε<sub>r</sub> ≈ 80, while at optical frequencies
            ε<sub>r</sub> = n² ≈ 1.77. Between these two regimes the permittivity drops in a series
            of relaxation steps — the classic Debye-relaxation behavior{' '}
            <Cite id="debye-1929" in={SOURCES} />. That's why microwave ovens work: 2.45 GHz sits
            right in the middle of water's relaxation tail, where ε<sub>r</sub>
