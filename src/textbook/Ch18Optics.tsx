  ...
  return (
    <ChapterShell chapter={chapter}>
      <p className="chapter-intro">
        ...
        reflection of the room appears on the front face. The light that makes it through emerges on
        the other side bent slightly off its original line. And if you tilt the glass at just the
        right angle, the reflection of the lamp suddenly becomes much dimmer — its glare polarised
        away. Three observations, three textbook chapters of optics, and all three are consequences
      ...
      <p className="mb-prose-3">
        ...
        . At the interface itself, Maxwell's equations demand four boundary conditions on the
        fields:
      </p>
      <Formula>
      ...
      <p className="mb-prose-3">
        ...
        going from dense to rare, sin θ<sub>2</sub> goes to one, then nothing greater can be made:
        there is no transmitted ray, and the boundary becomes a perfect mirror. That's{' '}
      ...
      <TryIt
        ...
        answer={
          <>
            <Formula>
              sin θ<sub>c</sub> = n<sub>2</sub>/n<sub>1</sub> = 1.00 / 1.33 ≈ 0.752
            </Formula>
            <Formula>
              θ<sub>c</sub> = arcsin(0.752) ≈{' '}
              <strong className="text-text font-medium">48.8°</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              Above 48.8° the underside of the water surface is a perfect mirror — which is why,
              swimming under a pool, looking up at a steep angle returns a silvery image of the pool
              floor
              <Cite id="hecht-2017" in={SOURCES} />.
            </p>
          </>
      ...
      <p className="mb-prose-3">
        ...
        shorter spatial period because v has dropped. Engineers building anti-reflection coatings
        and optical waveguides care about this constantly.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        is a slab of glass ground so that incoming parallel rays — all bent by Snell's law at the
        front face and again at the back — converge to a single{' '}
        <em className="text-text italic">focal point</em> on the far side (a converging, biconvex
        lens) or appear to diverge from a virtual focal point on the same side (a diverging,
        biconcave lens). For thin lenses the{' '}
        <Term def="The thin-lens approximation 1/f = 1/d_o + 1/d_i for object distance d_o, image distance d_i, and focal length f. Sign convention: distances measured along the direction of light propagation are positive; magnification m = -d_i/d_o.">
          thin-lens equation
        </Term>{' '}
        ties the focal length f, object distance d<sub>o</sub>, and image distance d<sub>i</sub>{' '}
        together
        <Cite id="hecht-2017" in={SOURCES} />:
      </p>
      <Formula>
      ...
      <p className="mb-prose-3">
        ...
        astronomical refractor. Real lenses suffer from chromatic aberration (because n depends on λ
        — different colours focus at different f) and spherical aberration (because a perfect sphere
        doesn't focus a perfect point); cancelling those is most of what a professional optical
        designer does.
      </p>
      ...
      <TryIt
        ...
        answer={
          <>
            <Formula>
              1/d<sub>i</sub> = 1/f − 1/d<sub>o</sub> = 1/0.050 − 1/1.00 = 20.0 − 1.0 = 19.0 m⁻¹
            </Formula>
            <Formula>
              d<sub>i</sub> ≈ <strong className="text-text font-medium">0.0526 m = 52.6 mm</strong>
            </Formula>
            <Formula>
              m = −d<sub>i</sub>/d<sub>o</sub> = −0.0526/1.00 ≈{' '}
              <strong className="text-text font-medium">−0.053</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
      ...
      <p className="mb-prose-3">
        ...
        <Term def="The empirical formula n(λ) ≈ A + B/λ² + C/λ⁴ + ... fit to refractive-index data for transparent glasses in the visible. Cauchy proposed it in 1836; the Sellmeier equation (1871) is a more physically-motivated successor.">
          Cauchy's formula
        </Term>{' '}
        fits most common glasses to four-figure accuracy
        <Cite id="hecht-2017" in={SOURCES} />:
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            ...
            sodium-D yellow line)?
          </>
        }
        hint="Convert λ to µm before squaring."
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">λ = 0.589 µm, so λ² = 0.347 µm².</p>
            <Formula>
              n = 1.504 + 0.00420 / 0.347 ≈ 1.504 + 0.0121 ≈{' '}
              <strong className="text-text font-medium">1.516</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              The published BK7 catalog value at the sodium-D line is n ≈ 1.5168 — Cauchy gets you
              the third decimal essentially for free
              <Cite id="hecht-2017" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        the{' '}
        <Term def="Augustin-Jean Fresnel's 1823 formulae giving the amplitude reflection and transmission coefficients at a dielectric interface, separately for the s (perpendicular) and p (parallel) polarisations. They follow directly from the four boundary conditions on E and B.">
          Fresnel equations
        </Term>
        <Cite id="fresnel-1823" in={SOURCES} />:
      </p>
      <Formula>
        r<sub>s</sub> = (n<sub>1</sub> cos θ<sub>1</sub> − n<sub>2</sub> cos θ<sub>2</sub>) / (n
        <sub>1</sub> cos θ<sub>1</sub> + n<sub>2</sub> cos θ<sub>2</sub>)
      </Formula>
      <Formula>
      ...
      <p className="mb-prose-3">
        ...
        polarisation-by-reflection in stress-analysis optics, and the way photographers use circular
      ...
      <p className="mb-prose-3">
        ...
        between the two polarisers at 45° to the first axis, and the linear polarisation becomes
        circular: now the analyser transmits a steady I<sub>0</sub>/2 · ½ = I<sub>0</sub>/4
        regardless of θ<sub>2</sub>, because the rotating E-vector always has a cosine-or-sine
        component along any axis
        <Cite id="hecht-2017" in={SOURCES} />.
      </p>
      ...
      <TryIt
        ...
        answer={
          <>
            <Formula>
              θ<sub>B</sub> = arctan(1.52 / 1.00) = arctan(1.52) ≈{' '}
              <strong className="text-text font-medium">56.7°</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              At that angle the reflected ray is 100% s-polarised. Note: the transmitted ray and the
              reflected ray are <em className="text-text italic">perpendicular</em> at Brewster's
              angle — that's another equivalent definition
              <Cite id="brewster-1815" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        <sub>2</sub> &gt; 1 — impossible. The boundary instead acts as a perfect mirror, dumping
        100% of the incident energy back into medium 1. There's still an evanescent wave on the
      ...
      <p className="mb-prose-3">
        ...
        better than copper at comparable bit rates
        <Cite id="hecht-2017" in={SOURCES} />.
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            ...
            from the fiber axis) that an input ray can make and still be guided?
          </>
        }
        ...
        answer={
          <>
            <Formula>
              sin θ<sub>c</sub> = 1.463 / 1.468 ≈ 0.99659
            </Formula>
            <Formula>
              θ<sub>c</sub> ≈ 85.25°
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              Measured from the fiber's <em className="text-text italic">axis</em>, the maximum
              acceptance half-angle is 90° − 85.25° ≈{' '}
              <strong className="text-text font-medium">4.75°</strong>. The corresponding "numerical
              aperture" is NA = √(n_core² − n_clad²) ≈{' '}
              <strong className="text-text font-medium">0.121</strong>, a typical single-mode fiber
              value
              <Cite id="hecht-2017" in={SOURCES} />.
            </p>
          </>
      ...
      <p className="mb-prose-3">
        ...
        decisive experiment: a pinhole, a card with two close slits, and a screen behind it. The
        light from the two slits added on the screen with light-and-dark stripes — bright where the
        two paths to the screen differed by an integer wavelength, dark where they differed by a
        half-integer
      ...
      <TryIt
        ...
        question={
          <>
            ...
            fringe sits 6.3 mm from the centre. What wavelength was used?
          </>
        }
        hint="y_m = m λ L / d."
        answer={
          <>
            <Formula>
              λ = y<sub>1</sub> · d / (L · 1) = (6.3×10⁻³)(1.0×10⁻⁴) / (1.0)
            </Formula>
            <Formula>
              λ ≈ <strong className="text-text font-medium">6.3×10⁻⁷ m = 630 nm</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              Red-orange — about the colour of a helium-neon laser line (632.8 nm) or a red-LED
              <Cite id="hecht-2017" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        a precision spectroscopic tool: a 1200-line/mm grating illuminated by light of finite
        bandwidth resolves features down to λ/Δλ ≈ 10⁵ in modest instruments
        <Cite id="born-wolf-1999" in={SOURCES} />.
      </p>
      ...
      <TryIt
        ...
        answer={
          <>
            ...
            <Formula>
              sin θ<sub>1</sub> = (1)·(550×10⁻⁹) / (1.667×10⁻⁶) ≈ 0.330
            </Formula>
            <Formula>
              θ<sub>1</sub> = arcsin(0.330) ≈{' '}
              <strong className="text-text font-medium">19.3°</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              ...
              sodium-D doublet (0.6 nm split, ≈0.022°) at first order with room to spare
              <Cite id="born-wolf-1999" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <Pullout>
        If light is a wave, it should interfere with itself. Young split a beam in two and watched
        it stripe and unstripe across a screen.
      </Pullout>
      ...
      <p className="mb-prose-3">
        ...
        . In thermal equilibrium it's negligible: most atoms are in the ground state. Invert the
      ...
      <p className="mb-prose-3">
        ...
        with a metastable upper state, (2) a <em className="text-text italic">pump</em> (flashlamp,
        electrical discharge, another laser) that drives a population inversion, and (3) an{' '}
        <em className="text-text italic">optical cavity</em> (two mirrors, one partially
        transmitting) that sends photons back through the gain medium many times before letting a
        fraction out as the beam. The cavity selects which longitudinal modes oscillate; the gain
        medium's homogeneous linewidth selects which atomic transitions amplify; the output
        coupler's reflectivity sets the steady-state intracavity power. Out the end comes a beam of
        unmatched <em className="text-text italic">coherence</em> — temporal (narrow linewidth, long
      ...
      >
        <CaseStudy
          ...
          specs={[
            ...
            { label: 'Operating wavelengths', value: <>1310 nm (O-band), 1550 nm (C-band)</> },
            {
              ...
              value: (
                <>
                  ~0.32 dB/km at 1310, ~0.20 dB/km at 1550 <Cite id="hecht-2017" in={SOURCES} />
                </>
              ),
            },
            { label: 'Core diameter', value: <>~9 µm; cladding 125 µm</> },
            {
              label: 'Confinement mechanism',
              value: <>total internal reflection (n_core − n_clad ≈ 0.005)</>,
            },
          ]}
        >
          <p className="mb-prose-2 last:mb-0">
            Modern single-mode fibre is a glass cylinder about as wide as a human hair, with the
            core (the light-guiding region) only nine micrometres across — about fifteen wavelengths
            of 1550-nm infrared light. The cladding is doped pure silica with a slightly lower index
            than the core, just enough to ensure that the propagating field is confined by total
            internal reflection at every wall encounter. At the operating wavelengths, silica's
            intrinsic absorption sits at a deep minimum: 0.2 dB/km means half the light is left
            after 15 km
            <Cite id="hecht-2017" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
            ...
            converting to electronics. The fibre, the doped-erbium amplifier, and the semiconductor
            pump laser are all 100% Maxwell-equations devices.
          </p>
        </CaseStudy>
        ...
        <CaseStudy
          ...
          specs={[
            {
              label: 'Bare glass (n = 1.52) reflectance',
              value: (
                <>
                  R = ((n−1)/(n+1))² ≈ 4.3% at normal incidence{' '}
                  <Cite id="hecht-2017" in={SOURCES} />
                </>
              ),
            },
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            reflects about <strong className="text-text font-medium">4%</strong> of incoming light
            by the Fresnel formula R = ((n−1)/(n+1))². After ten bare surfaces, only about (0.96)¹⁰
            ≈ 66% of incident light reaches the sensor; the rest bounces around inside as flare and
            ghosting.
          </p>
          <p className="mb-prose-2 last:mb-0">
          ...
          <p className="mb-prose-2 last:mb-0">
            The point: it's the same thin-film interference physics as a soap bubble's iridescence —
            controlled, designed, baked at high temperature into a borosilicate element. Newton
            would have recognised the principle.
          </p>
        </CaseStudy>
        ...
        <CaseStudy
          ...
          specs={[
            {
              label: 'Spectral resolution (typical lab Czerny–Turner)',
              value: <>R = λ/Δλ ≈ 10³–10⁵</>,
            },
            { label: 'Sodium-D doublet', value: <>588.995 nm and 589.592 nm</> },
            {
              ...
              value: (
                <>
                  electronic transitions; line strength ∝ population × oscillator strength{' '}
                  <Cite id="born-wolf-1999" in={SOURCES} />
                </>
              ),
            },
            {
              label: 'Used in',
              value: <>analytical chemistry, astrophysics (stellar spectra), forensics</>,
            },
          ]}
        >
          <p className="mb-prose-2 last:mb-0">
            Different elements have different electronic energy-level diagrams; the photon
            wavelengths corresponding to allowed transitions are sharp and characteristic. A grating
            spectrometer separates incoming light by wavelength using the same interference math as
            Young's double slit (with N slits instead of two — the fringe structure sharpens as N
            grows). The pattern on the detector is a "fingerprint" of the sample's atomic species.
          </p>
          <p className="mb-prose-2 last:mb-0">
            Sodium is the easy demo: spill a salt solution into a Bunsen flame and the orange colour
            you see is the sodium-D doublet at 588.995 and 589.592 nm, fine-structure-split by the
            0.6-nm spin-orbit coupling of the 3p excited state. Other elements light up elsewhere on
            the spectrum — strontium red, copper green, potassium violet — and a decent table-top
            spectrometer with R ≈ 10⁴ can quantify each line to a fraction of a percent of the major
            component. Astronomers extended the same idea to starlight in the 1860s: every element
            in the periodic table has been read off the spectrum of some celestial body before it
            was found in a laboratory sample on Earth
            <Cite id="born-wolf-1999" in={SOURCES} />.
          </p>
        </CaseStudy>
          ...
          specs={[
            {
              ...
              value: <>circularly polarised (RealD), or linearly polarised at ±45°</>,
            },
            { label: 'Glasses', value: <>quarter-wave plate + linear polariser per eye</> },
            {
              ...
              value: (
                <>
                  each eye sees only the matching polarisation; brain fuses the two images into
                  depth <Cite id="hecht-2017" in={SOURCES} />
                </>
              ),
            },
          ]}
        >
          <p className="mb-prose-2 last:mb-0">
            A 3D cinema runs two co-projected images on the same screen: one taken from a "left eye"
            camera, one from a "right eye" camera, the two viewpoints separated by a few
            centimetres. The trick is to deliver each image to the correct eye. The modern answer
            uses polarisation. RealD systems project the two images in opposite
            <em className="text-text italic"> circular</em> polarisations (left-handed and
            right-handed). Each eyepiece of the disposable glasses is a quarter-wave plate followed
            by a linear polariser, configured so it passes only one handedness. Your left eye sees
            only the left-camera image; your right eye sees only the right; your brain does the
            parallax fusion.
          </p>
          <p className="mb-prose-2 last:mb-0">
            Circular polarisation has a practical advantage over linear: you can tilt your head and
            the channel separation doesn't degrade. The physics is the same Fresnel / wave-plate
            machinery as everywhere else in optics; only the application is new. Polarising
            sunglasses, Brewster windows in laser tubes, optical isolators in fibre amplifiers, and
            these throwaway 3D-movie glasses are all members of the same family
            <Cite id="hecht-2017" in={SOURCES} />
            <Cite id="brewster-1815" in={SOURCES} />.
          </p>
        </CaseStudy>
      ...
      <FAQ intro="Loose threads — the questions a careful reader tends to surface after this chapter.">
        <FAQItem q="Why does the speed of light slow down inside glass?">
          <p>
            Strictly speaking it doesn't — the <em className="text-text italic">phase</em> speed of
            the macroscopic E-field inside the glass is c/n, but every individual photon's
            microscopic interaction is still at c. What happens is that the incident wave drives the
            bound electrons in the glass into oscillation; those oscillating dipoles re-radiate, and
            the superposition of the original wave and all the scattered waves moves more slowly
            than c through the bulk material. n = √ε<sub>r</sub> bundles all of that into one number
            <Cite id="jackson-1999" in={SOURCES} />
            <Cite id="hecht-2017" in={SOURCES} />. From outside, the practical answer is "yes, light
            slows by a factor of n in glass." From inside the microphysics, it's "no individual
            photon ever slows; the collective wavefront does."
          </p>
        </FAQItem>

        <FAQItem q="Why does the frequency stay the same across a boundary while wavelength changes?">
          <p>
            Because the boundary condition on the fields holds at every instant t. The tangential E
            on each side must match second-by-second, which forces both sides to oscillate at the
            same temporal frequency ω. Wavelength is v/f, and only v changes across the boundary, so
            λ scales as 1/n. A 500-nm green vacuum photon becomes a 333-nm wave inside crown glass
            (n = 1.5) but is still "green" — energy ℏω determines colour, not wavelength
            <Cite id="hecht-2017" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="If reflectance from a soap film depends on thickness, why don't ordinary windows show interference colours?">
          <p>
            ...
            light — at 4 mm thickness, the path-length difference 2nt ≈ 12 mm is far longer than the
            few-µm coherence length of a sunlight or incandescent source. The two reflections arrive
            on the retina with random uncorrelated phases, so their intensities add instead of their
            amplitudes; no interference fringes. (2) Even with a laser, a slab thick enough that 2nt
            = thousands of λ would show fringes only if the thickness varied across the slab by an
            appreciable fraction of λ. Optical-quality windows are flat to a small fraction of a
            wavelength only locally; the colour effect is washed out by surface roughness
            <Cite id="hecht-2017" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why is the sky blue and the sunset red?">
          <p>
            ...
            short-wavelength (violet/blue) light is scattered out of the direct line from the sun
            much more strongly than long-wavelength (red) light. Looking at the sky in any direction
            other than the sun, you see scattered blue. Looking at the sun near the horizon
            (sunset), the direct path through the atmosphere is much longer; the blue has been
            scattered out and what reaches you is the residual red/orange. That goes back to the
            same atom-as-driven-oscillator picture — the ε<sub>r</sub>(ω) curve has a 1/λ⁴
            susceptibility tail well below the UV resonances of N₂ and O₂
            <Cite id="jackson-1999" in={SOURCES} />
            <Cite id="hecht-2017" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why is Brewster's angle the same as the angle where the reflected and refracted rays are perpendicular?">
          <p>
            Geometric proof: at Brewster's angle θ<sub>B</sub>, tan θ<sub>B</sub> = n<sub>2</sub>/n
            <sub>1</sub>. Snell's law gives sin θ<sub>2</sub>/sin θ<sub>B</sub> = n<sub>1</sub>/n
            <sub>2</sub> = 1/tan θ<sub>B</sub> = cos θ<sub>B</sub>/sin θ<sub>B</sub>. So sin θ
            <sub>2</sub> = cos θ<sub>B</sub>, meaning θ<sub>2</sub> = 90° − θ<sub>B</sub>: the
            refracted ray is perpendicular to the would-be reflected ray. Physically, the in-medium
            oscillating dipoles excited by the p-polarised refracted wave can radiate in the
            direction of the refracted ray and perpendicular to it, but not along the dipole axis
            itself — and at this geometry "the reflected direction" coincides with "along the dipole
            axis." Hence no p-polarised reflection
            <Cite id="hecht-2017" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why are diamonds so bright and sparkly compared to glass?">
          <p>
            Two reasons, both refractive-index. (1) Diamond has n = 2.42 — much higher than glass's
            1.5. Brewster's-angle reflectance grows with n; at normal incidence R = ((n−1)/(n+1))²
            gives about 17% per facet for diamond vs 4% for glass. (2) Diamond's critical angle for
            TIR with air is arcsin(1/2.42) ≈ 24.4°, much smaller than glass's ≈ 42°, so a much
            greater fraction of internal rays bounce around inside the stone instead of exiting the
            back surface. A well-cut diamond is engineered to return essentially all light entering
            the table back out through the table — the "brilliant" cut is a TIR machine. Dispersion
            (Cauchy slope) is also higher for diamond, giving the "fire" of colours splaying out the
            back facets
            <Cite id="hecht-2017" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="How does a lens focus light using only refraction?">
          <p>
            ...
            (because a perfect sphere does not focus to a perfect point), coma, astigmatism, field
            curvature, distortion. Professional optics design is mostly the art of cancelling these
            aberrations among several lens elements made of different glasses.
          </p>
        </FAQItem>
        ...
        <FAQItem q="If a laser is just stimulated emission, why does it produce a tight beam?">
          <p>
            ...
            single transverse mode. (2) The Fabry–Pérot cavity geometry only sustains standing-wave
            modes whose round-trip phase is a multiple of 2π and whose transverse profile is an
            eigenmode of the resonator (typically a Gaussian TEM₀₀ for a confocal cavity). (3)
            Diffraction in the cavity sets the smallest possible beam waist; outside the cavity, the
            beam expands by a divergence half-angle θ ≈ λ/(π w₀) — for a 10-mW HeNe with w₀ = 0.3
            mm, θ ≈ 0.7 mrad. So tight, but not infinitely tight — diffraction is still the limit
            <Cite id="hecht-2017" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why is laser light 'coherent' if every photon comes from a separate atom?">
          <p>
            Stimulated emission is a phase-locked process: the photon emitted by the atom comes out
            in phase with the photon that triggered it. In a fully-saturated laser cavity,
            essentially every emission is stimulated (spontaneous emission is several orders of
            magnitude rarer per atom), so all the photons in the beam trace back to the same seed
            and carry the same phase relationship. That's{' '}
            <em className="text-text italic">temporal</em> coherence — the field amplitude has a
            well-defined phase over long timescales (microseconds to seconds for stable lasers).
            Combined with the cavity's spatial-mode selection, it produces a beam where the field is
            essentially a pure sinusoid with a single Gaussian transverse profile
            <Cite id="maiman-1960" in={SOURCES} />
            <Cite id="hecht-2017" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why does an ordinary mirror reflect almost everything while glass reflects only 4%?">
          <p>
            Because the mirror's reflecting layer is a thin film of metal (silver, aluminium, or for
            telescope mirrors sometimes gold), not a dielectric. In a metal, the conduction
            electrons respond to the incident field by setting up a surface current that cancels the
            field inside the metal — there is almost no transmitted wave, almost all the incident
            energy goes back into the reflected one. Aluminium gives ~91% reflectance in the
            visible; silver, 95%; protected silver in optical mirrors, 98–99% across the visible.
            The Fresnel formulae still apply, but with complex n for the metal — the imaginary part
            of n is what handles the absorption
            <Cite id="jackson-1999" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What's the difference between a transparent and an opaque material?">
          <p>
            Transparency requires that the material have very low absorption at visible wavelengths
            — i.e., the imaginary part of n is essentially zero. That happens when the material has
            no electronic transitions in the visible band: bandgap energies in the UV or higher
            (silica, quartz, water), no free electrons (so not a metal), and no scattering centres
            on the scale of λ (so a polycrystalline ceramic with grain sizes ~λ scatters and looks
            white, while a single crystal of the same material is clear). Many materials are
            transparent in some bands and opaque in others — silica is transparent in the visible
            and near-IR but opaque below 200 nm (electronic absorption) and above ~3 µm (vibrational
            absorption)
            <Cite id="hecht-2017" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="How does dispersion limit fiber-optic bandwidth?">
          <p>
            ...
            For a 1550-nm DWDM channel with a 10-GHz modulation bandwidth, the dispersion is small
            but nonzero — over hundreds of kilometres, pulse-spreading would smear adjacent bits
            into each other and limit bit-rate. Modern long-haul links compensate by inserting
            fibres with deliberately opposite-sign dispersion every so often, or by using digital
            signal processing to undo the dispersion in the receiver. The zero-dispersion wavelength
            for standard silica fibre sits around 1310 nm (one of the reasons the telecom O-band
            lives there)
            <Cite id="hecht-2017" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why do soap films get darker just before they pop?">
          <p>
            ...
            thins faster than the bottom. When the thickness falls below about λ/4n ≈ 100 nm, the
            path-length difference 2nt becomes smaller than half a wavelength even for violet light,
            so there's no constructive interference left anywhere in the visible — destructive
            interference is approximate everywhere, and the film looks very dark. The film at that
            point is just a few molecular layers thick; bursting follows shortly. Newton documented
            these "black films" in the 1670s
            <Cite id="hecht-2017" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What is the physical difference between an LED and a laser diode?">
          <p>
            Both are forward-biased p-n junctions in a direct-bandgap semiconductor (GaAs, InGaN,
            etc.), and in both, electrons and holes recombine at the junction to emit photons of
            energy roughly the bandgap. In an LED, emission is spontaneous, so the output is
            incoherent, broad-spectrum (≈30-nm linewidth), and uncollimated. A laser diode adds two
            cleaved end-facets (the simplest possible Fabry–Pérot mirrors — reflectance ~30% per
            facet from the semiconductor's high index) and a current density above the lasing
            threshold; stimulated emission dominates, the cavity picks a single longitudinal mode,
            and the output is coherent, narrow-line, and collimated. The hardware is similar; the
            operating regime is what makes one a display element and the other a fibre-optic
            transmitter
            <Cite id="hecht-2017" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why is 632.8 nm a famous wavelength?">
          <p>
            ...
            which lases easily in a low-pressure He-Ne mixture excited by a glow discharge. HeNe
            lasers were the workhorse laboratory laser from the 1960s through the 1990s, cheap and
            stable, with a coherence length of decimetres and a beautifully Gaussian beam. They've
            largely been replaced by semiconductor laser diodes for cost and efficiency reasons, but
            every optics-lab oldtimer recognises the colour instantly
            <Cite id="hecht-2017" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Can light go faster than c in a medium?">
          <p>
            The <em className="text-text italic">phase</em> velocity v_p = c/n can exceed c — this
            happens with n &lt; 1, as in X-rays in any material, or near a sharp absorption line at
            frequencies just above resonance. It does not transmit information faster than c. The{' '}
            <em className="text-text italic">group</em>
            ...
            wavefront can carry new information — stays bounded by c). Special relativity is never
            violated
            <Cite id="jackson-1999" in={SOURCES} />.
          </p>
        </FAQItem>
