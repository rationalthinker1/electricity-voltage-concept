  ...
  return (
    <ChapterShell chapter={chapter}>
      <p className="chapter-intro">
        Rub a balloon on your hair and stick it to a wall. The balloon stays — through paint,
        through gravity, through your fingers tugging at it — held there by something that doesn't
        touch anything. <strong className="text-text font-medium">That</strong> is electricity in
        its rawest form. Not the neat 60 Hz alternating current in your wall outlet, not the bright
        sparks of a thundercloud. Just two surfaces full of opposite{' '}
        <Term
          def={
            <>
      ...
      <PredictThenObserve
        ...
        question={
          <>
            Two positive point charges of <strong className="text-text font-medium">1 nC</strong>{' '}
            each sit <strong className="text-text font-medium">1 cm</strong> apart in air. The force
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">point charge</strong> — an idealised charge
              with no spatial extent, used as a building block. Real charged objects are integrated
              as sums of point charges.
            </>
          }
        >
          point charges
      ...
      <p className="mb-prose-3">
        ...
        each charge exerts on the other (in newtons),
        <strong className="text-text font-medium"> Q₁</strong> and{' '}
        <strong className="text-text font-medium">Q₂</strong> are the two charges (in coulombs,
        signed),
        <strong className="text-text font-medium"> r</strong> is the distance between them (in
        metres), and
        <strong className="text-text font-medium"> k = 8.99×10⁹ N·m²/C²</strong> is Coulomb's
        constant in SI units
        <Cite id="codata-2018" in={SOURCES} />. Sign convention: if Q₁ and Q₂ have the same sign, F
      ...
      <TryIt
        ...
        question={
          <>
            Two small spheres sit 10 cm apart in air, carrying{' '}
            <strong className="text-text font-medium">+5 nC</strong> and{' '}
            <strong className="text-text font-medium">−3 nC</strong>. What is the magnitude of the
            Coulomb force between them, and is it attractive or repulsive?
          </>
        }
        hint={
          <>
        ...
        answer={
          <>
            ...
            <p className="mb-prose-1 last:mb-0">
              The signs are opposite, so the force is attractive. Magnitude:{' '}
              <strong className="text-text font-medium">1.35×10⁻⁵ N (~13.5 µN)</strong>, attractive.
            </p>
          </>
        }
      />
      ...
      <p className="mb-prose-3">
        ...
        After traveling a distance <strong className="text-text font-medium">r</strong>, that
        influence is spread over the surface of a sphere of radius{' '}
        <strong className="text-text font-medium">r</strong>. The area of that sphere is
        <strong className="text-text font-medium"> 4πr²</strong>. The intensity per unit area must
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">inverse-square law</strong> — any force law
              where magnitude falls as 1/r². Coulomb's electrostatic force and Newton's
              gravitational force are the canonical examples; both reflect the surface area of a
              sphere growing as 4πr².
            </>
          }
        >
          power laws
      ...
      <PredictThenObserve
        ...
        question={
          <>
            If you <strong className="text-text font-medium">double</strong> the distance between
            two point charges, the force between them …
          </>
        }
        spec={{
          kind: 'multiple-choice',
      ...
      <TryIt
        ...
        question={
          <>
            Two protons sit 1 fm (10⁻¹⁵ m) apart — roughly a nuclear separation. Compute the ratio
            of the electric repulsion to the gravitational attraction between them.
          </>
        }
        hint={
          <>
        ...
        answer={
          <>
            ...
            <p className="mb-prose-1 last:mb-0">
              ...
              <strong className="text-text font-medium">10³⁶ times</strong> stronger than the
      ...
      <p className="mb-prose-3">
        ...
        what force to feel. The symbol is <strong className="text-text font-medium">E</strong>, and
        its definition is direct:
      </p>
      ...
      <p className="mb-prose-3">
        ...
        is the value of that test charge (in coulombs). Force per unit positive charge. The
        N/C-versus-V/m identity falls out in one line
      ...
      <p className="mb-prose-3">
        ...
        charge
        <strong className="text-text font-medium"> Q</strong> produces a field whose magnitude at
        distance <strong className="text-text font-medium">r</strong> from it is
      </p>
      ...
      <p className="mb-prose-3">
        ...
        (N/C), <strong className="text-text font-medium">k</strong> is Coulomb's constant,
        <strong className="text-text font-medium"> Q</strong> is the source charge (signed, in
        coulombs), and <strong className="text-text font-medium">r</strong> is the distance from the
        source charge to the point where the field is being evaluated (in metres). The direction is
        radially outward from <strong className="text-text font-medium">Q</strong> (if Q is
        positive) or inward (if Q is negative). Bring any other charge
        <strong className="text-text font-medium"> q</strong> into that field and the force on it is{' '}
        <InlineMath id="force-on-charge" /> — the new charge doesn't talk to the old one, it talks
        only to the field at its own location
      ...
      <p className="mb-prose-3">
        The 2D arrows above slice through the radial pattern in one plane. Rotate around the same
        point charge in 3D below: ~80 sample arrows on an invisible sphere of radius r let you
        confirm directly that doubling r quarters the field magnitude. The ratio readout locks at
      ...
      <p className="mb-prose-3">
        ...
        any charge that wanders in instantly knows what to do. Second, when charges
        <em className="text-text italic"> change</em>, the news travels at finite speed (the speed
        of light, as Maxwell would discover). Faraday's field gives you a place to put that news
        while it propagates. Action at a distance becomes local action on a field that obeys its own
        dynamics.
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            ...
            origin. What is the magnitude of <strong className="text-text font-medium">E</strong> at
            a point 5 cm away, and what force would an electron feel there?
          </>
        }
        hint={
          <>
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              The field magnitude from a point charge <Cite id="feynman-II-2" in={SOURCES} />:
            </p>
            ...
            <p className="mb-prose-1 last:mb-0">
              directed toward the positive source charge. Field:{' '}
              <strong className="text-text font-medium">3.6×10⁴ N/C</strong>; force on the electron:
      ...
      <p className="mb-prose-3">
        ...
        arrows, getting weaker by 1/r². For two charges, the patterns are more interesting. Two
      ...
      <p className="mb-prose-3">
        ...
        — sets of points all at the same electrostatic potential{' '}
        <strong className="text-text font-medium">V</strong>. They're the contour lines of an
      ...
      <TryIt
        ...
        question={
          <>
            A <strong className="text-text font-medium">+1 µC</strong> point charge sits in vacuum.
            What is the electrostatic potential at a point 1 m away, taking infinity as the
            reference (V → 0 at r → ∞)?
          </>
        }
        hint={
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              The potential of a single point charge, with V(∞) = 0, is{' '}
              <Cite id="griffiths-2017" in={SOURCES} />:
            </p>
            <Formula tex="V = \dfrac{kQ}{r} = \dfrac{(8.99\times 10^{9})(1\times 10^{-6})}{1} = 8.99\times 10^{3}\ \text{V}" />
            <p className="mb-prose-1 last:mb-0">
              Answer: <strong className="text-text font-medium">~9000 V (9 kV)</strong> at 1 m. A
              single microcoulomb is already a kilovolt-class source.
            </p>
          </>
        }
      />
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">conductor</strong> — a material with mobile
              charge carriers (usually electrons) free to drift under an applied field. Metals and
              electrolytes are the canonical examples.
            </>
          }
        >
          <strong className="text-text font-medium">conductor</strong>
        </Term>{' '}
        — copper, silver, salt water, your skin to a small degree — some of the electrons in each
        atom are not bound to any particular nucleus. They drift through the material, free to be
        pushed around by any applied field. In an{' '}
        <Term
          def={
            <>
              <strong className="text-text font-medium">insulator</strong> (dielectric) — a material
              in which all electrons are bound; charges can polarise but not flow. Glass, dry air,
              plastics.
            </>
          }
        >
          <strong className="text-text font-medium">insulator</strong>
        </Term>{' '}
      ...
      <p className="mb-prose-3">
        ...
        excess charge ends up <em className="text-text italic">on the surface</em>, as far apart as
        geometry allows
        <Cite id="griffiths-2017" in={SOURCES} />.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        wire to a battery and breaks the equilibrium.
      </p>
      ...
      >
        <CaseStudy
          ...
          specs={[
            {
              label: 'Cloud-to-ground potential',
              value: (
                <>
                  ~10<sup>8</sup>–10<sup>9</sup> V <Cite id="rakov-uman-2003" in={SOURCES} />
                </>
              ),
            },
            {
              label: 'Median peak return-stroke current',
              value: (
                <>
                  ~30 kA <Cite id="rakov-uman-2003" in={SOURCES} />
                </>
              ),
            },
            {
            ...
            {
              label: 'Channel breakdown field in air',
              value: (
                <>
                  ~3 MV/m <Cite id="uman-2001" in={SOURCES} />
                </>
              ),
            },
          ]}
        ...
        <CaseStudy
          ...
          specs={[
            {
              label: 'Equilibrium E-field inside a closed conductor',
              value: (
                <>
                  0 V/m <Cite id="griffiths-2017" in={SOURCES} />
                </>
              ),
            },
            {
              label: 'Excess charge location',
              value: (
                <>
                  on the outer surface <Cite id="griffiths-2017" in={SOURCES} />
                </>
              ),
            },
            {
              label: 'Inverse-square exponent bound from null-cavity tests',
              value: (
                <>
                  2 to within ~3×10<sup>−16</sup>{' '}
                  <Cite id="williams-faller-hill-1971" in={SOURCES} />
                </>
              ),
            },
            {
              label: "Cavendish's 1773 bound on the same exponent",
              value: (
                <>
                  2 to within ~1/50 <Cite id="cavendish-1773" in={SOURCES} />
                </>
              ),
            },
          ]}
        >
          <p className="mb-prose-2 last:mb-0">
            A common piece of folklore says a car protects you from lightning because of its rubber
            tires. The rubber is essentially irrelevant — the steel shell is doing all the work. Any
            closed conductor, charged or uncharged, holds the field inside its cavity at exactly
            zero in equilibrium. Free electrons in the metal redistribute themselves on the
            <em className="text-text italic"> outer</em> surface until any field they produce inside
            the cavity cancels every external field that tries to penetrate
            <Cite id="griffiths-2017" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
            ...
            <strong className="text-text font-medium">1/50</strong> of exactly 2
            ...
            <strong className="text-text font-medium"> ~3×10⁻¹⁶</strong>
          ...
          <p className="mb-prose-2 last:mb-0">
            For a real lightning strike, an enormous transient current flows through the body shell
            on its way to ground — paint flashes, antennas vaporize, electronics often die. But the
            cavity stays an equipotential, so the occupants inside do not see a potential difference
            across themselves. Tires don't matter; geometry does.
          </p>
        </CaseStudy>
      </CaseStudies>

      <FAQ intro="Loose threads from the chapter — the questions a careful reader tends to surface after the first pass.">
        <FAQItem q="Is charge a substance — a sort of electric fluid — or just a property of matter?">
          <p>
            A property, not a substance. An electron <em className="text-text italic">has</em>{' '}
            charge in the same way it has mass; you can't pour charge out of a bottle. Franklin's
        ...
        <FAQItem q="Why are there exactly two kinds of charge and not three, or seven?">
          <p>
            ...
            an integer multiple of <strong className="text-text font-medium">e</strong>, and the
            sign comes in two flavors. The two-sign structure falls out of the mathematics of U(1)
        ...
        <FAQItem q="If electrons are negative, why do textbooks draw current flowing from + to −?">
          <p>
            Historical accident. Franklin labeled the kind of charge that accumulates on glass
            rubbed with silk "positive," guessed it was the thing that flowed, and the convention
            stuck. A century later it turned out that in metals the actual carriers — electrons —
            are negative and drift the <em className="text-text italic">other</em> way. By then
            every diagram, every right-hand rule, every formula sign convention had been written in
            terms of conventional current. Rewriting all of it for accuracy was not worth the gain,
            so we live with the inversion. In an electrolyte or a plasma both signs really do flow
            at once, so the convention isn't even wrong there.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What is the constant k in Coulomb's law, and why is it so absurdly large?">
          <p>
            ...
            <Term
              def={
                <>
                  <strong className="text-text font-medium">permittivity</strong> of free space —
                  the SI constant ε₀ ≈ 8.854×10⁻¹² F/m that sets the strength of the electrostatic
            ...
            <strong className="text-text font-medium">6.24×10¹⁸</strong> electrons. Real laboratory
            charges sit at the nanocoulomb to microcoulomb level, and at those scales the forces
            become ordinary. The numerical bigness of <em className="text-text italic">k</em> is
        ...
        <FAQItem q="Why exactly 4π in 1/(4πε₀), and not just π or 2π?">
          <p>
            The <strong className="text-text font-medium">4π</strong> is the surface area of a unit
            sphere — it's the geometry of three-dimensional space leaking into the equations.{' '}
            <Term
              def={
                <>
        ...
        <FAQItem q="Is the electric field a real thing, or just bookkeeping?">
          <p>
            Real. You can't see it or touch it directly, but the field carries energy, carries
            momentum, and propagates information at the speed of light. When you wiggle a charge
            here, a charge a meter away doesn't feel anything for about three nanoseconds — and
        ...
        <FAQItem q="Why exactly inverse-square? Could the exponent secretly be 1.999 or 2.001?">
          <p>
            ...
            that requires the exponent to be 2 to within about{' '}
            <strong className="text-text font-medium">1/50</strong> by his analysis
        ...
        <FAQItem q="What's the difference between the electric field E and the potential V?">
          <p>
            <strong className="text-text font-medium">E</strong> is a vector at every point: it
            tells you the force per unit charge and which way that force points.{' '}
            <strong className="text-text font-medium">V</strong> is a scalar at every point: it
            tells you the potential energy per unit charge that a test charge would have if it sat
        ...
        <FAQItem q="What is an equipotential, geometrically?">
          <p>
            A surface — or in 2D cross-section, a curve — along which the potential V has the same
            value everywhere. You can walk along an equipotential without doing any work against the
            field, the same way you can walk along a contour line on a topographic map without
            changing elevation. Around an isolated point charge, equipotentials are concentric
            spheres. Around a dipole, they bend into nested ovals on each side and a flat plane down
            the middle. The field lines are the gradient flow — always perpendicular to the
            equipotentials, always pointing toward lower V<Cite id="griffiths-2017" in={SOURCES} />.
          </p>
        </FAQItem>

        <FAQItem q="Why does the field inside a hollow metal box vanish? (The Faraday-cage question.)">
          <p>
            Because the free electrons in the metal will rearrange until it does. If any field
            remained inside the conductor, the mobile charges would feel a force, accelerate, and
            keep rearranging until that interior field cancelled. In equilibrium the interior field
            must be zero — and a beautiful theorem says this implies the
            <em className="text-text italic"> cavity</em> inside is also field-free, provided there
            are no charges inside it
            <Cite id="griffiths-2017" in={SOURCES} />. This is exactly what Cavendish exploited in
            his 1773 null experiment to test the inverse-square law
            <Cite id="cavendish-1773" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why does your hair stand up when you pull off a wool sweater?">
          <p>
            Triboelectric charging — rubbing two dissimilar insulators transfers a small population
            of electrons from one to the other, leaving each surface slightly charged. The strands
        ...
        <FAQItem q="Does Coulomb's law work for moving charges too?">
          <p>
            Only approximately, and only at speeds far below c. The full story for moving charges
        ...
        <FAQItem q="Can charge be created or destroyed?">
          <p>
            No — total electric charge is conserved, locally and globally. You can pair-create a
            positron and an electron from a high-energy photon, but the photon was neutral and the
            pair sums to zero charge; the books still balance. Charge conservation is the symmetry
            partner, via Noether's theorem, of the gauge invariance that underlies electromagnetism.
            In everyday rubbing-balloons-on-hair experiments, you are not creating charge, only
            moving it from one surface to the other.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What does 1 coulomb actually look like in everyday terms?">
          <p>
            ...
            nanocoulombs and microcoulombs — a<em className="text-text italic"> whole</em> coulomb
            of free charge isolated in one place is essentially impossible to assemble.
          </p>
        </FAQItem>
