  ...
  return (
    <ChapterShell chapter={chapter}>
      <p className="chapter-intro">
        ...
        each about the size of a two-storey house — turn that gravitational potential energy into up
        to about two gigawatts of installed electrical capacity that lights kitchens hundreds of
        kilometres away
      ...
      <p>
        ...
        that the cause-and-effect relationship was a matter of choice. The stator's rotating field
        drives the rotor; equivalently, the rotor's rotating field induces voltage in the stator.
        Drive the rotor by some external mechanical means (a water turbine, a steam turbine, a
        gasoline engine, a wind blade) instead of letting the stator do it, and the same machine
      ...
      <p>
        ...
        opposition is exactly what produces the mechanical resistance you have to push against to
        keep the rotor turning. Energy in, work in, work out — strict conservation across the air
        gap
      ...
      <p>
        ...
        <M tex="\Phi(t) = BA \cos(\omega t)" />. The induced EMF is the time derivative
        <Cite id="griffiths-2017" in={SOURCES} />:
      </p>
      ...
      <p>
        ...
        with each. The simplest possible generator — sometimes called a single-phase{' '}
        ...
        — is exactly this picture, with two slip rings carrying the coil's two leads out to the
        external load.
      </p>
      ...
      <p>
        ...
        opposing the rotation. The mechanical torque you must apply to keep the rotor spinning is
        exactly <M tex="P_{\text{elec}} / \omega" />, where <M tex="P_{\text{elec}}" /> is the
        electrical power being delivered to the load. No load → no current → no back-torque → the
        rotor spins essentially freely (against bearing friction and windage). Full load → maximum
        current → maximum back-torque. Energy conservation is automatic; you can't extract
      ...
      <TryIt
        ...
        question={
          <>
            ...
            <strong className="text-text font-medium">A = 200 cm²</strong> rotates at{' '}
            <strong className="text-text font-medium">3600 RPM</strong> in a{' '}
            <strong className="text-text font-medium">0.5 T</strong> field. What is the peak EMF?
          </>
        }
        hint={
          <>
            Convert RPM to <M tex="\omega" /> in rad/s, then plug into <M tex="NBA\omega" />.
          </>
        }
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              First convert:{' '}
              <M tex="\omega = 2\pi \cdot (3600/60) = 2\pi \cdot 60 = 120\pi \approx 377\ \text{rad/s}" />
              . A = 200 cm² = 0.02 m².
            </p>
            <Formula tex="\varepsilon_{\text{peak}} = N B A \omega = (100)(0.5)(0.02)(377)" />
            <Formula tex="\varepsilon_{\text{peak}} \approx 377\ \text{V}" />
            <p className="mb-prose-1 last:mb-0">
              In RMS that's about 267 V — within a factor of two of standard line voltage. The 3600
              RPM happens to be the synchronous speed for a 2-pole machine on a 60 Hz grid, which is
              why utility-scale generators on steam turbines are usually 2-pole or 4-pole
      ...
      <p>
        ...
        , and every utility-scale generator on Earth is one. The rotor's field is established either
        by feeding DC current to a wound rotor through slip rings (the classical large-machine
        setup) or by permanent magnets on the rotor (small machines and increasingly mid-size wind
        turbines). The stator's three windings carry the AC output. The frequency of that output is
      ...
      <p>
        ...
        spins forever within a few parts per million of nominal because the grid frequency itself is
      ...
      <TryIt
        ...
        question={
          <>
            ...
            <strong className="text-text font-medium">40 poles</strong> and is connected to a 60 Hz
            grid. At what RPM does its shaft turn?
          </>
        }
        hint={
          <>
            The shaft must turn at synchronous speed: <M tex="n_s = 120\, f / p" />.
          </>
        }
        answer={
          <>
            ...
            <p className="mb-prose-1 last:mb-0">
              Slow! That's the right pace for a low-head hydro turbine — Francis or Kaplan runners
              want low RPM to keep their tip speeds reasonable and cavitation in check. Wind-turbine
              direct-drive generators use even higher pole counts (~100 poles or more) to run at
              10–20 RPM without a gearbox
              <Cite id="grainger-power-systems-2003" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p>
        ...
        <em className="text-text italic">field current</em> <M tex="I_f" />, which sets the rotor's
        magnetic flux and therefore the induced-EMF magnitude <M tex="|E_f|" />, and the rotor's{' '}
        <em className="text-text italic">load angle δ</em>, which is the steady-state phase lead of
      ...
      <p>
        ...
        more power no matter how hard the turbine pushes. The excess mechanical torque accelerates
        the rotor beyond synchronism — the unit{' '}
        <Term def="The condition in which a synchronous generator's rotor advances by a full electrical pole past the grid phasor. The terminal currents swing through a fault-level transient and the protection relay trips the machine offline.">
          slips a pole
        </Term>
        , the stator currents swing through a fault-level transient as <M tex="\delta" />
        wraps from 90° back through 270°, and the protection relay trips the generator off the bus
        to save it. Stable steady-state operation requires <M tex="\delta" /> well below 90°,
        typically 20°–45° at rated output, with the remaining margin reserved for fault-ride-through
        <Cite id="kundur-1994-power-stability" in={SOURCES} />.
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            ...
            <M tex="X_s = 1.5\ \text{pu}" />, <M tex="|V_{\text{grid}}| = 1\ \text{pu}" />,{' '}
            <M tex="|E_f| = 1.4\ \text{pu}" />. What is the steady-state power angle{' '}
            <M tex="\delta" /> when it delivers{' '}
            <strong className="text-text font-medium">500 MW</strong> at rated voltage?
          </>
        }
        hint={
          <>
            Per-unit P = 500/600. Then{' '}
            <M tex="\sin\delta = P \cdot X_s / (|V_{\text{grid}}| \cdot |E_f|)" />.
          </>
        }
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              Per-unit real power on the machine's own MW base:
            </p>
            ...
            <p className="mb-prose-1 last:mb-0">
              That's a high power angle by utility-operations standards — the rotor is well up the
              curve, with <M tex="P_{\max} = |V \cdot E_f|/X_s \approx 0.93\ \text{pu}" /> (about
              560 MW on the machine's base). Stability margin is thin; in practice the operator
              would dispatch additional reactive support (raise <M tex="|E_f|" />) to bring{' '}
              <M tex="\delta" /> back down before approving steady operation at this point
              <Cite id="kundur-1994-power-stability" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p>
        ...
        rectifies the AC to nearly-DC. A voltage regulator continuously trims the rotor's field
      ...
      <p>
        ...
        3-phase full-wave bridge), and the lead-acid battery sitting across the bus filters whatever
        remains. The whole assembly — generator, rectifier bridge, regulator, brushes on the rotor's
        two slip rings — fits in a package the size of a pineapple and lives bolted to the side of
        the engine block for the life of the car
        <Cite id="fitzgerald-kingsley-umans-2014" in={SOURCES} />.
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            ...
            The engine spins at <strong className="text-text font-medium">3000 RPM</strong> with a{' '}
            <strong className="text-text font-medium">2.5:1</strong> pulley ratio. What is the
            alternator's electrical frequency?
          </>
        }
        ...
        answer={
          <>
            ...
            <Formula>
              n<sub>alt</sub> = 3000 × 2.5 = 7500 RPM
            </Formula>
            <p className="mb-prose-1 last:mb-0">Electrical frequency:</p>
            <Formula>
              f = (7500 / 60) × 6 = <strong className="text-text font-medium">750 Hz</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              Much higher than grid frequency — which is fine, because the 6-diode bridge doesn't
              care: it rectifies cleanly at any frequency. Higher frequency actually helps, because
              the ripple period shrinks and battery filtering improves
              <Cite id="fitzgerald-kingsley-umans-2014" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p>
        ...
        its breaker closes — or transient circulating currents proportional to the voltage mismatch
      ...
      <ul>
        <li>
          <strong className="text-text font-medium">Frequency:</strong> |Δf| &lt; ~0.2 Hz. The
          incoming generator must already be turning at the right speed.
        </li>
        <li>
          <strong className="text-text font-medium">Phase:</strong> |Δφ| &lt; ~10°. The voltage
          waveforms must be aligned in time.
        </li>
        <li>
          <strong className="text-text font-medium">Voltage magnitude:</strong> |ΔV| &lt; ~5 %. The
      ...
      <p>
        ...
        — a lamp that goes dark when the two are in phase and bright when they're 180° out. The
        operator adjusts the generator's speed governor until the synchroscope rotates slowly (Δf
        small) and then closes the breaker as the lamp goes dark (Δφ small). Modern systems use a
        digital sync-check relay that closes the breaker automatically when all conditions are met.
        Wind farms and inverter-based renewables synchronise through power electronics rather than
        mechanically — the inverter generates a current waveform aligned with the grid's voltage, so
        there's never a hard mechanical lock-up to worry about
        <Cite id="kundur-1994-power-stability" in={SOURCES} />.
      </p>
      ...
      <p>
        ...
        <em className="text-text italic">
          electric energy cannot, at grid scale, be stored cheaply.
        </em>{' '}
      ...
      <p>
        ...
        fuel cost per kWh is the lowest, their thermal cycling cost is high (you don't want to ramp
      ...
      <p>
        ...
        largest single contingency on the system (in practice on the order of a few percent of peak
        load), kept synchronised to the bus but loaded below its rating, available to ramp up in
        seconds when an unscheduled outage drops a major generator
        <Cite id="kundur-1994-power-stability" in={SOURCES} />.
      </p>
      ...
      <p>
        ...
        capacity, the residual demand that the dispatchable generators must cover becomes{' '}
        <em className="text-text italic">more</em> variable than the original load, not less, with
        steep evening ramps as solar drops out and demand peaks. The grid's regulation requirement —
        fast-acting reserves, ramping capability, frequency response — therefore grows more
        demanding even as fuel use falls
        <Cite id="kundur-1994-power-stability" in={SOURCES} />.
      </p>
      ...
      <p>
        ...
        which accelerates the rotor back toward 60 Hz. The whole feedback loop closes in seconds.
        Slower outer loops dispatch additional reserves over minutes; load forecasting commits new
        generation hours ahead.
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            ...
            instantaneously. The system has{' '}
            <strong className="text-text font-medium">200 GW</strong> of total spinning inertia
            equivalent to <strong className="text-text font-medium">8 GW·s/Hz</strong>. By how much
            does frequency initially fall in the first second, before any governor response?
          </>
        }
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              The 8 GW·s/Hz inertia coefficient means: every 1 GW of power imbalance produces df/dt
              = 1/8 Hz/s of frequency decline, before any governor opens its valve.
            </p>
            <Formula>
              df/dt = −ΔP / H<sub>sys</sub> = −1 GW / (8 GW·s/Hz) ={' '}
              <strong className="text-text font-medium">−0.125 Hz/s</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              After one second the frequency would have fallen to ~59.875 Hz. Governor droop
              typically arrests the fall around 59.7 Hz before reserves bring it back. Below ~59.3
              Hz the grid would start dropping load to avoid cascading collapse
              <Cite id="kundur-1994-power-stability" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p>
        ...
        <M tex="2H \cdot df/dt = \Delta P/P_{\text{base}}" />, where <M tex="H" /> is the system
        inertia constant (the kinetic energy stored in all synchronous machines, divided by the
        system MVA base, with units of seconds). A grid dominated by large synchronous machines
        (coal, hydro, nuclear) has <M tex="H" /> in the 4–6 s range; a grid dominated by inverter-
      ...
      <p>
        ...
        in batteries and grid-forming inverters can replace some of the lost response, but the
        regulatory and engineering frameworks for verifying that replacement under fault conditions
      ...
      <TryIt
        ...
        question={
          <>
            A grid with total rotational inertia <M tex="H = 4\ \text{s}" /> instantly loses{' '}
            ...
            rate of frequency decline <M tex="df/dt" />?
          </>
        }
        ...
        answer={
          <>
            ...
            <Formula>
              ΔP / P<sub>base</sub> = 500 MW / 10 000 MW = 0.05 pu
            </Formula>
            <p className="mb-prose-1 last:mb-0">Swing equation:</p>
            <Formula>
              df/dt = − (ΔP / P<sub>base</sub>) · f<sub>nom</sub> / (2H) = − 0.05 · 60 / (2 · 4)
            </Formula>
            <Formula>
              df/dt = <strong className="text-text font-medium">−0.375 Hz/s</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              ...
              load-shedding scheme kicks in. Halve <M tex="H" /> to 2 s (an inverter-heavy grid) and
              the same outage produces −0.75 Hz/s — at the edge of what conventional protection
              relays can ride through
              <Cite id="kundur-1994-power-stability" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p>
        ...
        the alternator on every car. Synchronising any of these to a live grid requires matching
        frequency, phase, and voltage; once on the bus, every generator does its share of a
        real-time load-following dispatch because energy can't be stored. The grid frequency itself
        is the universal control signal: when load exceeds generation, the machines slow down; when
      ...
      >
          ...
          specs={[
            {
              ...
              value: <>22.5 GW (32 × 700 MW main units + 2 × 50 MW station-service)</>,
            },
            {
              label: 'Generator type',
              value: (
                <>
                  3-phase synchronous, water-cooled stator{' '}
                  <Cite id="fitzgerald-kingsley-umans-2014" in={SOURCES} />
                </>
              ),
            },
            ...
            { label: 'Rotational speed', value: <>~75 RPM (n_s = 120·50/80 = 75)</> },
            {
              ...
              value: <>~95–112 TWh/year, depending on water availability</>,
            },
          ]}
        >
          <p className="mb-prose-2 last:mb-0">
            Three Gorges is the largest hydroelectric facility ever constructed. The thirty-two main
            700 MW units sit in two underground powerhouses inside the dam, each unit consisting of
            a vertical-shaft Francis turbine coupled to a 3-phase synchronous generator with around
            80 poles. At 50 Hz that gives a synchronous shaft speed of about 75 RPM — appropriately
            slow for the Francis runner's 80 m hydraulic head, which would cavitate at higher tip
            speeds. The generator rotor is a wound construction with DC field excitation supplied
            through slip rings
            <Cite id="kundur-1994-power-stability" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
            The stator is water-cooled — necessary at 700 MW output because copper-loss density
        ...
        <CaseStudy
          ...
          specs={[
            {
              label: 'Total installed capacity',
              value: <>~2.08 GW (after 1986–93 uprate); originally 1.34 GW (1936)</>,
            },
            { label: 'Number of generators', value: <>17 (currently 13 large + 4 smaller)</> },
            {
              ...
              value: (
                <>
                  3-phase synchronous, vertical shaft{' '}
                  <Cite id="fitzgerald-kingsley-umans-2014" in={SOURCES} />
                </>
              ),
            },
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            Hoover Dam, completed in 1936, anchors the Western Interconnection. Its 17 generators
            ...
            <M tex="n_s = 120\cdot 60/40 = 180\ \text{RPM}" />. The slow rotation accommodates the
            high static head from Lake Mead without cavitating the runner
            <Cite id="fitzgerald-kingsley-umans-2014" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
            ...
            Phoenix, Las Vegas, and Los Angeles load centres. The whole installation illustrates a
            property of hydro that thermal plants lack: nearly the entire kinetic energy of the
            water converts to electricity, with large synchronous machines hitting efficiencies in
            the high nineties and overall water-to-wire conversion typically around 0.85–0.90 for
            installations of this class
            <Cite id="fitzgerald-kingsley-umans-2014" in={SOURCES} />.
          </p>
        </CaseStudy>
            ...
            { label: 'Grid interface', value: <>full-power back-to-back inverter</> },
            {
              ...
              value: (
                <>
                  ...
                  range <Cite id="fitzgerald-kingsley-umans-2014" in={SOURCES} />
                </>
              ),
            },
          ]}
        >
          <p className="mb-prose-2 last:mb-0">
            Modern utility wind turbines decouple themselves from the grid frequency through power
            electronics. The generator is a permanent-magnet synchronous machine with around a
            hundred poles on the rotor, sitting directly on the slow-turning hub shaft (10–18 RPM).
          ...
          <p className="mb-prose-2 last:mb-0">
            This decoupling is what makes variable-speed wind operation possible. The turbine blades
            can run at the speed that extracts the most power from the wind at any given moment (the
            maximum-power-point), while the grid interface delivers a clean 60 Hz current
            independent of shaft speed. The trade-off is that the inverter must handle the full
            machine rating — a 3 MW turbine needs a 3 MW power-electronics stack — rather than just
            a small slip-control fraction (as in older doubly-fed induction-generator turbines). The
            grid-side inverter also has to provide synthetic inertia: faking the
            frequency-supporting behaviour of a synchronous machine, because there's no physical
            rotating mass on the grid side
            <Cite id="kundur-1994-power-stability" in={SOURCES} />.
          </p>
        </CaseStudy>
        ...
        <CaseStudy
          ...
          specs={[
            {
              label: 'Engine',
              value: <>~16-cylinder 4-stroke V-configuration turbocharged diesel</>,
            },
            {
              label: 'Output',
              value: (
                <>
                  2 MW continuous, 2.2 MW standby{' '}
                  <Cite id="fitzgerald-kingsley-umans-2014" in={SOURCES} />
                </>
              ),
            },
            ...
            { label: 'Voltage', value: <>typically 480 V line-to-line for data center bus</> },
            {
              ...
              value: <>~10 s from cold start (engine + voltage regulator)</>,
            },
            { label: 'Fuel storage', value: <>typically 24–72 hours of run-time on-site</> },
          ]}
        >
          <p className="mb-prose-2 last:mb-0">
            Every Tier-III or higher data center has multiple of these — typically <M tex="N{+}1" />{' '}
            or <M tex="2N" /> redundancy on the standby generation. The unit is a turbocharged V16
            diesel engine direct-coupled to a 4-pole synchronous generator. At 60 Hz the rotor turns
            at 1800 RPM, well within the diesel's optimal torque range. The engine is constantly
            trickle-warmed (block heater + glow plugs) so it can start under load within a few
            seconds; the voltage regulator brings the output up to nominal in a few cycles after
            crank-start
            <Cite id="fitzgerald-kingsley-umans-2014" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
            An automatic transfer switch monitors the utility bus continuously. When grid voltage
            falls outside tolerance (typically ±10 %, sustained for ~50 ms), the ATS opens the
            utility-side breaker, signals the generator to start, waits for the generator to reach
            nominal voltage and frequency, and then closes the generator-side breaker. Total elapsed
            time: 5–10 seconds, during which the data center runs off battery UPS. When utility
            power returns, the ATS reverses the process: synchronises the generator to the bus,
      ...
      <FAQ intro="Loose threads — the questions a careful reader tends to surface after going through this chapter.">
        <FAQItem q="Why is the grid frequency exactly 60 Hz in North America and 50 Hz in Europe?">
          <p>
            Historical accident. Early generators were limited by mechanical and thermal
            considerations in their iron and copper, and a "high-frequency" design (the early
            Westinghouse 60 Hz standard from the 1890s) won out in North America while AEG's 50 Hz
            standard won in Germany and from there spread across Europe. Both are workable: 60 Hz
            gives slightly smaller transformers; 50 Hz gives slightly easier insulation. The two
            systems have been frozen in place for over a century because changing one country's
            frequency means replacing every motor, transformer, and clock in the country
            <Cite id="grainger-power-systems-2003" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why is grid frequency held so precisely at the nominal value?">
          <p>
            For two reasons. First, every synchronous machine on the grid is mechanically locked to
            it — change the frequency by 1 % and you're changing the rotational speed of ten
            thousand machines simultaneously, with mechanical and operational consequences. Second,
            synchronous clocks (utility-grade wall clocks, older microwave-oven displays, every "60
            Hz clock chip" in old electronics) count grid cycles directly, and a long-term frequency
            drift accumulates as time-of-day error. North American grid operators historically held
            the long-term time error within ±10 s using deliberate frequency adjustments; modern
            practice has relaxed this
            <Cite id="kundur-1994-power-stability" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why do generators produce AC instead of DC at the source?">
          <p>
            ...
            the last few decades with high-power semiconductor inverters
            <Cite id="grainger-power-systems-2003" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why does spinning a generator faster make more voltage but the same frequency relationship?">
          <p>
            ...
            <M tex="NBA\omega" />
            ), and frequency ∝ ω (the same rotation produces the sinusoid). So a generator at twice
            the shaft speed produces twice the voltage at twice the frequency. To stay synchronised
            to a fixed-frequency grid, the shaft speed must be fixed at synchronous speed — you
            can't trade off shaft speed against voltage. To make more voltage, you increase the
            rotor's field current (in a wound-rotor machine) or you wind more stator turns at design
            time
            <Cite id="fitzgerald-kingsley-umans-2014" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What is reactive power and why does the grid worry about it?">
          <p>
            Real power is <M tex="V \cdot I \cdot \cos\varphi" /> — the part of the current that's
            in phase with the voltage and actually delivers energy to the load. Reactive power is{' '}
            <M tex="V \cdot I \cdot \sin\varphi" /> — the part 90° out of phase, which sloshes back
            and forth between source and load each cycle without net energy transfer. Inductive
            loads (motors, transformers) absorb reactive power; capacitive loads (long lines,
            certain rectifier loads) produce it. The grid has to supply both, because inductive
            currents still flow through the transmission system and contribute to I²R heating in the
            wires. Synchronous generators control their reactive output by adjusting field current —
            over-excited gives capacitive (leading) VARs; under-excited gives inductive (lagging)
            VARs
            <Cite id="kundur-1994-power-stability" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why do inverter-based renewables 'lack inertia,' and why does the grid care?">
          <p>
            ...
            exceeds generation, that stored kinetic energy converts to electrical output for the
            first second or two, smoothing the frequency dip while governors respond. Inverter-based
            renewables (wind, solar) have no equivalent stored kinetic energy on the grid side — the
            inverter just synthesises whatever waveform the controller asks for. Modern grid-forming
            inverters provide <em className="text-text italic">synthetic inertia</em> by mimicking
            the kinetic-energy release in firmware, but doing it well at scale is still a current
            research and standards-development area
            <Cite id="kundur-1994-power-stability" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Can a motor really run as a generator just by spinning its shaft?">
          <p>
            Yes — that's literally how regenerative braking works in every EV. Spin a PMSM faster
            than synchronous and its back-EMF exceeds the inverter's DC-link voltage; current flows
            the other way, charging the battery and producing a braking torque on the rotor. An
            induction motor can also generate: drive its shaft above synchronous speed and slip goes{' '}
            <em className="text-text italic">negative</em>; bar currents reverse; the machine
            delivers power to the grid. Wind turbines with squirrel-cage induction generators worked
            exactly this way until the rise of doubly-fed and full-converter topologies in the 2000s
            <Cite id="fitzgerald-kingsley-umans-2014" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What happens if a generator's breaker closes when it's 180° out of phase with the grid?">
          <p>
            ...
            current
            <Cite id="kundur-1994-power-stability" in={SOURCES} />, and it lasts long enough (cycles
            to seconds) to mechanically deform the stator winding's end-turns and to jerk the
            rotor's shaft hard enough to potentially shear the coupling. This is why every modern
            synchronisation system has a hardwired sync-check relay that vetoes any breaker close
            attempt that fails its window
            <Cite id="kundur-1994-power-stability" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why do hydro and large thermal plants use 4-pole or 2-pole machines but wind turbines use 100+?">
          <p>
            Because the prime mover's optimal shaft speed differs by two orders of magnitude. A
            steam or gas turbine wants to spin at 3000–3600 RPM for thermodynamic efficiency,
            matching the 2-pole synchronous speed at 50/60 Hz. A Francis hydro turbine wants 100–200
            RPM for cavitation-free operation, matching 40–80 poles. A wind turbine's blades are
            limited to ~80 m/s tip speed before erosion and noise become problems, which on a 60
            m-radius blade is about 13 RPM — calling for ~100 poles to get to 60 Hz without a
            gearbox. The pole count is set by matching the mechanical optimum to the grid frequency
            <Cite id="fitzgerald-kingsley-umans-2014" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="How does a car alternator regulate its DC output voltage to ~14 V regardless of engine speed?">
          <p>
            Through the rotor's field current. The alternator's three-phase output is rectified by
            the diode bridge and fed to the battery and the car's bus. A separate{' '}
            <em className="text-text italic">regulator</em> circuit (now invariably a small IC
            inside the alternator housing) senses the DC bus voltage, compares it to a 14.0 V
            reference, and controls a switch in series with the rotor's field winding. Bus voltage
            low → close the switch longer → more field current → larger rotor flux → larger stator
            EMF → higher rectified output. The feedback handles arbitrary changes in engine speed
            and load with bandwidth in the kHz range
            <Cite id="fitzgerald-kingsley-umans-2014" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What is the difference between an alternator and a generator?">
          <p>
            In modern usage, "alternator" means an AC machine specifically. "Generator" is the
            umbrella term covering both AC alternators and DC generators (the latter mostly
            historical — DC generators with brushes and commutators are essentially obsolete,
            replaced by AC alternators plus rectification). In automotive usage, "generator" before
            about 1960 meant a brushed DC machine, while "alternator" was the new 3-phase-
            with-rectifier replacement; the words still carry that historical association. Utility
            usage just says "generator" and means the synchronous AC machine described in this
            chapter
            <Cite id="fitzgerald-kingsley-umans-2014" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why is the North American grid divided into three asynchronous interconnections?">
          <p>
            Three big AC grids — Eastern Interconnection, Western Interconnection, ERCOT (most of
            Texas) — run internally synchronous but are not synchronised with each other. They tie
            together only through DC links (back-to-back HVDC stations), which decouple the
            frequencies. The historical reason is that each grew from independent regional utilities
            and was easier to keep separate than to synchronise; the current engineering rationale
            is that a fault in one interconnection cannot cascade into the others. Europe is largely
            one synchronous grid (ENTSO-E Continental Europe), much of the former Soviet space is
            another, and the UK has historically been a third — connected to Europe by HVDC for the
            same reason
            <Cite id="grainger-power-systems-2003" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What is the role of pumped-storage hydro?">
          <p>
            ...
            economically into the gigawatt-hour range and historically the only one with significant
            deployed capacity, providing a few hours of peak-shaving for many continental grids
            <Cite id="grainger-power-systems-2003" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Could you in principle build a grid with no synchronous generators at all?">
          <p>
            That's the active question of the 2020s. As renewables grow and inverters replace
            synchronous machines, the grid's combined rotational inertia drops, frequency excursions
            get faster, and the traditional governor-based response can't keep up. Solutions in
        ...
        <FAQItem q="Why are large synchronous generators hydrogen-cooled?">
          <p>
            Because hydrogen has the lowest gas-phase viscosity and the highest thermal conductivity
            (and specific heat per unit mass) of any practical fluid. Windage losses inside the
            machine's gas-filled cavity scale with gas density × velocity²; switching from air to
            hydrogen at 1–3 bar cuts windage by an order of magnitude, freeing thermal and
            mechanical headroom for higher current density in the stator. The fire-safety penalty is
            handled by sealing the housing and continuously monitoring hydrogen purity. Essentially
            every utility generator above ~150 MW is hydrogen-cooled
            <Cite id="fitzgerald-kingsley-umans-2014" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What's the absolute upper limit on synchronous-generator size, and what sets it?">
          <p>
            Current state of the art is roughly 1.6–1.75 GW for a single 4-pole machine running at
            1500 or 1800 RPM (large nuclear or gas-turbine combined-cycle units). The limit is
