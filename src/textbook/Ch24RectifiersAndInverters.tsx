  ...
  return (
    <ChapterShell chapter={chapter}>
      <p className="chapter-intro">
        Pick up the brick on the cord of your laptop charger. It is heavier than it has any right to
        be — a hundred grams or so of plastic and silicon, taking 120 V at 60 Hz from the wall and
        producing 20 V of clean DC at five amps. Cut it open and you find one of the most complex
        circuits in your immediate vicinity: a bridge rectifier on the line side, a
        power-factor-correction pre-regulator, a high-frequency transformer driven by a 100 kHz
        MOSFET, a secondary rectifier, a smoothing capacitor, an opto-isolator, and a USB Power
      ...
      <p className="mb-prose-3">
        ...
        disconnect cleanly inside two seconds if the line ever goes dead
        <Cite id="mohan-undeland-robbins-2003" in={SOURCES} />. The box on the wall that takes one
        and produces the other is doing essentially the inverse of the laptop brick. Both problems —
        AC to DC, DC to AC — are the territory of power electronics, and the silicon that makes them
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">diode</strong> — a two-terminal device that
              conducts current readily in one direction (forward) and blocks it in the other
              (reverse). Implemented as a vacuum tube (Fleming 1904) or a doped semiconductor
              junction (Shockley 1949).
            </>
          }
        >
          diode
        ...
        Ambrose Fleming patented the first electronic diode — a thermionic vacuum tube he called the
        "oscillation valve" — in 1904
        <Cite id="fleming-1904" in={SOURCES} />. Heating a cathode boiled electrons off into vacuum;
        an anode at positive potential collected them; reverse the polarity and the cold anode
      ...
      <p className="mb-prose-3">
        ...
        either narrows or widens it. The current that flows is the famous
        <strong className="text-text font-medium"> Shockley diode equation</strong>:
      </p>
      <Formula>
      ...
      <p className="mb-prose-3">
        ...
        is the thermal voltage, about 25.85 mV at room temperature
        <Cite id="codata-2018" in={SOURCES} />. The exponential is the whole story: at V = 0 the
        current is zero; at V = 0.6 V it is already roughly a million times I<sub>s</sub>; at V =
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">forward voltage</strong> — the V across a
              forward-biased diode at its typical operating current; the practical "knee" of the I–V
              curve. ≈ 0.7 V for silicon p-n, ≈ 0.3 V for Schottky, ≈ 0.2 V for low-V<sub>F</sub>{' '}
              germanium.
            </>
          }
        >
        ...
        <Term
          def={
            <>
              ...
              metal-semiconductor junction rather than p-n. Lower V<sub>F</sub> (≈ 0.3 V) and
              majority-carrier conduction (no slow minority-carrier storage), so it switches in
              picoseconds. Standard rectifier in the output of every switching power supply.
            </>
          }
        >
          Schottky
        </Term>{' '}
        diode uses a metal-semiconductor junction instead of a p-n junction; it has V<sub>F</sub> ≈
        0.3 V and switches in picoseconds, which is why it is the standard output rectifier in fast
        switching supplies
        ...
        <Term
          def={
            <>
              ...
              diode designed to operate in reverse breakdown at a specific clamp voltage (typically
              2.4 V to 200 V). The "Zener voltage" V<sub>Z</sub> is set by the doping profile and is
              remarkably stable; used as a voltage reference and as an over-voltage clamp.
            </>
          }
        >
          Zener
        </Term>{' '}
        diode is doped to break down sharply at a specific reverse voltage (5.1 V, 12 V, whatever
        you order); past that, it clamps. Pull current through a 5.1 V Zener and the voltage across
        it stays glued to 5.1 V — which makes it a cheap voltage reference
        ...
        <Term
          def={
            <>
              ...
              arranged in a bridge between the AC input and the DC output. Routes each half-cycle
              through a different diode pair, producing a full-wave rectified output without needing
              a centre-tapped transformer. The universal rectifier of low-cost power supplies.
            </>
          }
        >
          bridge rectifier
        ...
        <Term
          def={
            <>
              ...
              capacitor C through load current <em className="text-text italic">I</em>, the
      ...
      <TryIt
        ...
        question={
          <>
            ...
            capacitor with a steady
            <strong className="text-text font-medium"> 1 A</strong> load current from 60 Hz mains.
            Estimate the peak-to-peak ripple.
          </>
        }
        hint={
          <>
            ΔV ≈ I · T / C, where T = 1/(2 f<sub>line</sub>) = 8.33 ms (half-cycle between peaks).
          </>
        }
        answer={
          <>
            ...
            <p className="mb-prose-1 last:mb-0">
              About <strong className="text-text font-medium">8.3 V peak-to-peak</strong> — enormous
              on a 5 V rail. That is why bulk caps in linear supplies are huge: to drag the ripple
              under 1 V at 1 A, you need ≈ 10 mF
              <Cite id="horowitz-hill-2015" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">linear regulator</strong> — a circuit that
              holds its output voltage constant by adjusting a pass transistor in series with the
              load, dropping the difference between V<sub>in</sub> and V<sub>out</sub> as heat.
        ...
        . Inside a three-terminal device like the LM7805 sits a pass transistor whose gate (or base)
        is controlled by a feedback loop. The loop measures V<sub>out</sub>, compares it to an
        internal Zener-or-bandgap reference, and adjusts the transistor's resistance to keep V
        <sub>out</sub> = 5.000 V regardless of input voltage or output current
        <Cite id="horowitz-hill-2015" in={SOURCES} />. The difference between V<sub>in</sub>
      ...
      <p className="mb-prose-3">
        ...
        <strong className="text-text font-medium">2 V of headroom</strong>
        (its{' '}
        <Term
          def={
            <>
              <strong className="text-text font-medium">dropout voltage</strong> — the minimum V
              <sub>in</sub> − V<sub>out</sub> required for a linear regulator to maintain
              regulation. Standard NPN-pass regulators need ≈ 2 V; low-drop-out (LDO) PMOS-pass
              regulators need only a few hundred millivolts.
            </>
          }
        >
          dropout voltage
        </Term>
        ) between input and output, or it slides out of regulation and the output simply tracks V
        <sub>in</sub> − 2 V. Low-drop-out (LDO) variants use a PMOS pass element instead and can
      ...
      <TryIt
        ...
        question={
          <>
            ...
            <strong className="text-text font-medium">500 mA</strong> at 5 V. How much power does it
            dissipate? How hot does it get without a heatsink (use θ<sub>JA</sub> ≈ 65 °C/W in still
            air)?
          </>
        }
        hint={
          <>
            P<sub>diss</sub> = (V<sub>in</sub> − V<sub>out</sub>) · I; ΔT = P · θ<sub>JA</sub>.
          </>
        }
        answer={
          <>
            <Formula>
              P<sub>diss</sub> = (12 − 5) · 0.5 = 3.5 W
            </Formula>
            <Formula>ΔT = 3.5 W · 65 °C/W ≈ 228 °C</Formula>
            <p className="mb-prose-1 last:mb-0">
              The junction would sit ~
              <strong className="text-text font-medium">228 °C above ambient</strong> — far above
              the 150 °C maximum
              <Cite id="horowitz-hill-2015" in={SOURCES} />. Add a heatsink (θ<sub>JA</sub> ≈ 10
              °C/W) and you drop ΔT to a survivable 35 °C; or use a switcher and burn 0.3 W instead
              of 3.5 W.
            </p>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        an embarrassment. The fix is to stop burning the voltage difference and start chopping it.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        output. The fundamental insight, formalised by Erickson and Maksimović, is{' '}
        <Term
          def={
            <>
      ...
      <p className="mb-prose-3">
        ...
        D = t<sub>on</sub>/T<sub>sw</sub>: when the switch is on the inductor sees V<sub>in</sub> −
        V<sub>out</sub>; when it is off it sees −V<sub>out</sub>. Volt-second balance gives
      </p>
      <Formula>
        (V<sub>in</sub> − V<sub>out</sub>) · D = V<sub>out</sub> · (1 − D)
      </Formula>
      <Formula>
        V<sub>out</sub> = D · V<sub>in</sub>
      </Formula>
      ...
      <p className="mb-prose-3">
        ...
        can power a 60 V LED string in your camera flash.
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            ...
            cycle from a <strong className="text-text font-medium">12 V</strong> input. What is the
        ...
        answer={
          <>
            <Formula>
              V<sub>out</sub> = 12 / (1 − 0.75) = 48 V
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              <strong className="text-text font-medium">48 V</strong>, an exact 4× step-up. Push D
              toward 1 and the equation blows up; real boost converters cap out at D ≈ 0.85 once
              switch and diode losses dominate
              <Cite id="erickson-maksimovic-2020" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <TryIt
        ...
        question={
          <>
            ...
            at duty cycle <strong className="text-text font-medium">D = 0.3</strong>. What is the
        ...
        hint={
          <>
            V<sub>out</sub> = D · V<sub>in</sub>; ideal power balance V<sub>in</sub> · I
            <sub>in</sub> = V<sub>out</sub> · I<sub>out</sub>.
          </>
        }
        answer={
          <>
            <Formula>
              V<sub>out</sub> = 0.3 · 24 = 7.2 V
            </Formula>
            <Formula>
              I<sub>in</sub> = V<sub>out</sub> · I<sub>out</sub> / V<sub>in</sub> = 7.2 · 5 / 24 =
              1.5 A
            </Formula>
            <p className="mb-prose-1 last:mb-0">
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">flyback converter</strong> — an isolated
              SMPS topology using a coupled inductor (transformer) as its energy store. During the
              switch on-time, energy accumulates in the primary's magnetic field; during the
              off-time, it transfers to the secondary through the rectifier. Provides galvanic
              isolation and arbitrary step ratio in one stage.
            </>
          }
        >
          flyback converter
        </Term>{' '}
        wraps a transformer around the same idea. The primary inductance stores energy while the
        switch is on; when the switch opens, the secondary winding releases that energy into a
        separate, galvanically-isolated output circuit. This is the cornerstone of every isolated
        low-power AC-DC supply — your laptop brick, your phone charger, your TV's standby rail —
        because the transformer breaks the conductive link between the lethal mains side and the
        safe-to-touch output
        <Cite id="mohan-undeland-robbins-2003" in={SOURCES} />.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">SCR / thyristor</strong> — a four-layer
              p-n-p-n device that latches ON when a gate pulse fires it and stays ON until the
              principal current crosses zero. Designed for high voltage and current; the workhorse
              switch of HVDC valves, phase-controlled rectifiers, and large industrial motor drives.
            </>
          }
        >
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">thyristor</strong> — the broader family of
              four-layer regenerative switches that includes the SCR, the gate-turn-off thyristor
              (GTO), and the integrated-gate commutated thyristor (IGCT). Used wherever
              multi-kilovolt, multi-kiloamp switching is required.
            </>
          }
        >
          thyristor
        </Term>{' '}
        became the workhorse of every megawatt-class converter for the next half-century. Today's
        high-power tools — the{' '}
        <Term
          def={
            <>
              <strong className="text-text font-medium">IGBT</strong> — insulated-gate bipolar
              transistor. A MOS-gated input drives a bipolar-output high-current device. Combines
              the easy drive of a MOSFET with the low conduction loss of a BJT. Standard switch in
              1–3 kV traction drives and industrial inverters.
            </>
          }
        >
          IGBT
        ...
        <Term
          def={
            <>
              ...
              field-effect transistor. Voltage-controlled four-terminal switch with gigaohm gate
              impedance. Modern power MOSFETs (silicon and SiC) switch tens of amps at hundreds of
              volts in tens of nanoseconds.
            </>
          }
        >
          MOSFET
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">inverter</strong> — a circuit that converts
              DC to AC. The "inverse" of a rectifier. Implemented as an H-bridge of MOSFETs or IGBTs
              switched by sinusoidal pulse-width modulation, followed by an LC filter.
            </>
          }
        >
          inverter
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">H-bridge</strong> — four switches (MOSFETs
              or IGBTs) arranged in two legs across a DC bus, with the load connected between the
              leg midpoints. Driving the four switches in complementary pairs lets you apply +V
              <sub>DC</sub>, −V<sub>DC</sub>, or zero across the load — the basic building block of
              every single-phase inverter and every brushed-DC drive.
            </>
          }
        >
          H-bridge
        </Term>
        : four switches, two per leg, across a DC bus, with the load wired between the two
        midpoints. Close S1 and S4 and the load sees +V<sub>DC</sub>. Close S2 and S3 and it sees −V
        <sub>DC</sub>. Switch between the two states fast, with a duty cycle modulated by a sine
        reference, and you produce{' '}
        <Term
          def={
            <>
              <strong className="text-text font-medium">PWM (pulse-width modulation)</strong> —
              encoding an analog control signal as the duty cycle of a high-frequency square wave.
              After low-pass filtering, the average reconstructs the control signal. Standard
              control technique for motor drives, inverters, class-D audio, and switching
              regulators.
            </>
          }
        >
      ...
      <p className="mb-prose-3">
        ...
        , where m ∈ [0, 1] is the modulation index. Setting the reference frequency to 60 Hz gives
      ...
      <p className="mb-prose-3">
        ...
        ripple. Drop the modulation index and the fundamental shrinks proportionally while the
        carrier sidelobes barely move; the inverter is now producing the same waveform shape at a
        lower output amplitude. Modern SiC and GaN inverters push f<sub>sw</sub> up by an order of
        magnitude over the IGBT generation precisely for this reason — every kilogram of output
        choke saved is a kilogram off an EV's weight
        <Cite id="erickson-maksimovic-2020" in={SOURCES} />.
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            ...
            <strong className="text-text font-medium">100 V peak</strong>, 60 Hz sine across a pure
            inductive load of <strong className="text-text font-medium">1 mH</strong>. What is the
            peak current?
          </>
        }
        ...
        answer={
          <>
            ...
            <Formula>
              X<sub>L</sub> = ωL = 377 · 10⁻³ = 0.377 Ω
            </Formula>
            <Formula>
              I<sub>peak</sub> = 100 / 0.377 ≈ 265 A
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              About <strong className="text-text font-medium">265 A peak</strong> — large, because a
              1 mH choke at 60 Hz is essentially a short circuit. That is why inverter output
              filters never use bare inductances that small without a current-limiting resistor or
              series capacitor in the filter
              <Cite id="erickson-maksimovic-2020" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        the inverter into a controlled-current device, not a controlled-voltage one — its job is to
      ...
      <p className="mb-prose-3">
        ...
        <strong className="text-text font-medium">cos(θ)</strong> and a reactive-power term
        proportional to <strong className="text-text font-medium">sin(θ)</strong>, where θ is the
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">anti-islanding</strong> — the requirement
              that a grid-tie inverter must rapidly detect an outage of the local grid feed and
              disconnect within ~2 seconds, so that line workers downstream are not exposed to power
              from rooftop solar. Detection is typically active (small disturbance probes) plus
              passive (over/under frequency and voltage).
            </>
          }
        >
          anti-islanding
        ...
        inverter must detect the outage and stop pushing current within about two seconds, so that
        line workers downstream are not electrocuted by power from your roof. The detection is
        harder than it sounds — a small island of solar inverters tied to a balanced local load can
        run for several seconds before any voltage or frequency excursion gives the outage away — so
        every grid-tie inverter ships with active disturbance probes that deliberately push the
        local frequency slightly until it either pulls back (grid present) or runs away (grid
        absent)
        <Cite id="mohan-undeland-robbins-2003" in={SOURCES} />.
      </p>
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">phase-locked loop (PLL)</strong> — a control
              loop that estimates the phase and frequency of the grid voltage in real time and
              produces a synchronised reference for the inverter's PWM. Without it the inverter
              cannot know when to fire the next current pulse.
            </>
          }
        >
          phase synchronisation
        </Term>
        : the inverter must know, at every microsecond, exactly where it is on the grid's 60 Hz sine
        wave. A phase-locked loop (PLL) tracks the grid voltage's zero-crossings and produces a
        continuously-updated phase reference; the PWM firmware uses that reference to time every
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">HVDC</strong> — high-voltage direct-current
              transmission. A converter station at each end of a long DC link converts AC to DC
              (rectifier) or DC to AC (inverter) using line-commutated thyristor valves (older) or
              voltage-source-converter IGBTs (newer). Lower line losses than AC over long distances;
              allows two non-synchronous grids to be linked.
            </>
          }
        >
          HVDC
      ...
      <p className="mb-prose-3">
        ...
        inductor's volt-second balance. Run the chopping backwards, with sinusoidal PWM, and you get
        an inverter — DC into AC, lossless in principle and 95% efficient in practice. Synchronise
        the inverter to a stiff grid voltage and you can push real or reactive power onto the line.
        Bigger silicon — thyristors, IGBTs — and you can do the same trick at gigawatt scale across
        half a continent. The physics is the diode equation; the engineering is everything else
        <Cite id="mohan-undeland-robbins-2003" in={SOURCES} />
        <Cite id="erickson-maksimovic-2020" in={SOURCES} />.
      </p>

      <Pullout>
        Every box that takes power from one form and gives it back as another — phone charger, EV
        inverter, HVDC valve hall — is the same physics with different silicon.
      </Pullout>
      ...
      <CaseStudies intro="Four working systems where this chapter's physics is the entire architecture.">
        <CaseStudy
          ...
          summary={
            <>
              A 100-watt flyback running at 100 kHz, primary PFC, secondary rectifier, USB-PD
              controller — the densest circuit you carry around.
            </>
          }
          specs={[
            {
              ...
              value: (
                <>
                  120 V<sub>rms</sub> / 60 Hz or 230 V<sub>rms</sub> / 50 Hz
                </>
              ),
            },
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            — typically a boost converter — shapes the input current to be sinusoidal in phase with
            the line voltage, instead of the spiky pulses a bare bridge-and-cap front end would
            draw. Without PFC, large numbers of supplies on one circuit would distort the line and
            overload the neutral
            <Cite id="mohan-undeland-robbins-2003" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
            Third, the flyback. A primary-side MOSFET switches at 65–130 kHz across the primary of a
            small ferrite-core transformer, storing energy in its primary inductance and
            transferring it to the secondary through a Schottky output rectifier each cycle. Fourth,
            the USB-PD controller — a small microcontroller that talks to whatever device you
            plugged in, negotiates the output voltage (5 V, 9 V, 15 V, 20 V, or higher), and
            commands the flyback's feedback loop to track that setpoint
            <Cite id="erickson-maksimovic-2020" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
        ...
        <CaseStudy
          ...
          summary={
            <>
              A 3-phase IGBT bridge between a 375 V battery pack and a 320 kW induction motor — and
              a regenerative brake too.
            </>
          }
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            the three output midpoints drive the three windings of an induction motor 120° apart in
            phase. The firmware computes the right sinusoidal PWM at the right frequency (variable,
            from 0 Hz at standstill up to several hundred Hz at top speed) to make the motor's
            rotating magnetic field produce the commanded torque
            <Cite id="mohan-undeland-robbins-2003" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
        ...
        <CaseStudy
          ...
          summary={
            <>
              Roof-mounted panels at 400 V DC, an H-bridge, an LC filter, a phase-locked loop, and
              the legal duty to disappear if the grid goes dark.
            </>
          }
          specs={[
        ...
        >
            ...
            <Term
              def={
                <>
                  ...
                  — a control loop that perturbs the DC input voltage of a PV array and measures the
                  change in power, climbing the I–V curve to the point of maximum extracted power.
                  Re-runs continuously because the optimum drifts with temperature and illumination.
                </>
              }
            >
              MPPT
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            seconds and stop injecting current — otherwise rooftop solar would silently energise the
            dead line and electrocute line workers. Detection uses passive over/under frequency and
            voltage windows, plus active "Sandia" frequency-shift probes that deliberately
            destabilise the local frequency if the grid is not strong enough to pull it back
            <Cite id="mohan-undeland-robbins-2003" in={SOURCES} />.
          </p>
        </CaseStudy>
      ...
      <FAQ intro="The questions a careful reader asks after looking at the back of any power supply.">
        <FAQItem q="Why does my laptop charger get warm even when nothing's plugged in?">
          <p>
            ...
            from the grid through the input bridge, and that current has to come through some small
            standing losses in the bridge and the PFC stage. Second, the switching controller IC is
            running its housekeeping loop even when no output current is drawn, which costs a few
            hundred milliwatts. Modern Energy Star supplies trim this "no-load" power below 0.1 W by
            entering a burst-mode where the switcher only fires once every few milliseconds
            <Cite id="erickson-maksimovic-2020" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why use a bridge of four diodes instead of just one?">
          <p>
            One diode (half-wave rectifier) throws away the negative half of every cycle. The output
            averages only V<sub>p</sub>/π ≈ 0.318 V<sub>p</sub>, the ripple frequency is the same as
            the line (60 Hz, harder to filter), and the transformer secondary carries DC bias which
            can saturate its core. A bridge uses both halves, doubles the DC output to 2V
            <sub>p</sub>/π ≈ 0.636 V<sub>p</sub>, doubles the ripple frequency to 120 Hz (easier to
            filter), and presents a balanced load to the transformer
            <Cite id="mohan-undeland-robbins-2003" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="How is my modern switching brick so much smaller than the wall-warts I had in the 1990s?">
          <p>
            ...
            volts AC, then a bridge rectifier and a linear regulator. Transformer core volume scales
            roughly as 1/f for a given power handling. Switching at 100 kHz instead of 60 Hz shrinks
            the magnetic core by more than three orders of magnitude, and the rest of the supply —
            input bridge, output rectifier, control IC — is comparatively tiny
            <Cite id="erickson-maksimovic-2020" in={SOURCES} />. Same job, a thousandth of the iron.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why does my UPS sometimes produce a 'modified sine wave' instead of a real sine?">
          <p>
            ...
            0, −V<sub>DC</sub>) in a stepped quasi-square waveform, sized to match the RMS of a real
            sine but with hideous harmonic content. It's cheaper because no filter and no
            ...
            refuse to recognise it as AC at all
            <Cite id="mohan-undeland-robbins-2003" in={SOURCES} />. "Pure sine wave" UPSes use full
            sinusoidal PWM and cost two-to-three times more.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why does my solar inverter have to disconnect during a grid outage?">
          <p>
            ...
            outage downstream would assume the line is dead, touch it, and be electrocuted. IEEE
            1547 requires every grid-tie inverter to detect the absence of the utility within ~2
            seconds and stop injecting current. The detection mixes passive (voltage/frequency
            window) and active (small frequency-shift probes) methods because a balanced local
            island can hide passive faults for surprisingly long
            <Cite id="mohan-undeland-robbins-2003" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="How does a grid-tie inverter sync to the grid before it closes the contactor?">
          <p>
            ...
            contactor closes, the firmware checks that the grid voltage and the inverter's internal
            reference are within tight bounds on frequency (~0.5 Hz), phase (~10°), and magnitude
            (~5 %)
        ...
        <FAQItem q="What's the difference between a rectifier and a diode?">
          <p>
            ...
            conducts in one direction. A rectifier is a circuit that uses one or more diodes to turn
            AC into pulsating DC. Every rectifier contains diodes; not every diode is in a rectifier
            (signal diodes do logic, Zeners regulate, photodiodes detect light, LEDs radiate). The
            language is loose: a "diode rectifier" usually means the whole assembly, while
            "rectifier diode" usually means a single high-current part
            <Cite id="horowitz-hill-2015" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why are Schottky diodes used as the output rectifier in switching supplies?">
          <p>
            ...
            switching, that tail would otherwise be a substantial chunk of every cycle
            <Cite id="horowitz-hill-2015" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why does my LED bulb sometimes flicker on a dimmer?">
          <p>
            ...
            <strong className="text-text font-medium">phase-controlled triacs</strong> (the AC
            version of an SCR): they conduct only during a programmed fraction of each half-cycle.
            An incandescent bulb's filament is slow enough to average the chopped waveform into
            smooth light. An LED bulb has a switching power supply inside; if the dimmer's chopping
            confuses the supply's controller — or chops so late in the cycle that the supply's
            hold-up cap can't keep up — you get flicker or buzz
            <Cite id="horowitz-hill-2015" in={SOURCES} />. "Dimmable" LED bulbs include extra
            firmware to deal with this.
          </p>
        </FAQItem>

        <FAQItem q="Can I run my desk fan from a car battery?">
          <p>
            Only with an inverter. A 12 V car battery is DC; a desk fan with an AC motor (most cheap
            ones) expects 120 V or 230 V rms AC at line frequency. A small inverter — an H-bridge of
            MOSFETs with sinusoidal PWM and a small LC filter — takes 12 V DC in and produces ~120 V
            AC out at typically 80–90 % efficiency
            <Cite id="mohan-undeland-robbins-2003" in={SOURCES} />. A DC brushless desk fan, by
            contrast, accepts 12 V DC directly because its commutation electronics already chop the
            DC into rotating-stator drive currents — no inverter needed.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What does 'soft-switching' mean and why does it matter?">
          <p>
            ...
            <em className="text-text italic"> zero voltage</em> (ZVS) or off at{' '}
            <em className="text-text italic">zero current</em> (ZCS), driving the overlap loss
            toward zero and letting the converter run faster without melting. Resonant LLC
            converters and phase-shift full-bridges are the canonical examples; they are why USB-PD
            bricks above ~65 W can hit 95% efficiency at 100+ kHz without fans
            <Cite id="erickson-maksimovic-2020" in={SOURCES} />.
          </p>
        </FAQItem>
      </FAQ>
