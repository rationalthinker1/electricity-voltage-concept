  ...
  return (
    <ChapterShell chapter={chapter}>
      <p className="chapter-intro">
        In the spring of 1800, a Pavia physics professor named Alessandro Volta packed a wooden
        crate, paid a courier, and shipped to Sir Joseph Banks at the Royal Society in London a
        description of an apparatus he had built on his lab bench. A short stack of discs: zinc,
        brine-soaked cardboard, copper, repeat, repeat, repeat. Touch the two ends with damp fingers
        and you got a tingling, sustained shock that lasted as long as you stayed in contact. Touch
        them with a pair of wires connected to a water bath and the water began to fizz with bubbles
      ...
      <p className="mb-prose-3">
        ...
        metals, and discovering chemical effects nobody had ever seen. The entire science of
        electrochemistry came out of that wooden crate. This chapter is about why the pile worked,
        what's actually going on inside any modern cell, and the small set of formulas — half-cell
        potentials, the Nernst equation, internal resistance — that predict how many volts a battery
        will sit at and how that voltage sags under load.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        ) on top of it, lay a disc of copper on top of that, and repeat the sequence twenty or
      ...
      <p className="mb-prose-3">
        ...
        voltage on the terminals as fast as a circuit drained it. Volta interpreted this as a
        "contact" property of dissimilar metals, and got the chemistry wrong on the details. But the
        device worked, and within a year of his letter to Banks, William Nicholson and Anthony
        Carlisle in London had used a pile to{' '}
        <Term def="The splitting of water (or any ionic compound) into its elements by passing a current through it. Demonstrated by Nicholson and Carlisle in 1800 using Volta's pile — the first chemical effect of sustained current ever observed.">
          electrolyse
        </Term>{' '}
        water — the first time anyone had used electricity to do chemistry on purpose
      ...
      <TryIt
        ...
        answer={
          <>
            <Formula>
              V<sub>total</sub> = N · V<sub>pair</sub> = 30 · 1.10 V ≈{' '}
              <strong className="text-text font-medium">33 V</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              Enough to give you a memorable shock; enough to electrolyse water; enough that
              contemporary experimentalists kept blowing themselves backwards across the lab when
              they touched the terminals with damp hands
              <Cite id="volta-1800-pile" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        the metal (driving it negative) or pulls them off it (driving it positive). When the
        reaction at one electrode is paired with a different reaction at the other, the two
      ...
      <Formula>
        2H⁺ + 2e⁻ → H₂ (at the copper surface;{' '}
        <Term def="The electrode where reduction happens — electrons are consumed. In a galvanic cell, this is the positive terminal. In an electrolytic cell, this is the negative terminal.">
          cathode
        </Term>
        )
      </Formula>
      <p className="mb-prose-3">
        ...
        gas. Net result: the wire passes current, the zinc shrinks, and hydrogen fizzes off the
        copper. The current can keep going as long as there is zinc left to dissolve and H⁺ in the
      ...
      <p className="mb-prose-3">
        ...
        The crucial point now: a battery is two reactions, not one — and they have to be reactions
        that <em className="text-text italic">want</em> to swap electrons with each other through an
        external wire
      ...
      <p className="mb-prose-3">
        ...
        . The voltage drooped under load and the cell ran down within hours. Three decades later, in
        1836, the British meteorologist John Frederic Daniell solved both problems by separating the
      ...
      <p className="mb-prose-3">
        ...
        every battery that came after. Lead-acid (next chapter) shares an electrolyte but separates
        the anode and cathode plates spatially; alkaline cells use a paste rather than a liquid;
        Li-ion (also next chapter) uses an organic liquid plus a permeable polymer membrane. They
        are all Daniell's cell with the chemistry swapped.
      </p>
      ...
      <TryIt
        ...
        answer={
          <>
            <Formula>
              I<sub>sc</sub> = V<sub>OC</sub> / R<sub>int</sub> = 1.10 V / 1 Ω ={' '}
              <strong className="text-text font-medium">1.10 A</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
      ...
      <p className="mb-prose-3">
        ...
        E°, expressed in volts relative to a universal reference called the{' '}
        <Term def="The reference electrode against which all other half-cell potentials are measured. Defined as 2H⁺ + 2e⁻ → H₂ with H⁺ at unit activity and H₂ at 1 atm, T = 298 K. Assigned E° = 0.00 V by convention.">
          standard hydrogen electrode (SHE)
        </Term>
        , which is itself assigned E° = 0.00 V<Cite id="bard-faulkner-2001" in={SOURCES} />.
      ...
      <TryIt
        ...
        answer={
          <>
            <Formula>
              E°<sub>cell</sub> = E°<sub>cathode</sub> − E°<sub>anode</sub> = +0.80 − (−0.76) ={' '}
              <strong className="text-text font-medium">+1.56 V</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              Silver-zinc cells were used in early hearing aids, watches, and some military
              applications because of their high voltage per cell and excellent energy density. They
              are still made for specialized photo and instrument batteries despite the cost of
              silver
              <Cite id="bard-faulkner-2001" in={SOURCES} />.
            </p>
          </>
      ...
      <p className="mb-prose-3">
        ...
        (Zn²⁺ builds up around the anode, Cu²⁺ depletes around the cathode), and the cell can be at
        any temperature from below freezing to above boiling. The Nernst equation gives the
        open-circuit voltage as a function of those conditions
      ...
      <p className="mb-prose-3">
        ...
        concentration ratio. So pump the Zn²⁺ side ten times more concentrated than the Cu²⁺ side
        and the cell loses about 30 mV; reverse it and you gain 30 mV. Small but real, and crucial
        for high-precision applications like pH probes and chemistry-lab reference electrodes
        <Cite id="bard-faulkner-2001" in={SOURCES} />.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        directly into a pH reading. It tells you why batteries that have been sitting on the shelf
        for years still give close to nameplate voltage at light loads.
      </p>
      ...
      <TryIt
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              Q = 0.01 / 1 = 0.01, so ln Q = −4.605. RT/nF at 298 K with n = 2 is (8.314 · 298) / (2
              · 96485) ≈ <strong className="text-text font-medium">0.01285 V</strong>.
            </p>
            <Formula>
              V = 1.10 − (0.01285)(−4.605) ≈ 1.10 + 0.059 ≈{' '}
              <strong className="text-text font-medium">1.16 V</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              Diluting the Zn²⁺ side adds about 60 mV — the cell hasn't done any work, the ion ratio
              has just been shifted in its favour
              <Cite id="nernst-1889" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        at work: the cell behaves like an ideal source V_OC in series with a resistor R_int, and the
        loaded terminal voltage is
      </p>
      <Formula>
      ...
      <p className="mb-prose-3">
        ...
        needed to drive the electrode reactions at a useful rate (Butler–Volmer kinetics), and the
      ...
      <p className="mb-prose-3">
        ...
        falls, which means V_OC itself drifts down — Nernst predicts this: products build up,
        reactants deplete, Q rises, V drops. And the internal resistance climbs as electrolyte gets
        depleted of carriers near the electrodes and as discharge products accumulate on the plates
        (PbSO₄ on a lead-acid plate, for example, partially insulates the metal underneath). Both
        effects compound: the loaded terminal voltage falls faster than V_OC alone would predict.
        That's the classic{' '}
        <Term def="The plot of terminal voltage vs charge drawn (or vs time at constant current). For most cells: a flat plateau at the working voltage, then a sharp 'knee' at end of life where the chemistry collapses.">
          discharge curve
        </Term>{' '}
      ...
      <TryIt
        ...
        answer={
          <>
            <Formula>
              V<sub>term</sub> = 1.5 · 1 / (0.2 + 1) = 1.5 · 0.833 ≈{' '}
              <strong className="text-text font-medium">1.25 V</strong>
            </Formula>
            <Formula>
              I = V<sub>OC</sub> / (R<sub>int</sub> + R<sub>L</sub>) = 1.5 / 1.2 ≈{' '}
              <strong className="text-text font-medium">1.25 A</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              The 250 mV droop is the IR drop across the internal resistance; it dissipates inside
              the cell as heat — which is why a heavily loaded alkaline cell gets warm to the touch.
              Push the current too hard and the cell wastes more of its energy as internal heating
              than it delivers to the load
              <Cite id="bard-faulkner-2001" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        voltage to within tens of millivolts before you build the cell. The Nernst equation corrects
        for non-standard concentrations and temperatures. Internal resistance (electrolyte
        conductivity + electrode kinetics + contact) drops the terminal voltage under load and
      ...
      <CaseStudies intro="Four places where the half-reaction picture, the Nernst equation, and internal resistance show up in real-world batteries.">
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            A 9 V transistor battery is just six alkaline cells stacked in series inside a steel
            can. Each cell is a zinc-powder anode and a manganese-dioxide cathode separated by a
            paper saturated with potassium hydroxide. The half-reactions:
          </p>
          <Formula>Zn + 2OH⁻ → Zn(OH)₂ + 2e⁻ (anode)</Formula>
          <Formula>2MnO₂ + 2H₂O + 2e⁻ → 2MnOOH + 2OH⁻ (cathode)</Formula>
          <p className="mb-prose-2 last:mb-0">
            Open-circuit voltage per cell is 1.5–1.65 V; six in series give the nominal 9 V the
            radio expects. The stack-in-series trick is the same as Volta's pile: an N-cell battery
            is N times the voltage of one cell.
          </p>
          <p className="mb-prose-2 last:mb-0">
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            A single AA cell is the modern descendant of the Daniell cell, with the chemistry
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            open-circuit; a "dead" cell still reads 1.0–1.2 V because the reactants aren't quite
            gone, they're just at unfavourable concentrations. Battery testers don't measure
            capacity — they measure terminal voltage under a calibrated load, which probes both V_OC
            and R_int. As the cell ages, R_int climbs (zinc gets passivated by reaction products),
            so a heavily-loaded reading sags more than a lightly-loaded one. That's why "fresh" vs
            "weak" is a richer distinction than just "voltage"
            <Cite id="bard-faulkner-2001" in={SOURCES} />.
          </p>
        </CaseStudy>
        ...
        >
          ...
          <p className="mb-prose-2 last:mb-0">
            What distinguishes a starter battery is not its voltage or its capacity — both modest by
            modern standards — but its absurdly low internal resistance. Cranking a cold engine
            demands several hundred amps for one or two seconds. At I = 400 A and R_int = 5 mΩ, the
            IR drop inside the battery is <strong className="text-text font-medium">2 V</strong>, so
        ...
        <CaseStudy
          ...
          specs={[
            { label: 'Half-reaction', value: <>AgCl + e⁻ → Ag + Cl⁻</> },
            {
              ...
              value: (
                <>
                  +0.222 V at 25 °C (1 M Cl⁻) <Cite id="bard-faulkner-2001" in={SOURCES} />
                </>
              ),
            },
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            The standard hydrogen electrode is universally agreed to be 0.00 V — but it is a pain to
            actually build (you need a constantly bubbling stream of pure hydrogen over a
            platinum-black-coated electrode in 1 M H⁺). For day-to-day work, every analytical
            chemist uses a more convenient secondary reference: most commonly an Ag/AgCl electrode,
            which is a silver wire coated in silver chloride, immersed in a saturated KCl solution.
            The cell potential is set by the well-characterized AgCl/Ag couple plus the (known,
            saturated) chloride activity, giving a stable{' '}
            <strong className="text-text font-medium">+0.197 V</strong> vs SHE that holds for years
            if the electrode is kept moist
            <Cite id="bard-faulkner-2001" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
            To measure an unknown's half-cell potential, you build a cell with the unknown on one
            side and the Ag/AgCl reference on the other, read the voltage on a high-impedance
            voltmeter, and add or subtract +0.197 V to convert to the SHE scale. The Nernst equation
            then converts that voltage into an ion concentration: every pH meter, every
            ion-selective electrode, every electrochemical sensor in a wastewater plant works
            exactly this way. The half-reaction picture isn't just textbook material — it is the
            operational principle of an entire industry of analytical instruments.
          </p>
        </CaseStudy>
      </CaseStudies>
      ...
      <FAQ intro="Loose threads from the chapter — the questions a careful reader tends to surface.">
        <FAQItem q="Why does the electrolyte conduct ions but not electrons?">
          <p>
            Because the charge carriers in solution are <em className="text-text italic">ions</em> —
            atoms or molecules that have gained or lost one or more electrons and are surrounded by
            hydration shells. They move in response to electric fields but slowly: a few mm/s under
            a volt-per-cm field. There are essentially no free electrons in a salt solution at room
            temperature; the energy needed to liberate one is too high. So the electrolyte happily
            passes current via ion drift while completely blocking the electron flow that would
            short-circuit the cell internally
            <Cite id="bard-faulkner-2001" in={SOURCES} />. The two electrodes are the only places
            where charge crosses between the electron-conducting world (metal wires) and the
            ion-conducting world (the electrolyte) — that's why all the chemistry happens there.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why does a battery's voltage stay roughly constant during discharge, instead of falling linearly like a capacitor?">
          <p>
            Because a capacitor's voltage is V = Q/C — directly proportional to how much charge is
            left on the plates — while a battery's voltage is set by the thermodynamics of the
            half-reactions, which barely change as long as both reactants are still present in
            macroscopic amounts. The Nernst equation gives the concentration dependence, and ln Q is
            a very slow function: even a 10× depletion of reactant only shifts V by ~30 mV
            <Cite id="nernst-1889" in={SOURCES} />. So most of a battery's discharge curve is a
            nearly flat plateau, with a sharp knee at the end when one of the reactants finally runs
            out.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What is a 'primary' battery vs a 'secondary' battery?">
          <p>
            A primary battery is single-use: once the chemistry runs forward, you can't run it back.
            Alkaline AA cells, lithium coin cells, the 9 V transistor radio battery — all primary. A
            secondary battery is rechargeable — applying a reverse voltage drives the discharge
            reaction backwards, restoring the reactants. Lead-acid, NiMH, and Li-ion are all
            secondary. The chemistry has to be reversible — both half-reactions must run cleanly in
            both directions without producing unwanted side products that block the electrodes
            <Cite id="bard-faulkner-2001" in={SOURCES} />. That reversibility constraint rules out
            most chemistries that would otherwise give very high cell voltages.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why is the Daniell cell historically important?">
          <p>
            Three reasons. (1) It was the first battery with a stable, predictable voltage — Daniell
            separated the two half-reactions and stopped the hydrogen polarization that plagued
            Volta's pile. (2) It made long-distance telegraphy practical; for decades, every
            telegraph office in Britain ran on Daniell cells
            <Cite id="daniell-1836" in={SOURCES} />. (3) It is the conceptual template for every
            battery since — two separated half-reactions connected through an ion-permeable barrier
            and an external wire. The Daniell cell is the textbook battery; everything else, from
            lead-acid to Li-ion to fuel cells, is the Daniell cell with different materials.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What does the Faraday constant mean physically?">
          <p>
            ...
            from its chemistry, F is what bridges the two pictures.
          </p>
        </FAQItem>

        <FAQItem q="Why does cold weather make car batteries weak?">
          <p>
            Two reasons. (1) The chemistry slows down: ion mobility in the sulphuric-acid
            electrolyte drops sharply with temperature, and the electrode kinetics (overpotentials)
            get worse, both of which raise R_int. A starter battery's R_int at −20 °C can be 2–3×
            its room-temperature value. (2) The available capacity also drops, because the rate of
        ...
        <FAQItem q="Why is energy density so much smaller for batteries than for fuels like gasoline?">
          <p>
            Because a battery has to carry both the reactants{' '}
            <em className="text-text italic">and</em> the products of its reaction, while a fuel
            (gasoline, propane) gets one reactant — oxygen — for free out of the atmosphere. Worse,
            the cell needs inactive supporting material: current collectors, separators,
            electrolyte, case, terminals. Even the best Li-ion cells store ~250 Wh/kg; gasoline
            holds ~12 000 Wh/kg of chemical energy, of which ~3000 Wh/kg comes out as useful work
        ...
        <FAQItem q="What is electrode polarization and why is it a problem?">
          <p>
            Polarization is the build-up of reaction products (or bubbles, or depleted reactant
            zones) at an electrode surface that raises its effective overpotential and the cell's
            internal resistance. Volta's original pile polarized severely because hydrogen bubbles
            accumulated on the copper cathode and partly insulated it from the electrolyte — every
            dozen seconds you had to mechanically wipe the bubbles off to restore the voltage
            <Cite id="bard-faulkner-2001" in={SOURCES} />. Daniell's cell defeated polarization by
            using a separate copper-sulphate compartment so the cathode reaction deposited copper (a
            metal that doesn't insulate) rather than producing gas. Modern cells use porous
            electrodes, electrolyte additives, and stirring (or convection) to avoid polarization
            build-up.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What sets the maximum theoretical voltage of a chemical cell?">
          <p>
            The most negative half-cell potential (lithium metal, at −3.04 V vs SHE) paired with the
            most positive (fluorine gas, at +2.87 V vs SHE) gives a thermodynamic{' '}
            <strong className="text-text font-medium">5.91 V</strong> per cell. Nobody builds Li/F₂
            batteries because fluorine reacts with literally every solvent and container material
            you might pick. The practical ceiling is set by what materials can coexist long enough
        ...
        <FAQItem q="Why does a battery have a positive and negative terminal even before you hook anything up?">
          <p>
            Because the two half-reactions inside the cell, given the choice, run spontaneously in
            one direction — metal A wants to give up electrons to the wire, metal B wants to absorb
            them. The terminals sit at whatever potential difference makes that exchange
            thermodynamically null at the open-circuit condition. The difference is V_OC, with the
            (+) terminal more positive because its electrode is the one that wants electrons
            <Cite id="bard-faulkner-2001" in={SOURCES} />. Open the circuit and no current flows,
            but the potential difference remains because the chemistry is still &quot;trying&quot;
            to react and the equilibrium it settles into pins the voltage.
          </p>
        </FAQItem>

        <FAQItem q="Why do batteries explode if you charge them backward?">
          <p>
            Because the reverse reaction isn't the same as the forward reaction. In a primary cell
            (alkaline, zinc-carbon, most lithium primaries) the chemistry was never designed to run
            backward; forcing it produces gas (hydrogen, oxygen, or worse), heat, and unstable
            intermediates. Pressure builds inside the can, the can ruptures, the electrolyte sprays.
            In a properly designed secondary cell (lead-acid, Li-ion) the chemistry is reversible so
            charging works — but charging too fast, or beyond the safe voltage, similarly produces
            gas or unstable intermediates and the same failure mode
            <Cite id="bard-faulkner-2001" in={SOURCES} />. Modern Li-ion packs have integrated
            protection circuits specifically because the failure modes are so energetic.
          </p>
        </FAQItem>

        <FAQItem q="How does a fuel cell differ from a battery?">
          <p>
            A fuel cell is a battery whose reactants are stored externally and supplied
            continuously, instead of being sealed inside the cell from the factory. A
            hydrogen-oxygen PEM fuel cell consumes H₂ from a tank and O₂ from the air, and produces
            water; it has the same two-half-reaction architecture as a battery, but its capacity is
            set by the size of the fuel tank rather than the size of the electrodes. We'll dig into
            the physics next chapter; for now, the point is just that &quot;battery&quot; and
            &quot;fuel cell&quot; are two specializations of the same Daniell-cell idea, differing
            in whether the reactants live inside the cell or are fed in from outside
            <Cite id="bard-faulkner-2001" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why do batteries self-discharge even when nothing is connected?">
          <p>
            Because no electrolyte is perfectly insulating to electrons, no electrode reaction is
            perfectly clean, and no separator is perfectly impermeable. Slow side reactions consume
            reactants over time: dissolved metals migrate across the separator and short-circuit
            themselves internally, electrolyte additives slowly oxidize the anode, parasitic
            reactions at the cathode use up small amounts of capacity, and gas evolution
