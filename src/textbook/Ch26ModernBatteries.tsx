  ...
  return (
    <ChapterShell chapter={chapter}>
      <p className="chapter-intro">
        Open the hood of a gasoline car built any time in the last hundred and sixty years and you
        find the same chemistry: lead plates in dilute sulphuric acid, six cells stacked to twelve
        volts, a thick cable to the starter motor. Open the back of the phone in your pocket and you
        find an entirely different chemistry: lithium ions shuttling between graphite and a
        lithium-cobalt-oxide host lattice through a flammable organic solvent. Open the fuel-cell
      ...
      <p className="mb-prose-3">
        ...
        source. His apparatus was a strip of lead foil rolled into a spiral with a strip of cloth as
        separator, immersed in dilute sulphuric acid
        <Cite id="plante-1859" in={SOURCES} />. Run current through it one way and a layer of lead
        oxide grew on one plate; run it the other way and the layer was consumed back into the
        electrolyte while a fresh layer grew on the opposite plate. The cell could be repeatedly
        cycled — what we now call a{' '}
        <Term def="A battery whose chemistry is reversible, so applying an external voltage drives the discharge reaction backwards and restores the original reactants. Lead-acid (Planté 1859) was the first; NiMH, Li-ion, and most modern chemistries follow.">
          secondary
        </Term>{' '}
        (rechargeable) cell.
      </p>
      <p className="mb-prose-3">
        ...
        arc-lamp street-lighting circuits and the early electric cars; by the 1920s, every gasoline
        car coming off Ford's assembly line carried one to spin its electric starter motor. Fifteen
        decades later, lead-acid is <em className="text-text italic">still</em> the chemistry under
        the hood of every internal-combustion car on Earth — about a billion vehicles, hundreds of
        millions of cells produced per year. It is not the most energy-dense or the longest-cycle
        chemistry; it is the cheapest and most rugged for the specific job of cranking an engine and
        buffering an alternator
      ...
      <p className="mb-prose-3">
        ...
        product. The anode is metallic lead (oxidation state 0), the cathode is lead dioxide PbO₂
        (oxidation state +4), and the electrolyte is dilute H₂SO₄. On discharge, both plates pick up
        sulphate ions to form lead sulphate PbSO₄ (oxidation state +2)
        <Cite id="bard-faulkner-2001" in={SOURCES} />:
      </p>
      ...
      <p className="mb-prose-3">
        ...
        the hydrometer trick is obsolete, but the underlying chemistry is unchanged
      ...
      <p className="mb-prose-3">
        ...
        aqueous chemistry (above this, water starts to electrolyse). Six cells in series make a
        nominal 12.6 V car battery
      ...
      <TryIt
        ...
        answer={
          <>
            <Formula>
              E = V · Q = 12 V · 60 Ah = 720 Wh ={' '}
              <strong className="text-text font-medium">0.72 kWh</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              About the energy content of{' '}
              <strong className="text-text font-medium">60 g of gasoline</strong> — but that
              gasoline is in a tank you drain once and refill, while the battery is good for ~500
              cycles of cranking the engine. The lead-acid is built for the brief, high-current job,
              not for energy storage at scale
              <Cite id="bard-faulkner-2001" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        <Cite id="goodenough-1980-licoo2" in={SOURCES} />. With LiCoO₂ paired against a
        lithium-metal anode, cell voltage jumped to ~4.0 V and energy density to about{' '}
        <strong className="text-text font-medium">eight times</strong> Whittingham's TiS₂ design.
      ...
      <p className="mb-prose-3">
        ...
        <Term def="A graphite or graphite-like carbon host that can reversibly accept Li⁺ ions between its layers. Replacing the dendrite-prone metallic-lithium anode with a carbon intercalation anode (Yoshino 1985) was the breakthrough that made Li-ion safe enough to commercialise.">
          carbon intercalation anode
        </Term>{' '}
        — initially petroleum coke, later graphite — that could absorb Li⁺ ions into the spaces
        between its layered planes without ever forming free lithium metal
        <Cite id="yoshino-1985" in={SOURCES} />. The dendrite problem evaporated. Sony
        commercialized the design in 1991 as the first lithium-ion cell; within a decade it
        dominated portable electronics; within three decades it had driven the cost from ~$1100/kWh
        to ~$140/kWh and made the electric vehicle commercially viable. Whittingham, Goodenough, and
      ...
      <Formula>
        LiC<sub>6</sub> ⇌ Li<sub>1−x</sub>C<sub>6</sub> + xLi⁺ + xe⁻ (anode, graphite host)
      </Formula>
      <Formula>
        Li<sub>1−x</sub>CoO<sub>2</sub> + xLi⁺ + xe⁻ ⇌ LiCoO<sub>2</sub> (cathode, layered oxide
        host)
      </Formula>

      <Pullout>
        Lithium-ion isn't a chemistry. It's a delivery mechanism — a single mobile ion that slides
        between two unchanging hosts.
      </Pullout>
      ...
      <TryIt
        ...
        answer={
          <>
            <Formula>
              ρ<sub>E</sub> = 12 Wh / 0.047 kg ≈{' '}
              <strong className="text-text font-medium">255 Wh/kg</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
      ...
      <ul>
        ...
        <li>
          <strong className="text-text font-medium">NMC</strong> (Li(Ni,Mn,Co)O<sub>2</sub>, ~3.7 V)
          — substitute nickel and manganese for some of the cobalt; higher energy density than LCO
          at lower cost. The current EV workhorse, from Chevy Bolt to most Volkswagen ID models.
        </li>
        <li>
          <strong className="text-text font-medium">NCA</strong> (LiNi<sub>0.8</sub>Co
          <sub>0.15</sub>Al<sub>0.05</sub>O<sub>2</sub>, ~3.6 V) — high nickel, trace aluminium for
          structural stability. Tesla's chemistry of choice in many models. Slightly higher energy
          density than NMC, slightly less robust.
        </li>
        <li>
          <strong className="text-text font-medium">LMO</strong> (LiMn<sub>2</sub>O<sub>4</sub>,
          ~3.7 V) — spinel manganese oxide, cheap, but shorter cycle life and prone to manganese
          dissolution. Used in cost-sensitive applications and as a blending component.
        </li>
      </ul>
      ...
      <p className="mb-prose-3">
        ...
        gram, the thermal stability, and the cycle life. The choice between them is the central
        battery-engineering decision in modern EVs and grid storage: LFP is the safer,
        longer-living, lower-energy option; NMC and NCA are the higher-energy, shorter-living
        options. Vehicle range vs. cycle life vs. cost vs. supply-chain risk — there is no universal
        winner
        <Cite id="bard-faulkner-2001" in={SOURCES} />.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        (specific surface area ~1000 m²/g, courtesy of activated charcoal) in an electrolyte, with a
        separator membrane. Apply a voltage and the ions in the electrolyte crowd up against each
        charged carbon surface, forming a{' '}
        <Term def="The Helmholtz double layer at a metal-electrolyte interface — a sheet of charge in the metal balanced by an opposite sheet of crowded ions in the electrolyte, separated by just a few angstroms. The basis of supercapacitor energy storage.">
          Helmholtz double layer
        </Term>{' '}
        just a few angstroms thick. The energy is stored in the electric field across that double
        layer
        <Cite id="bard-faulkner-2001" in={SOURCES} />, exactly like a regular capacitor — only the
      ...
      <p className="mb-prose-3">
        ...
        below Li-ion (~5–10 Wh/kg vs ~250 Wh/kg) because the double layer, however clever, just
      ...
      <TryIt
        ...
        answer={
          <>
            <Formula>
              U = ½ C V² = ½ (3000)(2.7)² ={' '}
              <strong className="text-text font-medium">10 935 J ≈ 3.0 Wh</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              The supercap cell is much larger and heavier (~500 g vs 47 g) but holds about{' '}
              <strong className="text-text font-medium">25%</strong> the energy of a single 18650 —
              so its volumetric and gravimetric energy densities are roughly 10× worse than Li-ion.
              The trade-off is in the time domain: it can deliver that 3 Wh in a second or two,
              whereas the Li-ion needs at minimum a few minutes of fast-charge to recover
              <Cite id="bard-faulkner-2001" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        <em className="text-text italic">overpotentials</em> at both electrodes, then drop further
        with current draw
      ...
      <p className="mb-prose-3">
        ...
        — has three regimes. At low current, activation overpotentials dominate; you lose ~0.3 V
        getting any reaction at all going. In the middle, ohmic resistance (mainly the membrane's
        proton-conducting resistance plus electrode contact) drops voltage linearly with current. At
        high current, mass transport limits set in: you simply can't get oxygen to the cathode fast
        enough, and the voltage falls off a cliff approaching a limiting current
        <Cite id="larminie-dicks-2003-fuel-cells" in={SOURCES} />. Typical operating points sit at
      ...
      <p className="mb-prose-3">
        ...
        and where there's a captive refuelling location; for cars they're competing with a Li-ion
        industry that has already won the cost curve
        <Cite id="larminie-dicks-2003-fuel-cells" in={SOURCES} />.
      </p>
      ...
      <TryIt
        ...
        answer={
          <>
            <Formula>
              V<sub>stack</sub> = 100 · 0.65 = 65 V
            </Formula>
            <Formula>
              P = V<sub>stack</sub> · I = 65 V · 200 A ={' '}
              <strong className="text-text font-medium">13 kW</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
      ...
      <p className="mb-prose-3">
        ...
        between two host lattices, 3.0–4.2 V per cell, 150–250 Wh/kg, the dominant chemistry of
        modern portable electronics and electric vehicles. Four major Li-ion cathode families (LCO,
        NMC, NCA, LFP) trading energy density, cost, cycle life, and safety against each other.
        Supercapacitors: not a battery, just an enormous double-layer capacitor — fast and durable
        but modest energy density. Fuel cells: same architecture as a battery but with external fuel
        supply, enabling long-range applications where battery mass becomes the limit. All five
      ...
      <CaseStudies intro="Four working systems built on the chemistries above, with the numbers that determine whether they work.">
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            A Tesla Model 3 Long Range pack contains roughly{' '}
            <strong className="text-text font-medium">4400 cylindrical 2170-format cells</strong>
            (21 mm diameter, 70 mm tall) wired in a series-parallel topology that yields ~360 V
            nominal and ~75 kWh stored. Each cell is an NCA or LFP Li-ion (Tesla switched the
            standard-range Model 3 to LFP in 2021 for non-North-American markets), held in a
            structural pack with active liquid cooling and a battery-management system that monitors
            per-string voltage, temperature, and impedance several times per second.
          </p>
          <p className="mb-prose-2 last:mb-0">
            Pack-level energy density of ~165 Wh/kg corresponds to about{' '}
            <strong className="text-text font-medium">455 kg</strong> of pack for 75 kWh — roughly a
            third of the vehicle's curb weight. That mass is what fundamentally limits how far
            &quot;more range&quot; can go on Li-ion: every kilowatt-hour you add adds another few
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            80–90% to avoid the high-voltage degradation regime, and warns against repeated full
            charges. The cycle-life budget of ~1500 cycles to 80% capacity, combined with that daily
            ceiling, is what gives the 8-year / 240 000 km pack warranty. Beyond that the pack still
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            An iPhone runs on a single Li-ion cell — not a pack, just one — in a flat polymer pouch
            shaped to fit the available volume inside the case. The chemistry is an LCO (or NCA-like
            high-Ni variant), the voltage is 3.85 V nominal, the capacity is around 12 Wh. A small
        ...
        >
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            grid-services revenue alone, demonstrating that batteries weren't just an environmental
            hedge but a competitive grid asset. Hundreds of similar installations followed
            worldwide. The Li-ion chemistry here is identical to the one in your phone, just
            multiplied by a factor of about ten million cells.
          </p>
        </CaseStudy>
        ...
        <CaseStudy
          ...
          specs={[
            { label: 'Cells in series', value: <>~370</> },
            {
              ...
              value: (
                <>
                  114 kW <Cite id="larminie-dicks-2003-fuel-cells" in={SOURCES} />
                </>
              ),
            },
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            <strong className="text-text font-medium">~92 kWh</strong> of usable electric energy —
            about
            <em className="text-text italic"> 30% more</em> than the largest Li-ion EV packs, in a
            fuel mass of just 5 kg
            <Cite id="larminie-dicks-2003-fuel-cells" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
            Refuelling takes ~5 minutes (vs. ~30 minutes for a Tesla Supercharger), and range is 650
            km on the WLTP cycle. The remaining problems are infrastructure (a handful of H₂
            stations exist worldwide outside California, Japan, and Germany), and the cost and
            carbon footprint of producing &quot;green&quot; hydrogen at scale — most commercial H₂
            today is steam-reformed from natural gas, which defeats most of the environmental case.
            Fuel-cell passenger cars are a niche; fuel-cell long-haul trucks, where battery mass is
            genuinely prohibitive, are the more likely path to growth.
          </p>
        </CaseStudy>
      </CaseStudies>
      ...
      <FAQ intro="Loose threads from the chapter — the questions a careful reader tends to surface.">
        <FAQItem q="Why does lead-acid persist for car starters when better chemistries exist?">
          <p>
            Cost and ruggedness. A 60 Ah lead-acid car battery costs ~$100 to manufacture at scale;
            an equivalent Li-ion replacement is 3–5× more. Lead-acid tolerates a wide temperature
            range (−30 to +60 °C in service), survives mechanical abuse, recycles cleanly (almost
        ...
        <FAQItem q="Why is lithium so special among the elements for battery anodes?">
          <p>
            Three reasons. (1) Most negative standard reduction potential of any element (Li⁺/Li at
            −3.04 V vs SHE), so pairing lithium with almost any cathode gives a high cell voltage.
            (2) Lowest atomic mass of any solid element (lithium is 6.94 amu); high-voltage cells
            made from light atoms have high energy density per kilogram. (3) Small ionic radius (Li⁺
            is ~76 pm), letting Li⁺ slide between the layers of host lattices like graphite and
            LiCoO₂ without disrupting them — the intercalation trick
            <Cite id="bard-faulkner-2001" in={SOURCES} />. No other element checks all three boxes.
            Sodium (next column down in the periodic table) has been studied extensively but has
            higher mass and bigger ionic radius, so sodium-ion cells trail Li-ion in energy density
            by a factor of ~1.5.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why does an LFP cell last 3000+ cycles when an NMC cell typically lasts 1500?">
          <p>
            The olivine LiFePO<sub>4</sub> structure is mechanically more stable through lithium
            insertion and extraction than layered LiCoO<sub>2</sub> or Li(NiMnCo)O<sub>2</sub>.
            Olivine LFP expands and contracts very little as Li⁺ comes and goes (about 6% volume
            change), so the crystal lattice doesn't accumulate micro-cracks. Layered oxides expand
            more (~7–10%) and develop crack networks over thousands of cycles that gradually
            disconnect active material from the current collector. The trade-off is voltage: LFP's
            phosphate framework gives only 3.2 V vs NMC's 3.7 V, so LFP cells store proportionally
            less energy per kilogram
            <Cite id="bard-faulkner-2001" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why was the lithium-metal anode such a problem, and why has it now come back?">
          <p>
            Lithium metal plated from solution doesn't form a smooth film: it grows as branching
            dendrites that eventually reach the opposite electrode through the separator, shorting
            the cell and igniting the flammable electrolyte. This is why Yoshino's carbon anode was
            such a critical move in 1985 — graphite could store lithium without ever forming free
            metal. But carbon stores only ~370 mAh/g vs lithium's ~3860 mAh/g, leaving a 10×
            theoretical energy-density gap unclaimed. Modern solid-state-electrolyte research aims
            to suppress dendrite formation mechanically (with ceramic electrolytes too rigid for
            dendrites to penetrate), enabling a return to lithium-metal anodes at much higher cell
            energy density
            <Cite id="bard-faulkner-2001" in={SOURCES} />. Several companies (QuantumScape, Solid
            Power) have built laboratory demonstrators; commercial deployment is expected by the
            late 2020s.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What's the difference between a 'Li-ion' battery and a 'Li-polymer' battery?">
          <p>
            Mostly the packaging. Both are intercalation-based lithium-ion chemistries with
            essentially the same electrode materials; the difference is in the electrolyte.
            Conventional Li-ion uses a liquid carbonate electrolyte in a sealed metal can (the
            cylindrical 18650 or 21700 cells, the prismatic blocks). Li-polymer (LiPo) uses a gelled
            or polymer electrolyte in a soft pouch, allowing the cell to be shaped to fit the host
            device. Phones and tablets use LiPo because of the form-factor flexibility; power tools
            and EVs use cylindrical Li-ion because the rigid can handles thermal cycling better
            <Cite id="bard-faulkner-2001" in={SOURCES} />. The chemistry inside is the same family.
          </p>
        </FAQItem>

        <FAQItem q="Why does Li-ion energy density seem to be levelling off?">
          <p>
            Because we're approaching the theoretical limits of intercalation chemistry. The cell
            voltage is set by the Li⁺/host reduction potentials and can't be pushed past ~4.3 V
            without the electrolyte breaking down. The capacity is set by how many Li⁺ ions you can
            stuff between graphite layers and back out without destabilising the cathode — about one
            lithium per six carbons in graphite, sets the practical limit. Together these give a
            ceiling of ~300 Wh/kg at the cell level for layered-oxide chemistries
            <Cite id="bard-faulkner-2001" in={SOURCES} />. Going higher requires moving to
            lithium-metal anodes (solid-state, see above) or to entirely new chemistries (Li-S,
            Li-O₂) where the theoretical limits are higher but the engineering is harder.
          </p>
        </FAQItem>

        <FAQItem q="Why does a fuel cell's open-circuit voltage drop below the thermodynamic 1.23 V?">
          <p>
            Because of mixed potentials and crossover losses. Trace amounts of H₂ migrate across the
            Nafion membrane and react at the cathode without doing external work; trace amounts of
            O₂ migrate the other way and react at the anode. Both shift the equilibrium potentials
            of the electrodes away from their ideal values by tens to hundreds of millivolts. Plus,
            even at zero current, there is an activation overpotential associated with starting any
            electrochemical reaction. Net effect: real PEM fuel cells start at ~0.95–1.0 V
            open-circuit instead of the thermodynamic 1.23 V
            <Cite id="larminie-dicks-2003-fuel-cells" in={SOURCES} />, and drop further with
            current.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why do supercapacitors have such low voltage per cell?">
          <p>
            Because their voltage is limited by the electrochemical stability window of the
            electrolyte. Above about ~2.7 V for aqueous electrolytes (well, 1.2 V for pure water —
            they use carbon-based aqueous compounds), or ~2.7–3.0 V for typical organic
            electrolytes, the solvent starts to break down. The double layer can't help: it isn't
            doing chemistry, but the supporting electrolyte still has to be physically stable at the
            applied voltage. To make a 12 V or 48 V supercapacitor system you stack 5–20 cells in
            series with balancing circuits to keep individual cell voltages from drifting
            <Cite id="bard-faulkner-2001" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why was the 2019 Chemistry Nobel awarded jointly to three people from different decades?">
          <p>
            Because each made one essential, distinct contribution that the next built on.
            Whittingham (Exxon, 1976) invented the intercalation electrode concept and showed it
            worked with TiS₂ and metallic Li. Goodenough (Oxford, 1980) replaced TiS₂ with LiCoO₂,
            jumping to ~4 V and 8× the energy density. Yoshino (Asahi Kasei, 1985) replaced the
            dendrite-prone Li metal anode with a carbon-host intercalation anode, solving the safety
            issue and enabling Sony's 1991 commercial launch. Take any one of those three steps away
            and modern Li-ion doesn't exist
            <Cite id="whittingham-1976" in={SOURCES} />
            <Cite id="goodenough-1980-licoo2" in={SOURCES} />
            <Cite id="yoshino-1985" in={SOURCES} />. Goodenough was 97 at the time of the award, the
            oldest Nobel laureate in any category in history.
          </p>
        </FAQItem>

        <FAQItem q="What is a redox flow battery and where does it fit in the family?">
          <p>
            A redox flow battery stores its reactants in two external tanks of dissolved redox
            species — usually vanadium compounds at different oxidation states — and pumps them
            through a cell with an ion-exchange membrane. The energy capacity is set by how big the
            tanks are; the power is set by how big the cell stack is. The two are independently
            scalable, which is the key feature: you can quadruple the storage capacity of an
        ...
        <FAQItem q="Why is graphene not the anode of every Li-ion cell yet?">
          <p>
            Graphene has been studied extensively as a high-surface-area variant of graphite and
            offers ~2× the theoretical capacity (~744 mAh/g vs 372 mAh/g) for lithium intercalation.
            The problem is irreversible capacity loss: graphene's enormous surface area reacts
            heavily with the electrolyte to form a thick SEI layer on first cycle, consuming a large
            fraction of the lithium budget before the cell is even useful
            <Cite id="bard-faulkner-2001" in={SOURCES} />. Composite anodes that blend graphite with
            silicon nanoparticles (silicon stores Li at ~3580 mAh/g) are the current commercial path
            forward — silicon is already in many modern Li-ion cells at 5–10% blend levels.
          </p>
        </FAQItem>

        <FAQItem q="Why does fast charging degrade a Li-ion battery more than slow charging?">
          <p>
            Because at high charge currents, the lithium plating reaction at the anode competes with
            the lithium intercalation reaction. Intercalation needs the Li⁺ ion to actually move{' '}
            <em className="text-text italic">into</em> a graphite layer, which has a finite kinetic
            timescale; if Li⁺ arrives faster than it can intercalate, some of it instead plates out
            as metallic lithium on the graphite surface — and metallic lithium grows dendrites, as
            in Whittingham's original lithium-metal cell. Repeated fast-charging accumulates lithium
            plating, gradually consuming the cyclable lithium inventory and growing dendrites that
            eventually short the cell
            <Cite id="bard-faulkner-2001" in={SOURCES} />. EV battery-management systems
            specifically taper charge current near full capacity for exactly this reason.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why do older Li-ion phones swell up?">
          <p>
            Because internal side reactions over years of use produce small amounts of gas —
            typically CO₂ and CO from slow electrolyte decomposition at the cathode — and the soft
            pouch packaging gradually balloons. In cylindrical Li-ion cells the gas vents out a
            pressure-relief disc; in pouch cells it just inflates the pouch. A swollen battery is a
            serious safety issue and shouldn't be charged or used; the swelling means the SEI layer
            has degraded, the cell's internal resistance has climbed, and the next failure step is
            often thermal runaway
            <Cite id="bard-faulkner-2001" in={SOURCES} />. Replace it promptly; modern recycling
