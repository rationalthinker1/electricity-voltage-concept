  ...
  return (
    <ChapterShell chapter={chapter}>
      <p className="mb-prose-3 first-letter:font-2 first-letter:font-light first-letter:text-[4em] first-letter:leading-none first-letter:float-left first-letter:m-[4px_12px_-4px_0] first-letter:text-accent">
        ...
        <Term def={<><strong className="text-text font-medium">distribution</strong> — the segment of the power grid between the substation and the customer's meter, typically operating at 4 kV to 35 kV line-to-line. Distinct from "transmission" (kV–hundreds of kV across regions) upstream and "service" (240/120 V) downstream.</>}>distribution</Term>{' '}
        feeders. In a typical 13.8 kV three-phase{' '}
        <Term def={<><strong className="text-text font-medium">wye (Y)</strong> — a three-phase configuration in which the three phase conductors meet at a common centre point (the neutral), which is then grounded. Line-to-neutral voltage is the line-to-line voltage divided by √3. The standard form for North-American distribution feeders.</>}>wye</Term>{' '}
        feeder, each of those wires sits at roughly <strong className="text-text font-medium">7,200 V</strong> with respect to a grounded neutral — the
      ...
      <p className="mb-prose-3">
        ...
        a <strong className="text-text font-medium">240 V split-phase service</strong>: two hot legs and a neutral. They enter your house through a
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">distribution transformer</strong> ("pole-pig") — the final step-down transformer on a power-grid feeder. One primary winding fed by a single medium-voltage phase; one centre-tapped secondary winding that delivers 240 V across the ends and 120 V from either end to the centre tap. Sizes for residential service typically 10–100 kVA.</>}>distribution transformer</Term>,
        ...
        of the feeder — for a 13.8 kV wye feeder, that's <strong className="text-text font-medium">7,200 V</strong> across the primary<Cite id="ansi-c84-1-2020" in={SOURCES} />.
      ...
      <p className="mb-prose-3">
        ...
        so the voltages at the two ends — measured against the centre tap — are <em className="italic text-text">equal in magnitude</em> but
        <em className="italic text-text"> 180° out of phase</em> at every instant. When one end is at +170 V relative to centre, the other is at
        −170 V; the difference between the two ends is therefore <strong className="text-text font-medium">240 V</strong> peak-to-peak in RMS terms,
      ...
      <p className="mb-prose-3">
        ...
        <strong className="text-text font-medium">7,200/120 = 60:1</strong>, and the full-secondary ratio is <strong className="text-text font-medium">7,200/240 = 30:1</strong>. Pick
        the ratio and the physics is fixed; everything else (KVA rating, oil volume, bushing geometry) is
        downstream engineering choice. Common residential-feeder sizes are <strong className="text-text font-medium">10, 15, 25, 37.5, 50, 75, and
      ...
      <p className="mb-prose-3">
        ...
        survived: pull <em className="italic text-text">both</em> voltages out of the same transformer secondary. The two ends of the
      ...
      <TryIt
        ...
        question={
          <>
            A <strong className="text-text font-medium">1,500 W</strong> portable space heater can be wired either at 120 V (plugged into a wall
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">weatherhead</strong> (service head) — the inverted-U fitting at the top of the service entrance conduit. Its downward-facing opening prevents rain from entering the conduit while letting the service-drop conductors enter from the side; the cable enters via "drip loops" that ensure water cannot run along the wire into the meter.</>}>weatherhead</Term>,
      ...
      <p className="mb-prose-3">
        ...
        — typically <strong className="text-text font-medium">#2 AWG aluminium triplex</strong> for a 100 A service, <strong className="text-text font-medium">#1/0</strong> or larger
      ...
      <TryIt
        ...
        question={
          <>
            ...
            <strong className="text-text font-medium"> 0.85 mΩ/m</strong> per conductor. At a load of <strong className="text-text font-medium">100 A</strong> on one of the two
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">form-2S</strong> — the standard ANSI meter form for residential single-phase 240/120 V three-wire service. Four blade contacts (two hots in / two hots out) and a continuous-pass neutral, in a cylindrical housing about 10 cm across. Plugs into a four-jaw meter socket.</>}>form-2S</Term>,
      ...
      <p className="mb-prose-3">
        A metal ring — the{' '}
        <Term def={<><strong className="text-text font-medium">anti-tampering ring</strong> (sealing ring, locking ring) — the steel band that clamps the revenue meter into its socket, typically secured by a wire-and-lead utility seal. Cutting the seal without authorization is a criminal offense (electricity theft); the ring is the visible legal boundary between utility-owned and customer-owned hardware.</>}>anti-tampering ring</Term>{' '}
      ...
      <p className="mb-prose-3">
        ...
        <strong className="text-text font-medium"> V(t)</strong> and <strong className="text-text font-medium">I(t)</strong> are the instantaneous service voltage and the
        instantaneous current crossing the meter (in volts and amperes), and <strong className="text-text font-medium">t</strong> is time (in
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">kilowatt-hour</strong> (kWh) — the unit of energy used on every electric bill in the world. 1 kWh = 1,000 W × 3,600 s = 3.6 × 10⁶ J. A 100 W bulb running for 10 hours uses exactly one kilowatt-hour.</>}>kilowatt-hour</Term>:
        one kWh is 1,000 W delivered for one hour, equal to <strong className="text-text font-medium">3.6 × 10⁶ J</strong>. North-American
      ...
      <TryIt
        ...
        question={
          <>
            A 1,500 W space heater runs <strong className="text-text font-medium">8 hours per day for 30 days</strong>. Compute the total energy
      ...
      <TryIt
        ...
        question={
          <>
            A smart meter reports <strong className="text-text font-medium">14.2 kWh</strong> of real energy and <strong className="text-text font-medium">0.3 kVARh</strong> of
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">neutral</strong> — the grounded current-carrying conductor of a single- or split-phase service. Carries the unbalanced return current between the two hot legs and is at (nominally) zero volts with respect to earth at the service entrance. Distinct from "ground," which is the safety-bond conductor and is not supposed to carry current under normal operation.</>}>neutral</Term>{' '}
        and{' '}
        <Term def={<><strong className="text-text font-medium">ground</strong> (equipment grounding conductor / "earth") — the safety-bond conductor that ties all exposed metal in a building to the earth and to the service-entrance neutral. Under normal operation it carries no current; under a fault it provides a low-impedance return that lets the breaker see a high enough current to trip.</>}>ground</Term>.
      ...
      <p className="mb-prose-3">
        Why bond <em className="italic text-text">only once</em>? Because if neutral and ground are tied together at multiple points downstream
      ...
      <p className="mb-prose-3">
        ...
        intact but the <strong className="text-text font-medium">neutral severed</strong>, the centre tap of the secondary winding loses its
        connection to the house's loads. The two 120 V branches no longer have a common reference point — they
        are now in <em className="italic text-text">series</em> across the full 240 V, with each branch's load acting as one leg of a voltage
      ...
      <p className="mb-prose-3">
        ...
        service), and <strong className="text-text font-medium">Z₁</strong> and <strong className="text-text font-medium">Z₂</strong> are the total load impedances (in ohms) on the
      ...
      <p className="mb-prose-3">
        Modern{' '}
        <Term def={<><strong className="text-text font-medium">open-neutral</strong> condition — a service-side break in the neutral conductor that floats the centre tap of the split-phase secondary. Loads on the two hot legs are then in series across 240 V, dividing the voltage by their relative impedances. Most common cause of single-event whole-house electronics damage on a North-American service.</>}>open-neutral</Term>{' '}
      ...
      <TryIt
        ...
        question={
          <>
            Your half of the house (L1 leg) is currently pulling <strong className="text-text font-medium">4 kW</strong>; your neighbour's half
            (L2 leg, sharing the same pole-pig with their own meter base but not the same neutral here — pretend
            they're on the same service as a thought experiment) is pulling <strong className="text-text font-medium">1 kW</strong>. The shared
      ...
      >
        <CaseStudy
          ...
          summary={<em className="italic text-text">Four houses sharing one pole-pig; 50 m of triplex per drop; a sealed form-2S meter; 200 A behind the main breaker.</em>}
          specs={[
        ...
        <CaseStudy
          ...
          summary={<em className="italic text-text">One step upstream from the pole-pig: the medium-voltage substation that gets the feeders going.</em>}
          specs={[
        ...
        <CaseStudy
          ...
          summary={<em className="italic text-text">One bad connection at the meter base burns out half the electronics in a house.</em>}
          specs={[
      ...
      >
        ...
        <FAQItem q="If there are two hot wires entering my house, what does 'single-phase' even mean?">
          <p>
            "Single-phase" refers to the upstream side of the pole-pig: only <em className="italic text-text">one</em> of the three medium-voltage
        ...
        <FAQItem q="If my service is rated 200 A, can I actually pull 200 A continuously?">
          <p>
            ...
            (§210.20) requires that a circuit's <em className="italic text-text">continuous</em> load not exceed 80 % of the breaker's
