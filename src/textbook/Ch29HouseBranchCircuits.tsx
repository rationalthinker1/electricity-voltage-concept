    ...
    <ChapterShell chapter={chapter}>
      <p className="chapter-intro">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">14 AWG</strong> — American Wire Gauge 14, a
              copper conductor with cross-section ≈ 2.08 mm². The standard residential wire for 15 A
              lighting and general-purpose receptacle circuits.
            </>
          }
        >
          14 AWG
        </Term>{' '}
        copper, three duplex receptacles wired in a daisy-chain, the whole run protected by a 15 A
        breaker in the panel. Twenty-four metres of cable threaded through stud bays, jacketed in
        the white or yellow vinyl sheath the trades call{' '}
        <Term
          def={
            <>
              <strong className="text-text font-medium">NM-B (Romex)</strong> —
              non-metallic-sheathed cable; the standard interior wire for residential framing. Two
              or three insulated conductors plus a bare ground inside a PVC jacket. The
              &ldquo;B&rdquo; designates 90 °C-rated insulation, though NEC sizes it to the 60 °C
              column for residential terminations.
            </>
          }
        >
          NM-B (Romex)
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">Table 310.16</strong> — the NEC table of
              allowable ampacities for insulated conductors in raceway, cable, or earth, indexed by
              gauge and insulation temperature rating. The 60 °C column governs residential branch
              circuits with standard 15/20/30 A devices.
            </>
          }
        >
          Table 310.16
        </Term>{' '}
        does this trade-off empirically for every gauge, insulation type, and ambient condition
        <Cite id="awg-table-nec" in={SOURCES} />. The standard residential rungs of that ladder are
        short:
      </p>
      <ul>
        <li>
          <strong className="text-text font-medium">14 AWG</strong> copper — cross-section{' '}
          <strong className="text-text font-medium">2.08 mm²</strong>, rated{' '}
          <strong className="text-text font-medium">15 A</strong>. The default for lighting circuits
          and general-purpose receptacles in bedrooms, hallways, and living rooms
          <Cite id="awg-table-nec" in={SOURCES} />.
        </li>
        <li>
          <strong className="text-text font-medium">12 AWG</strong> —{' '}
          <strong className="text-text font-medium">3.31 mm²</strong>, rated{' '}
          <strong className="text-text font-medium">20 A</strong>. The required gauge for kitchen
          small-appliance circuits, bathrooms, laundry rooms, and garage receptacles
          <Cite id="nec-2023" in={SOURCES} />.
        </li>
        <li>
          <strong className="text-text font-medium">10 AWG</strong> —{' '}
          <strong className="text-text font-medium">5.26 mm²</strong>, rated{' '}
          <strong className="text-text font-medium">30 A</strong>. Used for electric clothes dryers
          and tankless or smaller storage water heaters
          <Cite id="awg-table-nec" in={SOURCES} />.
        </li>
        <li>
          <strong className="text-text font-medium">8 AWG</strong> —{' '}
          <strong className="text-text font-medium">8.37 mm²</strong>, rated{' '}
          <strong className="text-text font-medium">40 A</strong>. Electric ranges of modest size
          and 40 A level-2 EV chargers
          <Cite id="awg-table-nec" in={SOURCES} />.
        </li>
        <li>
      ...
      <TryIt
        ...
        question={
          <>
            A <strong className="text-text font-medium">12 AWG</strong> copper conductor (A = 3.31
            mm²) is 25 m long and carries <strong className="text-text font-medium">15 A</strong>.
            Compute the round-trip voltage drop. Is it acceptable for a 120 V circuit under the 3 %
            guideline?
          </>
        }
        hint={
        ...
        answer={
          <>
            ...
            <p className="mb-prose-1 last:mb-0">
              That is about <strong className="text-text font-medium">4.0 %</strong> of 120 V — over
              NEC's 3 % branch-circuit recommendation
              <Cite id="nec-2023" in={SOURCES} />. The remedy is to drop the worst-case continuous
              load on this run or upsize to 10 AWG for the long pull. The breaker is still happy at
              15 A on a 20 A breaker, but the receptacle at the far end sees noticeably less than
              120 V.
            </p>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">NM cable</strong> — non-metallic-sheathed
              cable, governed by NEC Article 334. Two or three insulated copper conductors plus a
              bare equipment grounding conductor, wrapped in a PVC outer jacket. White jacket = 14
              AWG, yellow = 12 AWG, orange = 10 AWG by industry convention.
            </>
          }
        >
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">equipment grounding conductor (EGC)</strong>{' '}
              — the bare or green conductor in a cable, bonded to metal enclosures and equipment
              frames. Provides a low-impedance fault path back to the panel so that ground faults
              trip the breaker.
            </>
          }
        >
        ...
        <Term
          def={
            <>
              ...
              cable, NEC Article 340. Conductors are embedded in a solid PVC matrix (not just
              jacketed) so the cable can survive direct burial in earth. Used for outdoor branch
              circuits feeding a shed, a yard light, or a pump.
            </>
          }
        >
          UF-B cable
        </Term>{' '}
        has the same conductor count but with each conductor moulded into a solid PVC matrix rather
        than just jacketed, so the whole cable can be buried directly in earth at the depths Article
        300.5 prescribes
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">THHN</strong> — Thermoplastic High
              Heat-resistant Nylon-coated. A 90 °C-rated single-conductor wire pulled through
              conduit. THWN adds Water-resistance for damp locations. The default conductor type for
        ...
        is Thermoplastic, High Heat-resistant, Nylon-coated; THWN adds Water resistance. The 90 °C
        rating in dry locations and 75 °C in wet conditions sits above what residential NM-B exposes
        you to, and is what's used in conduit runs through garages, basements, or any exposed
        application
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">neutral conductor</strong> — the grounded
              current-carrying conductor that returns load current to the source. Bonded to ground
              only at the service entrance. Always white or grey in branch wiring. Carries current;
              not the same as the ground.
            </>
          }
        >
          neutral
        </Term>{' '}
        is white or grey; equipment grounding is bare copper or green. NM-B's outer jacket colour
        signals gauge: white sheath = 14 AWG, yellow = 12 AWG, orange = 10 AWG. Builders read a
        panel by glancing at the colour of the jackets entering it.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">voltage drop</strong> — the IR voltage
              difference between the panel and the load, caused by the resistance of the wires
              themselves. NEC recommends keeping branch-circuit drop under 3 % and total drop
              (feeder + branch) under 5 %. Informational notes only; not strictly enforced.
            </>
          }
        >
          voltage drop
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">dedicated circuit</strong> — a branch
              circuit serving one and only one piece of equipment, with no other receptacles or
              loads on it. Required by NEC for ranges, dryers, water heaters, EV chargers, and a few
      ...
      <Pullout>
        ...
        what's expensive to replace inside a wall.
      </Pullout>
      ...
      <TryIt
        ...
        question={
          <>
            A bedroom has a single 15 A circuit serving 4 ceiling lights (60 W each), a TV (90 W),
            and a desk computer (300 W). Compute the total continuous load. Does it fit the 80 %
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              Total power: 4·60 + 90 + 300 ={' '}
              <strong className="text-text font-medium">630 W</strong>. Current at 120 V:
            </p>
            ...
            <p className="mb-prose-1 last:mb-0">
              ...
              rule
              <Cite id="nec-2023" in={SOURCES} />. The circuit has roughly 7 A of headroom, which is
              exactly the point — bedrooms get a 15 A circuit because their loads are small and
              intermittent.
            </p>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        A 20 A breaker behind 14 AWG wire is a fire waiting to happen
        <Cite id="nec-2023" in={SOURCES} />. At 18 A continuous, the breaker is happy — it is sized
        for 20 A and the trip curve is flat there. But the wire is rated 15 A and is dissipating
        about 30 % more I²R than its insulation budget allows. The vinyl jacket softens; if the
        cable is bundled with others in a stud bay or run through insulation, the heat does not
        escape and the failure compounds. After hours or days, the insulation chars; eventually the
      ...
      <TryIt
        ...
        question={
          <>
            A homeowner finds <strong className="text-text font-medium">14 AWG NM-B</strong>{' '}
            connected to a <strong className="text-text font-medium">20 A breaker</strong> in their
        ...
        answer={
          <>
            ...
            <p className="mb-prose-1 last:mb-0">
              ...
              on the circuit really do need 20 A — pull new 12 AWG wire and keep the 20 A breaker.{' '}
              <em className="text-text italic">Never</em> the other way around
              <Cite id="nec-2023" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">aluminium</strong> conductors — used widely
              for service-entrance feeders and large sub-feeds because aluminium is roughly 30 %
              cheaper than copper for the same ampacity. The modern AA-8000 series alloy is
              well-behaved when terminated with antioxidant compound and AL-rated lugs. Older
              solid-aluminium branch wiring (1965–1973) is the source of a still-active fire-risk
              advisory.
            </>
          }
        >
      ...
      <p className="mb-prose-3">
        ...
        small-gauge residential stuff, not just the big feeders. By the late 1970s, those circuits
        were burning down houses at a rate the Consumer Product Safety Commission could measure
      ...
      <p className="mb-prose-3">
        ...
        loosened gap, the contact resistance climbed, the I²R at the joint heated it further, and a
      ...
      <p className="mb-prose-3">
        ...
        antioxidant-pasted at termination; the gauge is large enough that the per-joint power
        dissipation is small. The aluminium feeder coming into your house is fine. The aluminium
        branch in an old kitchen is the thing to check.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">small-appliance branch circuit</strong> —
              NEC Article 210.11(C)(1): a 20 A branch circuit dedicated to receptacles in the
              kitchen, dining area, pantry, and breakfast room. A dwelling unit must have at least
              two of these.
            </>
          }
        >
      ...
      <TryIt
        ...
        question={
          <>
            A kitchen has a <strong className="text-text font-medium">1500 W</strong> toaster oven,
            a <strong className="text-text font-medium">1100 W</strong> microwave, and a
            <strong className="text-text font-medium"> 900 W</strong> coffee maker. Can all three
            run simultaneously on a single 20 A small-appliance branch?
          </>
        }
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              Total: 1500 + 1100 + 900 = <strong className="text-text font-medium">3500 W</strong>.
              At 120 V:
            </p>
            <Formula tex="I = \\dfrac{3500}{120} \\approx 29.2\\ \\text{A}" />
            <p className="mb-prose-1 last:mb-0">
              That is well over the 20 A rating of the circuit. The breaker will trip in seconds.
              The fix is to distribute the three appliances across the kitchen's two 20 A
              small-appliance branches — which is exactly why NEC requires two of them
              <Cite id="nec-2023" in={SOURCES} />. Even a 30 A circuit (which would itself violate
              the 80 % rule under continuous use) would be a poor solution; the receptacles you'd
              plug into wouldn't be rated for it.
            </p>
          </>
        }
      />
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">continuous load</strong> — a load expected
              to operate at maximum current for three hours or more. EV chargers, dehumidifiers,
              lighting in commercial spaces, and electric baseboard heaters are typical continuous
              loads. NEC Article 210.20(A) requires the circuit rating to be at least 125 % of the
              continuous load.
            </>
          }
        >
        ...
        as one expected to operate at its maximum current for{' '}
        <strong className="text-text font-medium">three hours or more</strong>. For continuous
        loads, Article 210.20(A) requires the branch-circuit overcurrent protection to be sized at
        no less than <strong className="text-text font-medium">125 %</strong> of the continuous load
        <Cite id="nec-2023" in={SOURCES} />. Stated as a constraint on the load rather than the
        breaker: you can continuously load a circuit to no more than{' '}
      ...
      <p className="mb-prose-3">
        ...
        builds in similar safety derating throughout
      ...
      <TryIt
        ...
        question={
          <>
            A <strong className="text-text font-medium">50 A continuous</strong> level-2 EV charger
            is to be installed at the end of a{' '}
            <strong className="text-text font-medium">12 m</strong> run from the panel. What gauge
            copper is required, and what is the actual round-trip voltage drop on that wire at full
            charge?
          </>
        }
        hint={
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              50 A continuous / 0.80 = <strong className="text-text font-medium">62.5 A</strong>{' '}
              minimum breaker rating; round up to the next stock size,{' '}
              <strong className="text-text font-medium">70 A</strong>
              <Cite id="nec-2023" in={SOURCES} />. The wire ampacity must be at least 70 A; in the
              75 °C column that is <strong className="text-text font-medium">4 AWG</strong> copper
              at 85 A
              <Cite id="awg-table-nec" in={SOURCES} />.
            </p>
            <p className="mb-prose-1 last:mb-0">
              4 AWG copper has R<sub>per metre</sub> ≈ 0.83 mΩ/m at 75 °C. Round-trip drop at 50 A
              across 12 m:
            </p>
            <Formula tex="\\Delta V = 2 \\cdot 50 \\cdot 0.00083 \\cdot 12 \\approx 1.0\\ \\text{V}" />
            <p className="mb-prose-1 last:mb-0">
              On a 240 V circuit that is <strong className="text-text font-medium">0.4 %</strong> —
              well inside the 3 % branch guideline. The wire size is set by the 80 % rule and the
              breaker, not by the voltage drop on this short a run.
            </p>
          </>
        }
      />
      ...
      <p className="mb-prose-3">
        ...
        the load is within 80 % of the breaker. Each choice constrains the others. Choose the wire
        too thin and the breaker becomes a fire hazard; choose the breaker too small and the load
      ...
      <CaseStudies
        intro={
          <>
            Three working examples that pull together the gauge / breaker / length / load
            coordination of a real residential install.
          </>
        }
      >
        <CaseStudy
          ...
          specs={[
            ...
            {
              label: 'Original branch wiring',
              value: (
                <>
                  14 AWG copper throughout (15 A breakers) <Cite id="awg-table-nec" in={SOURCES} />
                </>
              ),
            },
            {
            ...
            },
            {
              ...
              value: (
                <>
                  200 A panel, 4/0 Al SER feed <Cite id="nec-2017-aluminum" in={SOURCES} />
                </>
              ),
            },
          ]}
        >
          <p className="mb-prose-2 last:mb-0">
            A common renovation scenario: a small post-war house with the original 100 A panel,
            every branch run in 14 AWG, and a load profile from when &ldquo;heavy appliances&rdquo;
            meant a vacuum cleaner. The homeowner now wants a level-2 EV charger (40 A continuous on
            a 50 A circuit) and a 3-tonne ducted heat pump (drawing ~20 A continuous at 240 V). Each
            of those alone is roughly half the panel's total capacity
            <Cite id="nec-2023" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
            Doing the load calc by NEC Article 220 shows the existing 100 A service is now
            undersized by something like 20 %. The upgrade path is a 200 A meter base and panel, a
            new 4/0 aluminium SER service-entrance cable from the meter, and the two new circuits —
            8 AWG copper to the EVSE, 10 AWG copper to the heat pump's air handler
            <Cite id="awg-table-nec" in={SOURCES} />. The existing 14 AWG branches stay; they are
            still correctly paired with 15 A breakers and are doing exactly the job they were sized
            for sixty years ago
            <Cite id="nec-2017-aluminum" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
            Worth noting: the new 4/0 aluminium feeder is in the right place. Aluminium scares are
            about branch wiring in receptacle terminations, not about service feeders
            <Cite id="nec-2017-aluminum" in={SOURCES} />.
          </p>
        </CaseStudy>
        ...
        <CaseStudy
          ...
          specs={[
            ...
            {
              label: 'Kitchen small-appliance',
              value: (
                <>
                  2 × 20 A on 12 AWG (210.11(C)(1)) <Cite id="nec-2023" in={SOURCES} />
                </>
              ),
            },
            {
              ...
              value: (
                <>
                  1 × 20 A on 12 AWG (210.11(C)(2)) <Cite id="nec-2023" in={SOURCES} />
                </>
              ),
            },
            {
              ...
              value: (
                <>
                  1 × 20 A GFCI on 12 AWG (210.11(C)(3)) <Cite id="nec-2023" in={SOURCES} />
                </>
              ),
            },
            {
              ...
              value: (
                <>
                  15 A AFCI on 14 AWG (210.12) <Cite id="nec-2023" in={SOURCES} />
                </>
              ),
            },
            {
              ...
              value: (
                <>
                  50 A on 6 AWG (NEMA 14-50) <Cite id="awg-table-nec" in={SOURCES} />
                </>
              ),
            },
            {
              ...
              value: (
                <>
                  30 A on 10 AWG (NEMA 14-30) <Cite id="awg-table-nec" in={SOURCES} />
                </>
              ),
            },
            {
              ...
              value: (
                <>
                  20 A GFCI on 12 AWG <Cite id="nec-2023" in={SOURCES} />
                </>
              ),
            },
          ]}
        >
          <p className="mb-prose-2 last:mb-0">
            A modern 2000 sq ft single-family build has roughly two dozen branch circuits in a 200 A
            panel. The kitchen takes two 20 A small-appliance circuits as required, plus dedicated
            circuits for the dishwasher (15 A), the disposal (15 A), and the refrigerator (15 A or
            20 A depending on the specifier)
            <Cite id="nec-2023" in={SOURCES} />. The laundry room gets one dedicated 20 A
            general-purpose and a separate 30 A on 10 AWG for the dryer.
          </p>
          <p className="mb-prose-2 last:mb-0">
            ...
            <Term
              def={
                <>
                  ...
                  Interrupter; a breaker that listens for the high-frequency current signature of an
                  arcing fault (a staple piercing a cable, a damaged extension cord) and trips
                  before the arc ignites surrounding combustibles. Required by NEC 210.12 in
                  bedrooms, living rooms, hallways, and most habitable spaces of new dwellings.
                </>
              }
            >
              AFCI
            </Term>{' '}
            protection on the breaker, per NEC 210.12; that requirement now covers nearly all
            habitable rooms in a new dwelling
            <Cite id="nec-2023" in={SOURCES} />. Bathrooms, garages, outdoor receptacles, basements,
            and any wet area get GFCI protection per 210.8.
          </p>
          <p className="mb-prose-2 last:mb-0">
            The big appliances: a 50 A circuit on 6 AWG to a NEMA 14-50 range receptacle, a 30 A
            circuit on 10 AWG to a NEMA 14-30 dryer outlet, and increasingly a third 50 A circuit on
            6 AWG to a NEMA 14-50 in the garage for level-2 EV charging
            <Cite id="awg-table-nec" in={SOURCES} />. HVAC is a separate fused disconnect; water
            heater, if electric, is its own 30 A or 40 A circuit. The panel directory of a modern
            house is half intermittent receptacle loads and half dedicated big appliances.
          </p>
        </CaseStudy>
        ...
        <CaseStudy
          ...
          specs={[
            ...
            },
            {
              ...
              value: (
                <>
                  10 AWG (30 A rated, 75 °C column) <Cite id="awg-table-nec" in={SOURCES} />
                </>
              ),
            },
            {
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            A homeowner runs a 240 V stick welder rated 25 A intermittent at the far end of a
            basement workshop, 30 m of cable run from the panel. By ampacity alone, 10 AWG copper at
            30 A is the right gauge for a 30 A breaker
            <Cite id="awg-table-nec" in={SOURCES} />. But the round-trip voltage drop check is
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            the additional voltage sag from the wire is enough to make the arc unstable. Stepping up
            to <strong className="text-text font-medium">8 AWG</strong> (R<sub>per metre</sub> ≈
            2.10 mΩ/m) drops the same calculation to about{' '}
            <strong className="text-text font-medium">3.1 V</strong>, or 1.3 % — well inside the
            guideline
            <Cite id="nec-2023" in={SOURCES} />. The breaker stays at 30 A; the wire is upsized
            specifically for the drop, not the ampacity. This is the canonical example of voltage
            drop, not thermal limit, driving gauge selection on a long run.
          </p>
        </CaseStudy>
      </CaseStudies>
      ...
      >
        <FAQItem q="Why does NEC use the 60 °C column for residential receptacles even when the wire is 90 °C insulated?">
          <p>
            The wire is rated to 90 °C internally, but the screw terminals on standard residential
            receptacles and most stock breakers are only listed to 60 °C — and a couple of bigger
            devices to 75 °C
            <Cite id="nec-2023" in={SOURCES} />. The weakest thermal link in the chain sets the
            ampacity. NEC 110.14(C) requires that the conductor be sized at the rating of the
            lowest-rated termination in the run. If you used the wire's 90 °C ampacity, the
            conductor itself would be fine but the joint at the receptacle screw would creep into
            thermal trouble.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Can I daisy-chain receptacles indefinitely on the same branch?">
          <p>
            NEC does not put a hard cap on receptacle count per general-purpose branch in a dwelling
            — Article 220 assumes a statistical load of 180 VA per duplex for non-dwelling calcs,
            but in residential settings the load calculation is by square footage rather than
            receptacle count
            <Cite id="nec-2023" in={SOURCES} />. In practice, builders cap a 15 A bedroom circuit at
            maybe a dozen receptacles plus the lights, and a 20 A circuit at fewer because the
            per-receptacle expected load is higher. The real limit is voltage drop on the
            daisy-chained loop and reliability of the wire-nut splices in each box, not the
        ...
        <FAQItem q="Why does my wire feel warm but my breaker hasn't tripped?">
          <p>
            Breakers protect against currents <em className="text-text italic">above</em> their
            rating. A wire run within rating still dissipates I²R as heat — a 14 AWG run at 12 A
            continuous puts about ~1.2 W per metre into the insulation, more than a hand can detect
            at the surface. The breaker is doing its job; the wire is also doing its job; the warmth
            is the design point
            <Cite id="nec-2023" in={SOURCES} />. What you do not want is a{' '}
            <em className="text-text italic">hot spot</em>: a single warm receptacle or junction box
            surrounded by a cool cable run usually means a loose connection developing contact
            resistance, and that is a fire risk in progress.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why are aluminium feeders OK but aluminium branch wiring is fire-prone?">
          <p>
            The failure mode is at the terminations, not in the bulk metal. Service-entrance feeders
            are large gauge — 4/0 AWG aluminium for 200 A service — terminated in heavy lugs
            designed for aluminium, with antioxidant paste applied and torqued to spec. The
            per-joint power dissipation is small relative to the conductor's thermal mass
            <Cite id="nec-2017-aluminum" in={SOURCES} />. Small-gauge branch wiring (12/14 AWG
        ...
        <FAQItem q="Can I use a 12-2 cable for a 240 V circuit by using the white wire as a second hot?">
          <p>
            Conditionally yes, and the rules are strict
        ...
        <FAQItem q="The neutral conductor carries current — why isn't it called the &ldquo;return&rdquo;?">
          <p>
            Historically, &ldquo;neutral&rdquo; meant the conductor at zero potential relative to
            ground — the centre-tap of the service transformer's secondary, bonded to earth at the
            service entrance only. It is electrically distinct from the equipment grounding
            conductor (which is not supposed to carry any current under normal conditions) and from
            the &ldquo;return&rdquo; in a DC circuit (where the grounded conductor and the current
            return are unambiguously the same)
            <Cite id="nec-2023" in={SOURCES} />. On a three-phase or split-phase AC system, the
            neutral can carry imbalance current between the phases, which is a distinct concept from
            the return current on a two-wire DC loop. The name is a holdover from the early days of
        ...
        <FAQItem q="How is voltage drop different from impedance drop in an AC circuit?">
          <p>
            ...
            residential runs the correction is well under one percent. The reactive term becomes
            significant only for very long runs (commercial / industrial), for tight conduit fills
            where mutual inductance is large, or at higher frequencies (harmonic currents, motor
            drives).
          </p>
        </FAQItem>
        ...
        <FAQItem q="Is conduit always required, or can NM-B run exposed in a basement?">
          <p>
            NEC 334.15 allows NM-B to run exposed in dry locations, including unfinished basements,
            provided it is run through the centre of structural members or otherwise protected from
            physical damage on the face of a stud or joist
            <Cite id="nec-2023" in={SOURCES} />. Where it crosses below 1.4 m above the floor or
            runs along the face of a wall in a habitable space, it must be protected by a running
            board, guard strip, or conduit. Garages and accessory buildings typically require
            conduit because the mechanical-damage risk is higher. Wet locations (outdoors, in damp
            basements) require UF-B or THHN-in-conduit instead.
          </p>
        </FAQItem>

        <FAQItem q="What's the cable stapling and box-fill requirement inside a stud bay?">
          <p>
            NEC 334.30 requires NM-B to be supported within 300 mm of every box and at intervals not
            exceeding 1.4 m along its run
            <Cite id="nec-2023" in={SOURCES} />. Cable staples must be the insulated-saddle kind
            specifically listed for NM-B; standard wire fence staples are not permitted because they
            can over-compress the jacket. Box-fill calculation, governed by Article 314.16, totals
            the volume each conductor and device occupies in a junction box and requires the box to
            be at least that volume
            <Cite id="nec-2023" in={SOURCES} />: a typical single-gang 18-cubic-inch box
            accommodates a standard receptacle plus a few 12 AWG splices.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why are tamper-resistant receptacles (TR) required in residential bedrooms?">
          <p>
            ...
            simultaneously — as a two-prong plug does — preventing a child from inserting a single
            object (a hairpin, a paperclip) into one slot. The receptacle is otherwise electrically
            and mechanically identical to a non-TR equivalent. The requirement covers bedrooms,
            living rooms, hallways, and essentially every other dwelling receptacle except a few
            specific exceptions (behind a permanently-installed appliance, more than 1.7 m above the
            floor).
          </p>
        </FAQItem>
        ...
        <FAQItem q="If I'm putting in conduit instead of NM-B, do I size the wire differently?">
          <p>
            Yes, slightly. THHN single conductors in conduit are derated as the conduit fill
            increases, because multiple current-carrying conductors in the same raceway shed heat
            less efficiently. NEC 310.15(C)(1) adjusts the ampacity downward when more than three
            current-carrying conductors share a raceway: 80 % for 4–6 conductors, 70 % for 7–9, and
            so on
            <Cite id="awg-table-nec" in={SOURCES} />. The conduit fill calculation of Chapter 9
            Table 1 separately limits how many conductors can mechanically fit. For a two-conductor
            residential 120 V branch in 1/2&quot; EMT, neither derating nor fill is usually the
            binding constraint — but in a feeder run with six or eight conductors in a single
            conduit, the adjustment can push you up a gauge.
          </p>
        </FAQItem>

        <FAQItem q="Can I just upsize the wire and skip worrying about the breaker?">
          <p>
            Not exactly. Upsizing the wire is always safe — a 12 AWG conductor on a 15 A breaker is
            wasted copper but never dangerous. But the breaker must still be sized to protect the{' '}
            <em className="text-text italic">smallest</em> wire in the run, not the largest, and you
            cannot pair a 30 A breaker with 14 AWG wire even if there is also a short stretch of 6
            AWG in series with it
            <Cite id="nec-2023" in={SOURCES} />. The breaker rating tracks the weakest segment of
            the conductor it protects. NEC 240.4 makes this explicit.
          </p>
        </FAQItem>
      </FAQ>
    </ChapterShell>
