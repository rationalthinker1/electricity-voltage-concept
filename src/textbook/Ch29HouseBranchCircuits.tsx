  ...
  return (
    <ChapterShell chapter={chapter}>
      ...
      <p className="mb-prose-3">
        Now plug a <em className="italic text-text">second</em> 1200 W heater into one of the other receptacles on the same circuit. Total current
        climbs to about <strong className="text-text font-medium">20 A</strong>. The 15 A breaker tolerates a brief overload but heats internally and
      ...
      <p className="mb-prose-3">
        ...
        it is the <strong className="text-text font-medium">insulation</strong> around the copper softening, charring, or igniting. Residential NM-B
        ...
        The <em className="italic text-text">weakest</em> rated thermal point in the whole chain sets the budget.
      </p>
      <p className="mb-prose-3">
      ...
      <p className="mb-prose-3">
        ...
        <Cite id="codata-2018" in={SOURCES} />, and <strong className="text-text font-medium">A</strong> is the conductor's cross-sectional area (in m²).
        For a fixed maximum-allowable wire temperature, the cooling side scales roughly with the perimeter (i.e. √A),
        so the allowed current scales roughly with √A. Doubling the cross-section does <em className="italic text-text">not</em> double the ampacity;
        it raises it by about <strong className="text-text font-medium">√2</strong> for a fixed insulation rating.
      </p>
      <p className="mb-prose-3">
        NEC{' '}
        <Term def={<><strong className="text-text font-medium">Table 310.16</strong> — the NEC table of allowable ampacities for insulated conductors in raceway, cable, or earth, indexed by gauge and insulation temperature rating. The 60 °C column governs residential branch circuits with standard 15/20/30 A devices.</>}>Table 310.16</Term>{' '}
      ...
      <ul>
        <li>
          <strong className="text-text font-medium">14 AWG</strong> copper — cross-section <strong className="text-text font-medium">2.08 mm²</strong>, rated <strong className="text-text font-medium">15 A</strong>. The
        ...
        <li>
          <strong className="text-text font-medium">12 AWG</strong> — <strong className="text-text font-medium">3.31 mm²</strong>, rated <strong className="text-text font-medium">20 A</strong>. The required gauge for
          kitchen small-appliance circuits, bathrooms, laundry rooms, and garage
          receptacles<Cite id="nec-2023" in={SOURCES} />.
        </li>
        <li>
          <strong className="text-text font-medium">10 AWG</strong> — <strong className="text-text font-medium">5.26 mm²</strong>, rated <strong className="text-text font-medium">30 A</strong>. Used for electric clothes
          dryers and tankless or smaller storage water heaters<Cite id="awg-table-nec" in={SOURCES} />.
        </li>
        <li>
          <strong className="text-text font-medium">8 AWG</strong> — <strong className="text-text font-medium">8.37 mm²</strong>, rated <strong className="text-text font-medium">40 A</strong>. Electric ranges of modest
          size and 40 A level-2 EV chargers<Cite id="awg-table-nec" in={SOURCES} />.
        </li>
        <li>
          <strong className="text-text font-medium">6 AWG</strong> — <strong className="text-text font-medium">13.3 mm²</strong>, rated <strong className="text-text font-medium">55 A</strong> in the 75 °C column (used at
      ...
      <TryIt
        ...
        question={
          <>
            A <strong className="text-text font-medium">12 AWG</strong> copper conductor (A = 3.31 mm²) is 25 m long and carries <strong className="text-text font-medium">15 A</strong>.
      ...
      <p className="mb-prose-3">
        <strong className="text-text font-medium">NM-B</strong> (the trade name Romex covers most variants) is{' '}
        <Term def={<><strong className="text-text font-medium">NM cable</strong> — non-metallic-sheathed cable, governed by NEC Article 334. Two or three insulated copper conductors plus a bare equipment grounding conductor, wrapped in a PVC outer jacket. White jacket = 14 AWG, yellow = 12 AWG, orange = 10 AWG by industry convention.</>}>non-metallic-sheathed cable</Term>:
        two or three insulated conductors plus a bare{' '}
        <Term def={<><strong className="text-text font-medium">equipment grounding conductor (EGC)</strong> — the bare or green conductor in a cable, bonded to metal enclosures and equipment frames. Provides a low-impedance fault path back to the panel so that ground faults trip the breaker.</>}>equipment grounding conductor</Term>,
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">UF-B cable</strong> — Underground Feeder cable, NEC Article 340. Conductors are embedded in a solid PVC matrix (not just jacketed) so the cable can survive direct burial in earth. Used for outdoor branch circuits feeding a shed, a yard light, or a pump.</>}>UF-B cable</Term>{' '}
      ...
      <p className="mb-prose-3">
        <strong className="text-text font-medium">THHN/THWN</strong> are individual conductors, not cables — single insulated wires pulled through
        conduit, with the four-letter code spelling out their insulation properties:{' '}
        <Term def={<><strong className="text-text font-medium">THHN</strong> — Thermoplastic High Heat-resistant Nylon-coated. A 90 °C-rated single-conductor wire pulled through conduit. THWN adds Water-resistance for damp locations. The default conductor type for commercial and industrial wiring.</>}>THHN</Term>{' '}
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">neutral conductor</strong> — the grounded current-carrying conductor that returns load current to the source. Bonded to ground only at the service entrance. Always white or grey in branch wiring. Carries current; not the same as the ground.</>}>neutral</Term>{' '}
      ...
      <p className="mb-prose-3">
        ...
        constraint is{' '}
        <Term def={<><strong className="text-text font-medium">voltage drop</strong> — the IR voltage difference between the panel and the load, caused by the resistance of the wires themselves. NEC recommends keeping branch-circuit drop under 3 % and total drop (feeder + branch) under 5 %. Informational notes only; not strictly enforced.</>}>voltage drop</Term>,
      ...
      <p className="mb-prose-3">
        ...
        load current (in amperes), <strong className="text-text font-medium">R<sub>per metre</sub></strong> is the wire's per-unit-length resistance at
        operating temperature (in Ω/m, tabulated in NEC Chapter 9 Table 8), and <strong className="text-text font-medium">L</strong> is the one-way
        run length from the panel to the load (in metres). For 14 AWG copper at 75 °C, R<sub>per metre</sub> ≈{' '}
        <strong className="text-text font-medium">8.45 mΩ/m</strong>; for 12 AWG, it is ≈ 5.31 mΩ/m; for 10 AWG, ≈ 3.34
      ...
      <p className="mb-prose-3">
        ...
        <em className="italic text-text">small-conductor protection</em>: 14 AWG copper is fixed to 15 A regardless of any ampacity table that
      ...
      <p className="mb-prose-3">
        Wire that already <em className="italic text-text">feels</em> warm to the touch under load is sending you a message. Receptacle screws
      ...
      <TryIt
        ...
        question={
          <>
            A homeowner finds <strong className="text-text font-medium">14 AWG NM-B</strong> connected to a <strong className="text-text font-medium">20 A breaker</strong> in their
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              14 AWG copper is rated <strong className="text-text font-medium">15 A</strong> by NEC Article 240.4(D)
            ...
            <p className="mb-prose-1 last:mb-0">
              ...
              really do need 20 A — pull new 12 AWG wire and keep the 20 A breaker. <em className="italic text-text">Never</em> the other way
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">aluminium</strong> conductors — used widely for service-entrance feeders and large sub-feeds because aluminium is roughly 30 % cheaper than copper for the same ampacity. The modern AA-8000 series alloy is well-behaved when terminated with antioxidant compound and AL-rated lugs. Older solid-aluminium branch wiring (1965–1973) is the source of a still-active fire-risk advisory.</>}>aluminium</Term>{' '}
      ...
      <p className="mb-prose-3">
        That sentence has a notorious asterisk. Between roughly <strong className="text-text font-medium">1965 and 1973</strong>, copper prices spiked
      ...
      <p className="mb-prose-3">
        ...
        through every load cycle worked itself looser over months and years. And aluminium <em className="italic text-text">creeps</em>: under
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">small-appliance branch circuit</strong> — NEC Article 210.11(C)(1): a 20 A branch circuit dedicated to receptacles in the kitchen, dining area, pantry, and breakfast room. A dwelling unit must have at least two of these.</>}>small-appliance branch circuits</Term>,
      ...
      <TryIt
        ...
        question={
          <>
            A kitchen has a <strong className="text-text font-medium">1500 W</strong> toaster oven, a <strong className="text-text font-medium">1100 W</strong> microwave, and a
            <strong className="text-text font-medium"> 900 W</strong> coffee maker. Can all three run simultaneously on a single 20 A
      ...
      <p className="mb-prose-3">
        ...
        as one expected to operate at its maximum current for <strong className="text-text font-medium">three hours or more</strong>. For continuous
        loads, Article 210.20(A) requires the branch-circuit overcurrent protection to be sized at no less than{' '}
        <strong className="text-text font-medium">125 %</strong> of the continuous load<Cite id="nec-2023" in={SOURCES} />. Stated as a constraint on
        the load rather than the breaker: you can continuously load a circuit to no more than{' '}
        <strong className="text-text font-medium">80 %</strong> of its breaker rating, because 1 / 1.25 = 0.80.
      </p>
      <p className="mb-prose-3">
      ...
      <p className="mb-prose-3">
        ...
        engineering-relevant numbers. A level-2 EVSE rated to charge at <strong className="text-text font-medium">32 A continuous</strong> requires
        the circuit be rated at no less than 32 / 0.80 = <strong className="text-text font-medium">40 A</strong>. A 40 A circuit on 8 AWG copper is
      ...
      <TryIt
        ...
        question={
          <>
            A <strong className="text-text font-medium">50 A continuous</strong> level-2 EV charger is to be installed at the end of a <strong className="text-text font-medium">12
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              50 A continuous / 0.80 = <strong className="text-text font-medium">62.5 A</strong> minimum breaker rating; round up to the next stock
              size, <strong className="text-text font-medium">70 A</strong><Cite id="nec-2023" in={SOURCES} />. The wire ampacity must be at least
              70 A; in the 75 °C column that is <strong className="text-text font-medium">4 AWG</strong> copper at 85 A
      ...
      >
        ...
        >
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            the arc unstable. Stepping up to <strong className="text-text font-medium">8 AWG</strong> (R<sub>per metre</sub> ≈ 2.10 mΩ/m) drops the
            same calculation to about <strong className="text-text font-medium">3.1 V</strong>, or 1.3 % — well inside the
      ...
      <FAQ
        intro={
          <>
            Branch-circuit rules are dense, but every one of them traces back to the wire's <em className="italic text-text">I²R</em> and the
      ...
      >
        ...
        <FAQItem q="Why does my wire feel warm but my breaker hasn't tripped?">
          <p>
            Breakers protect against currents <em className="italic text-text">above</em> their rating. A wire run within rating still
            ...
            not want is a <em className="italic text-text">hot spot</em>: a single warm receptacle or junction box surrounded by a cool cable
        ...
        <FAQItem q="Can I just upsize the wire and skip worrying about the breaker?">
          <p>
            ...
            but never dangerous. But the breaker must still be sized to protect the <em className="italic text-text">smallest</em> wire in the
