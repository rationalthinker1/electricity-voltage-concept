  ...
  return (
    <ChapterShell chapter={chapter}>
      ...
      <p className="mb-prose-3">
        ...
        the switches that interrupt them, and the dimmers that chop the waveform on its way to a
        lamp. The two most-asked questions in residential rough-in are also the two we'll answer in
        full: <em className="text-text italic">which screw does which colour wire go on?</em> and{' '}
        <em className="text-text italic">how on earth does a staircase with two switches work?</em>
      </p>
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">duplex receptacle</strong> — a single wiring
              device with two outlet positions, top and bottom, mounted in a single wall box.
              Standard residential 120 V outlets are duplex.
            </>
          }
        >
          duplex receptacle
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">NEMA pattern</strong> — a configuration code
              from NEMA WD 6 that specifies the geometry of a plug or receptacle. Format is X-YYR
              (receptacle) or X-YYP (plug), where X is the voltage/pole configuration and YY is the
        ...
        5-15R receptacle, which mates with the 5-15P plug on the end of every lamp cord and phone
        charger in the country
      ...
      <p className="mb-prose-3">
        ...
        terminals on the sides of the device. The convention is fixed and worth memorising once:
      </p>
      <ul>
        <li>
          The{' '}
          <Term
            def={
              <>
                <strong className="text-text font-medium">brass screw</strong> — the
                gold/yellow-coloured terminal screw on a receptacle or switch. Always lands the hot
                (line) conductor — by convention the black or red wire.
              </>
            }
          >
            brass screws
          </Term>{' '}
          (two, one above the other) on one side take the{' '}
          <Term
            def={
              <>
                <strong className="text-text font-medium">hot</strong> — the energised conductor of
                a circuit, normally at line voltage relative to neutral and ground. Black or red
                insulation by convention in North American residential wiring.
              </>
            }
          >
            hot
        ...
        <li>
          ...
          <Term
            def={
              <>
                <strong className="text-text font-medium">silver screw</strong> — the
                chrome/white-coloured terminal screw on a receptacle. Always lands the neutral
                conductor — by convention the white wire.
              </>
            }
          >
            silver screws
          </Term>{' '}
          (two, on the other side) take the{' '}
          <Term
            def={
              <>
                <strong className="text-text font-medium">neutral</strong> — the return conductor of
                a 120 V branch circuit; bonded to ground at the service panel but treated as an
                energised conductor for current. White insulation by convention.
              </>
            }
          >
            neutral
        ...
        <li>
          ...
          <Term
            def={
              <>
                <strong className="text-text font-medium">green screw</strong> — the
                equipment-grounding terminal on a receptacle or switch. Always lands the bare or
                green-insulated ground conductor; never carries current except during a fault.
              </>
            }
          >
            green screw
          </Term>{' '}
          (one, at the bottom) takes the{' '}
          <Term
            def={
              <>
                <strong className="text-text font-medium">ground</strong> — the equipment-grounding
                conductor; a bonded return path that carries fault current only, sized to trip the
                upstream breaker if a hot conductor contacts a metal enclosure.
              </>
            }
          >
            ground
      ...
      <p className="mb-prose-3">
        ...
        switched while the other stays always-on. That is exactly how a "switched outlet" controlled
        by a wall switch is built. The{' '}
        <Term
          def={
            <>
              <strong className="text-text font-medium">break-off tab</strong> — the small scored
              metal bridge between paired terminal screws on a duplex receptacle. Snapping it
              converts the device into two independently-fed halves; used for switched outlets and
              split receptacles.
            </>
          }
        >
      ...
      <p className="mb-prose-3">
        ...
        dielectric-withstand performance is governed by{' '}
        <strong className="text-text font-medium">UL 498</strong>
        <Cite id="ul-498" in={SOURCES} />. Both standards are referenced into the National
        Electrical Code by <strong className="text-text font-medium">NEC 110.3(B)</strong>
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">back-wire (push-in) holes</strong> — small
              spring-loaded apertures on the back of a receptacle that accept a stripped conductor
              pushed straight in. Faster than wrapping a screw, but on contractor-grade devices they
              have a reputation for working loose over time; commercial-grade devices use a clamped
              back-wire instead.
            </>
          }
        >
          push-in (back-wire) holes
        </Term>{' '}
        that grip a straight stripped conductor with a spring. Push-in holes are faster than screws
        but on the cheap-grade devices have a reputation for loosening over time; commercial-grade
      ...
      <ul>
        <li>
          <strong className="text-text font-medium">5-15</strong> — 15 A, 125 V, the standard
          household outlet.
        </li>
        <li>
          <strong className="text-text font-medium">5-20</strong> — 20 A, 125 V; the neutral slot is
          T-shaped so a 5-20 plug (one blade horizontal) fits but a 5-15 plug still works.
        </li>
        <li>
          <strong className="text-text font-medium">6-15</strong> — 15 A, 250 V (two hots, no
          neutral); window-unit air conditioners.
        </li>
        <li>
          <strong className="text-text font-medium">6-20</strong> — 20 A, 250 V; some shop tools.
        </li>
        <li>
          <strong className="text-text font-medium">14-30</strong> — 30 A, 125/250 V, with neutral;
          the standard electric-dryer outlet.
        </li>
        <li>
          <strong className="text-text font-medium">14-50</strong> — 50 A, 125/250 V, with neutral;
      ...
      <TryIt
        ...
        question={
          <>
            A 5-15R receptacle's brass screw measures{' '}
            <strong className="text-text font-medium">119 V</strong> to neutral. A space heater
            rated <strong className="text-text font-medium">800 W</strong> is plugged in. What
            current does the receptacle carry, and is it within its 15 A rating?
          </>
        }
        hint={
          <>
        ...
        answer={
          <>
            ...
            <p className="mb-prose-1 last:mb-0">
              Answer: <strong className="text-text font-medium">about 6.7 A</strong>, comfortably
              under the 15 A rating of a 5-15R
              <Cite id="nema-wd-6" in={SOURCES} />. A second similar load on the same duplex would
              still be fine; three would start to crowd the breaker.
            </p>
          </>
        }
      />
      ...
      <ul>
        <li>
          <strong className="text-text font-medium">1</strong> — 125 V, 2-pole 2-wire (no ground).
          The original ungrounded outlet; rare in new construction, common in pre-1962 homes.
        </li>
        <li>
          <strong className="text-text font-medium">5</strong> — 125 V, 2-pole 3-wire grounded. Hot,
          neutral, ground. The standard household outlet.
        </li>
        <li>
          <strong className="text-text font-medium">6</strong> — 250 V, 2-pole 3-wire grounded. Two
          hots (180° apart), ground, no neutral.
        </li>
        <li>
          <strong className="text-text font-medium">14</strong> — 125/250 V, 3-pole 4-wire grounded.
          Two hots, neutral, ground; gives both 240 V (between hots) and 120 V (each hot to
          neutral).
        </li>
      </ul>
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">configuration code</strong> — the first
              integer in a NEMA pattern number, which encodes voltage and pole/wire count. 1 = 125 V
              ungrounded, 5 = 125 V grounded, 6 = 250 V grounded, 14 = 125/250 V grounded.
            </>
          }
        >
          configuration code
        </Term>{' '}
        and the slot geometry travel together: a 6-20P plug (250 V, 20 A) physically cannot enter a
        5-15R receptacle (125 V, 15 A), because the slot orientations differ. That is the principal
      ...
      <ul>
        <li>
          5-15: 120 × 15 = <strong className="text-text font-medium">1800 W</strong>
        </li>
        <li>
          5-20: 120 × 20 = <strong className="text-text font-medium">2400 W</strong>
        </li>
        <li>
          6-15: 240 × 15 = <strong className="text-text font-medium">3600 W</strong>
        </li>
        <li>
          6-20: 240 × 20 = <strong className="text-text font-medium">4800 W</strong>
        </li>
        <li>
          14-30: 240 × 30 = <strong className="text-text font-medium">7200 W</strong>
        </li>
        <li>
      ...
      <p className="mb-prose-3">
        ...
        outlet's continuous rating is 16 A. We'll come back to this in Try 30.5.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        wraps around an upper silver screw, the black hot wraps around an upper brass screw. The
        outgoing cable to the next box does the same — onto the
        <em className="text-text italic"> other</em> brass screw, the{' '}
        <em className="text-text italic">other</em> silver screw, and the{' '}
      ...
      <p className="mb-prose-3">
        ...
        current from the panel directly, not from the receptacles upstream of it. The current at the
        very first box equals the sum of all the loads plugged in further down — and that, plus the
        breaker rating, is what the gauge of the branch wire has to survive.
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            Three 5-20 duplex receptacles are daisy-chained on a single 20 A circuit. Receptacle #2
            has a <strong className="text-text font-medium">1500 W</strong> heater plugged in;
            receptacle #3 has a <strong className="text-text font-medium">1000 W</strong> toaster.
            What current does the wire{' '}
            <em className="text-text italic">between the panel and receptacle #1</em> carry, and is
            the 20 A breaker happy?
          </>
        }
        hint={
          <>
        ...
        answer={
          <>
            ...
            <p className="mb-prose-1 last:mb-0">
              Total at receptacle #1: <strong className="text-text font-medium">≈ 20.8 A</strong>.
              That exceeds the 20 A breaker's instantaneous rating and well exceeds the 80 %
              continuous rating of 16 A. The breaker would either trip on a thermal-magnetic curve
              within minutes or — if the loads cycled — wear the contacts out. NEC 210.23
              effectively forbids this combination on one 20 A circuit
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">single-pole switch</strong> — a wall switch
              with two terminals (plus an equipment ground) that interrupts a single conductor — the
              hot — between a line and a load. The simplest, cheapest, most common switch in
              residential wiring.
            </>
          }
        >
        ...
        : two screw terminals plus a ground screw, one toggle, on or off. The two screws are both
        brass; one accepts the line (incoming hot from the panel) and the other accepts the load
        (outgoing hot to the lamp). The internal contact bridges the two when the toggle is up and
      ...
      <p className="mb-prose-3">
        ...
        only return path is through the load itself, which works for incandescent bulbs (a few mA
        dropped across a tungsten filament does nothing) but misbehaves with LED loads (the same mA,
        dropped across a switched-mode LED driver, makes the lamp flicker when "off"). The NEC's
        solution is to insist the neutral be present from day one so the future smart-switch
      ...
      <p className="mb-prose-3">
        ...
        This is the classic two-switch staircase, and the device that does it is the{' '}
        <Term
          def={
            <>
              <strong className="text-text font-medium">three-way switch</strong> — a switch with
              three current-carrying terminals (one common + two travellers) plus a ground, used in
              pairs to control one load from two locations. Not actually "three-way" in the sense of
              three states — it has two states, and the name is the count of conductive screws.
            </>
          }
        >
          three-way switch
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">common terminal</strong> — the single screw
              on a three-way switch that is wired to either the line (at the line-end switch) or to
              the load (at the load-end switch). Always darker — typically black, sometimes
              copper-coloured — to distinguish it from the two traveller screws.
            </>
          }
        >
          common terminal
        ...
        <Term
          def={
            <>
              ...
              conductors that run between the two three-way switches of a pair. The state of the
              load is determined by whether both switches are pointing at the same traveller (load
              on) or different travellers (load off).
            </>
          }
        >
          travellers
        </Term>{' '}
        (matching brass). Internally, the switch is a single-pole double-throw (SPDT): the common is
      ...
      <p className="mb-prose-3">
        ...
        the second switch's common feeds the lamp. The second is{' '}
        <em className="text-text italic">line in the middle, switches on either side</em>: the feed
        and the load both originate at the ceiling box (where the lamp lives), and a 3-wire cable
      ...
      <p className="mb-prose-3">
        ...
        that detours through a switch leaves the lamp de-energised whenever the switch happens to
        break the wrong leg.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">four-way switch</strong> — a switch with
              four current-carrying terminals (two pairs of travellers) plus a ground, used in the
              middle of a three-or-more-switch chain. Internally a DPDT swap: it cross-connects or
              straight-connects the two travellers passing through it.
            </>
          }
        >
          four-way switch
      ...
      <TryIt
        ...
        question={
          <>
            In a two-switch staircase, switch 1 is in the "up" position (traveller A) and switch 2
            is in the "down" position (traveller B). Is the lamp on or off? Now imagine flipping
            switch 2. Now flipping switch 1 from that new state.
          </>
        }
        hint={
          <>
      ...
      <Pullout>
        A three-way switch isn't three-way; it's two-way with a third pin to remind you that someone
        has to win the XOR.
      </Pullout>
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">dimmer</strong> — a wall switch whose
              internal solid-state device (typically a triac) chops the AC waveform delivered to the
              load, varying the load's time-averaged power by varying the fraction of each
              half-cycle the device conducts.
            </>
          }
        >
          dimmer
        </Term>{' '}
        replaces the snap-action contact of a single-pole switch with a solid-state device — almost
        always a{' '}
        <Term
          def={
            <>
              <strong className="text-text font-medium">triac</strong> — a bidirectional thyristor;
              a solid-state AC switch that, once triggered by a gate pulse during a half-cycle,
              stays on for the remainder of that half-cycle then automatically turns off at the next
              zero-crossing. The standard switching element in low-cost AC dimmers.
            </>
          }
        >
          triac
        </Term>
        . A triac is a bidirectional thyristor: once gated on during a half-cycle, it stays
        conducting until the current next crosses zero, at which point it shuts off automatically.
        By delaying the gate pulse, the dimmer can hold the load OFF for the first portion of each
        half-cycle and turn it ON only for the remainder. The result is a chopped sine wave; the
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">phase-cut</strong> — a dimming technique
              that chops a portion of each AC half-cycle to vary the load's time-averaged power.
              Leading-edge cuts the front of each half-cycle (the cheap triac-based topology);
              trailing-edge cuts the back (a more expensive MOSFET- or IGBT-based topology, better
              suited to electronic loads).
            </>
          }
        >
          phase-cut
      ...
      <ul>
        ...
        <li>
          <Term
            def={
              <>
                <strong className="text-text font-medium">Trailing-edge</strong> dimming — the
                dimmer turns the load ON at the zero-crossing and turns it OFF partway through the
                half-cycle. Built from a MOSFET or IGBT with a gate-driver capable of forced
                commutation. Better behaved with electronic loads; more expensive.
              </>
            }
          >
            Trailing-edge
          </Term>{' '}
          (reverse phase-cut): the dimmer turns the load ON at the zero-crossing and OFF partway
          through the half-cycle. Built from a MOSFET or IGBT — devices that can be forced off
          mid-conduction, unlike a triac. Much gentler on switched-mode power supplies because the
          turn-on occurs at zero current; correspondingly better suited to LED drivers and
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">conduction angle</strong> — the fraction of
              an AC half-cycle (in radians) during which a dimmer's switching device is in its ON
              state. α = π means fully on (the dimmer is bypassed); α = 0 means fully off.
            </>
          }
        >
          α
        </Term>{' '}
        as the conduction angle: the portion of each half-cycle, in radians, that the triac is on.
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">LED bulb</strong> — a screw-base lamp that
              hides a switched-mode AC-to-DC driver in its base, feeding a string of light-emitting
              diodes. The driver presents a non-linear, frequency-dependent impedance to the line
              and only sometimes plays nicely with a phase-cut dimmer.
            </>
          }
        >
          LED bulb
        ...
        driver's input voltage drops below the regulator's dropout and the LED simply stays off. The
        cure is either an LED bulb explicitly marketed as "dimmer-compatible" or a trailing-edge
        dimmer (or an MLV/ELV-rated dimmer) that switches at the zero-crossing and matches the
        driver's expected load profile
        <Cite id="lutron-dimmer-app-note" in={SOURCES} />.
      </p>
      ...
      <TryIt
        ...
        answer={
          <>
            ...
            <p className="mb-prose-1 last:mb-0">
              Answer: <strong className="text-text font-medium">40 A continuous, 9.6 kW</strong>. A
              typical level-2 EV charger sold for a 50 A circuit is configured to negotiate exactly
              that 40 A pilot signal — anything higher would either trip the breaker on a long
              charge session or violate the listing of the EVSE.
            </p>
          </>
        }
      />
      ...
      <CaseStudies
        intro={
          <>
            Two devices that show what receptacles, switches, and dimmers look like in the wild —
            and one retrofit that demonstrates why the 2023 NEC's neutral-in-every-switch-box rule
            exists.
          </>
        }
      >
          ...
          specs={[
            {
              ...
              value: (
                <>
                  5-20R, 125 V / 20 A <Cite id="nema-wd-6" in={SOURCES} />
                </>
              ),
            },
            {
            ...
            },
            {
              ...
              value: <>2 brass (hot), 2 silver (neutral), 1 green (ground); back-wire clamps</>,
            },
            {
              label: 'Wire range',
              value: (
            ...
            },
            {
              ...
              value: (
                <>
                  Installed per NEC 110.3(B) listing <Cite id="nec-2023" in={SOURCES} />
                </>
              ),
            },
          ]}
        >
          ...
          <p className="mb-prose-2 last:mb-0">
            What separates commercial-grade from residential-grade is mostly the termination.
            Instead of the spring-loaded push-in holes on the back of a contractor-grade device, a
            commercial duplex has clamped back-wires — the conductor pushes straight into a hole
            behind the side screw, and the side screw, when tightened, drives a pressure plate down
          ...
          specs={[
            {
              ...
              value: (
                <>
                  2× three-way switches (endpoints) + 1× four-way switch (middle landing) + 1×
                  ceiling lamp
                </>
              ),
            },
            {
              label: 'Travellers in middle box',
              value: <>4 (two pairs running through the four-way)</>,
            },
            {
              label: 'Configurations',
              value: <>2³ = 8 total switch positions; exactly 4 of them illuminate the lamp</>,
            },
            {
              label: 'NEC reference',
              value: (
                <>
                  Box-fill calculation per NEC 314.16 <Cite id="nec-2023" in={SOURCES} />
                </>
              ),
            },
          ]}
        >
          <p className="mb-prose-2 last:mb-0">
            Picture a three-story house with the staircase light controlled from the ground floor,
            the middle landing, and the upstairs hall. The standard topology runs the line into the
            ground-floor switch box, wires that switch as a three-way with its common on the line,
            then runs a 3-wire cable up to the middle landing. The middle-landing switch is a
            four-way: it receives two travellers from below and sends two travellers up, and in its
            two internal states either passes the travellers straight through or swaps them. The two
            travellers from the four-way then continue up to the upstairs switch, also a three-way,
            with its common on the load (the lamp).
          </p>
          <p className="mb-prose-2 last:mb-0">
            The truth table now has 2<sup>3</sup> = 8 rows — one for each combination of three
            switch positions — and exactly four of them light the lamp. The XOR of all three switch
            bits, inverted, gives the load state. Any single flip toggles the lamp regardless of
            which switch was flipped or what the others were doing. Adding a fourth landing simply
            inserts another four-way between the existing four-way and the upstairs three-way; the
            truth table doubles, and the property is preserved
            <Cite id="nec-2023" in={SOURCES} />. The box-fill calculation in NEC 314.16 has to
            account for the extra conductors the four-way introduces, which is why mid-loop switches
            sometimes need a deeper box than the endpoints.
          </p>
        </CaseStudy>
          ...
          specs={[
            {
              ...
              value: (
                <>
                  Phase-cut dimmer, leading- or trailing-edge selectable{' '}
                  <Cite id="lutron-dimmer-app-note" in={SOURCES} />
                </>
              ),
            },
            {
              label: 'Standby current draw',
              value: <>A few milliamperes from the line for radio + microcontroller</>,
            },
            {
              label: 'Required conductor',
              value: (
                <>
                  Neutral in the switch box — mandated by NEC 404.2(C) since 2011{' '}
                  <Cite id="nec-2023" in={SOURCES} />
                </>
              ),
            },
            {
              ...
              value: (
                <>
                  Without neutral, standby current flows through the load and can make LED lamps
                  glow when "off"
                </>
              ),
            },
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            A modern smart wall-dimmer is a triac (or MOSFET) phase-cut dimmer with a small
            microcontroller, a Wi-Fi or Zigbee radio, and an enclosure designed to drop into a
            standard switch box
            <Cite id="lutron-dimmer-app-note" in={SOURCES} />. The electronics need to be powered 24
            hours a day — the radio has to hear the "turn on" command even when the load is off — so
            the device draws a steady few milliamperes from the line for its own housekeeping. That
            standby current needs a return path.
          </p>
          <p className="mb-prose-2 last:mb-0">
            A dumb single-pole switch contains no electronics and needs no return path: when the
            toggle is open, no current flows, period. A smart switch breaks that assumption. Without
            a neutral wire in the switch box, the only return available is through the lamp itself,
            and a few milliamperes through an incandescent filament does nothing. Run the same
            standby current through an LED driver and the driver's input capacitor charges enough to
            fire the LEDs at low brightness — the bulb glows dimly when the switch is supposedly
            off.
          </p>
          <p className="mb-prose-2 last:mb-0">
      ...
      <FAQ intro="Questions readers ask after this chapter — receptacles, switches, dimmers, and the quirks of the wall-box.">
        <FAQItem q="Why is the neutral slot bigger than the hot slot on a 5-15 receptacle?">
          <p>
            So a polarised two-prong plug can only enter one way. The wider blade goes into the
            wider slot, lining up the appliance's internal neutral with the building's neutral and
            its internal switch with the building's hot. That keeps the switch on the energised side
            of the load when the appliance is "off," so the load isn't sitting at line potential
            through an unswitched filament. The asymmetry is a defined feature of NEMA WD 6
            <Cite id="nema-wd-6" in={SOURCES} />.
          </p>
        </FAQItem>

        <FAQItem q="Can I plug a 5-15 plug into a 5-20 receptacle (the one with the T-slot)?">
          <p>
            Yes. The T-slot on a 5-20R receptacle is shaped so that both a standard 5-15P plug (two
            parallel blades) and a 5-20P plug (one blade rotated 90°) physically fit
            <Cite id="nema-wd-6" in={SOURCES} />. The reverse is not allowed: a 5-20P plug will not
            enter a 5-15R, because the receptacle's neutral slot is a simple rectangle and refuses
            the rotated blade. That asymmetry keeps a 20 A appliance from being plugged into a 15 A
            circuit.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why does an outdoor receptacle have a weatherproof cover even when nothing's plugged in?">
          <p>
            Because NEC 406.9(B)(1) requires it: outdoor receptacles must remain weatherproof "in
            use" — meaning with a cord plugged in — not just when idle
            <Cite id="nec-2023" in={SOURCES} />. The bubble-style "in-use cover" extends out from
            the wall enough to enclose both the receptacle and the head of the cord cap, so
            wind-driven rain doesn't find its way to the brass terminals. A flat flap cover only
            seals when the receptacle is empty and is no longer compliant for new outdoor
            installations.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What's a 'switched outlet' and how is it wired?">
          <p>
            A switched outlet is a duplex receptacle whose top half is controlled by a wall switch
            and whose bottom half stays always-on (or vice versa). The wiring is the standard duplex
            installation with one twist: the brass-side break-off tab between the two hot screws is
            snapped off with pliers. That isolates the two halves on their hot conductor, so one
            half can be fed from the switched leg and the other from the always-on leg. The
            silver-side tab is left intact — the neutrals stay common.
          </p>
        </FAQItem>

        <FAQItem q="Why are some duplex receptacles 'tamper-resistant' by code now?">
          <p>
            Since the 2008 NEC, all 15 A and 20 A 125 V receptacles in dwelling-unit locations must
            be{' '}
            <Term
              def={
                <>
                  <strong className="text-text font-medium">tamper-resistant (TR)</strong> — a
                  receptacle with internal shutters that block both slots until the shutters are
                  pushed simultaneously, i.e., until a real two-bladed plug is inserted. Required by
                  NEC 406.12 in dwelling-unit locations since 2008.
                </>
              }
            >
              tamper-resistant
        ...
        <FAQItem q="Can a three-way switch be used as a single-pole switch?">
          <p>
            Yes, by using only the common terminal and one of the two travellers and ignoring the
            other. The switch's internal SPDT then degenerates to an SPST: in one toggle position
            the common is connected to the wired traveller (load on), and in the other position it's
            connected to the unused traveller (load off, because the unused screw goes nowhere).
            Many electricians keep three-ways in stock as a single-pole substitute. The only catch
            is the "ON/OFF" indication is missing from the toggle, because a three-way doesn't have
            a preferred up/down orientation.
          </p>
        </FAQItem>

        <FAQItem q="Why do dimmers sometimes hum?">
          <p>
            Mechanical vibration in the load. A leading-edge phase-cut dimmer fires the triac
            partway through each half-cycle, applying a sudden voltage step to the load; the load's
            inductance (filament coiling, transformer laminations) resonates at 60 Hz and its
            harmonics, and the result is an audible buzz
            <Cite id="lutron-dimmer-app-note" in={SOURCES} />. Bulbs marked "rough-service" or
            "dimmer-compatible" have stiffer filament supports specifically to suppress the
            resonance. Magnetic low-voltage transformers (MLV) almost always hum on cheap dimmers;
            the cure is an MLV-rated dimmer that controls the inrush more gently.
          </p>
        </FAQItem>

        <FAQItem q="What's the difference between 'MLV' (magnetic low voltage) and 'ELV' (electronic low voltage) dimmers?">
          <p>
            They're both dimmers for low-voltage lighting (typically 12 V halogen or LED tape behind
            a transformer), but they assume different transformer types. MLV dimmers expect a
            magnetic (iron-core) step-down transformer, which is inductive and tolerates
            leading-edge phase-cut chopping. ELV dimmers expect an electronic (switched-mode)
            transformer, which is capacitive and prefers trailing-edge chopping that turns on at
            zero-current and off mid-cycle
            <Cite id="lutron-dimmer-app-note" in={SOURCES} />. Using the wrong type usually doesn't
            cause an immediate failure but produces buzzing, flicker, or a shortened transformer
            life.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Can I put a GFCI receptacle on a circuit that's already protected by a GFCI breaker?">
          <p>
            You can, but it's redundant and a maintenance headache. Both devices trip on the same
            fault signal (5 mA imbalance between hot and neutral) but cannot communicate with each
            other; either one can trip first, and once one has tripped the other appears as "still
            working," which makes diagnosis harder. NEC 210.8 only requires a single layer of GFCI
            protection on the circuits it lists
            <Cite id="nec-2023" in={SOURCES} />, so installing both is over-design rather than a
            code violation.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why is the ground hole on the bottom of some receptacles and on top of others?">
          <p>
            The NEC is silent on orientation, and both are equally compliant
            <Cite id="nec-2023" in={SOURCES} />. "Ground-up" is preferred by many commercial
            electricians on the argument that a partially-inserted plug, if something metal drops
            past it, will hit the ground blade first instead of the hot. "Ground-down" is the
            traditional residential convention because the resulting outline vaguely resembles a
            face. The plug fits either way, so the choice is aesthetic rather than electrical.
          </p>
        </FAQItem>

        <FAQItem q="What's 'downstream protection' from a GFCI receptacle and why does it work?">
          <p>
            A GFCI receptacle has two pairs of terminals: LINE (feeding the GFCI itself) and LOAD
            (feeding everything wired downstream). Anything connected to the LOAD pair receives
            ground-fault protection from the same internal sensor that protects the GFCI's own face,
            because all of it shares one current-balance transformer inside the device
            <Cite id="nec-2023" in={SOURCES} />. That lets one GFCI at the head of a string protect
            three or four ordinary receptacles further along — a common bathroom or kitchen-counter
            wiring trick.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why does my 3-way switch sometimes work as expected and sometimes seem 'backwards' after re-wiring?">
          <p>
            Because the wiring is correct but one switch's toggle is mounted upside down. Three-ways
            do not have a preferred up = on / down = off orientation — they have two
            indistinguishable states and a XOR connecting them — so after a re-wire the toggle's
            "up" position may correspond to either traveller. The lamp toggles correctly with every
            flip; the visual labelling just lies about which physical position is "on." Flip the
        ...
        <FAQItem q="Does a switched-off light fixture still have live wires in the box?">
          <p>
            Yes — the neutral side. A single-pole or three-way switch only interrupts the hot,
