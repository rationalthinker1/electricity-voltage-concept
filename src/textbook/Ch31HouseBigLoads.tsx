  ...
  return (
    <ChapterShell chapter={chapter}>
      ...
      <p>
        ...
        are 180° out of phase, so the voltage <em>between</em> them is twice the voltage of either one to
      ...
      <p>
        where <strong>P</strong> is the real power delivered to a resistive load (in watts), <strong>V</strong>{' '}
        is the RMS supply voltage at the appliance terminals (in volts), and <strong>I</strong> is the RMS
      ...
      <p>
        with all three symbols defined as above. A <strong>5 000 W</strong> resistive dryer on 120 V draws
      ...
      <p>
        where <strong>P_loss</strong> is the resistive heat dissipated along the round-trip length of the
        branch wire (in watts), <strong>I</strong> is the current through the wire (in amperes), and{' '}
        <strong>R_wire</strong> is the total round-trip resistance of the conductor (in ohms; for residential
      ...
      <TryIt
        ...
        question={
          <>
            A <strong>1 500 W</strong> kettle heating element is wired once at 120 V and again, by switching its
            internal jumper, at 240 V. The supply wire from the panel to the kettle is the same in both cases:
            <strong> 20 m</strong> of copper with a round-trip resistance of <strong>0.40 Ω</strong>. Compute
        ...
        answer={
          <>
            ...
            <Formula>P_loss = (12.5)² × 0.40 = <strong>62.5 W</strong></Formula>
            <p>On 240 V:</p>
            <Formula>I = 1500 / 240 = 6.25 A</Formula>
            <Formula>P_loss = (6.25)² × 0.40 = <strong>15.6 W</strong></Formula>
            <p>
      ...
      <h2>L1 and L2 — same source, opposite phase</h2>
      ...
      <p>
        ...
        a 60 Hz sinusoid with peak ~170 V; the instantaneous voltage at L2 is the same sinusoid <em>negated</em>
      ...
      <p>
        ...
        <strong>√3 ≈ 1.732</strong> times the line-to-neutral voltage — about 208 V across each pair of hots,
      ...
      <h2>Pure 240 V loads (no neutral)</h2>
      ...
      <p>
        ...
        the trade calls <em>12-2 with ground</em> or <em>10-2 with ground</em> Romex<Cite id="nec-2023" in={SOURCES} />.
      ...
      <h2>120/240 V split loads (with neutral)</h2>
      ...
      <p>
        ...
        <Term def={<><strong>four-wire</strong> 120/240 V branch — a circuit with two ungrounded conductors (L1 and L2), a grounded neutral, and an equipment-grounding conductor. Allows the appliance to draw 240 V between L1 and L2 for its heating element and 120 V between either hot and neutral for control electronics or small motors. Mandatory since NEC 1996 for new dryer and range installations.</>}>four-wire</Term>{' '}
      ...
      <p>
        ...
        <Term def={<><strong>NEMA 14-50</strong> — the standard four-prong 50 A 120/240 V range receptacle. Same prong layout as the 14-30 but rated for 50 A on 6 AWG copper. Also the dominant receptacle for residential level-2 EV charging when the EVSE is plug-in rather than hardwired.</>}>NEMA 14-50</Term>{' '}
      ...
      <TryIt
        ...
        question={
          <>
            A modern dryer's 4-wire <strong>NEMA 14-30</strong> receptacle is wired with L1, L2, neutral, and
            ground. The drum-tumble motor draws <strong>6 A</strong> at 120 V from L1 to neutral; the heating
            element draws <strong>22 A</strong> at 240 V between L1 and L2. Compute the current flowing in
        ...
        answer={
          <>
            <p>The element current flows out L1 and back through L2 (or vice versa each half-cycle); the motor
            current flows out L1 and back through neutral. Sum on each conductor:</p>
            <Formula>I_L1 = I_motor + I_element = 6 + 22 = <strong>28 A</strong></Formula>
            <Formula>I_L2 = I_element = <strong>22 A</strong></Formula>
            <Formula>I_neutral = I_motor = <strong>6 A</strong></Formula>
            <Formula>I_ground = <strong>0 A</strong></Formula>
            <p>
      ...
      <p>
        ...
        <strong> 5 kW</strong> of electrical input under nominal operating conditions, drawing about 21 A
      ...
      <p>
        where <strong>FLA</strong> is the{' '}
        <Term def={<><strong>full-load amperage</strong> (FLA) — the steady-state current a motor draws under its rated mechanical load. Stamped on the equipment nameplate. The current the wire and the running thermal-protection device are sized against.</>}>full-load amperage</Term>{' '}
        of the motor (in amperes), <strong>P_rated</strong> is the electrical input power at the rated
        operating point (in watts), and <strong>V_supply</strong> is the supply voltage (in volts; 240 V for
        ...
        FLA ≈ 5 000 / 240 ≈ <strong>21 A</strong><Cite id="grainger-power-systems-2003" in={SOURCES} />.
      </p>
      <p>
      ...
      <p>
        ...
        sealed compressor to be sized up to <strong>175 % to 225 %</strong> of the motor's FLA when it is
        listed as an{' '}
        <Term def={<><strong>HACR breaker</strong> — Heating-Air-Conditioning-Refrigeration; a UL 489 breaker specifically listed for use with HVAC compressors. Its time-current curve is shaped to tolerate the brief locked-rotor inrush of an induction motor without tripping while still protecting the wire against sustained overload. Required by NEC Article 440 for HVAC branch circuits.</>}>HACR-rated</Term>{' '}
      ...
      <TryIt
        ...
        question={
          <>
            A 3-tonne residential heat pump is rated at <strong>5 kW</strong> running, on a 240 V split-phase
            service. The nameplate lists <strong>LRA = 95 A</strong>. What size breaker should it use, and
        ...
        answer={
          <>
            <p>Full-load amperage from the nameplate:</p>
            ...
            <p>
              Round down to the next stock size: a <strong>40 A</strong> HACR-rated 2-pole breaker on 8 AWG
      ...
      <h2>EV charging — level 1, level 2, level 3</h2>
      ...
      <p>
        ...
        copper feeding a 32 A continuous EVSE, giving <strong>7.7 kW</strong> of charging power and adding
        roughly <strong>30 km of range per hour</strong>. The high end of residential is a 60 A breaker on
      ...
      <p>
        ...
        <Term def={<><strong>UL 2231</strong> — the Underwriters Laboratories safety standard for personnel-protection systems in electric-vehicle charging circuits. Requires the EVSE itself to incorporate a charge-circuit-interrupting device (CCID) that detects ground faults of 20 mA or more within 100 ms, in addition to any upstream GFCI breaker.</>}>UL 2231</Term>{' '}
        for the EV-side charge-circuit interrupting device (CCID)<Cite id="ul-2231" in={SOURCES} />. The CCID
        senses the EVSE's own residual current and trips internally at <strong>20 mA in 100 ms</strong>, which
      ...
      <p>
        where <strong>P_charge</strong> is the DC power delivered to the battery pack (in watts),{' '}
        <strong>V</strong> is the AC supply voltage at the EVSE terminals (in volts; 240 V on level 2),{' '}
        <strong>I</strong> is the RMS AC current the EVSE delivers (in amperes; up to 48 A continuous on a
        residential 60 A branch), and <strong>η</strong> is the efficiency of the car's onboard AC-to-DC
        charger (typically <strong>~0.90 to 0.92</strong> for a residential AC/DC charger; the difference is
        lost as heat in the charger's MOSFETs, transformer, and rectifier diodes)<Cite id="sae-j1772" in={SOURCES} />.
        For a 240 V × 48 A × 0.92 install, P_charge ≈ <strong>10.6 kW</strong> ending up in the battery —
      ...
      <TryIt
        ...
        question={
          <>
            A level-2 EVSE delivers <strong>11.5 kW</strong> of AC power to a car on a 240 V circuit. If the
            car's onboard charger is <strong>92 % efficient</strong>, what AC current does the EVSE supply,
        ...
        answer={
          <>
            <p>The AC current the EVSE delivers comes directly from the AC supply power:</p>
            <Formula>I = P_AC / V = 11 500 / 240 ≈ <strong>48 A</strong></Formula>
            <p>That is the continuous current on a 60 A branch circuit (the 80 % continuous-load rule of
            Ch.29). DC power into the battery:</p>
            <Formula>P_charge = V × I × η = 240 × 48 × 0.92 ≈ <strong>10.6 kW</strong></Formula>
            <p>
              Roughly <strong>0.9 kW</strong> is lost as heat inside the car's onboard AC/DC charger over the
      ...
      <h2>Demand-load calculations and panel sizing</h2>
      ...
      <p>
        ...
        commonly used: sum the dwelling's general lighting and receptacle load at <strong>3 VA per square
        foot</strong>, add small-appliance and laundry branches at <strong>1 500 VA each</strong>, add the
        nameplate of every fixed appliance, and apply a flat demand factor of <strong>100 %</strong> on the
        first 8 kVA and <strong>40 %</strong> on the remainder when no additional heating or cooling load is
      ...
      <TryIt
        ...
        question={
          <>
            A 200 A panel at 240 V has an existing demand-load calculation showing <strong>130 A</strong> peak
            (typical for a fully-equipped house with a heat pump). The homeowner wants to add a 40 A circuit
            for a level-2 EV charger that draws <strong>32 A continuous</strong> while charging. Does the
        ...
        answer={
          <>
            <p>NEC 625.42 treats the EV charger as a continuous load, sized at 125 % of nameplate
            continuous:</p>
            <Formula>I_EVSE = 1.25 × 32 = <strong>40 A</strong></Formula>
            <p>Adding to the existing demand:</p>
            <Formula>I_total = 130 + 40 = <strong>170 A</strong></Formula>
            <p>
      ...
      >
        ...
        <FAQItem q="Can I run a 240 V circuit using two separate 14-2 cables, one for each hot, with a shared neutral?">
          <p>
            ...
            <em>opposite phases</em> (L1 and L2) and that they be handle-tied so they trip together. The
        ...
        <FAQItem q="What's a multi-wire branch circuit, and why is it dangerous to share a neutral across two unrelated 120 V circuits?">
          <p>
            A{' '}
            <Term def={<><strong>multi-wire branch circuit</strong> — NEC 210.4 terminology for a circuit that uses one shared neutral between two ungrounded conductors of opposite phase. Reduces conductor count and neutral current, but the two breakers must be handle-tied so a maintenance worker cannot leave one hot energised while servicing the other.</>}>multi-wire branch circuit</Term>{' '}
        ...
        <FAQItem q="How does a heat-pump dryer get away with a 120 V outlet when a resistive dryer needs 240 V?">
          <p>
            A{' '}
            <Term def={<><strong>heat-pump dryer</strong> — a clothes dryer that uses a closed-loop refrigerant cycle (compressor, condenser, evaporator) to remove humidity from the drum air rather than discarding heated humid air through a vent. Total electrical input is roughly 1 kW versus 5 kW for a resistive dryer; many models run on a standard 120 V receptacle.</>}>heat-pump dryer</Term>{' '}
