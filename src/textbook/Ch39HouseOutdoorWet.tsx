  ...
  return (
    <ChapterShell chapter={chapter}>
      <p>
        ...
        rod. They are not connected to earth at all in the literal sense. They are connected to <em>each other</em>,
      ...
      <h2>WR and TR receptacles, and the in-use cover</h2>
      ...
      <p>
        ...
        listed device with two extra letters stamped on the face: <em>WR</em> and <em>TR</em>.
      </p>
      <p>
        A
        {' '}<Term def={<><strong>WR receptacle</strong> — a weather-resistant receptacle whose body plastic, face plastic, and brass contacts are formulated and finished to resist UV, temperature cycling, and corrosion. Required by NEC 406.9 for all damp- and wet-location receptacles installed outdoors.</>}>WR receptacle</Term>{' '}
        ...
        {' '}<Term def={<><strong>TR receptacle</strong> — a tamper-resistant receptacle with internal shutters that block single-prong insertion. Required by NEC 406.12 in dwelling-unit receptacles; the shutters open only when both prongs of a plug push simultaneously.</>}>TR receptacle</Term>{' '}
        ...
        damp or wet locations to carry both labels; the same article requires that <em>every</em> 15 A and 20 A,
      ...
      <p>
        ...
        <em> whether or not the attachment plug cap is inserted</em>, which in practice means the bell-shaped or
      ...
      <TryIt
        ...
        question={
          <>
            ...
            <strong>250 kΩ</strong>. What is the leakage current, and will the upstream GFCI trip?
          </>
        }
        hint={<>Apply I = V/R from Ch.32, then compare to the 5 mA GFCI threshold.</>}
        answer={
          <>
            <p>Ohm's law across the wet surface track:</p>
            ...
            <p>
              ...
              track from forming in the first place. Answer: <strong>0.48 mA</strong>, <strong>no trip</strong>;
      ...
      <h2>The 1.5 m equipotential bonding grid</h2>
      ...
      <p>
        ...
        {' '}<em>every</em> conductive surface inside that volume be bonded together with a continuous No. 8 AWG
      ...
      <p>
        ...
        {' '}<Term def={<><strong>step potential</strong> — the voltage difference between two contact points on a body (most commonly between two feet on energised soil, or between a hand on one bonded surface and a foot on another). The hazard a bonded grid eliminates is the touch-and-step potential between a swimmer's hand on a fitting and a foot on the bottom or on the deck.</>}>step (or touch) potential</Term>{' '}
      ...
      <p>
        ...
        {' '}<Term def={<><strong>step potential (soil)</strong> — the voltage drop across the metre of damp earth between a person's two feet when fault current spreads radially from a grounding electrode. Different from the touch potential inside a bonded pool grid, but the same physics.</>}>step-potential</Term>{' '}
      ...
      <p>
        where <strong>V<sub>step</sub></strong> is the voltage difference across the gait between the two feet
        (in volts), <strong>E</strong> is the local potential gradient in the soil surface around the fault (in
        volts per metre), and <strong>Δd<sub>step</sub></strong> is the distance between the two feet (in metres;
      ...
      <p>
        Two construction details worth noting. The bond is #8 <em>solid</em> copper, not stranded — solid wire
        ...
        is <em>not</em> the same as a grounding conductor: it does not need to return to the service-panel
      ...
      <TryIt
        ...
        question={
          <>
            A faulted pool light energises the pool water at <strong>+20 V</strong> relative to local soil. The
            ...
            slab's rebar mat via its mounting bolts and sits at roughly <strong>+2 V</strong>. A swimmer's
            hand-on-ladder and foot-on-the-bottom-step bridges the gap. Wet hand-to-foot body resistance is{' '}
            <strong>2 kΩ</strong>. Compute the current and identify the IEC 60479-1 zone at one second of exposure.
          </>
        }
        hint={<>Use the I_body formula above; check Ch.32's zone ladder.</>}
        answer={
          <>
            <p>Voltage across the swimmer is the difference between the two surface potentials:</p>
            ...
            <p>
              ...
              intact, ΔV would have been zero and I would have been zero. Answer: <strong>9 mA</strong>,{' '}
              <strong>zone AC-2</strong>. The corroded split-bolt converted a code-compliant installation into
      ...
      <h2>Low-voltage landscape lighting</h2>
      ...
      <h2>Hot tubs and spas: NEC 680 Part IV</h2>
      ...
      <p>
        ...
        {' '}<em>hardwired</em>, not cord-and-plug-connected, with the wiring entering the tub's equipment
      ...
      <TryIt
        ...
        question={
          <>
            A residential hot tub draws <strong>35 A continuous</strong> at 240 V. Size the branch-circuit breaker
        ...
        answer={
          <>
            <p>Apply the continuous-load multiplier:</p>
            <Formula>I_breaker_min = 1.25 × 35 = 43.75 A</Formula>
            <p>
              Round up to the next standard size, which is <strong>50 A</strong>. The conductor must have
              ampacity at least 43.75 A at the 75°C termination; per NEC Table 310.16, <strong>8 AWG copper
              </strong> at 75°C is rated 50 A and satisfies both the breaker and the 125% rule<Cite id="nec-2023" in={SOURCES} />.
              Tubs with integrated 120 V control electronics need <strong>four-wire</strong> (L1, L2, neutral,
      ...
      <h2>EV chargers: Level 2 in detail</h2>
      ...
      <p>
        ...
        {' '}<Term def={<><strong>control pilot</strong> — the 1 kHz square-wave signal on the J1772 connector's pilot pin, modulated by the EVSE's duty cycle to advertise the maximum current the supply can deliver. SAE J1772 specifies the encoding: 6% = 6 A, 50% = 30 A, with two breakpoints; the vehicle reads the duty cycle and limits its onboard charger accordingly.</>}>control pilot</Term>{' '}
      ...
      <p>
        where <strong>P<sub>charge</sub></strong> is the AC power delivered to the vehicle's onboard charger (in
        watts), <strong>V</strong> is the line-to-line supply voltage at the EVSE (in volts, nominally 240 V on
        a North-American split-phase service), <strong>I</strong> is the RMS current the EVSE has authorised the
        vehicle to draw via the control-pilot duty cycle (in amperes), and <strong>η</strong> is the
        {' '}<Term def={<><strong>EVSE efficiency</strong> — the ratio of AC power delivered to the vehicle's onboard charger to AC power drawn from the panel. For a Level 2 EVSE this is dominated by I²R loss in the contactor and the cable, plus a small overhead for the control electronics; values run from 0.92 to 0.97 depending on model and cable length.</>}>EVSE efficiency</Term>{' '}
      ...
      <p>
        ...
        {' '}<Term def={<><strong>hardwired EVSE</strong> — an EVSE permanently connected to the branch circuit by direct conduit-and-conductor termination on its internal terminal block. Cleaner, more reliable, supports higher continuous currents (up to 80 A in some models) without the heat dissipation of a plug-and-receptacle, but not portable.</>}>hardwired EVSE</Term>,
      ...
      <p>
        ...
        {' '}<Term def={<><strong>UL 2231</strong> — the U.S. listing standard for personnel protection systems on EV charging equipment. Mandates an integrated ground-fault detector inside the EVSE that trips at roughly 20 mA on the AC side (looser than the 5 mA residential GFCI because the EVSE's vehicle-side circuit is permanently bonded and self-monitoring), with a clearing time on the order of 100 ms. Coexists with, and does not replace, an upstream 5 mA GFCI if one is required.</>}>UL 2231</Term>.
      ...
      <TryIt
        ...
        question={
          <>
            A new Level 2 EVSE is rated <strong>40 A continuous</strong> and terminates in a NEMA 14-50 cord cap.
        ...
        answer={
          <>
            <p>
              The 40 A rating is the breaker the unit's <em>own</em> NEMA 14-50 input circuit is sized for, by
              the same 125% rule:
            </p>
            ...
            <p>
              ...
              nameplate. Answer: <strong>50 A breaker, 6 AWG copper</strong> for a true 40 A draw EVSE; some
      ...
      <TryIt
        ...
        question={
          <>
            An outdoor receptacle is mounted on the back of a house, <strong>14 ft</strong> horizontally from the
        ...
        answer={
          <>
            <p>
              ...
              that NEC 680.22(A)(1) also <em>requires</em> at least one receptacle on the property between 6 ft
              and 20 ft of the pool — the convenience-receptacle rule — and it must itself be GFCI-protected.
              Answer: <strong>yes</strong> to GFCI, <strong>yes</strong> to in-use cover, <strong>14 ft is
      ...
      <h2>The 200-to-225 A service upgrade</h2>
      ...
      >
        ...
        >
          ...
          <p>
            ...
            (which is itself bonded to the rest of the perimeter grid <em>except</em> for the omitted ladder
      ...
      <FAQ intro="Questions readers ask after the wet-location and EVSE sections.">
        ...
        <FAQItem q="Why does NEC 2023 change garage receptacle GFCI rules?">
          <p>
            ...
            judged less acute than the false-trip nuisance. NEC 2023 removed most of those exceptions: <em>all
