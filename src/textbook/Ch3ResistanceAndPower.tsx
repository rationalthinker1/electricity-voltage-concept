  ...
  return (
    <ChapterShell chapter={chapter}>
      <p className="chapter-intro">
        ...
        back. The glass is hot. The filament inside is closer to <M tex="2800\ \text{K}" />
        ...
        <Term
          def={
            <>
              ...
              between voltage drop and current in a conductor, <M id="ohms-law" />. SI unit: ohm (Ω
              = V/A). Encodes both geometry and material.
            </>
          }
        >
        ...
        <Term
          def={
            <>
              ...
              transferred or converted, <M tex="P = dE/dt" />. SI unit: watt (W = J/s). For a
              resistor, <M tex="P = VI = I^2 R = V^2/R" />.
            </>
          }
        >
        ...
        <Term
          def={
            <>
              ...
              relation between current and voltage in an ordinary conductor: <M id="ohms-law" />{' '}
              (macroscopic) or <M tex="\vec{J} = \sigma\vec{E}" /> (microscopic). Holds for metals
              at ordinary fields; fails for diodes, plasmas, etc.
            </>
          }
        >
          Ohm's law
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              ...
              <M tex="\vec{J} = \sigma\vec{E}" />. SI unit: S/m. Reciprocal of resistivity ρ. Copper
              ≈ 5.96×10⁷ S/m.
            </>
          }
        >
        ...
        explanation
        <Cite id="drude-1900" in={SOURCES} />: an electron accelerates under <M tex="E" /> for an
        average time <M tex="\tau" /> between collisions with ions in the lattice, picks up a small
        drift velocity, then scatters and starts over. Average it out and you get a steady drift
        proportional to <M tex="\vec{E}" /> — friction with a clean linear law. Modern solid-state
        physics rewrote the inputs in quantum terms, but the linear relation between field and
        current density survives intact for ordinary metals at ordinary fields
      ...
      <p className="mb-prose-3">
        ...
        The cyan electrons drift opposite to the field — that's the sign convention catching us out,
        because conventional current points with <M tex="\vec{E}" />. And the teal rings around the
        wire are the magnetic field <M tex="\vec{B}" /> that any current carries with it,
        perpendicular to the axis and curling by the right-hand rule. Swap nichrome for copper and
        the same <M tex="\vec{E}" /> produces ~65× more <M tex="\vec{J}" /> — same equation,
        different conductor.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        it is Ohm's law <M tex="V = IR" /> — voltage drop end-to-end equals current times
        resistance, with <M tex="V" /> in volts and <M tex="I" /> in amperes.{' '}
      ...
      <p className="mb-prose-3">
        ...
        the source sits at a fixed 20 V and you choose the resistance — current falls along the
        hyperbola <M tex="I = V/R" />. Same law, two intuitions: voltage drives the current upward,
      ...
      <p className="mb-prose-3">
        ...
        value at one terminal to zero at the other. Drag a probe along the wire and the reading
        walks down that linear ramp.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        which is just <M tex="J" /> integrated over the cross-section — is{' '}
        ...
        <Term
          def={
            <>
              ...
              <M id="resistance-resistivity" />. SI unit: Ω·m. Reciprocal of conductivity. Copper ≈
              1.7×10⁻⁸ Ω·m.
            </>
          }
        >
      ...
      <p className="mb-prose-3">
        ...
        <M tex="3.77\times 10^{7}\ \text{S/m}" />, only ~63% of copper's
      ...
      <p className="mb-prose-3">
        ...
        second is joules per second <Cite id="griffiths-2017" in={SOURCES} />. This identity makes
        no assumption about what the element is — battery, resistor, motor, capacitor, antenna.
        Whenever charge moves through a potential difference, energy is transferred at the rate{' '}
        <M tex="VI" />. The rest of this section is about <em>where that energy goes</em> in the
      ...
      <p className="mb-prose-3">
        ...
        the electron's drift component is randomized by interaction with a lattice ion, and that
        gained kinetic energy is dumped into the lattice as a vibrational mode. The lattice warms.
        The electron starts over
        ...
        <Term
          def={
            <>
              ...
              temperature. For copper, <M tex="v_F \approx 1.6\times 10^{6}\ \text{m/s}" />
              — about 0.5% of <M tex="c" />.
            </>
          }
        >
          Fermi speeds
        </Term>{' '}
        of order <M tex="10^{6}\ \text{m/s}" /> — every direction, mostly cancelling — while the
        average <em className="text-text italic">drift</em> toward +x is of order{' '}
        <M tex="10^{-4}\ \text{m/s}" /> at a few amps. The ratio <M tex="v_F/v_d" /> is around{' '}
        <M tex="10^{10}" />: a hurricane of quantum-degenerate motion with the faintest steady
        breeze threaded through it. Yet that breeze is the entire macroscopic current, and the
        energy each electron loses to the lattice on every collision is the entire macroscopic heat
        <Cite id="ashcroft-mermin-1976" in={SOURCES} />.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        rate of work done by the field on the drifting charges. Always positive in a resistor ({' '}
        <M tex="\vec{J}" /> and <M tex="\vec{E}" /> point the same way). Integrate over the wire's
        volume <M tex="LA" />, with <M tex="E = V/L" />
      ...
      <p className="mb-prose-3">
        ...
        <M tex="\sigma" /> are the geometric and material quantities from above. The four
        expressions are algebraically identical once <M tex="V = IR" /> is substituted. James Joule
        established this experimentally in 1841 with a calorimeter that became the namesake of the
        SI unit of energy
        ...
        <Term
          def={
            <>
              ...
              <M id="power-i2r" />. The dissipated power equals the work the field does on charges,
              which scatter into lattice vibrations.
            </>
          }
        >
          Joule heating
        ...
        <Term
          def={
            <>
              ...
              <M tex="1\,\text{W} = 1\,\text{J/s}" />. Named after James Watt; <M id="power-vi" />{' '}
              in watts when <M tex="V" /> is in volts and <M tex="I" /> in amperes.
            </>
          }
        >
          watt
      ...
      <p className="mb-prose-3">
        ...
        radiates power proportional to <M tex="T^{4}" />, so a wire dissipating <M tex="P" /> watts
        over surface area <M tex="A_{\text{surf}}" /> with emissivity <M tex="\varepsilon" /> sits
        at the temperature that solves{' '}
        <M tex="P = \varepsilon\sigma_{\text{SB}} A_{\text{surf}} T^4" />. Tungsten's hostile
        combination of low conductivity and very high melting point lets a thin filament reach
        incandescent T without melting; nichrome's lower σ and high oxidation resistance let a
      ...
      <TryIt
        ...
        hint={
          <>
            Use <M tex="I = V/R" />, then <M tex="P = VI" /> (or <M tex="P = V^2/R" />
            ).
          </>
        }
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              Ohm's law gives the current; the power follows from <M tex="P = VI" />
              <Cite id="griffiths-2017" in={SOURCES} />:
            </p>
      ...
      <TryIt
        ...
        question={
          <>
            ...
            <M tex="c_{\text{water}} = 4186\ \text{J/(kg·K)}" />
            .)
          </>
        }
        hint={
          <>
            Energy in = energy out: <M tex="P\cdot t = mc\Delta T" />. 0.5 L of water has mass 0.5
            kg.
          </>
        }
        answer={
        ...
        <Term
          def={
            <>
              ...
              (reciprocal resistances): <M tex="1/R = 1/R_1 + 1/R_2 + \ldots" />
            </>
          }
        >
          <strong className="text-text font-medium">parallel</strong>
        </Term>{' '}
        — two branches at the same voltage <M tex="V" /> — and the currents add:{' '}
      ...
      <p className="mb-prose-3">
        ...
        = 1/Ω) are what add. Two equal resistors in parallel give half their value; in general, the
        parallel combination is always less than either branch on its own
        <Cite id="griffiths-2017" in={SOURCES} />.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        wire of length <M tex="L" /> into <M tex="n" /> equal segments; each segment has resistance{' '}
        <M tex="\rho(L/n)/A" />, and adding <M tex="n" /> of them in series recovers{' '}
        <M tex="\rho L/A" /> — the original formula.{' '}
        <em className="text-text italic">A fat wire is many thin wires in parallel.</em> Slice a
        wire of cross-section <M tex="A" /> into <M tex="n" /> filaments of cross-section{' '}
        <M tex="A/n" />; each filament has resistance <M tex="\rho L/(A/n) = n\rho L/A" />, and
        combining <M tex="n" /> of them in parallel gives <M tex="\rho L/A" /> again. "Long =
      ...
      <p className="mb-prose-3">
        ...
        <M tex="1.7\times 10^{-8}\ \Omega\cdot\text{m}" /> up through tungsten and nichrome and out
        into the insulators. Power dissipated in a resistor is the rate at which the field does work
      ...
      <CaseStudies
        intro={
          <>
            ...
            The same <M tex="P = I^2 R" /> equation gets exploited at radically different design
            points — once to make heat the product, once to suppress it as waste, and once to push
      ...
      >
        ...
        >
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            switched on. At room temperature, <M tex="R" /> is roughly a tenth of its operating
            value, so the inrush current is roughly ten times the steady-state operating current
            until the filament heats up
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            radiation goes as <M tex="T^4" />, but the fraction of that radiation falling in the
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            per-meter <M tex="I^2 R" /> dissipation in any realistic conductor is catastrophic. Push
            the same gigawatt at 500 kV and the current drops to{' '}
            <strong className="text-text font-medium">2 kA</strong>; the loss along the same
            conductor drops by a factor of <M tex="(500/11)^2 \approx 2000" />
            <Cite id="grainger-power-systems-2003" in={SOURCES} />. That quadratic in <M tex="V" />{' '}
            is the single biggest reason the grid exists in its current form.
          </p>
          <p className="mb-prose-2 last:mb-0">
            ...
            conductivity is only about <M tex="3.77\times 10^{7}\ \text{S/m}" /> — roughly 63% of
            copper's
            ...
            <M tex="R" /> still comes out lighter and cheaper. Inside your walls, where copper's
            mechanical and termination properties win, the calculus flips back
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            so that the line current at each stage is sane against the local <M tex="R" />.
          </p>
        </CaseStudy>
        ...
        <CaseStudy
          ...
          specs={[
            ...
            },
            {
              ...
              value: (
                <>
                  0, because <M tex="I^2 R = 0" /> <Cite id="joule-1841" in={SOURCES} />
                </>
              ),
            },
          ]}
        >
          ...
          <p className="mb-prose-2 last:mb-0">
            For a transmission cable the consequence is direct: <M tex="I^2 R" /> drops to literally
            zero in the cable itself. There is no in-conductor heat dissipation, no temperature
            rise, no current-limited derating. The catch is the cryogenic plant required to keep the
            conductor below its critical temperature — and the much subtler caveat that
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            <M tex="P = I^2 R" /> assumes an ordinary metallic conductor with a finite ρ. Strip the
            ρ and the entire dissipation argument vanishes — exactly as the formula promises. The
            fact that we use copper instead is a thermodynamic cost calculation, not a physical
            necessity.
          </p>
        </CaseStudy>
      </CaseStudies>
      ...
      <FAQ
        intro={
          <>
            Resistance is a one-line formula, <M id="resistance-resistivity" />, but it touches
            every wire in a building, every kettle, every transmission line, and every short-circuit
            fire. These are the questions that come up once the equation starts meeting reality.
          </>
        }
      >
        <FAQItem q="Why does a thinner wire have higher resistance, even though it's the same material?">
          <p>
            Resistance is <M id="resistance-resistivity" />: halve the cross-section <M tex="A" />{' '}
            and you double <M tex="R" />
            ...
            carrying its share of <M tex="I" />, the current density <M tex="J = I/A" /> climbs, and
            the field <M tex="E = J/\sigma" />
        ...
        <FAQItem q="Why does a longer wire have more resistance? Geometrically — what's actually doubling?">
          <p>
            ...
            wire the field is <M tex="E = V/L" /> and the same charge has to traverse the whole
            length, so doubling <M tex="L" /> doubles the integrated drop for a fixed <M tex="E" />
            <Cite id="griffiths-2017" in={SOURCES} />. Equivalently, a long wire is many short wires
            in series: each segment dissipates its share of <M tex="I^2 R" />, and the segments add.
            The formula <M id="resistance-resistivity" /> encodes both views at once.
          </p>
        </FAQItem>

        <FAQItem q="Why does copper's resistance go UP with temperature, while a semiconductor's goes DOWN?">
          <p>
            In a metal, the carrier density <M tex="n" /> is essentially fixed — every copper atom
            ...
            the band gap, and that swamps the increased scattering.{' '}
            <em className="text-text italic">Same equation</em> <M tex="\sigma = nq^2\tau/m" />,
            opposite slopes — because in metals only <M tex="\tau" /> moves and in semiconductors{' '}
            <M tex="n" /> dominates.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What is a superconductor, and why doesn't it heat up when current flows?">
          <p>
            ...
            <M tex="\tau \to \infty" />, so <M tex="\sigma \to \infty" /> and <M tex="R \to 0" />.
            No <M tex="I^2 R" /> means no heat dissipated — the dissipation isn't being hidden, it's
        ...
        <FAQItem q="Why does a kettle use a thick element, while a hair-dryer or toaster uses a thin coil?">
          <p>
            ...
            hundred kelvin and can be a moderately thick metal sheath — modest <M tex="R" />, big{' '}
            <M tex="I" />, lots of surface area in contact with water. A toaster needs to{' '}
            ...
            <M tex="P = \varepsilon\sigma_{\text{SB}} A_{\text{surf}} T^4" /> balances{' '}
            <M tex="I^2 R" />. To get there in open air, you go thin and use{' '}
        ...
        <FAQItem q="If silver is the best conductor, why is house wiring made of copper?">
          <p>
            ...
            conductivity — <M tex="\sigma_{\text{Ag}} \approx 6.30\times 10^{7}\ \text{S/m}" /> vs.{' '}
            <M tex="\sigma_{\text{Cu}} \approx 5.96\times 10^{7}\ \text{S/m}" />
            <Cite id="crc-resistivity" in={SOURCES} />. But silver is roughly an order of magnitude
            more expensive per kilogram, and you'd save only a few percent of <M tex="R" />
        ...
        <FAQItem q="Aluminum was banned for new house wiring in the 1970s — why?">
          <p>
            ...
            grows, contact resistance climbs, and <M tex="I^2 R" /> at the joint heats it further in
            a runaway. Modern aluminum service entrances use larger gauges, antioxidant paste, and
            AL-rated devices to avoid the failure mode.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why does a long extension cord get warm, but a short one doesn't?">
          <p>
            ...
            resistance. Power dissipated as heat is <M id="power-i2r" />, so the long cord dumps ten
            times as many watts into its own copper
        ...
        <FAQItem q="Why is high-voltage transmission so much more efficient than low-voltage?">
          <p>
            For a fixed amount of delivered power <M tex="P" />, the line current is{' '}
            <M tex="I = P/V" />, and the line losses are{' '}
            <M tex="P_{\text{loss}} = I^2 R = (P/V)^2 R" />
            ...
            the <M tex="I^2 R" /> curve does.
          </p>
        </FAQItem>

        <FAQItem q="If P = I²R, why doesn't a 5 V phone charger melt a thin USB cable?">
          <p>
            Because <M tex="I" /> is small. A 5 V × 2 A charger delivers 10 W; through a typical
            USB-A cable of ~0.2 Ω round-trip the dissipated power is{' '}
            <M tex="I^2 R = 4 \times 0.2 = 0.8\ \text{W}" /> spread over a meter of cable — easily
            shed by convection
            <Cite id="griffiths-2017" in={SOURCES} />. The cable does get faintly warm and you lose
            a tenth of a volt to <M tex="IR" /> drop. Try it with USB-PD at 100 W / 5 A and a
            too-thin wire and you genuinely can melt the insulation; this is why high-current USB-C
            cables include an
        ...
        <FAQItem q='What is "voltage drop"? Does some voltage actually get lost?'>
          <p>
            ...
            When current <M tex="I" /> passes through a wire of resistance <M tex="R" />, the
            potential at the far end is lower than at the near end by <M tex="IR" /> — that's the
            &quot;drop&quot;
            <Cite id="griffiths-2017" in={SOURCES} />. The missing potential energy didn't vanish;
            it was converted into heat at the rate <M tex="I^2 R" /> as electrons scattered against
            the lattice. A long thin extension cord shows this dramatically: plug a vacuum cleaner
            into a 30 m 16-gauge cord and its motor sees noticeably fewer volts than the outlet
            provides, with the difference radiating from the cord as warmth.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Would a wire have any resistance at all if it were perfectly pure?">
          <p>
            ...
            <Term
              def={
                <>
                  ...
                  <M tex="\rho = \rho_{\text{impurity}} + \rho_{\text{phonon}}(T) + \ldots" />.
            ...
            <M tex="\rho = \rho_{\text{residual}} + \rho_{\text{phonon}}(T)" />
            ...
            near 4 K can have <M tex="\rho" /> a thousand times lower than at room temperature, but
            only a true superconductor reaches exactly zero
        ...
        <FAQItem q="At the atomic level, what's actually causing the resistance?">
          <p>
            ...
            under <M tex="\vec{E}" />, then colliding with lattice ions and randomizing their drift
            component every <M tex="\tau \approx 2\times 10^{-14}\ \text{s}" />
            ...
            rate equation <M tex="\sigma = nq^2\tau/m" /> survives nearly intact
        ...
        <FAQItem q="What's the difference between resistance and impedance?">
          <p>
            ...
            response of a circuit element to current: <M tex="V = IR" />, and energy goes into heat
            at the rate <M tex="I^2 R" />.{' '}
            ...
            return energy each cycle. Impedance is the complex quantity <M tex="Z = R + jX" />,
            where the real part <M tex="R" /> is still dissipative and the imaginary part{' '}
            <M tex="X" /> (reactance) is energy-storing
            <Cite id="irwin-circuit-analysis-2015" in={SOURCES} />. Inside a pure resistor,{' '}
            <M tex="Z = R" />; everywhere else, AC needs the full complex picture.
          </p>
        </FAQItem>

        <FAQItem q="Why does nichrome glow red but copper doesn't, at the same current?">
          <p>
            For a given current <M tex="I" />, the power dissipated per meter is{' '}
            <M tex="I^2 R / L = I^2 \rho / A" /> — it scales directly with resistivity. Nichrome's{' '}
            <M tex="\rho" /> is more than 60× copper's
        ...
        <FAQItem q="A short circuit causes a fire — but what's actually happening at the wire level?">
          <p>
            ...
            resistance path. With <M tex="I = V/R" />, the current rockets to hundreds of amperes
            within the impedance limit of the supply
            <Cite id="griffiths-2017" in={SOURCES} />. The wire itself still has its small{' '}
            <M tex="R" />, so the dissipated power <M tex="I^2 R" /> goes from watts to{' '}
            ...
            before the wire's <M tex="P = I^2 R" /> overruns its thermal budget.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Does a wire's resistance change while it's hot?">
          <p>
            ...
            until the filament heats and <M tex="R" /> climbs to its steady-state value.
          </p>
        </FAQItem>
      </FAQ>
    </ChapterShell>
