  ...
  return (
    <ChapterShell chapter={chapter}>
      ...
      <p className="mb-prose-3">
        ...
        {' '}<Term def={<><strong className="text-text font-medium">1.2/50 µs voltage waveform</strong> — the standard IEEE C62.41 open-circuit test pulse: rises from 10 % to 90 % of peak in 1.2 µs and falls to half-peak at 50 µs. Used to characterise an SPD's voltage clamping behaviour.</>}>1.2/50 µs voltage waveform</Term>{' '}
        (rises to peak in 1.2 microseconds, falls to half in 50) and the
        {' '}<Term def={<><strong className="text-text font-medium">8/20 µs current waveform</strong> — the standard IEEE C62.41 short-circuit test pulse: rises to peak in 8 µs, falls to half in 20 µs. Used to characterise an SPD's energy-handling and discharge-current rating.</>}>8/20 µs current waveform</Term>{' '}
      ...
      <p className="mb-prose-3">
        ...
        <strong className="text-text font-medium"> dI/dt</strong> is the rate of change of current through it (in A/s). For L = 5 µH and a current
      ...
      <p className="mb-prose-3">
        ...
        with the
        {' '}<Term def={<><strong className="text-text font-medium">nominal discharge current (I<sub>n</sub>)</strong> — the surge current the SPD can pass through itself fifteen times without damage at the 8/20 µs waveform, per UL 1449. The repeated-pulse durability rating, as opposed to the once-only maximum.</>}>nominal discharge current (I<sub>n</sub>)</Term>{' '}
        and
        {' '}<Term def={<><strong className="text-text font-medium">maximum surge current (I<sub>max</sub>)</strong> — the largest 8/20 µs surge an SPD will survive a single time, per UL 1449. Typically a factor of two or three higher than I<sub>n</sub>.</>}>maximum surge current (I<sub>max</sub>)</Term>{' '}
      ...
      <TryIt
        ...
        question={
          ...
          <strong className="text-text font-medium"> R = 25 Ω</strong> and whose self-inductance is <strong className="text-text font-medium">L = 6 µH</strong>. Compute the
        ...
        answer={
          <>
            ...
            <p className="mb-prose-1 last:mb-0">
              ...
              <em className="italic text-text"> very</em> bad surge ground. Adding a second rod six feet away halves both the resistance and
              ...
              Answer: <strong className="text-text font-medium">V<sub>R</sub> ≈ 250 kV, V<sub>L</sub> ≈ 7.5 kV</strong>; on paper the resistive
      ...
      <p className="mb-prose-3">
        ...
        {' '}<Term def={<><strong className="text-text font-medium">grounding electrode</strong> — any of the conductive elements listed in NEC 250.52(A) that establish a connection to earth: ground rod, concrete-encased electrode, ground ring, metal underground water pipe, plate electrode, structural building steel, or other listed electrodes. The first item in each electrode category present at the building must be used.</>}>grounding electrode</Term>{' '}
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">ground rod</strong> — a copper-clad steel rod, normally 8 ft long and 5/8 in. diameter, driven full-depth into soil at the service entrance. Per NEC 250.52(A)(5) and 250.53. The most common electrode in residential construction.</>}>ground rod</Term>{' '}
        ...
        {' '}<Term def={<><strong className="text-text font-medium">spreading resistance</strong> — the resistance from a grounding electrode through the surrounding soil to remote earth. Set by the electrode geometry and the resistivity of the local soil; for an 8 ft rod in average soil, typically 25–300 Ω at 60 Hz.</>}>spreading resistance</Term>{' '}
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">Ufer electrode / concrete-encased electrode</strong> — a 20 ft minimum length of bare #4 AWG copper or 1/2 in. rebar embedded in the concrete footing of a new building. Required by NEC 250.50 in new construction when it is present. The most reliable residential ground because moisture in the concrete keeps the resistance low even when the surrounding soil is dry.</>}>Ufer electrode</Term>{' '}
      ...
      <p className="mb-prose-3">
        <strong className="text-text font-medium">Metal underground water pipe.</strong> NEC 250.52(A)(1) permits a metal water service pipe in
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">ground ring</strong> — a 20 ft minimum length of bare #2 AWG or larger copper buried in a trench at least 30 in. deep, forming a loop around the building. NEC 250.52(A)(4). Less common in residential work; more common around radio towers and substations.</>}>ground ring</Term>{' '}
      ...
      <TryIt
        tag="Try 40.2"
        question={
          <>Two ground rods six feet apart, each with a 60 Hz resistance of <strong className="text-text font-medium">25 Ω</strong> and a
          self-inductance of <strong className="text-text font-medium">6 µH</strong>. Compute the combined parallel resistance and the combined
        ...
        answer={
          <>
            ...
            <p className="mb-prose-1 last:mb-0">
              ...
              Answer: <strong className="text-text font-medium">R = 12.5 Ω, L = 3 µH, both halved.</strong> Code requires the 6 ft spacing exactly
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">Type 2 SPD</strong> — a surge protective device listed for installation on the load side of the service disconnect (typically in the main panel, either as a hardwired panel-mount SPD or as a plug-in breaker that occupies two slots). The most common residential whole-house SPD layer.</>}>Type 2 SPD</Term>{' '}
      ...
      <p className="mb-prose-3">
        ...
        <Term def={<><strong className="text-text font-medium">Type 3 SPD</strong> — a point-of-use surge protective device installed at least ten metres of wire from the service disconnect: a plug-in strip with surge protection or a hardwired SPD at a sub-panel. UL 1449's lowest discharge-current rating but the layer closest to the load.</>}>Type 3 SPD</Term>{' '}
      ...
      <p className="mb-prose-3">
        ...
        VPR-rated quantity), <strong className="text-text font-medium">L<sub>lead</sub></strong> is the total self-inductance of the lead wires
        connecting the SPD to the panel bus and to ground (in henries; a rule of thumb is 25 nH/inch for
        straight #6 AWG wire), and <strong className="text-text font-medium">dI/dt</strong> is the rate of change of surge current through those
      ...
      <TryIt
        tag="Try 40.3"
        question={
          <>A Type 2 panel SPD on a 120 V branch has a VPR of <strong className="text-text font-medium">600 V</strong>. The leads from the SPD to
          the panel bus and ground bar total <strong className="text-text font-medium">12 inches</strong> (300 nH of inductance). During the surge,
          the current through the SPD has a rate of rise of <strong className="text-text font-medium">dI/dt = 10⁹ A/s</strong> (1 kA/µs). What is
        ...
        answer={
          <>
            ...
            <p className="mb-prose-1 last:mb-0">
              ...
              <strong className="text-text font-medium"> +300 V from leads, 900 V total at the load</strong>.
            </p>
          </>
        }
      />
      ...
      <p className="mb-prose-3">
        ...
        {' '}<Term def={<><strong className="text-text font-medium">grounding electrode conductor (GEC)</strong> — the conductor that connects the equipment-grounding bus at the service to the grounding electrode system. Sized by NEC Table 250.66 based on the size of the service-entrance ungrounded conductors.</>}>grounding electrode conductor</Term>{' '}
      ...
      <TryIt
        tag="Try 40.4"
        question={
          <>A new service is rated <strong className="text-text font-medium">200 A</strong>, fed by copper service-entrance conductors. Per NEC
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              ...
              copper, the required minimum copper GEC is <strong className="text-text font-medium">#4 AWG</strong><Cite id="nec-2023" in={SOURCES} />.
            </p>
            <p className="mb-prose-1 last:mb-0">
              ...
              upgraded. Answer: <strong className="text-text font-medium">#4 AWG copper</strong>.
            </p>
          </>
        }
      />
      ...
      <p className="mb-prose-3">
        ...
        {' '}<Term def={<><strong className="text-text font-medium">transfer switch</strong> — a switch (manual or automatic) that connects the panel to either the utility service or a generator, but never both simultaneously. Required by NEC 702 for any optional standby system unless an interlock is used. Automatic transfer switches sense utility loss and switch over on their own.</>}>transfer switch</Term>{' '}
        or a {' '}
        <Term def={<><strong className="text-text font-medium">generator interlock</strong> — a mechanical sliding plate installed in a residential panel that physically prevents the main breaker and the generator-feed breaker from both being closed at the same time. A code-approved alternative to a transfer switch under NEC 702 when the panel's manufacturer has listed an interlock for the specific panel.</>}>generator interlock kit</Term>.
      ...
      <FAQ intro="Questions readers ask after wiring an SPD or driving a second ground rod.">
        ...
        <FAQItem q="What's the difference between an MOV and a gas-discharge tube?">
          <p>
            A {' '}<Term def={<><strong className="text-text font-medium">gas-discharge tube (GDT)</strong> — a sealed glass envelope with two electrodes separated by a low-pressure inert gas. Above a threshold voltage the gas ionises and conducts heavily; below it, the gap is essentially open. Used as a primary protection element on long lines (telecom, antenna feeds) where the surge can have very high energy.</>}>gas-discharge tube</Term>{' '}
