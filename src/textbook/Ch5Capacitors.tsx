  ...
  return (
    <ChapterShell chapter={chapter}>
      <p className="chapter-intro">
        ...
        — the simplest device in all of electronics. There are thousands of them inside the phone in
        your pocket, hundreds inside the cable that charges it, and a few thousand farads worth on
      ...
      <p className="mb-prose-3">
        ...
        <Cite id="griffiths-2017" in={SOURCES} />. The gap fills with a uniform electric field,
        pointing from the positive plate to the negative one. The total charge on the device is
        still zero — what one plate gained, the other lost — but the{' '}
        <Term def="The configuration in which equal-and-opposite charges sit on two conductors with an insulator between them. Setting this up costs work; tearing it down releases that work back. The thing a capacitor actually 'stores.'">
          charge separation
        </Term>{' '}
      ...
      <p className="mb-prose-3">
        ...
        together; an{' '}
        <Term def="A capacitor that achieves high capacitance per volume by growing a thin aluminium- or tantalum-oxide dielectric on a foil anode through electrochemistry. The oxide only insulates with the correct polarity, so these caps are polarised — reversing them destroys the oxide and the cap.">
          electrolytic
        </Term>{' '}
        capacitor is a long strip of foil rolled into a can with a wet paste in between; the touch
        sensor on your phone screen is a printed grid of tiny capacitors whose values your finger
        perturbs. They differ in scale, in dielectric, in geometry — not in principle.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        is itself negative, gets a push <em className="text-text italic">toward</em> the bottom
        plate. You have to overcome that push to get the electron across. Not much — but more than
        zero. Move a third, and the field is stronger still. By the millionth electron the work per
      ...
      <p className="mb-prose-3">
        ...
        the charge, double the voltage. The proportionality is geometric, set by the size and
        spacing of the plates and the stuff in between
      ...
      <p className="mb-prose-3">
        ...
        <em className="text-text italic">capacity</em>
        <Cite id="volta-1782" in={SOURCES} />. We call the same quantity{' '}
      ...
      <p className="mb-prose-3">
        ...
        line rises — how many coulombs per volt the geometry will hold. Big plates, thin gap,
        easy-to-polarise material in between: a deep bucket. Small plates, wide gap: shallow. The
        earlier "Build one charge at a time" demo is exactly this picture made kinetic — each
        electron drops in, the voltage climbs, and the slope of that climb is determined by the
        geometry, not by you.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        plate along any path through the gap. Maxwell's equations make the result path-independent
        for an electrostatic configuration; the ratio depends only on geometry and the dielectric,
        never on the source
      ...
      <p className="mb-prose-3">
        ...
        s of area <M tex="A" /> separated by a vacuum gap of width <M tex="d" />, Gauss's law
        applied to the surface of one plate gives a uniform field{' '}
        <M tex="E = Q/(\varepsilon_0 A)" /> in the gap, and integrating that field across the gap
        yields a voltage <M tex="V = Ed = Qd/(\varepsilon_0 A)" />. Re-arranging
        <Cite id="griffiths-2017" in={SOURCES} />:
      </p>
      ...
      <p className="mb-prose-3">
        ...
        <M tex="\varepsilon_r" />, the material's{' '}
      ...
      <p className="mb-prose-3">
        ...
        pillbox encloses
        <Cite id="jackson-1999" in={SOURCES} />. Re-arrange and you get back <M>C = ε₀ A / d</M>.
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            Two square plates 5 cm × 5 cm are held 0.5 mm apart in vacuum. What is their
            capacitance?
          </>
        }
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              Area: <strong className="text-text font-medium">A = (0.05 m)² = 2.5×10⁻³ m²</strong>.
              Gap: <strong className="text-text font-medium">d = 5×10⁻⁴ m</strong>. ε₀ = 8.854×10⁻¹²
              F/m
              <Cite id="codata-2018" in={SOURCES} />.
            </p>
            <Formula>C = ε₀ A / d = (8.854×10⁻¹²)(2.5×10⁻³) / (5×10⁻⁴)</Formula>
            <Formula>
              C ≈ <strong className="text-text font-medium">44 pF</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              A laboratory-scale parallel-plate cap of this size lands solidly in the picofarad
              range. To get a microfarad into a millimetre cube the industry stacks dozens of thin
              high-εᵣ layers in parallel
      ...
      <p className="mb-prose-3">
        ...
        <M tex="C \approx 0.9\,\text{pF}" />. A whole farad in air would need plates the size of a
        small lake. The reason the capacitor industry exists at all is the εᵣ trick: stack thin
        layers of high-permittivity ceramic between thin metallised foils and you can fit a
        microfarad into a millimetre cube
        <Cite id="horowitz-hill-2015" in={SOURCES} />.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        do work <M tex="v \cdot dq" /> against the existing field. The cost per coulomb is exactly
        the present voltage. For a real, finite chunk of charge δq, the work is{' '}
      ...
      <p className="mb-prose-3">
        ...
        cap would have cost essentially zero. Adding 1 nC to the same cap when it already holds 200
        µC would cost <em className="text-text italic">twice</em> as much as adding it at 100 µC.
        The cost climbs linearly with how far you have already gone
        <Cite id="griffiths-2017" in={SOURCES} />.
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            A 10 nF capacitor already carries 100 nC. How much work does it take to add the next 1
            nC?
          </>
        }
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              Current voltage:{' '}
              <strong className="text-text font-medium">V = Q/C = 100 nC / 10 nF = 10 V</strong>.
              Work to add the next 1 nC:
            </p>
            <Formula>
              W ≈ δq · V = (1×10⁻⁹ C)(10 V) ={' '}
              <strong className="text-text font-medium">10 nJ</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              The cost rises linearly with how full the cap already is — adding 1 nC to an empty cap
              costs essentially zero, and adding 1 nC at 200 nC of charge would cost twice as much
              <Cite id="griffiths-2017" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        back, and why the total energy stored is not <M tex="QV" /> but half of <M tex="QV" />.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        <M tex="q" /> runs from 0 to <M tex="Q" />
      ...
      <p className="mb-prose-3">
        ...
        electric field, distributed throughout the volume at a density that depends only on the
      ...
      <p className="mb-prose-3">
        ...
        different ways. That equivalence is not a coincidence; it is a special case of the more
      ...
      <Pullout>
        A capacitor doesn't store charge. The plates always net to zero. What it stores is the{' '}
        <em className="text-text italic">separation</em> — and the field that fills the gap because
        of it.
      </Pullout>
      ...
      <TryIt
        ...
        question={
          <>
            A 100 µF capacitor is charged to 12 V. How much energy is stored? And how many electrons
            of net charge sit on each plate?
          </>
        }
        ...
        answer={
          <>
            <Formula>
              U = ½ C V² = ½ (1×10⁻⁴)(12)² ={' '}
              <strong className="text-text font-medium">7.2×10⁻³ J ≈ 7.2 mJ</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">And the charge separation:</p>
            <Formula>Q = C V = (100×10⁻⁶)(12) = 1.2×10⁻³ C = 1.2 mC</Formula>
            <Formula>
              N = Q / e = 1.2×10⁻³ / 1.602×10⁻¹⁹ ≈{' '}
              <strong className="text-text font-medium">7.5×10¹⁵ electrons</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              About seven quadrillion electrons swapped sides — large in count, tiny in mass, and
              the 7 mJ they represent is enough to make a satisfying spark across a screwdriver if
              you discharge the cap directly
              <Cite id="codata-2018" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        . The capacitor starts empty (V_C = 0) and the full battery voltage initially appears across
        the resistor, driving a current I = V₀/R. As charge accumulates on the cap, V_C rises and
        the voltage across the resistor — V₀ − V_C — falls. The current falls with it. Kirchhoff
      ...
      <p className="mb-prose-3">
        ...
        switch closed (in seconds), <M tex="R" /> is the series resistance (in ohms), and{' '}
        <M tex="C" /> is the capacitance (in farads). The product <M tex="RC" /> has units of
        seconds and sets the timescale of the exponential approach.
      </p>
      ...
      <TryIt
        ...
        question={
          <>
            An RC circuit has R = 10 kΩ and C = 100 µF. What is the time constant τ? Roughly how
            long to charge to 99% of the supply voltage?
          </>
        }
        ...
        answer={
          <>
            <Formula>
              τ = R C = (1×10⁴ Ω)(1×10⁻⁴ F) = <strong className="text-text font-medium">1 s</strong>
            </Formula>
            <p className="mb-prose-1 last:mb-0">
              After one time constant the cap reaches 1 − 1/e ≈ 63.2% of V₀. After 5τ it reaches
              99.3%, the standard engineering threshold for &ldquo;fully charged&rdquo;
              <Cite id="horowitz-hill-2015" in={SOURCES} />.
            </p>
            <Formula>
              5τ = <strong className="text-text font-medium">5 s</strong> &nbsp; (to reach ≈ 99% of
              V₀)
            </Formula>
          </>
        }
      ...
      <p className="mb-prose-3">
        ...
        — the time for V_C to reach (1 − 1/e) ≈ 63% of V₀. After 5τ, the capacitor is at 99.3% of V₀
        and is effectively "done" charging for most engineering purposes. The same τ governs the
        discharge curve (with the sign of the exponent flipped), the response of any first-order
      ...
      <p className="mb-prose-3">
        ...
        the heartbeat of every analog filter, every blinker, every sample-and-hold circuit on Earth.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        wrote to his friend Réaumur that he "would not take a second [shock] for the kingdom of
        France"
        <Cite id="leyden-jar-1745" in={SOURCES} />. The glass was the dielectric; the water and the
        experimenter's hand were the two plates. It was the first practical capacitor, and the first
      ...
      <p className="mb-prose-3">
        ...
        the transistor age, then the multi-layer ceramic chip capacitors of today — which fit 1 µF
      ...
      <CaseStudies
        intro={
          <>
            Four places where the bottom-layer story of stored charge — linear V, quadratic U, field
            in the gap, time constant RC — shows up at full scale, from cardiology to the chip on
            your finger.
          </>
        }
      >
        <CaseStudy
          ...
          specs={[
            {
              label: 'Typical stored energy (adult dose)',
              value: (
                <>
                  ~150–360 J <Cite id="horowitz-hill-2015" in={SOURCES} />
                </>
              ),
            },
            {
              label: 'Typical capacitor',
              value: (
                <>
                  ~100–200 µF <Cite id="horowitz-hill-2015" in={SOURCES} />
                </>
              ),
            },
            {
              ...
              value: (
                <>
                  ~2 kV <Cite id="horowitz-hill-2015" in={SOURCES} />
                </>
              ),
            },
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            <M tex="\tfrac{1}{2}CV^2 \approx 300\,\text{J}" /> of energy — the order of a joule per
            kilogram of patient mass, enough to depolarise the heart muscle and reset its rhythm
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            <em className="text-text italic"> stored in the field</em> between the capacitor's
            plates; the discharge is governed by an RC time constant; the current peak and pulse
            shape are first-order linear circuit theory. The clinical balance is also a clean
            illustration of why ½CV² and not CV is the relevant figure — half the energy delivered
            comes out of the shrinking field as the cap drains, not from the (already-fixed) initial
            charge.
          </p>
        </CaseStudy>
        ...
        <CaseStudy
          ...
          specs={[
            ...
            },
            {
              ...
              value: (
                <>
                  ~0.1–1 pF <Cite id="horowitz-hill-2015" in={SOURCES} />
                </>
              ),
            },
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            Capacitive touch screens are an industrial-scale exercise in measuring tiny capacitance
            changes. Beneath the glass is a grid of transparent ITO electrodes patterned as row
            drivers and column receivers. The native capacitance between any row and column is a few
            picofarads, formed almost entirely by fringing fields that sneak through the glass and
            into the air just above it.
          </p>
          <p className="mb-prose-2 last:mb-0">
            A finger, which is a conductor sitting roughly at body potential, terminates some of
            those fringing field lines to ground. The mutual capacitance between the row and column
            under the finger drops by a fraction of a picofarad — small, but easily measurable with
            switched-capacitor circuitry running at kilohertz scan rates
            <Cite id="horowitz-hill-2015" in={SOURCES} />. The whole grid is read out tens of times
            per second to produce a coarse 2D image of "where the fingers are."
          </p>
          <p className="mb-prose-2 last:mb-0">
            The single underlying fact is the geometry rule{' '}
            <M tex="C = \varepsilon_0 \varepsilon_r A / d" />: change the geometry, change the
            capacitance. A finger near the glass is a new conductor cutting into the field's
            geometry. The capacitor doesn't care that the change came from a person; it just reports
            a new C.
          </p>
        </CaseStudy>
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            plate area is enormous — thousands of square metres per gram of activated carbon — and
            the effective gap d is the Debye length of the electrolyte, a nanometre or so. Putting
            both into <M tex="C = \varepsilon_0 \varepsilon_r A / d" /> gives capacitances in the
            thousands of farads per cell
            <Cite id="horowitz-hill-2015" in={SOURCES} />.
          </p>
          <p className="mb-prose-2 last:mb-0">
            The penalty is voltage. The double layer breaks down at a few volts per cell, so a 750 V
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            A consumer camera flash is the cleanest possible "capacitor stores energy on a long
            ...
            <M tex="\tfrac{1}{2}CV^2 \approx 8\,\text{J}" /> in its field.
          </p>
          <p className="mb-prose-2 last:mb-0">
            When you press the shutter, a small trigger transformer ionises the xenon tube, the cap
            dumps its energy into the now-conducting plasma in about a millisecond, and the
            photographer sees a brief but very bright flash. The same energy delivered over the
            original five-second charge time would be a barely perceptible glow; compressing it into
            1 ms multiplies the instantaneous power by a factor of ~5000. The capacitor is a
            timescale-converter.
          </p>
        </CaseStudy>
      </CaseStudies>
      ...
      <FAQ intro="Loose threads from the chapter — the questions a careful reader tends to surface.">
        <FAQItem q="What does it mean to “store” charge if the total charge on a capacitor is zero?">
          <p>
            The capacitor's two plates always have net charges of <M tex="+Q" /> and <M tex="-Q" />,
            summing to zero. What's stored is the <em className="text-text italic">separation</em>:
        ...
        <FAQItem q="Why does adding the N-th charge cost more work than the first?">
          <p>
            Because by the time you add the N-th charge there are already <M tex="N-1" /> like
            charges on the same plate (and N−1 opposite charges on the other), and the field they
            have already established opposes the new charge's motion across the gap. The first
            charge moved through nothing; the second moved against the field of one; the millionth
            moved against the field of nine hundred and ninety-nine thousand nine hundred and
            ninety-nine. The work cost is <M tex="q \cdot V" />, and <M tex="V" /> grows linearly
            with how many charges are already there
            <Cite id="griffiths-2017" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why does putting a dielectric in a capacitor increase its capacitance?">
          <p>
            Dielectric molecules polarise in the applied field: their electron clouds shift slightly
            opposite to the field, and the rotated dipoles set up a small counter-field that
            partially cancels the applied one. The net field in the gap drops by a factor εᵣ — the
        ...
        <FAQItem q="Why does series-connecting capacitors decrease the total capacitance?">
          <p>
            ...
            V₂ + … = Q/C₁ + Q/C₂ + …. So <M tex="1/C_{\text{total}} = 1/C_1 + 1/C_2 + \cdots" />.
        ...
        <FAQItem q="Can you charge a capacitor with zero resistance in the loop?">
          <p>
            Not in a useful way. With R = 0, τ = RC = 0 and the charging current's mathematical peak
            ...
            <M tex="\tfrac{1}{2}CV^2" /> regardless of the value of R
        ...
        <FAQItem q="Why is τ = RC and not R/C or R+C?">
          <p>
            ...
            <M tex="R \cdot C" /> has units of (V/(C/s))·(C/V) = seconds. Neither R/C nor R+C has
            units of time. More mechanically, the ODE <M tex="dQ/dt = (V_0 - Q/C)/R" /> rearranges
            to <M tex="R \cdot C \cdot dQ/dt = (CV_0 - Q)" />, in which the coefficient on the time
        ...
        <FAQItem q="Why does a capacitor block DC but pass AC?">
          <p>
            ...
            <M tex="Z = 1/(j\omega C)" />: infinite at DC (ω = 0), small at high frequency
        ...
        <FAQItem q="What's the difference between a capacitor and a battery?">
          <p>
            A capacitor stores energy in an electric field; a battery stores energy in chemical
            bonds. The capacitor's voltage falls linearly with charge as it discharges (V = Q/C); a
            battery's voltage stays roughly constant until its chemistry is nearly exhausted. The
            capacitor can charge and discharge in microseconds to seconds and survive millions of
            cycles; a battery is much slower and degrades in hundreds to a few thousand cycles.
            Energy density per kilogram: lithium-ion ~250 Wh/kg, even the best supercaps ~10 Wh/kg
            <Cite id="horowitz-hill-2015" in={SOURCES} />. Power density is the reverse — capacitors
            win there by an order of magnitude. They are complementary, not interchangeable.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why are electrolytic capacitors polarised?">
          <p>
            ...
            That oxide only forms — and only insulates — when the anode is held positive. Reverse
            the polarity and the chemistry runs backwards: the oxide dissolves, leakage current
            rises, gas builds up inside the can, and eventually the can ruptures (or explodes).
            Tantalum electrolytics behave similarly. Non-polar caps (ceramic, film) have a symmetric
            dielectric and can be wired either way
            <Cite id="horowitz-hill-2015" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What's ESR and why does it heat a capacitor up?">
          <p>
            ESR — equivalent series resistance — lumps together every resistive loss inside a real
            capacitor: the bulk resistance of the plate foils, the contact resistance to the leads,
            dielectric absorption losses, and (for electrolytics) the resistance of the wet paste.
            When current I flows through the cap, I²·ESR is dissipated as heat inside the can
            <Cite id="horowitz-hill-2015" in={SOURCES} />. High-ripple-current applications
            (switching power supplies, motor drives) push enough current through their caps that
            ESR-driven heating is often the dominant failure mechanism — the cap's electrolyte dries
            out, ESR rises further, and the failure runs away.
          </p>
        </FAQItem>

        <FAQItem q="Why do high-quality audio amplifiers use so many capacitors?">
          <p>
            Three jobs. (1) Coupling caps pass the AC signal between gain stages while blocking the
            DC bias each stage sits at. (2) Bypass caps short any AC noise on the supply rails to
            ground so the amplifier's gain stages see a clean DC supply. (3) Reservoir caps in the
            power-supply section smooth the rectified-mains AC ripple into something approximating
            DC
            <Cite id="horowitz-hill-2015" in={SOURCES} />. All three jobs are versions of the same
            physical fact: a cap stores enough energy in its field to bridge brief gaps in supply or
            signal current on the time scale set by RC.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What's a supercapacitor and how is it different from a regular capacitor?">
          <p>
            ...
            <M tex="C = \varepsilon_0 \varepsilon_r A / d" /> then gives capacitances in the
            thousands of farads per cell. The penalty is the breakdown voltage of the electrolyte
            (~2.7 V per cell), so high-voltage supercap banks need many cells in series
            <Cite id="horowitz-hill-2015" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why does a capacitor explode if you reverse-bias an electrolytic?">
          <p>
            Because the dielectric — that thin grown oxide layer — is itself maintained
            electrochemically by the correct polarity. Reverse the bias and the oxide begins to
            dissolve. Leakage current rises, which heats the electrolyte, which generates gas. The
            can's pressure relief vents (the X-shaped score on the top of a modern electrolytic) are
            designed to release the gas without shrapnel — but the can still ruptures and the cap is
            destroyed. Always observe the polarity marking on an electrolytic
            <Cite id="horowitz-hill-2015" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why do some capacitors fail just because they're old?">
          <p>
            The wet electrolyte in an aluminium electrolytic capacitor slowly evaporates through its
            rubber end-seal, and the rate of loss roughly doubles for every 10 °C rise in operating
            temperature. As the electrolyte dries out, ESR rises and capacitance drops; eventually
            the cap can no longer do its job in a power supply or audio stage, and the equipment
            fails — usually with a faint hum, a swollen capacitor can, or a brown stain on the PCB
            <Cite id="horowitz-hill-2015" in={SOURCES} />. Solid-electrolyte and film capacitors
            don't suffer this particular failure mode and last much longer.
          </p>
        </FAQItem>

        <FAQItem q="How does a touchscreen actually detect a finger?">
          <p>
            Underneath the glass is a grid of transparent indium-tin-oxide electrodes patterned as
            drive lines and sense lines. At each intersection, the two electrodes form a tiny mutual
            capacitance of a few picofarads, set mostly by the fringing field that bulges out above
            the glass. A grounded conductor (your finger) near a given intersection terminates some
            of that fringing field, reducing the mutual capacitance by a fraction of a pF. The touch
            controller sweeps the grid tens of times per second with switched-capacitor sensing,
            builds a heat-map of where the C-values dropped, and reports those locations as touch
            points
            <Cite id="horowitz-hill-2015" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What is the smallest possible capacitor? Could a single atom be one?">
          <p>
            In principle, anything with two conductors at different potentials is a capacitor — and
