  ...
  return (
    <ChapterShell chapter={chapter}>
      ...
      <p className="mb-prose-3">
        ...
        sharpen into its modern shape, is that <em className="italic text-text">moving</em> charge is the source of magnetism. Static charge makes
        an electric field. Charge in motion makes <em className="italic text-text">both</em> an electric field <em className="italic text-text">and</em> a magnetic one. The
      ...
      <p className="mb-prose-3">
        ...
        the cleanest formulas in classical physics. At a perpendicular distance <strong className="text-text font-medium">r</strong> from the wire, the
        magnitude is
      </p>
      ...
      <p className="mb-prose-3">
        ...
        around the wire in the direction of <strong className="text-text font-medium">B</strong>. The constant <strong className="text-text font-medium">μ₀ ≈ 1.257×10⁻⁶ T·m/A</strong>
        is the permeability of free space <Cite id="codata-2018" in={SOURCES} />; it plays the same role for magnetism
        that <strong className="text-text font-medium">1/(4π ε₀)</strong> plays for electricity, and the two are linked by <strong className="text-text font-medium">μ₀ ε₀ = 1/c²</strong>.
      ...
      <TryIt
        tag="Try 6.1"
        question={<>A long straight wire carries <strong className="text-text font-medium">I = 10 A</strong>. What is the magnitude of B at a perpendicular distance of <strong className="text-text font-medium">5 cm</strong>?</>}
        hint="B = μ₀ I / (2π r), with μ₀ = 4π × 10⁻⁷ T·m/A."
        answer={
          <>
            <Formula>|B| = μ₀ I / (2π r)</Formula>
            <Formula>|B| = (4π×10⁻⁷)(10) / (2π · 0.05) = (4π×10⁻⁶) / (0.1π) = <strong className="text-text font-medium">4×10⁻⁵ T = 40 µT</strong></Formula>
      ...
      <p className="mb-prose-3">
        The factor of <strong className="text-text font-medium">2π</strong> is geometric, the same way the <strong className="text-text font-medium">4π</strong> in Coulomb's law is
        geometric — it counts how field lines spread around a wire (cylindrically) instead of around a point
        (spherically). The fall-off here is <strong className="text-text font-medium">1/r</strong>, not 1/r². A line of charge spreads its influence over
      ...
      <p className="mb-prose-3">
        ...
        elementary electromagnetism: <strong className="text-text font-medium">parallel currents attract, antiparallel currents repel.</strong> The
      ...
      <p className="mb-prose-3">
        where <strong className="text-text font-medium">F</strong> is the magnitude of the force one wire exerts on a segment of the other (in newtons),
        <strong className="text-text font-medium"> L</strong> is the length of that segment (in metres) so <strong className="text-text font-medium">F/L</strong> has units of N/m,
        <strong className="text-text font-medium"> I₁</strong> and <strong className="text-text font-medium">I₂</strong> are the currents in the two wires (in amperes, signed by direction),
        <strong className="text-text font-medium"> d</strong> is the perpendicular spacing between the wires (in metres), and
        <strong className="text-text font-medium"> μ₀ ≈ 1.257×10⁻⁶ T·m/A</strong> is the permeability of free space <Cite id="codata-2018" in={SOURCES} />. Same sign of current → attractive (negative if you've adopted the
        ...
        apart, produces a force of <strong className="text-text font-medium">2×10⁻⁷ N/m</strong> between them <Cite id="griffiths-2017" in={SOURCES} />.
        That definition is what the <strong className="text-text font-medium">μ₀ = 4π × 10⁻⁷</strong> exact value used to be; the 2019 SI redefinition
        based the ampere instead on the elementary charge <strong className="text-text font-medium">e</strong>, demoting μ₀ to a measured quantity.
      </p>
      <p className="mb-prose-3">
        The product structure is not mysterious — it's just <strong className="text-text font-medium">F = IL × B</strong> applied twice. Each wire sits in the
        field produced by the other: wire 2 feels its partner's field <strong className="text-text font-medium">B₁ = μ₀ I₁ / (2π d)</strong> (the 1/r law from
        the previous section), and the magnetic force on a length <strong className="text-text font-medium">L</strong> of current <strong className="text-text font-medium">I₂</strong> in that
        field is <strong className="text-text font-medium">F = I₂ L B₁</strong>. Substitute and divide by L to get the force per unit length. The
        <strong className="text-text font-medium"> 1/d</strong> falloff is the same cylindrical geometry as a single wire; the <strong className="text-text font-medium">I₁ I₂</strong> on top is
      ...
      <TryIt
        tag="Try 6.2"
        question={<>Two long parallel wires carry <strong className="text-text font-medium">100 A</strong> each in the same direction, separated by <strong className="text-text font-medium">10 cm</strong>. What is the force per unit length between them, and is it attractive or repulsive?</>}
        hint="F/L = μ₀ I₁ I₂ / (2π d). Same direction of current → attractive."
        answer={
          <>
            <Formula>F / L = μ₀ I<sub>1</sub> I<sub>2</sub> / (2π d)</Formula>
            <Formula>F / L = (4π×10⁻⁷)(100)(100) / (2π · 0.10) = <strong className="text-text font-medium">0.02 N/m = 20 mN/m</strong></Formula>
            <p className="mb-prose-1 last:mb-0">
              The force is <strong className="text-text font-medium">attractive</strong> (parallel currents pull together)<Cite id="ampere-1826" in={SOURCES} />.
      ...
      <p className="mb-prose-3">
        ...
        together. The answer is the size of <strong className="text-text font-medium">μ₀</strong>: between two wires carrying 100 A each, separated by
        a meter, the force is just <strong className="text-text font-medium">2×10⁻³ N/m</strong> — about a fifth of a gram weight per meter. Detectable
      ...
      <p className="mb-prose-3">
        where <strong className="text-text font-medium">F</strong> is the force vector on the charged particle (in newtons), <strong className="text-text font-medium">q</strong> is its charge
        (in coulombs, signed), <strong className="text-text font-medium">v</strong> is its velocity vector (in m/s), <strong className="text-text font-medium">B</strong> is the local
        magnetic flux density vector (in tesla), and <strong className="text-text font-medium">×</strong> denotes the vector cross product — so the force
        comes out perpendicular to <em className="italic text-text">both</em> the velocity and the field. The two facts
        worth pausing on:
      </p>
      <p className="mb-prose-3">
        First, the force is always perpendicular to the velocity, so it does no work. <em className="italic text-text">Magnetism cannot speed a
        ...
        case, where <strong className="text-text font-medium">F = qE</strong> is parallel to <strong className="text-text font-medium">E</strong> and does plenty of work.
      </p>
      <p className="pullout">
        Magnetism doesn't do work. It only steers.
      </p>
      <p className="mb-prose-3">
        Second, "perpendicular to <strong className="text-text font-medium">v</strong>" plus "constant magnitude" is the recipe for circular motion. A
        charged particle injected into a uniform magnetic field traces out a circle of radius
      </p>
      <Formula>r = m v / (q B)</Formula>
      <p className="mb-prose-3">
        where <strong className="text-text font-medium">r</strong> is the radius of the circular orbit (in metres), <strong className="text-text font-medium">m</strong> is the particle's mass
        (in kilograms), <strong className="text-text font-medium">v</strong> is its speed perpendicular to <em className="italic text-text">B</em> (in m/s), <strong className="text-text font-medium">q</strong> is its
        charge magnitude (in coulombs), and <strong className="text-text font-medium">B</strong> is the magnetic flux density (in tesla).
      </p>
      <p className="mb-prose-3">
      ...
      <p className="mb-prose-3">
        where <strong className="text-text font-medium">T</strong> is the orbital period (in seconds) and <em className="italic text-text">m</em>, <em className="italic text-text">q</em>, <em className="italic text-text">B</em> are as above
        — which, remarkably, has no <strong className="text-text font-medium">v</strong> in it. Faster particles trace bigger circles in <em className="italic text-text">exactly</em>
      ...
      <TryIt
        tag="Try 6.3"
        question={<>A 1 m segment of wire carries <strong className="text-text font-medium">5 A</strong> perpendicular to a uniform <strong className="text-text font-medium">B = 0.1 T</strong> field. What is the force on the segment?</>}
        hint="For a straight wire of length L perpendicular to B, F = B I L."
        answer={
          <>
            <Formula>F = B I L = (0.1 T)(5 A)(1 m) = <strong className="text-text font-medium">0.5 N</strong></Formula>
            <p className="mb-prose-1 last:mb-0">
      ...
      <TryIt
        tag="Try 6.4"
        question={<>A non-relativistic electron with kinetic energy 1 keV enters a <strong className="text-text font-medium">B = 1 mT</strong> field perpendicular to its velocity. What is its cyclotron radius? (m<sub>e</sub> = 9.11×10⁻³¹ kg, e = 1.602×10⁻¹⁹ C.)</>}
        hint="First find v from ½mv² = KE. Then r = mv/(qB)."
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">First convert: KE = 1 keV = 1.602×10⁻¹⁶ J. Solve for v:</p>
            <Formula>v = √(2 · KE / m) = √(2 · 1.602×10⁻¹⁶ / 9.11×10⁻³¹) ≈ 1.88×10⁷ m/s</Formula>
            <p className="mb-prose-1 last:mb-0">(About 6% of c, so non-relativistic is borderline but OK.) Then:</p>
            <Formula>r = m v / (q B) = (9.11×10⁻³¹)(1.88×10⁷) / (1.602×10⁻¹⁹ · 1×10⁻³)</Formula>
            <Formula>r ≈ <strong className="text-text font-medium">0.107 m ≈ 11 cm</strong></Formula>
            <p className="mb-prose-1 last:mb-0">
      ...
      <p className="mb-prose-3">
        ...
        a current-carrying conductor in a transverse <strong className="text-text font-medium">B</strong> field, the magnetic force pushes the carriers
        sideways across the slab until enough of them pile up on one face to make a transverse <em className="italic text-text">electric</em> field
        ...
        <em className="italic text-text"> Hall voltage</em> — has a sign that tells you the sign of the carriers. Edwin Hall used it in 1879 to
      ...
      <p className="mb-prose-3">
        where <strong className="text-text font-medium">B</strong> is the magnetic flux density on the solenoid's axis (in tesla),
        <strong className="text-text font-medium"> μ₀ ≈ 1.257×10⁻⁶ T·m/A</strong> is the permeability of free space <Cite id="codata-2018" in={SOURCES} />,
        <strong className="text-text font-medium"> I</strong> is the current through the wire (in amperes), and <strong className="text-text font-medium">n = N / L</strong> is the number of
        turns per unit length (in turns per metre, with <em className="italic text-text">N</em> the total turn count over solenoid length <em className="italic text-text">L</em>). No dependence on radius (so long as you
      ...
      <p className="mb-prose-3">
        ...
        <em className="italic text-text"> inductor</em>: a coil that opposes any change in current through it because changing current means
      ...
      <p className="mb-prose-3">
        ...
        your new frame is <em className="italic text-text">not</em> electrically neutral. There's a net charge on it, and an honest electric field
        around it — and that field exerts an honest electric force on the test charge. <strong className="text-text font-medium">The force you call
        "magnetic" in one frame is exactly the force you call "electric" in another.</strong> The numbers all match
        out, term for term, because magnetism is what the Coulomb force <em className="italic text-text">has to look like</em> to a moving
        observer to keep relativity consistent <Cite id="feynman-II-13" in={SOURCES} /><Cite id="jackson-1999" in={SOURCES} />.
      </p>
      <p className="mb-prose-3">
        This wasn't how Maxwell or Ampère thought about it. They had two coupled fields, <strong className="text-text font-medium">E</strong> and
        <strong className="text-text font-medium"> B</strong>, with their own equations. It took Einstein in 1905 to point out that the same fields are
      ...
      <CaseStudies
        intro={
          <>
            ...
            magnitude in <strong className="text-text font-medium">B</strong>, all running on the same Biot–Savart and Lorentz equations from this chapter.
          </>
        }
      >
        <CaseStudy
          ...
          summary={<em className="italic text-text">A superconducting solenoid the size of a car, tuned to flip your hydrogen nuclei.</em>}
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            Paul Lauterbur's 1973 paper in <em className="italic text-text">Nature</em> proposed using superimposed magnetic-field gradients on top
            of a strong, uniform static <strong className="text-text font-medium">B₀</strong> to spatially encode an NMR signal — the technique he called
            zeugmatography and that became magnetic resonance imaging<Cite id="lauterbur-1973" in={SOURCES} />. The
            entire scheme depends on the precession of hydrogen nuclei in <strong className="text-text font-medium">B₀</strong>, with the precession
            frequency set by <strong className="text-text font-medium">ω = γ B₀</strong>. A bigger <strong className="text-text font-medium">B₀</strong> means a higher Larmor frequency,
            a larger population difference between spin states, and a stronger signal — which is why clinical scanners
            kept climbing from <strong className="text-text font-medium">0.3 T</strong> in the early 1980s to today's <strong className="text-text font-medium">1.5–3 T</strong>
            workhorses and the small but growing fleet of <strong className="text-text font-medium">7 T</strong> research machines.
          </p>
          <p className="mb-prose-2 last:mb-0">
            None of this is possible with copper. To produce <strong className="text-text font-medium">3 T</strong> uniformly over a meter-scale bore,
            the formula <strong className="text-text font-medium">B = µ₀ n I</strong> for a solenoid demands tens of thousands of ampere-turns. A
            ...
            <strong className="text-text font-medium"> 4 K</strong>; once energised, the coil is short-circuited on itself and the current circulates
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            <strong className="text-text font-medium"> 3 T</strong> field has killed patients. The energy stored in the field, <strong className="text-text font-medium">U = B²/(2µ₀)</strong>
        ...
        <CaseStudy
          ...
          summary={<em className="italic text-text">1232 superconducting magnets, each one bending a proton beam through a 2.8 km arc.</em>}
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            A relativistic proton moving in a magnetic field traces out a circle of radius <strong className="text-text font-medium">r = p / (qB)</strong>.
            For the LHC's design beam energy of <strong className="text-text font-medium">7 TeV</strong>, that radius works out — given the available
            real estate inside the existing LEP tunnel — to demand a bending field of <strong className="text-text font-medium">8.33 T</strong> in the
            dipole sections<Cite id="bruning-lhc-2004" in={SOURCES} />. To produce it, CERN built and installed
            <strong className="text-text font-medium"> 1232</strong> superconducting NbTi dipole magnets, each <strong className="text-text font-medium">14.3 m</strong> long, each carrying
            <strong className="text-text font-medium"> 11,850 A</strong> through its windings at the design point.
          </p>
          <p className="mb-prose-2 last:mb-0">
            NbTi loses its superconductivity above <strong className="text-text font-medium">~9 T</strong> at <strong className="text-text font-medium">4.2 K</strong>; to push the field
            higher you have to push the temperature lower. The LHC's magnets sit in a bath of superfluid helium at
            <strong className="text-text font-medium"> 1.9 K</strong>, which buys back a few hundred millitesla of operating margin and dramatically
            improves the thermal conductivity of the cryogen<Cite id="bruning-lhc-2004" in={SOURCES} />. The whole
            <strong className="text-text font-medium"> 27 km</strong> ring is the largest single piece of cryogenic equipment ever built.
          </p>
          <p className="mb-prose-2 last:mb-0">
            The fundamental physics is the Lorentz force from this chapter: <strong className="text-text font-medium">F = q(v × B)</strong>, with the
            cross-product geometry forcing the orbit closed. The engineering is everything that goes into producing a
            uniform <strong className="text-text font-medium">8.3 T</strong> field, persistent for hours, across <strong className="text-text font-medium">1232</strong> magnets in series,
            with the bore stable to <strong className="text-text font-medium">~100 µm</strong> over kilometers.
          </p>
        </CaseStudy>
        ...
        <CaseStudy
          ...
          summary={<em className="italic text-text">A weak dipole, a leaky shield, and the reason any compass needle ever points north.</em>}
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            total intensity of Earth's surface field as roughly <strong className="text-text font-medium">25,000 nT</strong> near the magnetic equator
            and <strong className="text-text font-medium">65,000 nT</strong> near the poles — i.e., <strong className="text-text font-medium">25–65 µT</strong><Cite id="chulliat-wmm-2020" in={SOURCES} />.
            That is about <strong className="text-text font-medium">fifty thousand times</strong> weaker than a clinical MRI, and about a hundred million
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            fluid carries currents, currents make <strong className="text-text font-medium">B</strong>, and feedback between the fluid motion and the
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            that fixes the cyclotron radius in the earlier section — <strong className="text-text font-medium">r = mv/(qB)</strong> — sets the geometry
        ...
        <CaseStudy
          tag="Case 4.4"
          title="A magnetar"
          summary={<em className="italic text-text">The strongest magnets in the known universe, ten quadrillion times the Earth's field.</em>}
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            order of <strong className="text-text font-medium">10¹⁴–10¹⁵ G</strong>, or <strong className="text-text font-medium">10¹⁰–10¹¹ T</strong>
            <Cite id="duncan-thompson-1992" in={SOURCES} />. They named the objects <em className="italic text-text">magnetars</em>. About thirty
            confirmed examples are known in our galaxy.
          </p>
          <p className="mb-prose-2 last:mb-0">
            At these field strengths the energy density <strong className="text-text font-medium">B²/(2µ₀)</strong> dominates over every other
            astrophysical energy density nearby, including the rest-mass energy density of ordinary matter for fields
            above <strong className="text-text font-medium">~10¹⁰ T</strong>. The vacuum itself becomes birefringent, the quantum electrodynamic
            corrections to Maxwell's equations stop being small, and the atomic structure of any matter on the
            star's surface is reorganised by the field into long, anisotropic chains aligned with <strong className="text-text font-medium">B</strong>
      ...
      <FAQ intro="Twelve questions that come up if you take the relativistic-shadow picture seriously.">
        <FAQItem q="If magnetism is just electricity in a different reference frame, why does a stationary bar magnet stick to my fridge — nothing is moving?">
          <p>
            Something <em className="italic text-text">is</em> moving — you just can't see it. Every iron atom in the magnet contains electrons with
            ...
            atomic level, a frozen pattern of <strong className="text-text font-medium">~10²³</strong> circulating currents per cubic centimeter.
          </p>
          <p>
        ...
        <FAQItem q="Where does a bar magnet's field actually come from at the atomic level — currents, or something else?">
          <p>
            Two contributions, and the second one is bigger. Electrons orbiting nuclei contribute a small <em className="italic text-text">orbital</em>
            magnetic moment, much like a classical current loop. But the dominant effect in iron, nickel, and cobalt is
            <strong className="text-text font-medium"> electron spin</strong> — an intrinsic angular momentum with no classical analog that nonetheless
        ...
        <FAQItem q="Why doesn't a magnetic force do work on a charged particle?">
          <p>
            Because <strong className="text-text font-medium">F = q(v × B)</strong> is, by construction, perpendicular to <strong className="text-text font-medium">v</strong>. The rate of
            work done is <strong className="text-text font-medium">F · v</strong>, and the dot product of any vector with something perpendicular to it
            is zero <Cite id="griffiths-2017" in={SOURCES} />. So a static <strong className="text-text font-medium">B</strong> field can bend a
          ...
          <p>
            ...
            time-varying <em className="italic text-text">electric</em> field between the dees, with the magnetic field doing nothing but holding
        ...
        <FAQItem q="Is there such a thing as a magnetic monopole — a north pole without a south?">
          <p>
            ...
            equations encode this as <strong className="text-text font-medium">∇ · B = 0</strong>: magnetic field lines never end on a source, they only
        ...
        <FAQItem q="Why is the tesla such a huge unit — most magnets seem to be in millitesla or microtesla?">
          <p>
            Because <strong className="text-text font-medium">μ₀ = 4π × 10⁻⁷ T·m/A</strong> is tiny <Cite id="codata-2018" in={SOURCES} />. Plug it into
            the field of a long wire and you find that <strong className="text-text font-medium">1 A</strong> at <strong className="text-text font-medium">1 cm</strong> produces only
            <strong className="text-text font-medium"> ~2×10⁻⁵ T</strong> — twenty microtesla, comparable to the Earth's field at the ground
            <Cite id="griffiths-2017" in={SOURCES} />. A refrigerator magnet is a few millitesla. A clinical MRI is
            <strong className="text-text font-medium"> 1.5 to 3 T</strong>, which is why it takes a superconducting solenoid carrying hundreds of amps to
            produce one.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why do two parallel wires carrying current in the same direction attract, when same-sign charges repel?">
          <p>
            Because magnetic force is not a force between charges; it's a force between <em className="italic text-text">currents</em>, and the
            geometry of <strong className="text-text font-medium">v × B</strong> flips the sign you'd naively expect <Cite id="ampere-1826" in={SOURCES} />.
          ...
          <p>
            ...
            contraction makes the <em className="italic text-text">other</em> wire look slightly positively charged from that frame's perspective,
        ...
        <FAQItem q="What is the right-hand rule actually doing geometrically?">
          <p>
            It's a mnemonic for the orientation of the cross product in a right-handed coordinate system. <strong className="text-text font-medium">v × B</strong>
            is, by definition, perpendicular to both inputs and pointing in whichever of the two perpendicular
            directions makes <strong className="text-text font-medium">{'(v, B, v × B)'}</strong> a right-handed triple <Cite id="griffiths-2017" in={SOURCES} />.
            Your right hand happens to be a right-handed coordinate system, so curling fingers from <strong className="text-text font-medium">v</strong> to
            <strong className="text-text font-medium"> B</strong> with thumb extended encodes the orientation manually.
          </p>
          <p>
            If physics had picked the left-handed convention instead, every formula would still work — you'd just flip
            the sign of <strong className="text-text font-medium">B</strong> everywhere and use your left hand. The choice is conventional; the geometry
            is not.
          </p>
        </FAQItem>
        ...
        <FAQItem q="What is the cyclotron frequency, and why is it independent of the particle's speed?">
          <p>
            From <strong className="text-text font-medium">r = mv/qB</strong> and <strong className="text-text font-medium">T = 2π r/v</strong>, the speed cancels:
          </p>
          <Formula>f = qB / (2π m)</Formula>
          <p>
            Faster particles trace bigger circles in <em className="italic text-text">exactly</em> the same period <Cite id="feynman-II-13" in={SOURCES} />.
            ...
            <strong className="text-text font-medium"> m</strong> gets a γ-factor and the period drifts — fixed by the <em className="italic text-text">synchrotron</em>.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why are some materials magnetic and others not?">
          <p>
            ...
            filled atomic shell, and the net moment is zero or negligible (this is <em className="italic text-text">diamagnetism</em> /
            <em className="italic text-text"> paramagnetism</em>, both of order <strong className="text-text font-medium">10⁻⁵</strong>) <Cite id="griffiths-2017" in={SOURCES} />.
            In iron, nickel, cobalt, and certain rare-earth compounds, an exchange interaction with no classical analog
            energetically favors <em className="italic text-text">parallel</em> alignment of neighboring spins over a domain — millions of atoms
        ...
        <FAQItem q={`What's the difference between B and H — and which one is the "real" magnetic field?`}>
          <p>
            <strong className="text-text font-medium">B</strong> (the magnetic flux density, in tesla) is what shows up in the Lorentz force law and is
            what the rest of physics treats as fundamental. <strong className="text-text font-medium">H</strong> (the magnetic field intensity, in A/m)
            is an engineering bookkeeping construct that separates the field from <em className="italic text-text">free</em> currents you control
            from the field from <em className="italic text-text">bound</em> currents inside magnetized matter
            <Cite id="jackson-1999" in={SOURCES} />. In vacuum they're proportional: <strong className="text-text font-medium">B = μ₀ H</strong>. In
            iron, <strong className="text-text font-medium">B = μ₀(H + M)</strong>, where <strong className="text-text font-medium">M</strong> is the magnetization of the material
            <Cite id="griffiths-2017" in={SOURCES} />.
          </p>
          <p>
            If you only care about what force a charged particle feels, you only need <strong className="text-text font-medium">B</strong>.
          </p>
        </FAQItem>

        <FAQItem q="Why does iron concentrate magnetic field — what is it actually doing?">
          <p>
            Iron's atomic spins align with whatever external <strong className="text-text font-medium">B</strong> field you apply to it, and their
            cooperative magnetization <strong className="text-text font-medium">M</strong> adds to the original field
            <Cite id="griffiths-2017" in={SOURCES} />. The relative permeability <strong className="text-text font-medium">μᵣ</strong> of soft iron is a
            few thousand, meaning the <strong className="text-text font-medium">B</strong> inside the iron can be a few thousand times the
            <strong className="text-text font-medium"> B</strong> you'd have produced in vacuum with the same solenoid current. That's why an
        ...
        <FAQItem q="Can a metal cage shield a region from a magnetic field, the way a Faraday cage shields it from E?">
          <p>
            Not very well, for <em className="italic text-text">static</em> magnetic fields. A Faraday cage works because mobile charges in the
            metal rearrange until the interior electric field is zero — but there are no mobile <em className="italic text-text">magnetic</em>
            charges to rearrange <Cite id="griffiths-2017" in={SOURCES} />. To shield a steady <strong className="text-text font-medium">B</strong> you
          ...
          <p>
            For <em className="italic text-text">time-varying</em> magnetic fields, ordinary conductors do work: the changing flux induces eddy
        ...
        <FAQItem q="If I shake a charge back and forth, does its magnetic field change instantaneously everywhere?">
          <p>
            ...
            propagates outward at the speed of light <strong className="text-text font-medium">c</strong>, never faster
            <Cite id="jackson-1999" in={SOURCES} />. The constants of magnetism and electricity satisfy
            <strong className="text-text font-medium"> μ₀ ε₀ = 1/c²</strong>, which is no coincidence: it's how the wave equation falls out of
        ...
        <FAQItem q="Why does electric current produce a magnetic field, but moving water doesn't?">
          <p>
            ...
            What you need for a net <strong className="text-text font-medium">B</strong> is for one species to move relative to the other — which is
          ...
          <p>
            ...
            in opposite directions — then yes, the flowing ions <em className="italic text-text">do</em> produce a magnetic field, by Ampère's law
        ...
        <FAQItem q="Why does the Hall voltage have a sign — and what did Edwin Hall actually learn from it in 1879?">
          <p>
            The Hall voltage's sign tells you which way the carriers had to deflect in the transverse <strong className="text-text font-medium">B</strong>
            field — and therefore which sign of charge is doing the carrying. Hall measured it on gold and found that
            the carriers behaved as if <em className="italic text-text">negative</em>, two decades before J. J. Thomson identified the electron
          ...
          <p>
            ...
            the <em className="italic text-text">quantum</em> Hall effect, where the transverse conductance becomes precisely <strong className="text-text font-medium">n e²/h</strong>,
