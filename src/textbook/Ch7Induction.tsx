  ...
  return (
    <ChapterShell chapter={chapter}>
      ...
      <p className="mb-prose-3">
        ...
        Not while the current flowed steadily, but at the <em className="italic text-text">moment of connection</em>, and again at the moment of
        disconnection<Cite id="faraday-1832" in={SOURCES} />. The thing that mattered was not the magnetic field. It was
        the magnetic field <em className="italic text-text">changing</em>. Once you can see that distinction, the world reorganises around it.
      ...
      <p className="mb-prose-3">
        ...
        sides of it. One coil — the <em className="italic text-text">primary</em> — was connected to a bank of voltaic cells through a switch. The
        other — the <em className="italic text-text">secondary</em> — was connected to a galvanometer, sitting many feet away to keep its own
      ...
      <p className="mb-prose-3">
        ...
        <em className="italic text-text"> rate of change</em>. He spent the next year confirming this in every form he could think of: bar magnets
      ...
      <p className="mb-prose-3">
        where <strong className="text-text font-medium">Φ<sub>B</sub></strong> is the magnetic flux through the loop (in webers, Wb = T·m² = V·s),
        <strong className="text-text font-medium"> B</strong> is the magnetic field (a vector, in teslas) at each point of the surface, and
        <strong className="text-text font-medium"> dA</strong> is the outward-normal area element of any surface bounded by the loop.
        For a flat loop in a uniform field, this is just <strong className="text-text font-medium">BA cos θ</strong>, where <strong className="text-text font-medium">θ</strong> is the angle
      ...
      <p className="mb-prose-3">
        where <strong className="text-text font-medium">EMF</strong> is the electromotive force around the loop (in volts — the line integral
        <strong className="text-text font-medium"> ∮ E·dℓ</strong> of the induced electric field, equivalently the work per unit charge a free
        charge would gain in one trip around the loop), <strong className="text-text font-medium">Φ<sub>B</sub></strong> is the magnetic flux
        through any surface bounded by the loop (in webers), <strong className="text-text font-medium">t</strong> is time (in seconds), and the
      ...
      <p className="mb-prose-3">
        ...
        <em className="italic text-text"> any</em> surface bounded by the loop — flat, curved, weirdly shaped, doesn't matter. The integral comes out
        the same, because <strong className="text-text font-medium">∇ · B = 0</strong> guarantees that flux is conserved through closed surfaces and
        therefore depends only on the boundary<Cite id="griffiths-2017" in={SOURCES} />. Second, if the loop is wound
        <strong className="text-text font-medium"> N</strong> times around the same flux path, every turn sees the same dΦ/dt and the EMFs add: the total
        is <strong className="text-text font-medium">N · dΦ/dt</strong>. That's why coils have lots of turns. Third, the minus sign is doing real work —
        we'll come back to it.
      </p>
      <p className="mb-prose-3">
        In differential form, the same statement reads <strong className="text-text font-medium">∇ × E = −∂B/∂t</strong>. A magnetic field that changes in
        time produces an electric field that <em className="italic text-text">curls</em>. Crucially, this E exists everywhere in space, not just where
      ...
      <TryIt
        tag="Try 7.1"
        question={<>A 100-turn coil sees the flux through it change by <strong className="text-text font-medium">ΔΦ = 10⁻⁴ Wb</strong> over <strong className="text-text font-medium">Δt = 1 ms</strong>. What is the magnitude of the induced EMF?</>}
        hint="|EMF| = N · |dΦ/dt|."
        answer={
          <>
            <Formula>|EMF| = N · |ΔΦ / Δt| = 100 · (10⁻⁴ Wb / 10⁻³ s)</Formula>
            <Formula>|EMF| = <strong className="text-text font-medium">10 V</strong></Formula>
      ...
      <p className="mb-prose-3">
        ...
        scales with <strong className="text-text font-medium">|dΦ/dt|</strong>, not with <strong className="text-text font-medium">Φ</strong> itself. Drag the turn count up and the lamp
        gets brighter again, because every turn sees the same dΦ/dt and they add in series.
      </p>
      <p className="mb-prose-3">
        The lamp also <em className="italic text-text">changes color</em> when you reverse the magnet's direction. That is the minus sign in
        <strong className="text-text font-medium"> EMF = −dΦ/dt</strong> made visible: flip the sign of dΦ/dt, flip the sign of the EMF, flip the
      ...
      <p className="mb-prose-3">
        ...
        in 1834 and provably equivalent to it: <strong className="text-text font-medium">the induced current always flows in the direction that opposes
      ...
      <p className="mb-prose-3">
        ...
        increases. The induced current organises itself to create its own magnetic field <em className="italic text-text">opposing</em> that
        increase — i.e., pointing the other way through the loop. From the magnet's perspective, the loop now looks
        like another north pole pointing back at it. North repels north. You have to <em className="italic text-text">do work</em> to push the magnet
      ...
      <p className="mb-prose-3">
        ...
        that <em className="italic text-text">maintains</em> the dying flux — a south pole facing the magnet's north. North attracts south. You have
      ...
      <p className="pullout">
        Magnetism never <em className="italic text-text">moves</em>; only the flux does. Move the flux and electricity falls out — paid for in
      ...
      <p className="mb-prose-3">
        ...
        in a fixed field and let the geometry do the work. The flux through a flat coil of area <strong className="text-text font-medium">A</strong>
        rotating at angular rate <strong className="text-text font-medium">ω</strong> in a uniform field <strong className="text-text font-medium">B</strong> is
      </p>
      ...
      <p className="mb-prose-3">
        where <strong className="text-text font-medium">N</strong> is the number of turns in the coil, <strong className="text-text font-medium">B</strong> the uniform magnetic field
        (in teslas), <strong className="text-text font-medium">A</strong> the area of one turn (in m²), <strong className="text-text font-medium">ω</strong> the angular rate of
        rotation (in rad/s), and <strong className="text-text font-medium">t</strong> the time (in seconds); the result is an EMF in volts.
        A pure sine wave whose peak is <strong className="text-text font-medium">NBAω</strong>. Crank up <strong className="text-text font-medium">N, B, A,</strong> or <strong className="text-text font-medium">ω</strong>
        and the amplitude grows in proportion. The frequency you get is <strong className="text-text font-medium">f = ω / (2π)</strong>. North American
        wall-outlet power is 60 Hz, which corresponds to a generator shaft turning at <strong className="text-text font-medium">ω = 2π · 60 ≈ 377 rad/s</strong>
      ...
      <p className="mb-prose-3">
        The oscilloscope above tells you <em className="italic text-text">what</em> comes out the terminals; it does not, by itself, tell you
        <em className="italic text-text"> why</em> a constant rotation has to produce a sinusoid. The reason is geometric, and geometry is
        easier to see in three dimensions than two. The flux through a flat loop is not
        <strong className="text-text font-medium"> B·A</strong> — it is <strong className="text-text font-medium">B·A·cos θ</strong>, where θ is the angle between the loop's normal
      ...
      <p className="mb-prose-3">
        ...
        pivot relative to B, watch the translucent disc fill and fade as <strong className="text-text font-medium">cos θ</strong> swings from +1 to
      ...
      <TryIt
        tag="Try 7.2"
        question={<>A 50-turn coil with area <strong className="text-text font-medium">A = 100 cm²</strong> rotates at <strong className="text-text font-medium">60 Hz</strong> in a uniform <strong className="text-text font-medium">B = 0.1 T</strong> field. What is the peak induced EMF?</>}
        hint="Peak EMF = NBAω, with ω = 2πf."
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">Convert: A = 100 cm² = 0.01 m²; ω = 2π · 60 ≈ 377 rad/s.</p>
            <Formula>EMF<sub>peak</sub> = N B A ω = 50 · 0.1 · 0.01 · 377</Formula>
            <Formula>EMF<sub>peak</sub> ≈ <strong className="text-text font-medium">18.85 V</strong></Formula>
            <p className="mb-prose-1 last:mb-0">
      ...
      <p className="mb-prose-3">
        ...
        Wind two coils around a shared iron core and the same flux <strong className="text-text font-medium">Φ(t)</strong> threads both of them. Apply Faraday's law to
        each:
      </p>
      <Formula>V₁ = N₁ · dΦ/dt &nbsp;&nbsp;&nbsp; V₂ = N₂ · dΦ/dt</Formula>
      <p className="mb-prose-3">
        where <strong className="text-text font-medium">V₁</strong> and <strong className="text-text font-medium">V₂</strong> are the (open-circuit) terminal voltages on the primary
        and secondary (in volts), <strong className="text-text font-medium">N₁</strong> and <strong className="text-text font-medium">N₂</strong> are the corresponding turn counts,
        and <strong className="text-text font-medium">dΦ/dt</strong> is the time rate of change of the shared core flux through one turn (in Wb/s = V).
      ...
      <p className="mb-prose-3">
        ...
        <strong className="text-text font-medium"> I₂ / I₁ = N₁ / N₂</strong>, so power <strong className="text-text font-medium">VI</strong> is preserved across the transformer. You
      ...
      <TryIt
        ...
        answer={
          <>
            ...
            <Formula>V₂ = <strong className="text-text font-medium">46 V</strong></Formula>
            <p className="mb-prose-1 last:mb-0">
      ...
      <p className="mb-prose-3">
        The reason this matters at planetary scale is the <strong className="text-text font-medium">I²R</strong> loss in transmission lines. The power
        delivered down a wire is <strong className="text-text font-medium">P = V · I</strong>, but the heat dissipated along the way is
        <strong className="text-text font-medium"> I² · R<sub>line</sub></strong>. If you can carry the same power at ten times the voltage and a tenth
        the current, your transmission losses drop by a factor of <strong className="text-text font-medium">100</strong>. That is why the grid runs at
      ...
      <p className="mb-prose-3">
        ...
        changes, Faraday's law produces a back-EMF in the same loop — this is <Term def="The coil's own resistance to a changing current. A current I in a coil sets up flux Φ proportional to I, and dI/dt produces a back-EMF V = −L dI/dt. SI unit is the henry.">self-inductance</Term> <strong className="text-text font-medium">L</strong>,
        defined by <strong className="text-text font-medium">V = −L dI/dt</strong>. For two separate coils, a changing current in one induces a voltage
        in the other through their shared flux — that is <Term def="The coupling coefficient M between two coils, defined by V₂ = −M dI₁/dt. A transformer is engineered to maximise M; a magnetically shielded inductor is engineered to minimise it.">mutual inductance</Term> <strong className="text-text font-medium">M</strong>.
      ...
      <TryIt
        tag="Try 7.4"
        question={<>What is the self-inductance of a long air-core solenoid with <strong className="text-text font-medium">N = 1000 turns</strong>, length <strong className="text-text font-medium">ℓ = 10 cm</strong>, and cross-section <strong className="text-text font-medium">A = 1 cm²</strong>?</>}
        ...
        answer={
          <>
            ...
            <Formula>L ≈ <strong className="text-text font-medium">1.26×10⁻³ H ≈ 1.26 mH</strong></Formula>
            <p className="mb-prose-1 last:mb-0">
      ...
      <p className="mb-prose-3">
        ...
        <strong className="text-text font-medium"> B</strong> produces a curling <strong className="text-text font-medium">E</strong> in empty space, then by symmetry — once you add the
        <em className="italic text-text">displacement current</em> term to Ampère's law — a changing <strong className="text-text font-medium">E</strong> produces a curling
        <strong className="text-text font-medium"> B</strong> in empty space too<Cite id="maxwell-1865" in={SOURCES} />. Pair the two and you have a
      ...
      <CaseStudies
        intro={
          <>
            Three industries built directly on top of <strong className="text-text font-medium">EMF = −dΦ/dt</strong> — operating at wildly different
      ...
      >
        <CaseStudy
          ...
          summary={<em className="italic text-text">Every wall outlet on Earth traces back to a coil spinning past a magnet at 50 or 60 Hz.</em>}
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            at angular rate <strong className="text-text font-medium">ω</strong> inside a stator carrying <strong className="text-text font-medium">N</strong> turns of copper, and the
            stator sees a flux that swings as <strong className="text-text font-medium">Φ(t) = NBA cos(ωt)</strong>. Faraday's law immediately gives
            the peak terminal voltage <strong className="text-text font-medium">NBAω</strong> at exactly the angular frequency of the rotor
            ...
            rational multiple of the same <strong className="text-text font-medium">ω</strong>.
          </p>
          <p className="mb-prose-2 last:mb-0">
            ...
            <strong className="text-text font-medium"> 765 kV</strong> long-distance link carries the same power as a hypothetical <strong className="text-text font-medium">7.65 kV</strong>
            ...
            <strong className="text-text font-medium"> V₂/V₁ = N₂/N₁</strong> is exact in the lossless limit and stays within a few percent in
            practice.
          </p>
          <p className="mb-prose-2 last:mb-0">
        ...
        <CaseStudy
          ...
          summary={<em className="italic text-text">An air-gap transformer at 100–200 kHz, sitting under your nightstand.</em>}
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            <strong className="text-text font-medium"> 110–205 kHz</strong> band; the secondary coil, embedded in the back of the phone, sees a
            time-varying flux and develops an induced EMF by Faraday's law<Cite id="wpc-qi-1.3" in={SOURCES} />.
            Baseline Power Profile devices deliver up to <strong className="text-text font-medium">5 W</strong>; the Extended Power Profile reaches
            <strong className="text-text font-medium"> 15 W</strong>.
          </p>
          <p className="mb-prose-2 last:mb-0">
            Without an iron core threading both coils, the coupling coefficient <strong className="text-text font-medium">k = M / √(L₁ L₂)</strong>
            ...
            <strong className="text-text font-medium"> 60–80%</strong>, versus <strong className="text-text font-medium">≥ 95%</strong> for a USB-C cable<Cite id="feynman-II-17" in={SOURCES} />.
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            below the relevant EMC limits. The whole industry runs the equation <strong className="text-text font-medium">EMF = −N dΦ/dt</strong>
            written for an air-gap coupling, at a frequency chosen to make <strong className="text-text font-medium">dΦ/dt</strong> large enough to
        ...
        <CaseStudy
          ...
          summary={<em className="italic text-text">A short-circuited transformer that happens to be your saucepan.</em>}
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            <strong className="text-text font-medium"> 20–100 kHz</strong> range<Cite id="lucia-induction-2014" in={SOURCES} />. The resulting
            oscillating <strong className="text-text font-medium">B</strong> field penetrates the glass (which is essentially invisible to it) and
          ...
          <p className="mb-prose-2 last:mb-0">
            Wall-to-pan efficiencies of <strong className="text-text font-medium">85–90%</strong> are routine, well above the ~40% you get from a
      ...
      >
        <FAQItem q="Why does a magnet at rest near a coil produce no current, but one in motion does?">
          <p>
            Faraday's law cares about <strong className="text-text font-medium">dΦ/dt</strong>, not <em className="italic text-text">Φ</em>. A stationary magnet pins down a perfectly
            ...
            (by <strong className="text-text font-medium">∇ × E = −∂B/∂t</strong>) means a curling electric field appears in the wire and pushes the
        ...
        <FAQItem q="What is &ldquo;flux,&rdquo; in plain words?">
          <p>
            Magnetic flux is <strong className="text-text font-medium">how many field lines pierce a surface</strong>, weighted by how perpendicular
            they hit it. Formally:
          </p>
          <Formula>Φ<sub>B</sub> = ∫∫ B · dA</Formula>
          <p>
            For a flat loop in a uniform field, that's just <strong className="text-text font-medium">BA cos θ</strong>: field strength times area
        ...
        <FAQItem q="Why is there a minus sign in EMF = −dΦ/dt? What goes wrong without it?">
          <p>
            The minus sign is <strong className="text-text font-medium">Lenz's law</strong>: the induced current always flows so as to <em className="italic text-text">oppose</em>
            the change in flux that caused it<Cite id="feynman-II-17" in={SOURCES} />. Without it, the induced
            current would <em className="italic text-text">reinforce</em> the change, accelerating the magnet that produced it, which would
        ...
        <FAQItem q="Could you generate AC from a stationary coil if the magnetic field were changing on its own?">
          <p>
            Yes, and that's exactly how a <strong className="text-text font-medium">transformer</strong> works. Neither coil moves; an alternating
            current in the primary makes the iron core's <strong className="text-text font-medium">B</strong> oscillate, and the oscillating flux
            ...
            <strong className="text-text font-medium"> dΦ/dt</strong> appears in the equation<Cite id="griffiths-2017" in={SOURCES} />. The two cases
        ...
        <FAQItem q="Why is a transformer useless on DC?">
          <p>
            A DC current in the primary makes a steady magnetic flux through the core, so <strong className="text-text font-medium">dΦ/dt = 0</strong>
            in the secondary — no induced EMF<Cite id="feynman-II-17" in={SOURCES} />. The only moment a DC primary
            does anything is the instant you <em className="italic text-text">switch it on or off</em>, which is precisely the moment Faraday
        ...
        <FAQItem q="Does Lenz's law violate Newton's third law? The magnet seems to feel a &ldquo;back force.&rdquo;">
          <p>
            The opposite, actually — it <em className="italic text-text">enforces</em> Newton's third law. When you push a magnet into a coil,
            the induced current produces its own magnetic field that pushes <strong className="text-text font-medium">back</strong> on the magnet with
            ...
            <strong className="text-text font-medium"> F = qv × B</strong>, and the loop's induced current pushes the magnet via the equal-and-opposite
        ...
        <FAQItem q="Why does dropping a magnet through a copper tube fall so slowly?">
          <p>
            ...
            rapidly. That induces large azimuthal <strong className="text-text font-medium">eddy currents</strong> in the copper, and by Lenz's law
            those currents organise themselves to <em className="italic text-text">oppose</em> the changing flux — i.e., they create a field
        ...
        <FAQItem q="What's the difference between EMF and voltage?">
          <p>
            <strong className="text-text font-medium">Voltage</strong> is the line integral of a <em className="italic text-text">conservative</em> electric field — the kind that
            comes from static charges, where ∮E·dℓ around any closed loop is zero. <strong className="text-text font-medium">EMF</strong> is the line
            integral of <em className="italic text-text">any</em> field that does work on charges around a loop, including the curling
            non-conservative E induced by a changing B<Cite id="jackson-1999" in={SOURCES} />. For an induced EMF,
            <strong className="text-text font-medium"> ∮ E · dℓ = − dΦ/dt ≠ 0</strong> — the field isn't conservative, so calling it a &ldquo;potential
        ...
        <FAQItem q="Why do generators need to be physically big to make big currents?">
          <p>
            The peak EMF from a rotating coil is <strong className="text-text font-medium">NBAω</strong><Cite id="griffiths-2017" in={SOURCES} />.
            Frequency <strong className="text-text font-medium">ω</strong> is fixed by the grid (377 rad/s in North America), and B is capped by the
            saturation field of iron (~1.5 T). That leaves only <strong className="text-text font-medium">N</strong> (turns) and
            <strong className="text-text font-medium"> A</strong> (loop area) as engineering knobs, and the current you can draw from the machine is
        ...
        <FAQItem q="What's a &ldquo;self-induced EMF&rdquo; versus a &ldquo;mutual&rdquo; one?">
          <p>
            ...
            <strong className="text-text font-medium"> self-inductance L</strong>, defined by <em className="italic text-text">V = −L dI/dt</em><Cite id="griffiths-2017" in={SOURCES} />.
            <strong className="text-text font-medium"> Mutual inductance M</strong> is the same idea but between two separate coils: a changing
            current in coil 1 produces a changing flux through coil 2, inducing EMF <em className="italic text-text">V₂ = −M dI₁/dt</em>. A
            transformer is engineered to maximise <em className="italic text-text">M</em>; a noise-suppression choke is engineered to maximise
            its own <em className="italic text-text">L</em><Cite id="feynman-II-17" in={SOURCES} />.
          </p>
        </FAQItem>

        <FAQItem q="Could you make a perpetual motion machine if you could just reverse Lenz's sign?">
          <p>
            That's a tidy way to see why the sign is fixed. If the induced current <em className="italic text-text">attracted</em> an approaching
            magnet instead of repelling it, the magnet would accelerate as it entered the coil, do <em className="italic text-text">negative</em>
        ...
        <FAQItem q="Why does opening a switch on an inductor cause a spark?">
          <p>
            An inductor stores energy <em className="italic text-text">½LI²</em> in its magnetic field. When you open the switch, you're trying
            to drive <strong className="text-text font-medium">I</strong> to zero in microseconds, which means <strong className="text-text font-medium">dI/dt</strong> spikes to a huge
            negative number. The self-induced EMF <em className="italic text-text">V = −L dI/dt</em> spikes to a correspondingly huge
            <em className="italic text-text">positive</em> voltage — often hundreds or thousands of volts across a small motor coil — and that
        ...
        <FAQItem q="What is &ldquo;back-EMF&rdquo; in an electric motor?">
          <p>
            ...
            <em className="italic text-text"> opposing</em> the applied terminal voltage<Cite id="feynman-II-17" in={SOURCES} />. That opposing
            voltage is the back-EMF, and it scales linearly with the shaft speed. The actual current through the
            motor is <em className="italic text-text">I = (V<sub>applied</sub> − V<sub>back-EMF</sub>) / R<sub>winding</sub></em> — which is why a
        ...
        <FAQItem q="Why does the grid run at 50 or 60 Hz instead of 1 Hz or 1 kHz?">
          <p>
            ...
            larger transformers and motors — the volt-seconds per turn scale as <strong className="text-text font-medium">V/(Nf)</strong>, so halving
            <strong className="text-text font-medium"> f</strong> means doubling iron cross-section to avoid saturation<Cite id="griffiths-2017" in={SOURCES} />.
            Too high and the I²R-like <em className="italic text-text">eddy-current</em> and <em className="italic text-text">hysteresis</em> losses in iron cores grow,
        ...
        <FAQItem q="Why is a transformer made of laminated iron rather than solid iron?">
          <p>
            ...
            circulating <strong className="text-text font-medium">eddy currents</strong> in the iron itself, which dissipate energy as I²R heat and
        ...
        <FAQItem q="How fast does induction &ldquo;communicate&rdquo;? Is it instant?">
          <p>
            ...
            <strong className="text-text font-medium"> ∇ × E = −∂B/∂t</strong>, combined with Maxwell's added displacement current
            <strong className="text-text font-medium"> ∇ × B = μ₀ε₀ ∂E/∂t</strong>, has wave solutions travelling at exactly
            <em className="italic text-text"> c = 1/√(μ₀ε₀)</em><Cite id="maxwell-1865" in={SOURCES} />. So when you change the current in the
        ...
        <FAQItem q="What happens to the energy if the secondary of a transformer is open-circuit?">
          <p>
            ...
            open-circuit voltage and does no work. The primary still draws a small <em className="italic text-text">magnetising current</em>
