  ...
  return (
    <ChapterShell chapter={chapter}>
      <p className="chapter-intro">
        We've spent five chapters building toward a single question, and never asking it. A battery
        sits on the workbench. A bulb sits a meter away. They're connected by a length of copper
        wire. You close the switch, the bulb glows, and the battery loses chemical energy at exactly
        the rate the bulb gains heat and light.{' '}
      ...
      <p className="mb-prose-3">
        ...
        <em className="text-text italic"> around</em> the wire, in the form of the electromagnetic
        field, and pours inward into the resistive parts on every side at once. The wire isn't the
        medium. The wire is the destination. Maxwell wrote it down in 1865
        <Cite id="maxwell-1865" in={SOURCES} />, Poynting finished it in 1884
        <Cite id="poynting-1884" in={SOURCES} />, and Feynman called it "crazy" before teaching it
        anyway
        <Cite id="feynman-II-27" in={SOURCES} />. This last chapter is the proof.
      </p>
      ...
      <p className="mb-prose-3">
        ...
        flow of charge. It is not a flow of <em className="text-text italic">energy</em>. The two
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">radial flux</strong> — energy or field flow
              pointing along the cylindrical radius (toward or away from the axis). For a
              current-carrying wire, the Poynting vector points radially inward at the surface.
            </>
          }
        >
          radially inward
        </Term>
        , perpendicular to both, on every side of the wire at once. Energy is flowing into the wire.
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">surface integral</strong> — the integral of
              a vector field's normal component over a (typically closed) surface. For the Poynting
              vector, ∮ S · dA gives the total electromagnetic power flowing across that surface.
            </>
          }
        >
          surface integral
      ...
      <p className="mb-prose-3">
        ...
        <Term
          def={
            <>
              <strong className="text-text font-medium">Poynting flux</strong> — the integral of the
              Poynting vector over a surface, ∮ S · dA. Gives the net electromagnetic power crossing
              that surface in watts.
            </>
          }
        >
          Poynting flux
        </Term>{' '}
        through the wire's surface equals the dissipated power, identically, by construction. No
        approximation. No "in the limit of." It is the same quantity, written in two different ways
      ...
      <PredictThenObserve
        ...
        question={
          <>
            A battery powers a bulb through two copper wires. The energy that ends up lighting the
            bulb travels primarily through …
          </>
        }
        spec={{
      ...
      <TryIt
        ...
        question={
          <>
            ...
            <strong className="text-text font-medium">a = 1 mm</strong> and length{' '}
            <strong className="text-text font-medium">L = 1 m</strong> drops
            <strong className="text-text font-medium"> V = 12 V</strong> across its ends while
            carrying <strong className="text-text font-medium">I = 5 A</strong>. Compute the
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              Use the surface formula derived in this section
              <Cite id="feynman-II-27" in={SOURCES} />:
            </p>
      ...
      <TryIt
        ...
        question={
          <>
            ...
            <strong className="text-text font-medium">VI</strong>.
          </>
        }
        hint={
          <>
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              The lateral surface area is <strong className="text-text font-medium">2π a L</strong>.
            ...
            <p className="mb-prose-1 last:mb-0">
              ...
              <em className="text-text italic">VI</em> = 12 × 5 = 60 W. The 2π a L on top cancels
      ...
      <p className="mb-prose-3">
        ...
        <strong className="text-text font-medium">E</strong> and{' '}
        <strong className="text-text font-medium">B</strong> at every point in the surrounding space
        and integrating <strong className="text-text font-medium">S</strong> in and out of the
      ...
      <p className="mb-prose-3">
        From microscopic Ohm's law, <strong className="text-text font-medium">E = J/σ</strong>. As σ
        → ∞ at fixed current density, the axial field inside the conductor must go to zero. (You
        cannot sustain a non-zero <strong className="text-text font-medium">E</strong> in a perfect{' '}
        <Term
          def={
            <>
              <strong className="text-text font-medium">superconductor</strong> — a material with
              exactly zero DC electrical resistance below a critical temperature. Persistent
              currents flow with no voltage drop and no dissipation; the axial E-field inside
              vanishes.
            </>
          }
        >
        ...
        <strong className="text-text font-medium">E</strong> inside the wire vanishes, and so does{' '}
        <strong className="text-text font-medium">S</strong>
      ...
      <p className="mb-prose-3">
        ...
        flows, which constrains where <strong className="text-text font-medium">B</strong> is, which
      ...
      <TryIt
        ...
        question={
          <>
            ...
            peak electric-field amplitude <em className="text-text italic">E₀</em> in the wave?
          </>
        }
        hint={
          <>
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              The time-averaged Poynting magnitude for a plane wave is
              <Cite id="jackson-1999" in={SOURCES} />:
            </p>
            <Formula tex="\\langle|S|\\rangle = \\tfrac{1}{2} c \\varepsilon_0 E_0^2" />
            <p className="mb-prose-1 last:mb-0">
              Solve for <em className="text-text italic">E₀</em>:
            </p>
            <Formula tex="E_0 = \\sqrt{2 \\langle|S|\\rangle / (c \\varepsilon_0)}" />
            <p className="mb-prose-1 last:mb-0">
              Plug in <em className="text-text italic">⟨|S|⟩</em> = 1361 W/m²
              <Cite id="kopp-lean-2011" in={SOURCES} />, <em className="text-text italic">c</em> =
              2.998×10⁸ m/s, and
            ...
            <p className="mb-prose-1 last:mb-0">
              About <strong className="text-text font-medium">1.0 kV/m</strong> of peak oscillating
              electric field, threading every cubic meter of space between here and the Sun.
            </p>
          </>
        }
      />
      ...
      <TryIt
        ...
        question={
          <>
            An ideal lossless capacitor is driven by a sinusoidal voltage source. Over one complete
            AC cycle, what is the net Poynting flux into the capacitor's volume?
          </>
        }
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              ...
              capacitor charges, <strong className="text-text font-medium">S</strong> flows radially
              inward from the surrounding space into the gap, building up field energy{' '}
              <em className="text-text italic">½ ε₀ E²</em> per unit volume in the dielectric. On
            ...
            <p className="mb-prose-1 last:mb-0">
              In circuit-theory language, an ideal capacitor consumes zero{' '}
              <em className="text-text italic">real</em> power; in field language, the Poynting flux
              is purely reactive. Energy sloshes in and out through space twice per cycle with no
              net transfer.
            </p>
          </>
        }
      ...
      <TryIt
        ...
        question={
          <>
            ...
            formula <em className="text-text italic">P = V²/R</em>, show that the Poynting flow into
        ...
        answer={
          <>
            <p className="mb-prose-1 last:mb-0">
              The current is <em className="text-text italic">I = V/R</em> = 10 / 100 ={' '}
            ...
            <p className="mb-prose-1 last:mb-0">
              And for cross-check, <em className="text-text italic">V²/R</em> = 100 / 100 ={' '}
              ...
              <strong className="text-text font-medium">J·E</strong>, balanced by Poynting's theorem
              <Cite id="poynting-1884" in={SOURCES} />.
            </p>
          </>
        }
      ...
      <CaseStudies
        intro={
          <>
            Three places the Poynting picture is not a thought experiment but the standard
            engineering description — from a coaxial cable on a workbench to the entire global solar
            energy budget.
          </>
        }
      >
        <CaseStudy
          ...
          summary={
            <em className="text-text italic">
              The signal travels in the plastic between the conductors. The copper just guides it.
            </em>
          }
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            <strong className="text-text font-medium">B</strong> is purely circumferential. Their
            ...
            <strong className="text-text font-medium">S</strong> over any cross-section of the
            dielectric and the answer is <strong className="text-text font-medium">VI</strong> —
        ...
        <CaseStudy
          ...
          summary={
            <em className="text-text italic">
              1361 watts per square meter, streaming across 150 million kilometers of vacuum.
            </em>
          }
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            ...
            <strong className="text-text font-medium">|S|</strong> arriving at the top of Earth's
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            <strong className="text-text font-medium">E</strong> and{' '}
            <strong className="text-text font-medium">B</strong> are mutually perpendicular and in
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            thin semiconductor and partly redirected into an electrical circuit. The absorption
        ...
        <CaseStudy
          ...
          summary={
            <em className="text-text italic">
              A superconducting transmission line in service: nearly all the energy stays in the
              dielectric.
            </em>
          }
          specs={[
        ...
        >
          <p className="mb-prose-2 last:mb-0">
            High-temperature superconducting (HTS) power cables have been operated at utility scale
            since the mid-2000s — Yokohama, Albany, Essen and others — using BSCCO- or YBCO-coated
            tape conductors cooled by forced-flow liquid nitrogen at around{' '}
            <strong className="text-text font-medium">70 K</strong>
            <Cite id="green-bohn-2015" in={SOURCES} />. Inside the superconducting core the DC
            resistance is exactly zero; even at{' '}
            <strong className="text-text font-medium">50/60 Hz</strong>
            the residual AC loss in the tape is a few watts per meter, dwarfed by the cryogenic
          ...
          <p className="mb-prose-2 last:mb-0">
            ...
            whatever normal-conducting load finally closes the circuit at the far end
            <Cite id="jackson-1999" in={SOURCES} />. The leads are rails for the field; the resistor
      ...
      <FAQ intro="The last chapter is the one that produces the most leftover questions. These are the ones that come up when the picture has finally landed and the reader starts pressing on it.">
        <FAQItem q="If the energy flows through space and not the wire, why does the wire matter at all?">
          <p>
            ...
            <strong className="text-text font-medium">E</strong> and{' '}
            <strong className="text-text font-medium">B</strong> both have components transverse to
            ...
            <strong className="text-text font-medium">E</strong>, no enclosed current to set up the
            circumferential <strong className="text-text font-medium">B</strong>, no{' '}
            <strong className="text-text font-medium">S</strong>. The wire isn't carrying energy;
        ...
        <FAQItem q="Where does the Poynting vector get its energy from in the first place?">
          <p>
            From the battery — or whatever EMF source is driving the circuit. Inside an ideal
            battery, chemical (or mechanical, or thermal) energy is converted into field energy: the
            source maintains a non-electrostatic force that does work pushing positive charge from
            low to high potential, and that work ends up stored in the electromagnetic field
            surrounding the whole circuit
            <Cite id="griffiths-2017" in={SOURCES} />. Davis and Kaplan verified this explicitly for
        ...
        <FAQItem q="Is the Poynting flow real, or is it just a bookkeeping convenience?">
          ...
          <p>
            ...
            density <strong className="text-text font-medium">u</strong> changes at any point only
            by net
            <strong className="text-text font-medium"> S</strong> divergence or by mechanical work
            done on charge
            ...
            fix <strong className="text-text font-medium">S</strong> up to the curl of an arbitrary
        ...
        <FAQItem q="If I cut the wire mid-circuit, the bulb goes out almost instantly. What changed in the field?">
          <p>
            ...
            <strong className="text-text font-medium">E</strong> inside what's left of the wire is
            cancelled — and once <strong className="text-text font-medium">E</strong> inside the
            conductor goes to zero, so does <InlineMath tex="\\vec{J} = \\sigma\\vec{E}" /> and so
            does the circumferential <strong className="text-text font-medium">B</strong>. With both
            ...
            cut at roughly ⅔ <em className="text-text italic">c</em> in copper, which is why
        ...
        <FAQItem q="Does the Poynting picture also work in AC circuits?">
          <p>
            ...
            <strong className="text-text font-medium">S(t)</strong> oscillates with them — but the
        ...
        <FAQItem q="Inside an ideal battery, what direction does the Poynting flow point?">
          <p>
            ...
            high potential, so the current <strong className="text-text font-medium">J</strong> is
            opposite to the electrostatic <strong className="text-text font-medium">E</strong>.
            ...
            <strong className="text-text font-medium">S</strong> leaving the battery's volume
            <Cite id="poynting-1884" in={SOURCES} />. Davis and Kaplan plotted the streamlines
            explicitly: <strong className="text-text font-medium">S</strong>
        ...
        <FAQItem q="In a purely capacitive circuit with no resistance, where does the energy go?">
          <p>
            ...
            <strong className="text-text font-medium">S</strong> points radially{' '}
            <em className="text-text italic">inward</em> from the surrounding space into the gap,
            depositing energy in the growing
            <strong className="text-text font-medium"> E</strong>-field there. The total stored
            ...
            <strong className="text-text font-medium">S</strong> flows out of the gap into the
        ...
        <FAQItem q="Has anyone directly measured the Poynting vector around a wire?">
          <p>
            ...
            <strong className="text-text font-medium">S</strong> from independent measurements of{' '}
            <strong className="text-text font-medium">E</strong> and
            <strong className="text-text font-medium"> B</strong> and verify that the surface
        ...
        <FAQItem q="In a superconductor the Poynting flow doesn't enter the wire. Where does the energy actually end up?">
          <p>
            ...
            <strong className="text-text font-medium">E</strong> inside the superconductor vanishes,
            ...
            element finally closes the circuit (a normal-conducting load, the room-temperature
        ...
        <FAQItem q="Is the Poynting picture compatible with quantum mechanics?">
          <p>
            ...
            <strong className="text-text font-medium">S</strong> to extraordinary accuracy
            ...
            probabilistic one. For the DC and 60 Hz and gigahertz cases that run civilization, the
            photon number per cubic wavelength is astronomical and the classical Poynting picture is
            exact for any practical purpose
            <Cite id="griffiths-2017" in={SOURCES} />.
          </p>
        </FAQItem>
        ...
        <FAQItem q="Why is the field energy density quadratic in the fields, rather than linear?">
          <p>
            ...
            <strong className="text-text font-medium">Q</strong> requires moving each successive{' '}
            <strong className="text-text font-medium">dq</strong> against the already-present
        ...
        <FAQItem q="Is the Poynting picture the same as electromagnetic waves carrying energy?">
          <p>
            ...
            which <strong className="text-text font-medium">E</strong>
            and <strong className="text-text font-medium">B</strong> are mutually perpendicular and
        ...
        <FAQItem q="Could you, in principle, build a wireless transmission line using the Poynting picture as a design guide?">
          <p>
            You already have. Every radio link, every microwave oven cavity, every
            laser-power-beaming demonstration is literally an engineered Poynting flux from source
            to load through space
            <Cite id="jackson-1999" in={SOURCES} />. The interesting case is the near-field one: a
            tightly resonant pair of coils can exchange energy with efficiency comparable to a wired
            link, because the Poynting flux is sharply concentrated between them. That's how
            wireless phone chargers, RFID, and proposed grid-scale wireless transmission all work —
            and from the field's point of view, even a normal wired circuit is "wireless" in the
            sense that no joules ever pass through the conductors
            <Cite id="feynman-II-27" in={SOURCES} />.
          </p>
        </FAQItem>
      </FAQ>
