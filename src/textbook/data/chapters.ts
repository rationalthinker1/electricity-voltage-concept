...
export const TRACKS: Record<TrackId, { name: string; description: string; accent: string }> = {
  practical: {
    ...
    description: 'For wiring a house and reading a panel safely.',
    accent: 'teal',
  },
  bench: {
    name: 'Bench engineer',
    description: 'For designing analog and digital electronics.',
    accent: 'accent',
  },
  rigor: {
    name: 'Physics rigor',
    description: 'For the full Maxwell-relativity-Poynting story.',
    accent: 'pink',
  },
};
...
export const CHAPTERS: ChapterEntry[] = [
  ...
  },
  {
    ...
    relatedLabs: ['ohms-law', 'joule'],
    sources: ['nec-2023', 'sae-j1772', 'ul-2231', 'iec-62196', 'iec-60479-2018', 'codata-2018'],
    punchline:
