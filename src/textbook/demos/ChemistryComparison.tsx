...
export function ChemistryComparisonDemo({ figure }: Props) {
  ...
  return (
    <Demo
      ...
      caption={
        <>
          All six chemistries are intercalation cells; the trade-offs come from cathode choice. LFP
          wins on cycle life and safety; NMC and NCA win on energy density; lead-acid stays in the
          picture because of cost and rugged high-current delivery. Numbers are typical mid-2020s
