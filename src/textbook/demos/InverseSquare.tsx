...
export function InverseSquareDemo({ figure }: Props) {
  ...
  return (
    <Demo
      ...
      caption={
        <>
          Both axes are logarithmic. The curve is a straight line of slope <strong>−2</strong> — the
          algebraic signature of an inverse-square law. Slide <strong>r</strong> from 1&nbsp;cm to
          1&nbsp;m and the force changes by four orders of magnitude.
        </>
      }
