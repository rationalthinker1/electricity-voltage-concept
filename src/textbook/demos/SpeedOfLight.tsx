    ...
    <Demo
      ...
      caption={
        <>
          ...
          and the bottom pulse arrives a factor of √2.25 = 1.5 too late.{' '}
          <strong>The refractive index n = √(εᵣ μᵣ)</strong> is just this slowdown factor.
        </>
      }
    >
...
function drawPulse(ctx: CanvasRenderingContext2D, cx: number, cy: number, color: string) {
