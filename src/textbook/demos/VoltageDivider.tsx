  ...
  return (
    ...
    >
      ...
      <EquationStrip
        ...
        right={<M tex={`V_\\text{out (loaded)} = ${Vout.toFixed(2)}\\,\\text{V}`} />}
      />
    </Demo>
  );
}
